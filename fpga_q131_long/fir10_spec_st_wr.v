...
module fir10_spec_st_wr(clk, rst, clk_en, input_ch_id,
output_ch_id,
rdy_to_ld, done, data_in, fir_result);
parameter OUT_WIDTH = 61;
parameter IN_WIDTH = 28;
parameter FACTOR = 10;
parameter ACCUM_WIDTH = 61;
...
wire [60:0]fir_int_res_fill;
assign fir_int_res_fill =  fir_int_res[60 :0];
