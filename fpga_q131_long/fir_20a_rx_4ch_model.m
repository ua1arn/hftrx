...
% Generated on: Dec 31, 2022 12:04:49 PM
...
coef_in_file = fopen ('fir_20a_rx_4ch_coef_reload.txt', 'r');
h = fscanf(coef_in_file, '%d' );
h = h';
fclose(coef_in_file);
...
for j = 1:sx
    ...
    %
    file_name = ['fir_20a_rx_4ch_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model                   
      output = fir_20a_rx_4ch_mlab(data_channel,h);
    ...
    file_name = ['fir_20a_rx_4ch_model_output'];
    ...
    fprintf(outfile2, '%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n',reshaped_output_full');
    fclose(outfile2);        
end      
