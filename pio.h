...
#define PIO_H_INCLUDED
	...
	#define BSRR_S(v) ((v) * GPIO_BSRR_BS0)	/* ѕреобразование значени€ дл€ установки бита в регистре */
	#define BSRR_C(v) ((v) * GPIO_BSRR_BR0)	/* ѕреобразование значени€ дл€ сброса бита в регистре */

	// ѕараметры дл€ arm_stm32f30x_hardware_pio_prog
		...
		/* —пасибо ST, что исправили опечатки в заголовочном файле */
...
// включить подт€жку вверх или вниз
...
// отключить подт€жку вверх или вниз
