...
// SPI SD CARD (MMC SD)
	...
	DMAC14.CHCTRL_n = 1 * (1U << 3);		// SWRST
	//DMAC14.CHCTRL_n = 1 * (1U << 17);	// CLRINTMSK
	DMAC14.CHCTRL_n = 1 * (1U << 16);	// SETINTMSK - запрещаем прерывание от контроллера DMA
