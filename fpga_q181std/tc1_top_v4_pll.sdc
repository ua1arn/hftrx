...
#
#************************************************************
create_clock -name "clockfromadc" -period 122.88MHz [get_ports {adc_clka}]
#create_clock -name "ref122800" -period 122.88MHz [get_ports {refclk_in}]
...
#create_generated_clock -name "sai1_sck_a_clock" -source "ref122800" -divide_by 10 -duty_cycle 20.0
...
set_false_path -from [get_clocks {clockfromadc ref122800 sclk_clock sai1_sck_a_clock fpga_ctl_cs_clock fpga_fir_clk_clock}] -to [get_ports {adc_dith adc_rand adc_shdn adc_pga dac_sleep}]
set_false_path -from [get_clocks {clockfromadc ref122800 sclk_clock sai1_sck_a_clock fpga_ctl_cs_clock fpga_fir_clk_clock}] -to [get_ports {led0 led1 led2 led3}]
set_false_path -from [get_clocks {clockfromadc ref122800 sclk_clock sai1_sck_a_clock fpga_ctl_cs_clock fpga_fir_clk_clock}] -to [get_ports {sai1_sd_b}]
