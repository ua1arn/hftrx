...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "fir_10wfm_2ch_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "fir_10wfm_2ch_st" "DSP BLOCKS"
}
add_fir_constraints
