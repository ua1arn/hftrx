...
%% Generated on: May 31, 2017 10:20:12 PM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% cic40_ddc_2rx_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    cic40_ddc_2rx_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    cic40_ddc_2rx_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    cic40_ddc_2rx_fir_comp_coeff(31,80e6,4e6,true,false)


function cic40_ddc_2rx_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	...
	filename = 'cic40_ddc_2rx_fir_comp_coeff.txt';
