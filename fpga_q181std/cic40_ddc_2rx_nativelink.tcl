...
set ipfs_ext "vho"
if {[file exists cic40_ddc_2rx.vho]} {
	set hdl_ext "vhd"
} else {
	puts "Warning: Could not find cic40_ddc_2rx.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME cic40_ddc_2rx_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.cic40_ddc_2rx_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "cic40_ddc_2rx.${ipfs_ext}" -section_id eda_simulation -library work

foreach i $input_files {
  set_global_assignment -name EDA_TEST_BENCH_FILE "$i" -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE "cic40_ddc_2rx_tb.${hdl_ext}" -section_id tb -library work
