...
void hardware_uart2_initialize(uint_fast8_t debug, uint_fast32_t defbaudrate);
...
void hardware_uart6_initialize(uint_fast8_t debug, uint_fast32_t defbaudrate);
