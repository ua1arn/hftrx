...
#define UACIN_RTS96_DATASIZE ((OUTSAMPLES_AUDIO48 * 2 + 1) * UACIN_RTS96_SAMPLEBYTES * UACIN_FMT_CHANNELS_RTS96)
#define UACIN_RTS192_DATASIZE ((OUTSAMPLES_AUDIO48 * 4 + 1) * UACIN_RTS192_SAMPLEBYTES * UACIN_FMT_CHANNELS_RTS192)
