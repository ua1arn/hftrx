...
#define AFSPECTRE_COLOR DSGN_SPECTRUMBG2
	...
	#define DESIGNCOLORSTATETEXT	COLORPIP_RED	// температура, напряжение - was DSGN_LABELTEXT
	...
	#define DESIGNCOLORSTATETEXT	COLORPIP_GREEN	// температура, напряжение - was DSGN_LABELTEXT
	#define DESIGNCOLORSTATEBACK	COLORPIP_BLACK
	...
	#define DESIGNBIGCOLORB 		COLORPIP_WHITE //DSGN_SPECTRUMBG2		// цвет частоты дополнительного приемника
	#define DESIGNBIGCOLORBINACTIVE DSGN_SPECTRUMBG2
	#define FMENUACTIVETEXT			COLORPIP_WHITE
	#define FMENUACTIVEBACK			COLORPIP_BLACK
	#define FMENUINACTIVETEXT		DSGN_SPECTRUMBG2
	#define FMENUINACTIVEBACK		COLORPIP_BLACK
	#define LABELACTIVETEXT			COLORPIP_WHITE
	#define LABELACTIVEBACK			COLORPIP_BLACK
	#define LABELINACTIVETEXT		DSGN_SPECTRUMBG2
	#define LABELINACTIVEBACK		COLORPIP_BLACK
	#define DSGN_LABELTEXT				COLORPIP_WHITE
	#define DSGN_LABELBACK				COLORPIP_BLACK
	#define DSGN_FMENUTEXT				COLORPIP_GREEN
	#define DSGN_FMENUBACK				COLORPIP_BLACK
	#define DSGN_GRIDCOLOR      COLOR_OLIVE        // center marker
	...
	#define DESIGNCOLORSTATETEXT	COLORPIP_WHITE	// температура, напряжение - was DSGN_LABELTEXT
	#define DESIGNCOLORSTATEBACK	COLORPIP_BLACK
