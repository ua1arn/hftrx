...
#define AFSPECTRE_COLOR COLORPIP_SPECTRUMBG2
	...
	#define COLORPIP_SPECTRUMBG2	(COLORPIP_BASE + 13) // TFTRGB(0, 24, 8)		//COLOR_xxx - полоса пропускания приемника
	#define COLORPIP_SPECTRUMFG		(COLORPIP_BASE + 14) // TFTRGB(0, 255, 0)		// цвет спектра при сполошном заполнении
	...
	#define COLORPIP_DARKGRAY   (COLORPIP_BASE + 15) // TFTRGB(0x00, 0x64, 0x00)
		...
		#define COLORPIP_BLACK COLORPIP_BLACK
		#define COLORPIP_WHITE COLORPIP_WHITE
		#define COLORPIP_BLUE COLORPIP_BLUE
		#define COLORPIP_GREEN COLORPIP_GREEN
		#define COLORPIP_RED COLORPIP_RED
		#define COLORPIP_GRAY COLORPIP_GRAY
		#define COLORPIP_DARKGREEN COLORPIP_DARKGREEN
		#define COLORPIP_YELLOW COLORPIP_YELLOW

		#define COLORPIP_GRIDDIGITS  COLORPIP_GRIDCOLOR2
		#define COLORPIP_DARKRED  COLORPIP_GRIDCOLOR2	// COLORPIP_DARKRED
	...
	#if COLORSTYLE_ATS52
		// new (for ats52).
		#define COLORPIP_GRIDCOLOR0		TFTRGB(128, 0, 0)		//COLOR_GRAY - center marker
		#define COLORPIP_GRIDCOLOR2		TFTRGB(96, 96, 96)		//COLOR_DARKRED - other markers
		#define COLORPIP_SPECTRUMBG		TFTRGB(0, 64, 24)			//
		#define COLORPIP_SPECTRUMBG2	TFTRGB(0, 24, 8)		//COLOR_xxx - полоса пропускания приемника
		#define COLORPIP_SPECTRUMFG		TFTRGB(0, 255, 0)		// цвет спектра при сполошном заполнении
		#define DESIGNCOLOR_SPECTRUMFENCE	TFTRGB(255, 255, 255)	//COLOR_WHITE
		#define COLORPIP_SPECTRUMLINE	COLORPIP_YELLOW

	#elif COLORSTYLE_RED
		//
		#define COLORPIP_GRIDCOLOR0     	COLORPIP_RED        	// center marker
		#define COLORPIP_GRIDCOLOR2     	COLORPIP_DARKRED      // other markers
		#define COLORPIP_GRIDDIGITS 		COLORPIP_RED

		#define COLORPIP_SPECTRUMBG     	COLORPIP_BLACK
		#define COLORPIP_SPECTRUMBG2   	COLORPIP_DARKRED      // полоса пропускания приемника
		#define COLORPIP_SPECTRUMFG			COLORPIP_RED			// цвет спектра при сполошном заполнении
		#define DESIGNCOLOR_SPECTRUMFENCE	COLOR_WHITE
		#define COLORPIP_SPECTRUMLINE		COLORPIP_RED

	#elif COLORSTYLE_GREEN
		// old
		#define COLORPIP_GRIDCOLOR0     	COLORPIP_GREEN        	// center marker
		#define COLORPIP_GRIDCOLOR2     	COLORPIP_DARKGREEN      // other markers
		#define COLORPIP_GRIDDIGITS 		COLORPIP_GREEN

		#define COLORPIP_SPECTRUMBG     	COLORPIP_BLACK
		#define COLORPIP_SPECTRUMBG2   		COLORPIP_DARKGREEN      // полоса пропускания приемника
	...
	#define DESIGNBIGCOLOR 		COLORPIP_RED 		// DARK RED

	#define DESIGNBIGCOLORB 	COLORPIP_RED		// цвет частоты дополнительного приемника
	#define DESIGNBIGCOLORBINACTIVE COLORPIP_DARKRED

	#define FMENUACTIVETEXT		COLORPIP_WHITE
	#define FMENUACTIVEBACK		COLORPIP_DARKRED
	#define FMENUINACTIVETEXT	COLORPIP_BLACK
	#define FMENUINACTIVEBACK	COLORPIP_RED
	#define FMENUTEXT			COLORPIP_RED
	#define FMENUBACK			COLORPIP_BLACK

	#define LABELACTIVETEXT		COLORPIP_WHITE
	#define LABELACTIVEBACK		COLORPIP_DARKRED
	#define LABELINACTIVETEXT	COLORPIP_BLACK
	#define LABELINACTIVEBACK	COLORPIP_RED
	...
	#define DESIGNBIGCOLORBINACTIVE COLORPIP_DARKGREEN

	#define FMENUACTIVETEXT		COLORPIP_YELLOW
	#define FMENUACTIVEBACK		COLORPIP_DARKGREEN
	#define FMENUINACTIVETEXT	COLORPIP_BLACK
	#define FMENUINACTIVEBACK	COLORPIP_DARKGREEN
	#define FMENUTEXT			COLORPIP_GREEN
	#define FMENUBACK			COLORPIP_BLACK


	#define LABELACTIVETEXT		COLORPIP_YELLOW
	#define LABELACTIVEBACK		COLORPIP_DARKGREEN
	#define LABELINACTIVETEXT	COLORPIP_BLACK
	#define LABELINACTIVEBACK	COLORPIP_DARKGREEN
	...
	#define DESIGNBIGCOLORB 	COLORPIP_YELLOW		// цвет частоты и режима ополнительного приемника
	#define DESIGNBIGCOLORBINACTIVE COLORPIP_DARKGREEN
	...
	#define LABELBACK			COLORPIP_BLACK
		...
		#define DESIGNBIGCOLORBINACTIVE COLORPIP_SPECTRUMBG2
		#define FMENUACTIVETEXT		COLORPIP_WHITE
		#define FMENUACTIVEBACK		COLORPIP_BLACK
		#define FMENUINACTIVETEXT	COLORPIP_SPECTRUMBG2
		#define FMENUINACTIVEBACK	COLORPIP_BLACK
		#define LABELACTIVETEXT		COLORPIP_WHITE
		#define LABELACTIVEBACK		COLORPIP_BLACK
		#define LABELINACTIVETEXT	COLORPIP_SPECTRUMBG2
		...
		#define FMENUACTIVETEXT		COLORPIP_WHITE
		#define FMENUACTIVEBACK		COLORPIP_GRAY
		#define FMENUINACTIVETEXT	COLORPIP_BLACK
		#define FMENUINACTIVEBACK	COLORPIP_GRAY

		#define LABELACTIVETEXT		COLORPIP_WHITE
		#define LABELACTIVEBACK		COLORPIP_GRAY

		#define LABELINACTIVETEXT	COLORPIP_BLACK
		#define LABELINACTIVEBACK	COLORPIP_GRAY
