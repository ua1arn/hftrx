...
#define AFSPECTRE_COLOR COLORPIP_SPECTRUMBG2
	...
	#define COLORPIP_LOCKED  	 TFTRGB(0x3C, 0x3C, 0x00)
		...
		#define COLORPIP_GRIDDIGITS 	COLORPIP_YELLOW
	...
	#define COLORMAIN_DARKBLUE  COLOR_DARKBLUE
	...
	#define LABELBACK			COLORMAIN_BLACK
		...
		#define DESIGNBIGCOLORB 	COLORMAIN_WHITE //COLORPIP_SPECTRUMBG2		// цвет частоты дополнительного приемника
		...
		#define LABELTEXT			COLORMAIN_WHITE
		#define LABELBACK			COLORMAIN_BLACK
		...
		#define FMENUACTIVETEXT		COLORMAIN_WHITE
		#define FMENUACTIVEBACK		COLORMAIN_GRAY
		#define FMENUINACTIVETEXT	COLORMAIN_BLACK
		#define FMENUINACTIVEBACK	COLORMAIN_GRAY

		#define LABELACTIVETEXT		COLORMAIN_WHITE
		#define LABELACTIVEBACK		COLORMAIN_GRAY

		#define LABELINACTIVETEXT	COLORMAIN_BLACK
		#define LABELINACTIVEBACK	COLORMAIN_GRAY
