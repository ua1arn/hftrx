...
typedef struct
{
	...
	#define DSGN_FMENUACTIVETEXT	COLORPIP_BLACK
	#define DSGN_FMENUACTIVEBACK	COLORPIP_GRAY
	#define DSGN_FMENUINACTIVETEXT	COLORPIP_WHITE
	#define DSGN_FMENUINACTIVEBACK	COLORPIP_DARKGREEN

	#define DSGN_LABELACTIVETEXT	COLORPIP_BLACK
	#define DSGN_LABELACTIVEBACK	COLORPIP_GRAY
	#define DSGN_LABELINACTIVETEXT	COLORPIP_WHITE
	...
	/* выделенный текст в меню */
	#define DSGN_MENUSELCOLOR	COLORPIP_BLACK
	#define DSGN_MENUSELBGCOLOR	COLORPIP_CYAN
	/* выделенный текст в значениях */
	#define DSGN_MENUVALSELCOLOR	COLORPIP_BLACK
	#define DSGN_MENUVALSELBGCOLOR	COLORPIP_CYAN
	...
	#define DSGN_FMENUTEXT			COLORPIP_DARKCYAN
	#define DSGN_FMENUBACK			COLORPIP_BLACK
	...
	#define DSGN_FMENUACTIVETEXT    	COLORPIP_BLACK
	#define DSGN_FMENUACTIVEBACK    	COLORPIP_WHITE
	#define DSGN_FMENUINACTIVETEXT    	COLORPIP_WHITE
	#define DSGN_FMENUINACTIVEBACK    	COLORPIP_BLACK

	// labels, middle menu
	#define DSGN_LABELACTIVETEXT    	COLORPIP_BLACK
	#define DSGN_LABELACTIVEBACK    	COLORPIP_WHITE
	#define DSGN_LABELINACTIVETEXT    	COLORPIP_WHITE
	#define DSGN_LABELINACTIVEBACK    	COLORPIP_BLACK
