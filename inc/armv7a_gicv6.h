...
#endif /* #if (defined(__L2C_PRESENT) && (__L2C_PRESENT == 1U)) || defined(DOXYGEN) */
    ...
    switch(outer)
    {
      ...
      case WT:
        *descriptor_l1 |= 1 << SECTION_TEX1_SHIFT;
        break;
      case WB_NO_WA:
        *descriptor_l1 |= (1 << SECTION_TEX1_SHIFT) | (1 << SECTION_TEX1_SHIFT);
        break;
    }
  }
  return 0;
      ...
      switch(outer)
      {
        ...
        case WT:
          *descriptor_l2 |= 1 << PAGE_4K_TEX1_SHIFT;
          break;
        case WB_NO_WA:
          *descriptor_l2 |= (1 << PAGE_4K_TEX1_SHIFT) | (1 << PAGE_4K_TEX1_SHIFT);
          break;
      }
    }
  }
