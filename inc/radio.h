...
#define MODECOLORBG_RX	COLOR_GREEN
	...
	#define DESIGNBIGCOLOR COLOR_RED 		// DARK RED
	//#define DESIGNBIGCOLORHALF COLOR_RED 	// DARK RED
	#define DESIGNCOLORSTATE	COLOR_RED
	#define DESIGNCOLORDARKSTATE	COLOR_DARKRED
#else /* COLORSTYLE_RED */
	#define DESIGNBIGCOLOR COLOR_YELLOW 		// GOLD
	//#define DESIGNBIGCOLORHALF COLOR_YELLOW
	#define DESIGNCOLORSTATE	COLOR_GREEN
	#define DESIGNCOLORDARKSTATE	COLOR_DARKGREEN
	...
	#define COLOR565_SPECTRUMFENCE	TFTRGB565(255, 255, 255)	//COLOR_WHITE
	//#define COLOR565_SPECTRUMLINE	TFTRGB565(0, 255, 0)	//COLOR_GREEN
	#define COLOR565_SPECTRUMLINE	TFTRGB565(0xFF, 0xD7, 0x00)	//COLOR_GOLD
#endif
