...
#define GUI_H_INCLUDED
	...
	#else
		// old
		#define COLORPIP_GRIDCOLOR        (COLORPIP_BASE + 10) // TFTRGB565(128, 128, 0)        //COLOR_GRAY - center marker
		#define COLORPIP_GRIDCOLOR2        (COLORPIP_BASE + 11) // TFTRGB565(128, 0, 0x00)        //COLOR_DARKRED - other markers
		#define COLORPIP_SPECTRUMBG        (COLORPIP_BASE + 12) // TFTRGB565(0, 0, 0)            //COLOR_BLACK
		#define COLORPIP_SPECTRUMBG2    (COLORPIP_BASE + 13) // TFTRGB565(0, 128, 128)        //COLOR_CYAN - полоса пропускания приемника
		#define COLORPIP_SPECTRUMFG		(COLORPIP_BASE + 14) // TFTRGB565(0, 255, 0)		//COLOR_GREEN
		#define COLORPIP_SPECTRUMFENCE	(COLORPIP_BASE + 15) // TFTRGB565(255, 255, 255)	//COLOR_WHITE
		//#define COLORPIP_SPECTRUMLINE	(COLORPIP_BASE + 10) // TFTRGB565(0, 255, 0)	//COLOR_GREEN
		#define COLORPIP_SPECTRUMLINE	COLORPIP_YELLOW
	...
	#define COLOR_BUTTON_PR_NON_LOCKED	COLOR_BLUE	// was: COLORPIP_DARKGREEN2
	#define COLOR_BUTTON_LOCKED			COLOR_YELLOW
	#define COLOR_BUTTON_PR_LOCKED		COLOR_LOCKED // TFTRGB565(0x3C, 0x3C, 0x00)
