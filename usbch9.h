...
//#if CPUSTYLE_R7S721
	...
	*/
	...
	#define HARDWARE_USBD_AUDIO_IN_CHANNELS_RTS96		2
	...
	#define HARDWARE_USBD_AUDIO_IN_CHANNELS_RTS192		2
	...
	#define HSINTERVAL_AUDIO48 4	// endpoint descriptor parameters
	#define FSINTERVAL_AUDIO48 1
		...
		#define VIRTUAL_AUDIO_PORT_DATA_SIZE_OUT	(DMABUFFSIZE16 * sizeof (uint16_t) / 2)
