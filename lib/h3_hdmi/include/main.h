...
#endif
//#define  framebuffer1 0x43000000///0x4e000000 ///__attribute__ ((section ("UNCACHED")));
//#define  framebuffer2 (0x43000000+(512*512))
//#define  framebuffer3 (0x43000000+2*(512*512))
