...
static USBH_StatusTypeDef USBH_AUDIO_InterfaceInit(USBH_HandleTypeDef *phost, const USBH_TargetTypeDef * target);
...
static USBH_StatusTypeDef USBH_AUDIO_InterfaceInit(USBH_HandleTypeDef *phost, const USBH_TargetTypeDef * target)
{
  ...
  (void)USBH_memcpy(& AUDIO_Handle->target, target, sizeof AUDIO_Handle->target);
