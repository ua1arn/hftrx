...
#define XPAR_AUDIO_AXI_FIFO_MIC_BASEADDR 0x43C50000
#define XPAR_AUDIO_AXI_FIFO_MIC_HIGHADDR 0x43C5FFFF


/* Peripheral Definitions for peripheral AUDIO_AXI_FIFO_PHONES */
#define XPAR_AUDIO_AXI_FIFO_PHONES_BASEADDR 0x43C30000
#define XPAR_AUDIO_AXI_FIFO_PHONES_HIGHADDR 0x43C3FFFF
