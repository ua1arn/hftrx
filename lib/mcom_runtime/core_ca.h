...
#define GICDistributor      ((GICDistributor_Type      *)     ICC_BASE ) /*!< \brief GIC Distributor register set access pointer */
...
#define GICInterface        ((GICInterface_Type        *)     GIC_BASE )   /*!< \brief GIC Interface register set access pointer */
...
#define PTIM ((Timer_Type *) BASE_ADDR_TIMERs )   /*!< \brief Timer register struct */
