...
//    MMU_TTSection (TTB_BASE, __ROM_BASE, __ROM_SIZE/0x100000, Sect_Normal_Cod); // multiple of 1MB sections
    ...
    //--------------------- PERIPHERALS -------------------
//    MMU_TTSection (TTB_BASE, VE_A9_MP_ROM_BASE      , 64, Sect_Device_RO); // 64MB NOR
//    MMU_TTSection (TTB_BASE, VE_A9_MP_FLASH_BASE1   , 64, Sect_Device_RO); // 64MB NOR
    MMU_TTSection (TTB_BASE, VE_A9_MP_DRAM_BASE     , 1024, Sect_Device_RW); // 32MB RAM
    MMU_TTSection (TTB_BASE, VE_A9_MP_VRAM_BASE     , 16, Sect_Device_RW); // 32MB RAM
//    MMU_TTSection (TTB_BASE, VE_A9_MP_VPU           , 16, Sect_Device_RW);
//    MMU_TTSection (TTB_BASE, VE_A9_MP_USB_BASE      , 16, Sect_Device_RW);
    ...
    MMU_TTPage4k(TTB_BASE, PERIPHERAL_A_FAULT      , 16, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, DESCRIPTOR_FAULT);
    // Define peripheral range 0x1C000000-0x1C00FFFF
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_PDMA_BASE      ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_NAND_REG_BASE  ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_TIMER_BASE     ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_SERIAL_BASE    ,  4, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_SPI0_BASE      ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_SPI1_BASE      ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_GPIO_BASE      ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);

    MMU_TTPage4k(TTB_BASE, VE_A9_MP_MAIL_BASE      ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_SPIN_BASE      ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_MFBSP0_BASE    ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_MFBSPD0_BASE   ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_MFBSP1_BASE    ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    MMU_TTPage4k(TTB_BASE, VE_A9_MP_MFBSPD1_BASE   ,  1, Page_L1_4k, (uint32_t *)PERIPHERAL_A_TABLE_L2_BASE_64k, Page_4k_Device_RW);
    ...
    MMU_TTPage64k(TTB_BASE, VE_A9_MP_MPU_BASE       ,  1, Page_L1_64k, (uint32_t *)PERIPHERAL_B_TABLE_L2_BASE_64k, Page_64k_Device_RW);
    MMU_TTPage64k(TTB_BASE, VE_A9_MP_GIC_DISTRIBUTOR_BASE    ,  1, Page_L1_64k, (uint32_t *)PERIPHERAL_B_TABLE_L2_BASE_64k, Page_64k_Device_RW);
    MMU_TTPage64k(TTB_BASE, VE_A9_MP_PRIVATE_TIMER           ,  1, Page_L1_64k, (uint32_t *)PERIPHERAL_B_TABLE_L2_BASE_64k, Page_64k_Device_RW);
    MMU_TTPage64k(TTB_BASE, VE_A9_MP_DSP_BASE                ,  1, Page_L1_64k, (uint32_t *)PERIPHERAL_B_TABLE_L2_BASE_64k, Page_64k_Device_RW);
    ...
    MMU_TTPage4k (TTB_BASE, VE_A9_MP_PL310_BASE     ,  1,  Page_L1_4k, (uint32_t *)PRIVATE_TABLE_L2_BASE_4k, Page_4k_Device_RW);
