...
//#define	WITHFILTSOFTMAX		100		/* код управления сглаживанием скатов фильтра основной селекции на приёме */
	...
	#define WITHAMLOW10MIN	(50 / 10)		// минимальная частота высокочастотного среза в десятках герц
	#define WITHAMLOW10MAX	(700 / 10)		// минимальная частота высокочастотного среза в десятках герц
	#define WITHAMHIGH100MAX	(6000 / 100)	// максимальная частота высокочастотного среза в десятках герц
	#define WITHAMHIGH100MIN	(800 / 100)		// минимальная частота высокочастотного среза в сотнях герц
	#define WITHAMHIGH100DEF	(4400 / 100)	// Начальное значение в сотнях герц

	// Параметры НЧ фильтра в режиме SSB
	#define WITHSSBLOW10MIN	(50 / 10)		// минимальная частота высокочастотного среза в десятках герц
	#define WITHSSBLOW10MAX	(700 / 10)		// минимальная частота высокочастотного среза в десятках герц
	#define WITHSSBHIGH100MAX	(6000 / 100)	// максимальная частота высокочастотного среза в десятках герц
	#define WITHSSBHIGH100MIN	(800 / 100)		// минимальная частота высокочастотного среза в сотнях герц
	#define WITHSSBHIGH100DEF	(4400 / 100)	// Начальное значение в сотнях герц

	// Параметры НЧ фильтра в режиме WFM
	#define WITHWFMLOW10MIN	(50 / 10)		// минимальная частота высокочастотного среза в десятках герц
	#define WITHWFMLOW10MAX	(700 / 10)		// минимальная частота высокочастотного среза в десятках герц
	#define WITHWFMLOW10DEF	(100 / 10)	// Начальное значение в десятках герц

	#define WITHWFMHIGH100MAX	(18000 / 100)	// максимальная частота высокочастотного среза в десятках герц
	#define WITHWFMHIGH100MIN	(4000 / 100)		// минимальная частота высокочастотного среза в сотнях герц
	#define WITHWFMHIGH100DEF	(12000 / 100)	// Начальное значение в сотнях герц
