...
#if 1
		// little board
		EMIT_MASKWRITE(0XF8000760, 0x00003FFFU ,0x000016E0U),	// MIO_PIN_24
		EMIT_MASKWRITE(0XF8000764, 0x00003FFFU ,0x000016E1U),	// MIO_PIN_25
#else
		// antminer board
		EMIT_MASKWRITE(0XF80007c0, 0x00003FFFU ,0x000016E0U),	// MIO_PIN_48
		EMIT_MASKWRITE(0XF80007c4, 0x00003FFFU ,0x000016E1U),	// MIO_PIN_49
#endif
