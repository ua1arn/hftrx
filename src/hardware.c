...
sysinit_debug_initialize(void)
{
	...
	#if WITHDEBUG
	{
		...
		if (enable_divider)
			value |= 8;     // enable "by 64" divider for CCNT. Clock Divider, bit [3]

		value |= 16;		// Export Enable, bit [4]
