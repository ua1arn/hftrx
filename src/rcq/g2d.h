...
#define G2D_RCQ 	                ((volatile struct g2d_rcq_reg *) 					& G2D->RCQ_IRQ_CTL)
...
#define G2D_CSC		                ((volatile struct g2d_mixer_csc_reg *) 				(G2D_BLD_BASE + 0x100))
...
#define __va_to_pa(_a) ((uintptr_t) _a)
