...
#define BTIN48_CAPACITY 8
#define BTOUT48_CAPACITY 8
...
#if WITHVITA49RX
	adapter_t vita49rx;	/* канал передачи в поток vita-49 */
	transform_t rts96tovita49;
#endif /* WITHVITA49RX */
#if WITHVITA49TX
	adapter_t vita49tx;	/* канал получения данных из потока vita-49 для пердачи в эфир */
	transform_t vita49torts96;
#endif /* WITHVITA49TX */
...
void buffers_initialize(void)
{
	...
	adpt_initialize(& vita49rx, zzzUACIN_RTS192_SAMPLEBYTES * 8, 0, "vita49rx");
	transform_initialize(& rts96tovita49, & ifspectrumin96, & vita49rx);
#endif /* WITHVITA49RX */
#if WITHVITA49TX
	/* VITA 49.0-2015 streaming sink support */
	adapter_t vita49tx;	/* канал приёма из потока vita-49 для пердачи в эфир */
	adpt_initialize(& vita49tx, zzzUACIN_RTS192_SAMPLEBYTES * 8, 0, "vita49tx");
	transform_initialize(& vita49torts96, & vita49rx, & ifspectrumin96);
#endif /* WITHVITA49TX */
