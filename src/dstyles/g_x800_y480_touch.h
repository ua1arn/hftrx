...
//		BDCV_SPMRX = ROWS2GRID(27)	// вертикальный размер спектра в ячейках
	...
	static const dzone_t dzones [] =
	{
		...
		{	43, 0,	5,	0,	display2_notch5,	& dzi_default, PGALL, },	// NOTCH on/off
		{	43, 5,	3,	0,	display2_voxtune3,	& dzi_default, PGALL, },	// VOX
		{	47, 5,	3,	0,	display2_datamode3,	& dzi_default, PGALL, },	// DATA mode indicator
		{	47, 15,	3,	0,	display2_usbsts3,	& dzi_default, PGALL, },	// USB host status
...
//		{	45, 15,	5,	0,	display2_notch5,		& dzi_default, PGALL, },	// NOTCH on/off
	#else /* WITHENCODER2 */
		{	45, 0,	5,	0,	display2_notch5,		& dzi_default, PGALL, },	// FUNC item label
		{	45,	4,	5,	0,	display2_notchfreq5,	& dzi_default, PGALL, },	// FUNC item value
	#endif /* WITHENCODER2 */
...
//		{	46, 35,	3,	0,	display2_nr3,		& dzi_default, PGALL, },	// NR
		...
		{	17,	7,	21,	11,	display2_freqX_a,	& dzi_freqa, PGALL, },	// MAIN FREQ Частота Герцы маленьким шрифтом.
		{	38, 10,	3,	0,	display2_mode3_a,	& dzi_modea,	PGALL, },	// SSB/CW/AM/FM/...
		{	43, 10,	3,	0,	display2_rxbw3,		& dzi_rxbw, PGALL, },	// 3.1 / 0,5 / WID / NAR
