	...
	static const dzone_t dzones [] =
	{
		...
		{   0, 	5,	SM_BG_W_CELLS, SM_BG_H_CELLS, display2_smeter15, 	& dzi_smtr2, PGALL, },	// Изображение стрелочного прибора
	#endif /* WITHBARS */
	#if WITHAFSPECTRE
	...
	#if WITHAUTOTUNER
		{	28, 			DLE1,	20, 5, display2_swrsts20,	& dzi_default, REDRSUBSET_MENU, },	// SWR METER display
	#endif /* WITHAUTOTUNER */
	#endif /* WITHMENU */
