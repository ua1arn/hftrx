	...
	{
		{	0,	0,	display2_clearbg, 	REDRM_ALL, PGALL , },
		{	0,	0,	display2_keyboard_screen0,	REDRM_ALL, PGALL, }, // Обработка клавиатуры и валкодеров при нахождении в режиме основного экрана
		//{	10,	0,	display2_rxbwval6alt,	REDRM_ALL, PGALL, },	// RX BW value
		{	17,	0,	display_txrxstate5alt, REDRM_ALL, PGALL, },
		{	21,	0,	display2_ant7alt,		REDRM_ALL, PGALL, },
		{	26,	0,	display2_att5alt,		REDRM_ALL, PGALL, },
		{	31,	0,	display2_preovf5alt,	REDRM_ALL, PGALL, },
		{	35,	0,	display2_genham1,	REDRM_ALL, PGALL, },	// Отображение режима General Coverage / HAM bands
		{	38,	0,	display2_lockstate5alt, REDRM_ALL, PGALL, },	// LOCK
		{	42, 0,	display2_notch7alt,	REDRM_ALL, PGALL, },	// NOTCH on/off
		{	42, 5,	display2_voxtune3,	REDRM_ALL, PGALL, },	// VOX
		{	46, 5,	display2_datamode3,	REDRM_ALL, PGALL, },	// DATA mode indicator
		{	46, 15,	display2_usbsts3,	REDRM_ALL, PGALL, },	// USB host status
		{	46, 20,	display2_rec3,		REDRM_ALL, PGALL, },	// Отображение режима записи аудио фрагмента
#if WITHBARS
		{    0, 4,  display2_smeter15_init,REDRM_INIS, PGINI, },	//  Инициализация стрелочного прибора
		{    0, 4,  display2_smeter15, 	REDRM_ALL, PGALL, },	// Изображение стрелочного прибора
#endif /* WITHBARS */
#if WITHAFSPECTRE
		{	0,	4,	display2_af_spectre15_init,	REDRM_INIS, PGINI, },
		{	0,	4,	display2_af_spectre15_latch,	REDRM_ALL,	PGALL, },
		{	0,	4,	display2_af_spectre15,		REDRM_ALL, PGALL, },
#endif /* WITHAFSPECTRE */
		{   0,  0,  layout_init,		REDRM_INIS, PGINI, },
//		{   47, 20, display2_bkin3,		REDRM_ALL, PGALL, },
//		{	46, 20,	display2_agc3,		REDRM_ALL, PGALL, },	// AGC mode
//		{	46, 25,	display2_voxtune3,	REDRM_ALL, PGALL, },	// VOX
//		{	46, 30,	display2_datamode3,	REDRM_ALL, PGALL, },	// DATA mode indicator
//		{	46, 35,	display2_nr3,		REDRM_ALL, PGALL, },	// NR
		{	42, 15,	display2_atu4alt,		REDRM_ALL, PGALL, },	// TUNER state (optional)
		{	42, 20,	display2_byp4alt,		REDRM_ALL, PGALL, },	// TUNER BYPASS state (optional)

		{	17,	7,	display2_freqX_a,	REDRM_ALL, PGALL, },	// MAIN FREQ Частота (большие цифры)
		{	38, 10,	display2_mode3_a,	REDRM_ALL,	PGALL, },	// SSB/CW/AM/FM/...
		{	42, 10,	display2_rxbw3,		REDRM_ALL, PGALL, },	// 3.1 / 0,5 / WID / NAR
		{	46, 10,	display2_nr3,		REDRM_ALL, PGALL, },	// NR : was: AGC
		{	38, 15,	display2_mainsub3,	REDRM_ALL, PGALL, },	// main/sub RX: A/A, A/B, B/A, etc

		{	42,	15,	display2_vfomode5alt,	REDRM_ALL, PGALL, },	// SPLIT
		{	26,	20,	display2_freqX_b,	REDRM_ALL, PGALL, },	// SUB FREQ
		{	38, 20,	display2_mode3_b,	REDRM_ALL,	PGALL, },	// SSB/CW/AM/FM/...

		{	0,	0, display2_siglevel4, 	REDRM_ALL, PGALL, },	// signal level dBm
		{	0,	DLES,	display2_wfl_init,	REDRM_INIS,	PGINI, },	// формирование палитры водопада
		{	0,	DLES,	display2_latchwaterfall,	REDRM_ALL,	PGALL, },	// формирование данных спектра для последующего отображения спектра или водопада
		{	0,	DLES,	display2_spectrum,	REDRM_ALL, PGALL, },// подготовка изображения спектра
		{	0,	DLES,	display2_waterfall,	REDRM_ALL, PGALL, },// подготовка изображения водопада
		{	0,	DLES,	display2_colorbuff,	REDRM_ALL,	PGALL, },// Отображение водопада и/или спектра
		{	0,	DLES,	gui_WM_walktrough,	REDRM_ALL, PGALL, },

		{	0,	0,	display2_nextfb, 	REDRM_ALL, PGALL, },
	};
