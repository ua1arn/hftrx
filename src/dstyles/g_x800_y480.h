	...
	static const FLASHMEM struct dzone dzones [] =
	{
		...
		{	18, 0,	3, 0, display2_atu3,		REDRM_MODE, PGALL, },	// TUNER state (optional)
		{	22, 0,	3, 0, display2_byp3,		REDRM_MODE, PGALL, },	// TUNER BYPASS state (optional)
		{	26,	0,	5, 0, display2_ant5,		REDRM_MODE, PGALL, },
		{	32,	0,	4, 0, display2_att4,		REDRM_MODE, PGALL, },
		{	37,	0,	3, 0, display2_preovf3,	REDRM_BARS, PGALL, },
	#if WITHBARS
		...
		{	37, 10,	3, 0, display2_mode3_a,	REDRM_MODE,	PGALL, },	// SSB/CW/AM/FM/...
		{	41, 10,	3, 0, display2_rxbw3,		REDRM_MODE, PGALL, },	// 3.1 / 0,5 / WID / NAR
		{	46, 10,	3, 0, display2_agc3,		REDRM_MODE, PGALL, },	// AGC mode

		{	37, 15,	3, 0, display2_nr3,		REDRM_MODE, PGALL, },	// NR : was: AGC
		{	41, 15,	3, 0, display2_datamode3,	REDRM_MODE, PGALL, },	// DATA mode indicator
		...
		{	20,	20,	3, 0, display2_vfomode3,	REDRM_MODE, PGALL, },	// SPL
		{	24,	20,	0, 0, display2_freqX_b,	REDRM_FRQB, PGALL, },	// SUB FREQ
		{	37, 20,	0, 0, display2_mode3_b,	REDRM_MODE,	PGALL, },	// SSB/CW/AM/FM/...
		{	41, 20,	3, 0, display2_voxtune3,	REDRM_MODE, PGALL, },	// VOX
		{	45,	20,	4, 0, display2_lockstate4, REDRM_MODE, PGALL, },	// LOCK

		// размещены под S-метром (15 ячеек)
		{	1, 	25,	5, 0, display2_voltlevelV5, REDRM_VOLT, PGALL, },	// voltmeter with "V"
		{	7, 	25,	6, 0, display2_currlevelA6, REDRM_VOLT, PGALL, },	// PA drain current d.dd with "A"

		//{	14, 25,
		//{	19, 25,
		//{	23, 25,
		//{	27, 25,
		{	33, 25,	3, 0, display2_rec3,		REDRM_BARS, PGALL, },	// Отображение режима записи аудио фрагмента
		{	37, 25,	3, 0, display2_spk3,		REDRM_MODE, PGALL, },	// отображение признака включения динамика
		{	41, 25, 0, 0, display2_bkin3,		REDRM_MODE, PGALL, },	// BREAK-IN
		{	45,	25,	5, 0, display2_wpm5, 		REDRM_BARS, PGALL, },	// 22WPM

		//{	24, 30,	10, 0, display_freqmeter10, REDRM_BARS, PGALL, },	// измеренная частота опоры
		{	37, 30,	8, 0, display2_freqdelta8, REDRM_BARS, PGALL, },	// выход ЧМ демодулятора
...
//		{	0,	DLES,	50, 0, display2_gcombo,	REDRM_BARS, PGWFL | PGSPE, },// подготовка изображения спектра и волрада
		...
		{	23, DLE1,	4, 0, display2_thermo4,	REDRM_VOLT, PGALL, },	// thermo sensor
		{	28, DLE1,	3, 0, display2_usbsts3,		REDRM_BARS, PG0, },	// USB host status
		{	32, DLE1,	7, 0, display2_classa7,		REDRM_BARS, PGALL, },	// Class-A power amplifier
		//{	28, DLE1,	10, 0, display_freqmeter10, REDRM_BARS, PGALL, },	// измеренная частота опоры
	...
	#if WITHAUTOTUNER
		{	28, 			DLE1,	0, 0, display2_swrsts22,	REDRM_BARS, REDRSUBSET_MENU, },	// SWR METER display
	#endif /* WITHAUTOTUNER */
	#endif /* WITHMENU */
