...
//			{	0,	28,	0,	BDCV_ALLRX,	display2_spectrum,	& dzi_default, PGSPE, },// подготовка изображения спектра
//			{	0,	28,	0,	BDCV_ALLRX,	display2_waterfall,	& dzi_default, PGWFL, },// подготовка изображения водопада
	#else
