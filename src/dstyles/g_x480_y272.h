...
//			{	0,	28,	0,	30,	display2_spectrum,	& dzi_default, PGSPE, },// подготовка изображения спектра
//			{	0,	28,	0,	30,	display2_waterfall,	& dzi_default, PGWFL, },// подготовка изображения водопада
	#else
