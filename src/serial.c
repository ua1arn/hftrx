...
void hardware_uart1_initialize(uint_fast8_t debug)
{
	...
	RCC->MP_APB5LPENSETR = RCC_MC_APB5LPENSETR_USART1LPEN; // Включение тактирования USART1.
...
xxxx!;
	...
	RCC->MP_APB1LPENSETR = RCC_MC_APB1LPENSETR_USART2LPEN; // Включение тактирования USART2.
...
xxxx!;
	...
	RCC->MP_APB1ENSETR = RCC_MC_APB1ENSETR_UART4EN; // Включение тактирования UART4.
	(void) RCC->MP_APB1ENSETR;
	RCC->MP_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART4LPEN; // Включение тактирования UART4.
	(void) RCC->MP_APB1LPENSETR;
...
xxxx!;
	...
	RCC->MP_APB1ENSETR = RCC_MC_APB1ENSETR_UART7EN; // Включение тактирования UART7.
	(void) RCC->MP_APB1ENSETR;
	RCC->MP_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART7LPEN; // Включение тактирования UART7.
	(void) RCC->MP_APB1LPENSETR;
	...
	void RAMFUNC_NONILINE USART5_Handler(void)
	{
		...
		if (csr & US_CSR_RXRDY)
			HARDWARE_UART5_ONRXCHAR(USART1->US_RHR);
		if (csr & US_CSR_TXRDY)
			HARDWARE_UART5_ONTXCHAR(USART1);
	}
...
xxxx!;
	...
	RCC->MP_APB1ENSETR = RCC_MC_APB1ENSETR_UART5EN; // Включение тактирования UART5.
	(void) RCC->MP_APB1ENSETR;
	RCC->MP_APB1LPENSETR = RCC_MC_APB1LPENSETR_UART5LPEN; // Включение тактирования UART5.
	(void) RCC->MP_APB1LPENSETR;
