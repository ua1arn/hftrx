...
typedef enum {
    MBD_USB_EP_TYPE_CTRL = 0,
    MBD_USB_EP_TYPE_ISO = 1,
    MBD_USB_EP_TYPE_BULK = 2,
    MBD_USB_EP_TYPE_INT = 3
} usb_ep_type_t;

enum  {
    USB_EP_ATTR_ALLOW_CTRL = 1 << MBD_USB_EP_TYPE_CTRL,
    USB_EP_ATTR_ALLOW_BULK = 1 << MBD_USB_EP_TYPE_BULK,
    USB_EP_ATTR_ALLOW_INT = 1 << MBD_USB_EP_TYPE_INT,
    USB_EP_ATTR_ALLOW_ISO = 1 << MBD_USB_EP_TYPE_ISO,
