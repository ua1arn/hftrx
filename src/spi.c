...
#define USESPILOCK (WITHSPILOWSUPPORTT || CPUSTYPE_T113 || CPUSTYPE_D1S)	/* доступ к SPI разделяет DFU устройство и user mode программа */
...
#elif WIHSPIDFHW && (CPUSTYPE_T113 || CPUSTYPE_D1S)
