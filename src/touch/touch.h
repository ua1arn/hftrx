...
uint_fast16_t board_tsc_normalize_x(uint_fast16_t x, uint_fast16_t y);	/* получение координаты нажатия в пределах 0..DIM_X-1 */
uint_fast16_t board_tsc_normalize_y(uint_fast16_t x, uint_fast16_t y);	/* получение координаты нажатия в пределах 0..DIM_Y-1 */
