...
__STATIC_FORCEINLINE void RV_Sv39_Set_SMCIR(uintptr_t smcir)
{
...
__STATIC_FORCEINLINE uintptr_t RV_Sv39_Get_SMIR(void)
{
    uintptr_t result;
...
__STATIC_FORCEINLINE void RV_Sv39_Set_SMIR(uintptr_t smir)
{
...
__STATIC_FORCEINLINE void RV_Sv39_Set_SATP(uintptr_t asid, uintptr_t *ppn)
{
...
typedef struct mmulayout_tag
{
	...
	int flag;	// 0 - дескрипторы памяти, 1 - таблицы (mtable)
