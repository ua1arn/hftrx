...
// UA1ARN
//
#ifndef ADF4001_C_INCLUDED
#define ADF4001_C_INCLUDED

#define ADF4001_SPIMODE SPIC_MODE3	// MODE3 only supported

#define ADF4001_GO_STATE 0	/* prog_adf4001_n parameter: . */

enum
{
	ADF4001_FOLD_TRISTATE = 0x00,
	ADF4001_FOLD_LD = 0x01,
	ADF4001_FOLD_N_OUT = 0x02,
	ADF4001_FOLD_AVDD = 0x03,
	ADF4001_FOLD_R_OUT = 0x04,
	ADF4001_FOLD_LD_OPENDRAIN = 0x05,
	ADF4001_FOLD_SDO = 0x06,
	ADF4001_FOLD_DGND = 0x07
};
...
prog_adf4001_func(
	...
	uint_fast8_t FoLD,		/* ADF4001_FOLD_xxx constants  */
	uint_fast8_t cpipll,
	uint_fast8_t stop
	)
{
	...
	spi_select(target, ADF4001_SPIMODE);
	...
	)
{
	...
	spi_select(target, ADF4001_SPIMODE);	/* start sending data to target chip */
