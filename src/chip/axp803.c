...
int board_helperboard_t507_lpddr4_axp853_initialize(void)
{
	...
	//VERIFY(0 == axp858_set_dcdc5(1100));	// VCC-DRAM - 1.1 volt for LPDDR4, 1.2 volt for LPDDR3 - see DC5SET
...
int board_helperboard_t507_lpddr3_axp853_initialize(void)
{
	...
	VERIFY(0 == axp858_set_dcdc3(950));		// VDD-SYS 0.9..0.99 volt recommended
	VERIFY(0 == axp858_set_dcdc4(1100));		// VDD-GPU 0.81..1.2 volt recommended
	//VERIFY(0 == axp858_set_dcdc5(1200));	// VCC-DRAM - 1.1 volt for LPDDR4, 1.2 volt for LPDDR3 - see DC5SET
