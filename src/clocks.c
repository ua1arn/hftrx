...
//		EMIT_MASKWRITE(0XF80007A0, 0x00003FFFU ,0x00001680U),	// SD0
//		EMIT_MASKWRITE(0XF80007A4, 0x00003FFFU ,0x00001680U),	// SD0
//		EMIT_MASKWRITE(0XF80007A8, 0x00003FFFU ,0x00001680U),	// SD0
//		EMIT_MASKWRITE(0XF80007AC, 0x00003FFFU ,0x00001680U),	// SD0
//		EMIT_MASKWRITE(0XF80007B0, 0x00003FFFU ,0x00001680U),	// SD0
//		EMIT_MASKWRITE(0XF80007B4, 0x00003FFFU ,0x00001680U),	// SD0
...
void hardware_sdhost_setspeed(unsigned long ticksfreq)
{
	...
	else
	{
		SD0->TIMEOUT_CTRL_SW_RESET_CLOCK_CTRL =
			(SD0->TIMEOUT_CTRL_SW_RESET_CLOCK_CTRL & ~ (0x00FF00uL)) |
			0x001000uL;	// SDCLK_Frequency_Select: 80h - base clock divided by 256
