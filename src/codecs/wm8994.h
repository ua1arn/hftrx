/* $Id$ */
/*
 * wm8994.h		--  CIRRUS LOGIC WM8994ECS/R
 *
 */

#ifndef WM8994_H_INCLUDED
#define WM8994_H_INCLUDED
...
#define	WM8994L_OUT_VOL_MAX	(WM8994L_OUT_SPK_MAX * WM8994L_OUT_HP_MAX)
#define	WM8994L_OUT_VOL_MIN	0
