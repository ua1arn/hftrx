...
//void xPNG_Draw(u32 px,u32 py,LuImage *png,u8 layer)   //������� PNG �� ������� � �������� �����������
//{
// if(png==NULL)return;
//
...
void PNG_Background(LuImage *png,u32 memory)           //������� ������� PNG �� �������
{
 if(png==NULL)return;
...
// G2D_BLT.dst_y=0;
 ...
 G2D_BLT.color=*(volatile u32*)png[0]->data; //0x00000000; //�������� ���� RGB
 G2D_BLT.alpha=0xFF;       //����� ���������
...
//  else break;
 ...
 G2D_STRETCHBLT.color=*(volatile u32*)png[0]->data; //0x00000000; //�������� ���� RGB
