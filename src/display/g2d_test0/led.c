...
static LuImage *png[5]; //������ ���������� �� ������ PNG (����� PNG)

#define DstImageFormat G2D_FMT_XRGB8888

//#define SrcImageFormat G2D_FMT_ABGR_AVUY8888
#define SrcImageFormat G2D_FMT_XBGR8888 // ����� ����������� ��� alpha ������
//----------------------------------------------------------------------------------------------------------

void PNG_Load(LuImage **png,const void *buffer)      //��������� PNG �� buffer � ����� ���������� ������(malloc)
{
 *png=luPngReadMemory((char*)buffer);
}

//void xPNG_Draw(uint32_t px,uint32_t py,LuImage *png,u8 layer)   //������� PNG �� ������� � �������� �����������
//{
// if(png==NULL)return;
//
...
//{
// memset((void*)VIDEO_MEMORY,0,LCD_PIXEL_WIDTH*LCD_PIXEL_HEIGHT*BYTE_PER_PIXEL*2); //������� �����������
//}
...
void PNG_Background(LuImage *png,uint32_t memory)           //������� ������� PNG �� �������
{
 if(png==NULL)return;
...
void Rect(void)
{
 ...
 G2D_FILLRECT.color=0x00ff0000; //0xFFFF0000; //���� �������������� ARGB
 G2D_FILLRECT.alpha=0; //0xFF;       //����� �������������� (� ��������� �������� 0 - ������������� ������, 0xFF - ����������)
...
// local_delay_ms(200);
...
#if 1
 G2D_BLT.flag=G2D_BLT_NONE | 1*G2D_BLT_SRC_COLORKEY | 0*G2D_BLT_PIXEL_ALPHA; // G2D_BLT_PIXEL_ALPHA; //��� ������������ �������� - ����� colorkey ��� alpha

 G2D_BLT.src_image.addr[0]=(uintptr_t)png[0]->data;    //������, ��� �������� ��������
 G2D_BLT.src_image.addr[1]=0;//(uintptr_t)png[0]->data;	// was index=0
 G2D_BLT.src_image.addr[2]=0;//(uintptr_t)png[0]->data;	// was index=0
 G2D_BLT.src_image.w=png[0]->width;              //�������� ������
 ...
 G2D_BLT.src_rect.w=png[0]->width;               //������
...
// G2D_BLT.dst_y=0;
 ...
 G2D_BLT.color=*(volatile uint32_t*)png[0]->data; //0x00000000; //�������� ���� RGB
 G2D_BLT.alpha=0xFF;       //����� ���������
...
//  else break;
 ...
 G2D_STRETCHBLT.src_rect.w=png[0]->width;               //������
 G2D_STRETCHBLT.src_rect.h=png[0]->height;

 G2D_STRETCHBLT.dst_image.addr[0]=VIDEO_MEMORY1;        //�������� �� ��������� 1 (UI), ��� ��� ��������� 0 (VI) �� ����� ���������� ����� (����� ��� �� �����)
 ...
 G2D_STRETCHBLT.dst_rect.w=png[0]->width/2;             //������
 G2D_STRETCHBLT.dst_rect.h=png[0]->height/2;

 G2D_STRETCHBLT.color=*(volatile uint32_t*)png[0]->data; //0x00000000; //�������� ���� RGB
...
//  else goto Again;
 ...
 G2D_STRETCHBLT.dst_rect.x=rand()%(DIM_X-w);        //���������� ������
...
// PNG_Load(&png[1],Cobra_png);
 ...
 G2D_BLT.src_image.addr[0]=(uint32_t)png[1]->data;
 G2D_BLT.src_image.addr[0]=(uint32_t)png[1]->data;
 G2D_BLT.src_image.w=png[1]->width;              //�������� ������
 ...
 G2D_BLT.src_rect.x=0;                           //��������
 G2D_BLT.src_rect.y=0;
 G2D_BLT.src_rect.w=png[1]->width;               //������
