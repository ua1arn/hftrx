...
static uint32_t sun8i_tv2_vi_scaler_base(int channel)
{
 return 0;
...
static int sun8i_tv2_vi_scaler_coef_index(unsigned int step)
{
...
static void sun8i_tv2_vi_scaler_set_coeff(uint32_t base, uint32_t hstep, uint32_t vstep)
{
	...
	offset = sun8i_tv2_vi_scaler_coef_index(hstep) *
...
void sun8i_tv2_vi_scaler_setup(uint32_t src_w, uint32_t src_h, uint32_t dst_w, uint32_t dst_h, uint32_t hscale, uint32_t vscale, uint32_t hphase, uint32_t vphase)
{
	uint32_t chphase, cvphase;
	uint32_t insize, outsize;
	uint32_t base;

	base = sun8i_tv2_vi_scaler_base(CHANNEL);
	...
	sun8i_tv2_vi_scaler_set_coeff(base,
				  hscale, vscale);
}

void sun8i_tv2_vi_scaler_enable(uint8_t enable)
{
	uint32_t val, base;
