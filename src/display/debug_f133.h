...
static void G2D_BLD_Type_print(const G2D_BLD_TypeDef * p, const char * base)
{
	...
	PRINTF("%s->ROP_INDEX[0]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->ROP_INDEX[0], (unsigned) p->ROP_INDEX[0] );	/*!< Offset 0x000 ROP_INDEX[0]          */
	PRINTF("%s->ROP_INDEX[1]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->ROP_INDEX[1], (unsigned) p->ROP_INDEX[1] );	/*!< Offset 0x000 ROP_INDEX[0]          */
	PRINTF("%s->ROP_INDEX[2]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->ROP_INDEX[2], (unsigned) p->ROP_INDEX[2] );	/*!< Offset 0x000 ROP_INDEX[0]          */
	PRINTF("%s->ROP_INDEX[3]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->ROP_INDEX[3], (unsigned) p->ROP_INDEX[3] );	/*!< Offset 0x000 ROP_INDEX[0]          */
	PRINTF("%s->BLD_CH_ISIZE[0]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_ISIZE[0], (unsigned) p->BLD_CH_ISIZE[0] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_ISIZE[1]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_ISIZE[1], (unsigned) p->BLD_CH_ISIZE[1] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_ISIZE[2]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_ISIZE[2], (unsigned) p->BLD_CH_ISIZE[2] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_ISIZE[3]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_ISIZE[3], (unsigned) p->BLD_CH_ISIZE[3] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_OFFSET[0]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_OFFSET[0], (unsigned) p->BLD_CH_OFFSET[0] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_OFFSET[1]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_OFFSET[1], (unsigned) p->BLD_CH_OFFSET[1] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_OFFSET[2]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_OFFSET[2], (unsigned) p->BLD_CH_OFFSET[2] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
	PRINTF("%s->BLD_CH_OFFSET[3]=0x%08X; /* 0x%08X */\n", base, (unsigned) p->BLD_CH_OFFSET[3], (unsigned) p->BLD_CH_OFFSET[3] );	/*!< Offset 0x000 BLD_CH_ISIZE[0]          */
