...
const struct qmkey qmdefs [NQMKEYS] =
{
	...
	{ KIF_NONE,		KBD_ENC4_PRESS,			KBD_ENC4_HOLD,			' ', },		// 11 2nd small encoder (encoder_ENC2F object) ENCF3
	{ KIF_EXTMENU,	KBD_CODE_DISPMODE,		KBD_CODE_MENU, 			' ', },		// 12 DISPLAY/MENU
	{ KIF_SLOW,		KBD_CODE_BAND_UP,		KBD_CODE_BAND_UP, 		' ', },		// 13 BAND UP
	{ KIF_NONE,		KBD_ENC5_PRESS,			KBD_ENC5_HOLD,			' ', },		// 14 3rd small encoder (encoder_ENC3F object) ENCF3
	{ KIF_NONE,		KBD_ENC6_PRESS,			KBD_ENC6_HOLD,			' ', },		// 15 4th small encoder (encoder_ENC4F object) ENCF4
	...
	{ KIF_NONE,		KBD_ENC3_PRESS,			KBD_ENC3_HOLD,			' ', },		// 19 1st small encoder (encoder_ENC1F object) ENCF1
