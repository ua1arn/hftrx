...
#define r7s721_jpio_inputs(n, ipins) do { \
		GPIO.JPMC ## n &= ~ (ipins);	/* Port Mode Control Register: 0 - port, 1 - alternative */ \
		GPIO.JPIBC ## n |= (ipins);	/* Port Input Buffer Control Register (PIBCn): 0 - hiZ, 1 - input */ \
	} while (0)
