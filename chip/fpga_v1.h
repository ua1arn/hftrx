	...
	)
{
	...
	RBBIT(18, glob_mode_wfm);				/* b18: mode_wfm - разрешение передачи в DSP квадратур 192 кГц */
	RBBIT(17, glob_tx_bpsk_enable);			/* b17: tx_bpsk_enable - разрешение прямого формирования модуляции в FPGA */
