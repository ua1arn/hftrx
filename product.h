...
//#define DEFAULTDIALFREQ	225000L
//#define DEFAULTDIALFREQ	14021000L
#define WITHISBOOTLOADER	1	/* соответствующим Build Target компилируем и собирем bootloader */
...
//#define CTLSTYLE_STORCH_V3	1	// Rmainunit  	_v5fm.pcb, Rmainunit_v5jm.pcb, Rmainunit_v5km.pcb STM32F767ZET6, 2xUSB, SD-CARD, 8-bit display interface, NAU8822L и FPGA EP4CE22E22I7N
...
//#define CTLSTYLE_STORCH_V8	1	// rmainunit_v5km2.pcb rmainunit_v5km3.pcb rmainunit_v5km4.pcb R7S721020VCFP, TFT 4.3" или 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, AD9246BCPZ-125
//#define CTLSTYLE_STORCH_V9	1	// rmainunit_v5km2.pcb rmainunit_v5km3.pcb rmainunit_v5km4.pcb R7S721020VCFP, TFT 4.3" или 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, AD9246BCPZ-125

//
//#define CTLSTYLE_DSPV1A	1	// Плата "Дятел" с кодеками для DSPIF4 с 12 кГц IF DSP трактом
...
//#define CTLSTYLE_RA4YBO	1	// "Стационарный c Павлином" ATMega1284, up-conversion to 73050 для RA4YBO
//#define CTLSTYLE_RA4YBO_V1	1	// "Портативный с LS020 с тюнерм без часов" ATMega644 @8MHz, up-conversion to 64455 для RA4YBO
//#define CTLSTYLE_RA4YBO_V2	1	// "Стационарный с LS020" ATMega644 @8MHz, up-conversion to 64455 для RA4YBO
//#define CTLSTYLE_RA4YBO_V3	1	// "Стационарный с Павлином" STM32F101RB, Si570+LMX2306+AD9834, up-conversion to 64455 для RA4YBO
...
//#define CTLSTYLE_V1H	1	// Плата с процессором ATMega328 (DIP-28) - тестирование Hittite HMC830
//#define CTLSTYLE_V1X	1	// Плата с процессором ATXMega128A4U
//#define CTLSTYLE_V1T	1	// Плата Teensy 3.1 с процессором MK20DX256VLH7
...
//#define CTLSTYLE_V5 1		// ATMega: (UA1ZH) Маленькая плата на ATMEGA, с двумя AD9834 и четырьмя ГУН (atmega_ctlstyle_v5.h)
...
#elif 0 && CPUSTYLE_STM32H7XX && CTLSTYLE_STORCH_V7	// rmainunit_v5km0.pcb STM32H743IIT6, TFT 4.3", 2xUSB, SD-CARD, NAU8822L и FPGA EP4CE22E22I7N
...
#elif 1 && CPUSTYLE_STM32H7XX && CTLSTYLE_STORCH_V7	// rmainunit_v5km0.pcb STM32H743IIT6, TFT 4.3", 2xUSB, SD-CARD, NAU8822L и FPGA EP4CE22E22I7N
...
#elif CPUSTYLE_R7S721 && CTLSTYLE_STORCH_V8	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 4.3" or 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, AD9246BCPZ-125
	...
	//#include "boards/arm_r7s72_tqfp176_ctlstyle_storch_v8_ra4asn.h"	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N
	...
	//#include "boards/arm_r7s72_tqfp176_ctlstyle_storch_v8_r4dz.h"	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 4.3", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N
...
#elif CPUSTYLE_R7S721 && CTLSTYLE_STORCH_V9	// rmainunit_v5km5.pcb R7S721020VCFP, TFT 4.3" or 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, AD9246BCPZ-125
...
#elif 1 && CPUSTYLE_STM32MP1 && CTLSTYLE_STORCH_V7	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 4.3" or 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, AD9246BCPZ-125
	#include <boards/arm_stm32mp1xx_ctlstyle_video11.h>	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 4.3", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N
	#include "paramdepend.h"							/* проверка зависимостей параметров конфигурации */
	#include <boards/arm_stm32mp1xx_cpustyle_video11.h>	// Rmainunit_v5l.pcb (mini USBx2, wide display interface) - mini RX
#elif CPUSTYLE_STM32MP1 && CTLSTYLE_STORCH_V7	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 4.3" or 7", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, AD9246BCPZ-125
	#include <boards/arm_stm32mp1xx_ctlstyle_storch_v9a.h>	// rmainunit_v5km2.pcb R7S721020VCFP, TFT 4.3", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N
	#include "paramdepend.h"							/* проверка зависимостей параметров конфигурации */
	#include <boards/arm_stm32mp1xx_cpustyle_storch_v9a.h>	// Rmainunit_v5l.pcb (mini USBx2, wide display interface) - mini RX
	...
	#include "boards/atmega328_ctlstyle_v1h.h"	// Плата с процессором ATMega328 (DIP-28) - тестирование Hittite HMC830
	#include "paramdepend.h"				/* проверка зависимостей параметров конфигурации */
	...
	#include "boards/atmega_ctlstyle_ra4ybo_v3.h"	// "Стационарный с Павлином" STM32F103C8T6, 2*HMC830, up-conversion to 64455 для RA4YBO
	#include "paramdepend.h"				/* проверка зависимостей параметров конфигурации */
...
#elif CPUSTYLE_MK20DX && CTLSTYLE_V1T		// Плата Teensy 3.1 с процессором MK20DX256VLH7
