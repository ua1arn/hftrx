...
// UA1ARN
//
// Для выбора конфигурации целевого трансивера/приёмника раскомментировать в данном файле одну из секций.
// В зависимости от выбранной конфигурации, в проект включаются пары файлов из каталога ./boards
//
// В проекте используется файл product.h - данный файл (product_template.h) копируется и переименовывается в product.h. Для компиляции требуется выбрать одну из конфигураций.
...
#define CTLSTYLE_STORCH_V7	1
	...
	#include "boards/arm_stm32mp1xx_ctlstyle_storch_v9a_R1BBU.h"	// rmainunit_v5km7.pcb STM32MP153DAB, TFT 4.3", 2xUSB, NAU8822L и FPGA EP4CE22E22I7N, LTC2208
...
#elif (CPUSTYLE_T507) && CTLSTYLE_STORCH_V7 && 0
	#include "boards/arm_allwt507_ctlstyle_t507_v4.h"
	#include "paramdepend.h"							/* проверка зависимостей параметров конфигурации */
	#include "boards/arm_allwt507_cpustyle_t507_v4.h"
#elif (CPUSTYLE_T507) && CTLSTYLE_STORCH_V7 && 1
...
#elif (CPUSTYLE_T113 || CPUSTYLE_F133) && CTLSTYLE_STORCH_V7 && 0
	#include "boards/arm_allwt113s3_ctlstyle_storch_v9w.h"	// rmainunit_sv9u.pcb. rmainunit_sv9w.pcb, rmainunit_sv9x.pcb  Allwinner t133-S3, USB HUB, 2xUSB, NAU8822L и FPGA EP4CE22E22I7N
