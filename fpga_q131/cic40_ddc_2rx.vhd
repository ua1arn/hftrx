...
ARCHITECTURE SYN OF cic40_ddc_2rx IS


	COMPONENT cic40_ddc_2rx_cic
	PORT (
		clk	: IN STD_LOGIC;
		clken	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
...
BEGIN
	...
	cic40_ddc_2rx_cic_inst : cic40_ddc_2rx_cic
	PORT MAP (
		clk  =>  clk,
		clken  =>  clken,
		reset_n  =>  reset_n,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.CICModel"  active_core="cic40_ddc_2rx_cic" >
...
-- Retrieval info:      <PRIVATE name = "Rate Change Factor" value="40"  type="INTEGER"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "Number of channels per interface" value="4"  type="INTEGER"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "Integrator pipeline number" value="2"  type="INTEGER"  enable="0" />
-- Retrieval info:      <PRIVATE name = "Use pipeline in integrator" value="0"  type="BOOLEAN"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="cic40_ddc_2rx.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="cic40_ddc_2rx_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
