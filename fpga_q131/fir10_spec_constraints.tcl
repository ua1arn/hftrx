...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "fir10_spec_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "fir10_spec_st" "DSP BLOCKS"
}
add_fir_constraints
