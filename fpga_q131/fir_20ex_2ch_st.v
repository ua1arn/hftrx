...
mux_2to1_cen tdl_mux(.clk(clk), .rst(rst), .gclk_en(clk_en), .bin(tdl_dat_6_n), .ain(data_in),
...
defparam tdl_ff_6_n.LENGTH = 400;
defparam tdl_ff_6_n.ADDR_WIDTH = 9;
defparam tdl_ff_6_n.READ_ST = 3;
defparam tdl_ff_6_n.MEM_CORE = "AUTO";
defparam tdl_ff_6_n.INIT_FILE = "fir_20ex_2ch_zero.hex";

wire coef_en ;
assign coef_en = clk_en;
wire [18:0] coef_st_comb_0_n;
wire [COEF_WIDTH-1:0]coef_st_0_n;
assign coef_st_0_n = coef_st_comb_0_n[18:0];
msft_mem_coef Ucoef_0_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_0_n));
defparam Ucoef_0_n.WIDTH = 19;
defparam Ucoef_0_n.LENGTH = 200;
defparam Ucoef_0_n.READ_ST = 199;
defparam Ucoef_0_n.ADDR_WIDTH = 8;
defparam Ucoef_0_n.INIT_FILE = "fir_20ex_2ch_coef_0.hex";
defparam Ucoef_0_n.MEM_CORE = "AUTO";
wire [18:0] coef_st_comb_1_n;
wire [COEF_WIDTH-1:0]coef_st_1_n;
assign coef_st_1_n = coef_st_comb_1_n[18:0];
msft_mem_coef Ucoef_1_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_1_n));
defparam Ucoef_1_n.WIDTH = 19;
defparam Ucoef_1_n.LENGTH = 200;
defparam Ucoef_1_n.READ_ST = 199;
defparam Ucoef_1_n.ADDR_WIDTH = 8;
defparam Ucoef_1_n.INIT_FILE = "fir_20ex_2ch_coef_1.hex";
defparam Ucoef_1_n.MEM_CORE = "AUTO";
wire [18:0] coef_st_comb_2_n;
wire [COEF_WIDTH-1:0]coef_st_2_n;
assign coef_st_2_n = coef_st_comb_2_n[18:0];
msft_mem_coef Ucoef_2_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_2_n));
defparam Ucoef_2_n.WIDTH = 19;
defparam Ucoef_2_n.LENGTH = 200;
defparam Ucoef_2_n.READ_ST = 199;
defparam Ucoef_2_n.ADDR_WIDTH = 8;
defparam Ucoef_2_n.INIT_FILE = "fir_20ex_2ch_coef_2.hex";
defparam Ucoef_2_n.MEM_CORE = "AUTO";
wire [18:0] coef_st_comb_3_n;
wire [COEF_WIDTH-1:0]coef_st_3_n;
assign coef_st_3_n = coef_st_comb_3_n[18:0];
msft_mem_coef Ucoef_3_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_3_n));
defparam Ucoef_3_n.WIDTH = 19;
defparam Ucoef_3_n.LENGTH = 200;
defparam Ucoef_3_n.READ_ST = 199;
defparam Ucoef_3_n.ADDR_WIDTH = 8;
defparam Ucoef_3_n.INIT_FILE = "fir_20ex_2ch_coef_3.hex";
defparam Ucoef_3_n.MEM_CORE = "AUTO";
wire [18:0] coef_st_comb_4_n;
wire [COEF_WIDTH-1:0]coef_st_4_n;
assign coef_st_4_n = coef_st_comb_4_n[18:0];
msft_mem_coef Ucoef_4_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_4_n));
defparam Ucoef_4_n.WIDTH = 19;
defparam Ucoef_4_n.LENGTH = 200;
defparam Ucoef_4_n.READ_ST = 199;
defparam Ucoef_4_n.ADDR_WIDTH = 8;
defparam Ucoef_4_n.INIT_FILE = "fir_20ex_2ch_coef_4.hex";
defparam Ucoef_4_n.MEM_CORE = "AUTO";
wire [18:0] coef_st_comb_5_n;
wire [COEF_WIDTH-1:0]coef_st_5_n;
assign coef_st_5_n = coef_st_comb_5_n[18:0];
msft_mem_coef Ucoef_5_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_5_n));
defparam Ucoef_5_n.WIDTH = 19;
defparam Ucoef_5_n.LENGTH = 200;
defparam Ucoef_5_n.READ_ST = 199;
defparam Ucoef_5_n.ADDR_WIDTH = 8;
defparam Ucoef_5_n.INIT_FILE = "fir_20ex_2ch_coef_5.hex";
defparam Ucoef_5_n.MEM_CORE = "AUTO";
wire [18:0] coef_st_comb_6_n;
wire [COEF_WIDTH-1:0]coef_st_6_n;
assign coef_st_6_n = coef_st_comb_6_n[18:0];
msft_mem_coef Ucoef_6_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(19'b0),.data_out(coef_st_comb_6_n));
defparam Ucoef_6_n.WIDTH = 19;
defparam Ucoef_6_n.LENGTH = 200;
defparam Ucoef_6_n.READ_ST = 199;
defparam Ucoef_6_n.ADDR_WIDTH = 8;
defparam Ucoef_6_n.INIT_FILE = "fir_20ex_2ch_coef_6.hex";
...
sadd_reg_top_cen Uaddl_0_n_3_n (.clk(clk),  .gclk_en(clk_en), .ain(mlu_res_6_n), .bin(51'd0), .res(tree_l_0_n_3_n) );
...
assign fir_acc_in = {fir_mc_res[53], fir_mc_res[53], fir_mc_res};
