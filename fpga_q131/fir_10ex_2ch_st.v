...
defparam tdl_ff_0_n.INIT_FILE = "fir_10ex_2ch_zero.hex";
...
defparam tdl_ff_1_n.INIT_FILE = "fir_10ex_2ch_zero.hex";
...
defparam tdl_ff_2_n.INIT_FILE = "fir_10ex_2ch_zero.hex";
...
defparam tdl_ff_3_n.INIT_FILE = "fir_10ex_2ch_zero.hex";
...
msft_mem_coef Ucoef_0_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(21'b0),.data_out(coef_st_comb_0_n));
defparam Ucoef_0_n.WIDTH = 21;
defparam Ucoef_0_n.LENGTH = 240;
defparam Ucoef_0_n.READ_ST = 239;
defparam Ucoef_0_n.ADDR_WIDTH = 8;
defparam Ucoef_0_n.INIT_FILE = "fir_10ex_2ch_coef_0.hex";
...
msft_mem_coef Ucoef_1_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(21'b0),.data_out(coef_st_comb_1_n));
defparam Ucoef_1_n.WIDTH = 21;
defparam Ucoef_1_n.LENGTH = 240;
defparam Ucoef_1_n.READ_ST = 239;
defparam Ucoef_1_n.ADDR_WIDTH = 8;
defparam Ucoef_1_n.INIT_FILE = "fir_10ex_2ch_coef_1.hex";
defparam Ucoef_1_n.MEM_CORE = "AUTO";
wire [20:0] coef_st_comb_2_n;
wire [COEF_WIDTH-1:0]coef_st_2_n;
assign coef_st_2_n = coef_st_comb_2_n[20:0];
msft_mem_coef Ucoef_2_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(21'b0),.data_out(coef_st_comb_2_n));
defparam Ucoef_2_n.WIDTH = 21;
defparam Ucoef_2_n.LENGTH = 240;
defparam Ucoef_2_n.READ_ST = 239;
defparam Ucoef_2_n.ADDR_WIDTH = 8;
defparam Ucoef_2_n.INIT_FILE = "fir_10ex_2ch_coef_2.hex";
defparam Ucoef_2_n.MEM_CORE = "AUTO";
wire [20:0] coef_st_comb_3_n;
wire [COEF_WIDTH-1:0]coef_st_3_n;
assign coef_st_3_n = coef_st_comb_3_n[20:0];
msft_mem_coef Ucoef_3_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(8'b0),.data_in(21'b0),.data_out(coef_st_comb_3_n));
defparam Ucoef_3_n.WIDTH = 21;
defparam Ucoef_3_n.LENGTH = 240;
defparam Ucoef_3_n.READ_ST = 239;
defparam Ucoef_3_n.ADDR_WIDTH = 8;
defparam Ucoef_3_n.INIT_FILE = "fir_10ex_2ch_coef_3.hex";
...
wire [52:0] mlu_res_2_n;
mac_tl Umtl_2_n             (.clk(clk), 
             .data_in(mlu_resx_2_n),
             .data_out(mlu_res_2_n));
defparam Umtl_2_n.DATA_WIDTH = 53;

wire [52:0] mlu_resx_3_n;
