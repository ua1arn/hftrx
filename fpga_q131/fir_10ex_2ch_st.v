...
ram_lut_cen Ur0_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_3_n,ser_dat_2_n,ser_dat_1_n,ser_dat_0_n } ), .wr_en(1'b0),.data_out( lut_val_0_n[10:0]) ) ;
...
ram_lut_cen Ur1_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_7_n,ser_dat_6_n,ser_dat_5_n,ser_dat_4_n } ), .wr_en(1'b0),.data_out( lut_val_1_n[13:0]) ) ;
...
ram_lut_cen Ur2_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_11_n,ser_dat_10_n,ser_dat_9_n,ser_dat_8_n } ), .wr_en(1'b0),.data_out( lut_val_2_n[15:0]) ) ;
...
ram_lut_cen Ur3_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_14_n,ser_dat_13_n,ser_dat_12_n } ), .wr_en(1'b0),.data_out( lut_val_3_n[17:0]) ) ;
defparam Ur3_n.device_family = "CYCLONEIII";
defparam Ur3_n.init_file = "fir_10ex_2ch_coef_3.hex";
defparam Ur3_n.data_width = 18;
defparam Ur3_n.addr_width = 7;
defparam Ur3_n.depth = 80;
defparam Ur3_n.mem_core = "M4K";
assign lut_val_3_n[19] = lut_val_3_n[17];
assign lut_val_3_n[18] = lut_val_3_n[17];
wire [19:0] lut_val_4_n;
ram_lut_cen Ur4_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_17_n,ser_dat_16_n,ser_dat_15_n } ), .wr_en(1'b0),.data_out( lut_val_4_n[19:0]) ) ;
defparam Ur4_n.device_family = "CYCLONEIII";
defparam Ur4_n.init_file = "fir_10ex_2ch_coef_4.hex";
defparam Ur4_n.data_width = 20;
defparam Ur4_n.addr_width = 7;
defparam Ur4_n.depth = 80;
defparam Ur4_n.mem_core = "M4K";
wire [19:0] lut_val_5_n;
ram_lut_cen Ur5_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_20_n,ser_dat_19_n,ser_dat_18_n } ), .wr_en(1'b0),.data_out( lut_val_5_n[17:0]) ) ;
...
ram_lut_cen Ur6_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_24_n,ser_dat_23_n,ser_dat_22_n,ser_dat_21_n } ), .wr_en(1'b0),.data_out( lut_val_6_n[15:0]) ) ;
...
ram_lut_cen Ur7_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_28_n,ser_dat_27_n,ser_dat_26_n,ser_dat_25_n } ), .wr_en(1'b0),.data_out( lut_val_7_n[13:0]) ) ;
...
ram_lut_cen Ur8_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_32_n,ser_dat_31_n,ser_dat_30_n,ser_dat_29_n } ), .wr_en(1'b0),.data_out( lut_val_8_n[10:0]) ) ;
...
ram_lut_cen Ur9_n(.gclk_en(clk_en), .clk_in(clk), .clk_out(clk), .addr_in( {coef_set_dly[3],coef_set_dly[2],coef_set_dly[1],coef_set_dly[0],ser_dat_33_n } ), .wr_en(1'b0),.data_out( lut_val_9_n[0:0]) ) ;
defparam Ur9_n.device_family = "CYCLONEIII";
defparam Ur9_n.init_file = "fir_10ex_2ch_coef_9.hex";
defparam Ur9_n.data_width = 1;
defparam Ur9_n.addr_width = 5;
defparam Ur9_n.depth = 20;
