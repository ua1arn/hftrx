...
%% Generated on: Jul 3, 2020 12:47:16 AM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% cic_128a_3iq_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    cic_128a_3iq_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    cic_128a_3iq_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    cic_128a_3iq_fir_comp_coeff(31,80e6,4e6,true,false)


function cic_128a_3iq_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	...
	filename = 'cic_128a_3iq_fir_comp_coeff.txt';
