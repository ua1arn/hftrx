...
% Generated on: Oct 11, 2018 3:11:03 AM
...
for j = 1:sx
    ...
    %
    file_name = ['fir_40ex_2ch_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model                   
      output = fir_40ex_2ch_mlab(data_channel);
    ...
    file_name = ['fir_40ex_2ch_model_output'];
    ...
    fprintf(outfile2, '%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n',reshaped_output_full');
    fclose(outfile2);        
end      
