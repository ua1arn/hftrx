...
%% Generated on: May 31, 2017 10:18:17 PM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% cic_64_3iq_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    cic_64_3iq_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    cic_64_3iq_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    cic_64_3iq_fir_comp_coeff(31,80e6,4e6,true,false)


function cic_64_3iq_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	...
	filename = 'cic_64_3iq_fir_comp_coeff.txt';
