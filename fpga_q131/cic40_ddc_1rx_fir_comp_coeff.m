...
%% Generated on: Oct 12, 2017 11:50:52 AM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% cic40_ddc_1rx_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    cic40_ddc_1rx_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    cic40_ddc_1rx_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    cic40_ddc_1rx_fir_comp_coeff(31,80e6,4e6,true,false)


function cic40_ddc_1rx_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	...
	filename = 'cic40_ddc_1rx_fir_comp_coeff.txt';
