...
ARCHITECTURE SYN OF cic_128a_2iq IS


	COMPONENT cic_128a_2iq_cic
	PORT (
		clk	: IN STD_LOGIC;
		clken	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
...
BEGIN
	...
	cic_128a_2iq_cic_inst : cic_128a_2iq_cic
	PORT MAP (
		clk  =>  clk,
		clken  =>  clken,
		reset_n  =>  reset_n,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.CICModel"  active_core="cic_128a_2iq_cic" >
...
-- Retrieval info:      <PRIVATE name = "Rate Change Factor" value="128"  type="INTEGER"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "Output Bit Width" value="28"  type="INTEGER"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="cic_128a_2iq.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="cic_128a_2iq_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
