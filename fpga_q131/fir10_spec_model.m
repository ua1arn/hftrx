...
% Generated on: Dec 30, 2022 4:43:15 PM
...
coef_in_file = fopen ('fir10_spec_coef_reload.txt', 'r');
...
for j = 1:sx
    ...
    %
    file_name = ['fir10_spec_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model                   
      output = fir10_spec_mlab(data_channel,h);
    ...
    file_name = ['fir10_spec_model_output'];
