...
%% Generated on: Jul 3, 2020 12:49:35 AM
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% cic20a_ddc_2rx_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    cic20a_ddc_2rx_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    cic20a_ddc_2rx_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    cic20a_ddc_2rx_fir_comp_coeff(31,80e6,4e6,true,false)


function cic20a_ddc_2rx_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	...
	filename = 'cic20a_ddc_2rx_fir_comp_coeff.txt';
