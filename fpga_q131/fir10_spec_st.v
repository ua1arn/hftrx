...
msft_mem_coef Ucoef_0_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(9'b0),.data_in(22'b0),.data_out(coef_st_comb_0_n));
...
msft_mem_coef Ucoef_1_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(9'b0),.data_in(22'b0),.data_out(coef_st_comb_1_n));
...
assign fir_acc_in = {fir_mc_res[54], fir_mc_res[54], fir_mc_res[54], fir_mc_res};
