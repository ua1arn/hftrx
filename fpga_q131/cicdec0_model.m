...
% Generated on: Jan 24, 2026 11:23:26 AM
...
coef_in_file = fopen ('cicdec0_coef_reload.txt', 'r');
...
for j = 1:sx
    ...
    for i = 1: num_ch
     ...
     % run this output through the model                   
      output = cicdec0_mlab(data_channel,h);
    ...
    file_name = ['cicdec0_model_output'];
