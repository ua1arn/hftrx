...
defparam tdl_ff_0_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_1_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_2_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_3_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_4_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_5_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_6_n.INIT_FILE = "fir5_spec_zero.hex";
...
defparam tdl_ff_7_n.INIT_FILE = "fir5_spec_zero.hex";
...
msft_mem_coef Ucoef_0_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_0_n));
...
msft_mem_coef Ucoef_1_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_1_n));
...
msft_mem_coef Ucoef_2_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_2_n));
...
msft_mem_coef Ucoef_3_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_3_n));
defparam Ucoef_3_n.WIDTH = 23;
defparam Ucoef_3_n.LENGTH = 120;
defparam Ucoef_3_n.READ_ST = 119;
defparam Ucoef_3_n.ADDR_WIDTH = 7;
defparam Ucoef_3_n.INIT_FILE = "fir5_spec_coef_3.hex";
defparam Ucoef_3_n.MEM_CORE = "AUTO";
wire [22:0] coef_st_comb_4_n;
wire [COEF_WIDTH-1:0]coef_st_4_n;
assign coef_st_4_n = coef_st_comb_4_n[22:0];
msft_mem_coef Ucoef_4_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_4_n));
defparam Ucoef_4_n.WIDTH = 23;
defparam Ucoef_4_n.LENGTH = 120;
defparam Ucoef_4_n.READ_ST = 119;
defparam Ucoef_4_n.ADDR_WIDTH = 7;
defparam Ucoef_4_n.INIT_FILE = "fir5_spec_coef_4.hex";
defparam Ucoef_4_n.MEM_CORE = "AUTO";
wire [22:0] coef_st_comb_5_n;
wire [COEF_WIDTH-1:0]coef_st_5_n;
assign coef_st_5_n = coef_st_comb_5_n[22:0];
msft_mem_coef Ucoef_5_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_5_n));
defparam Ucoef_5_n.WIDTH = 23;
defparam Ucoef_5_n.LENGTH = 120;
defparam Ucoef_5_n.READ_ST = 119;
defparam Ucoef_5_n.ADDR_WIDTH = 7;
defparam Ucoef_5_n.INIT_FILE = "fir5_spec_coef_5.hex";
defparam Ucoef_5_n.MEM_CORE = "AUTO";
wire [22:0] coef_st_comb_6_n;
wire [COEF_WIDTH-1:0]coef_st_6_n;
assign coef_st_6_n = coef_st_comb_6_n[22:0];
msft_mem_coef Ucoef_6_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_6_n));
defparam Ucoef_6_n.WIDTH = 23;
defparam Ucoef_6_n.LENGTH = 120;
defparam Ucoef_6_n.READ_ST = 119;
defparam Ucoef_6_n.ADDR_WIDTH = 7;
defparam Ucoef_6_n.INIT_FILE = "fir5_spec_coef_6.hex";
defparam Ucoef_6_n.MEM_CORE = "AUTO";
wire [22:0] coef_st_comb_7_n;
wire [COEF_WIDTH-1:0]coef_st_7_n;
assign coef_st_7_n = coef_st_comb_7_n[22:0];
msft_mem_coef Ucoef_7_n (.rst(rst), .clk_in(coef_in_clk), .clk_out(clk),.clk_en(clk_en), .we(1'b0),.wr_addr(7'b0),.data_in(23'b0),.data_out(coef_st_comb_7_n));
defparam Ucoef_7_n.WIDTH = 23;
defparam Ucoef_7_n.LENGTH = 120;
defparam Ucoef_7_n.READ_ST = 119;
defparam Ucoef_7_n.ADDR_WIDTH = 7;
defparam Ucoef_7_n.INIT_FILE = "fir5_spec_coef_7.hex";
defparam Ucoef_7_n.MEM_CORE = "AUTO";


wire [50:0] mlu_resx_0_n;
...
wire [50:0] mlu_res_0_n;
mac_tl Umtl_0_n             (.clk(clk), 
             .data_in(mlu_resx_0_n),
             .data_out(mlu_res_0_n));
defparam Umtl_0_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_1_n;
...
wire [50:0] mlu_res_1_n;
mac_tl Umtl_1_n             (.clk(clk), 
             .data_in(mlu_resx_1_n),
             .data_out(mlu_res_1_n));
defparam Umtl_1_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_2_n;
...
wire [50:0] mlu_res_2_n;
mac_tl Umtl_2_n             (.clk(clk), 
             .data_in(mlu_resx_2_n),
             .data_out(mlu_res_2_n));
defparam Umtl_2_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_3_n;
...
wire [50:0] mlu_res_3_n;
mac_tl Umtl_3_n             (.clk(clk), 
             .data_in(mlu_resx_3_n),
             .data_out(mlu_res_3_n));
defparam Umtl_3_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_4_n;
...
wire [50:0] mlu_res_4_n;
mac_tl Umtl_4_n             (.clk(clk), 
             .data_in(mlu_resx_4_n),
             .data_out(mlu_res_4_n));
defparam Umtl_4_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_5_n;
...
wire [50:0] mlu_res_5_n;
mac_tl Umtl_5_n             (.clk(clk), 
             .data_in(mlu_resx_5_n),
             .data_out(mlu_res_5_n));
defparam Umtl_5_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_6_n;
...
wire [50:0] mlu_res_6_n;
mac_tl Umtl_6_n             (.clk(clk), 
             .data_in(mlu_resx_6_n),
             .data_out(mlu_res_6_n));
defparam Umtl_6_n.DATA_WIDTH = 51;

wire [50:0] mlu_resx_7_n;
