...
#create_generated_clock -name "sai1_sck_a_clock" -source "ref122880" -divide_by 10 -duty_cycle 20.0
...
set_false_path -from [get_clocks {ref122880}] -to [get_ports {led0 led1 led2 led3}]
