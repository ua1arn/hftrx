SET CONVERTER=..\Debug\genregdefs.exe --cortexa5x "core_ca53.h:a-profile/gicv2.h" --cortexa7 "core_ca.h" --guid "{DADB7421-2CE1-4351-A89A-B0338D2EB5AF}"
...
SET FILELIST= ve.csv gic.csv cpusubsysctrl.csv ccu.csv sys_cfg.csv ndfc.csv tsc.csv uart.csv gpio.csv smhc.csv i2s_pcm.csv dmic.csv owa.csv audio_codec.csv twi.csv spi.csv cir_rx.csv tpadc.csv gpadc.csv ce.csv rtc.csv iommu.csv ths.csv timer.csv hstimer.csv ^
	...
	dramcom.csv dramctl0.csv dramphy0.csv dramc.csv sramc.csv r_timer.csv ^
	r_intc.csv r_wdog.csv r_prcm.csv r_twd.csv r_cpucfg.csv r_cir-rx.csv r_rsb.csv r_pwm.csv ^
	aw_a64.csv	 
