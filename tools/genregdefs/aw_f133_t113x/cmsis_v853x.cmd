...
SET FILELIST=gic.csv r_cpucfg.csv r_ccu.csv cpusubsysctrl.csv risc_cfg.csv ccu.csv sys_cfg.csv ^
	...
	timer.csv hstimer.csv can.csv ^
	de3.csv di.csv g2d.csv dsi.csv hdmi.csv display_if_top.csv tcon_lcd.csv tcon_tv.csv tve.csv csi_v853x.csv ^
	...
	mctl_com.csv mctl_phy.csv dcu.csv ve.csv ^
	memortmap_t113x.csv
