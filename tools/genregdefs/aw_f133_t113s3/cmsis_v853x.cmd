...
SET FILELIST=gic.csv r_cpucfg.csv r_ccu.csv cpusubsysctrl.csv risc_cfg.csv ccu.csv sys_cfg.csv ^
	uart.csv gpio.csv smhc.csv i2s_pcm.csv dmic.csv audio_codec.csv twi.csv spi.csv ^
	cir_rx.csv cir_tx.csv ledc.csv tpadc.csv gpadc.csv ce.csv rtc.csv iommu.csv ths.csv ^
	timer.csv hstimer.csv can.csv usbehci.csv usbotg.csv usbphyc.csv ^
