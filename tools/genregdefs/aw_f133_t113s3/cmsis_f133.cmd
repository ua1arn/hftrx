...
SET FILELIST=risc_cfg.csv risc_wdg.csv risc_timestamp.csv ccu.csv r_ccu.csv plic.csv sys_cfg.csv ^
	...
	emac.csv clint.csv mctl_com.csv mctl_phy.csv r_prcm.csv r_cpucfg.csv c0_cpux_cfg.csv c0_cpux_mbist.csv
