...
static unsigned fill_CDCECM_function(uint_fast8_t fill, uint8_t * p, unsigned maxsize, int highspeed)
{
	...
	n += CDCECM_InterfaceDescriptorDataIf(fill, p + n, maxsize - n, INTERFACE_CDCECM_DATA_6, 0x00, 2);	/* INTERFACE_CDCECM_DATA_6 Data class interface descriptor */
...
void usbd_descriptors_initialize(uint_fast8_t HSdesc)
{
	...
	} funcs [] =
	{
			...
			{ fill_Configuration_main_group,	INTERFACE_count, 1, }
