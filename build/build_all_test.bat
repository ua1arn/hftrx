...
cd ..
cd atmega32a_8
make MAKE_DEFINES=-DCTLSTYLE_SW2018XVR=1
cd ..
cd atmega644p_8
make MAKE_DEFINES=-DCTLSTYLE_SW2018XVR=1
cd ..
cd atsam3s4b
make MAKE_DEFINES=-DCTLSTYLE_V8B=1
cd ..
cd atsam4sa16c
make MAKE_DEFINES=-DCTLSTYLE_V8B=1
cd ..
...
cd ..
cd atxmega128a4u
make MAKE_DEFINES=-DCTLSTYLE_V1X=1
cd ..
cd mk20dx256vlh7
make MAKE_DEFINES=-DCTLSTYLE_V1T=1
cd ..
cd r7s721020
make MAKE_DEFINES=-DCTLSTYLE_STORCH_V8=1
cd ..
cd stm32f030f4p
make MAKE_DEFINES=-DCTLSTYLE_V1E=1
cd ..
cd stm32f051c6t
make MAKE_DEFINES=-DCTLSTYLE_V1F=1
cd ..
cd stm32f101rb
make MAKE_DEFINES=-DCTLSTYLE_V1B=1
cd ..
cd stm32f103c8
make MAKE_DEFINES=-DCTLSTYLE_RA4YBO_V3=1
cd ..
cd stm32f303vc
make MAKE_DEFINES=-DCTLSTYLE_RA4YBO_V3=1
cd ..
cd stm32f401rb
make MAKE_DEFINES=-DCTLSTYLE_V1K=1
cd ..
cd stm32f407vg
make MAKE_DEFINES=-DCTLSTYLE_V2D=1
cd ..
cd stm32f429zi
make MAKE_DEFINES=-DCTLSTYLE_V2D=1
cd ..
cd stm32f446ze
make MAKE_DEFINES=-DCTLSTYLE_V3D=1
cd ..
cd stm32f723ze
make MAKE_DEFINES=-DCTLSTYLE_STORCH_V3=1
cd ..
cd stm32f746zg
make MAKE_DEFINES=-DCTLSTYLE_STORCH_V3=1
cd ..
cd stm32f767zi
make MAKE_DEFINES=-DCTLSTYLE_STORCH_V5=1
cd ..
cd stm32f769ii
make MAKE_DEFINES=-DCTLSTYLE_STORCH_V5=1
cd ..
