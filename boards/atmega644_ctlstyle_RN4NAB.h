...
*/
	...
	#define WITHPREAMPATT2_6DB	1	/* УВЧ и аттенюатор с затуханиями 0 - 6 - 12 - 18 dB */
	#define WITHAGCMODESLOWFAST 1	/* среди режимов АРУ есть только быстро-медленно - RN4NAB */
