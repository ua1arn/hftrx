...
// Аппаратура контроллера с общими выводами для HD44780 и I2C (нельзя одновременно использовать)
...
#define LS020_RESET_SET(v) do { \
	...
	#define LS020_RESET	(1U << PC6)			// Pin 28 - D6 signal in HD44780 socket
...
//#endif
	...
	#define TARGET_BAND_DATAS_BIT_LOW PA0		// какой бит данных младший в слове считанном с порта
