/* $Id$ */
/* board-specific CPU DIP40 attached signals */
//
...
#ifndef ATMEGA_CPUSTYLE_RV9CQQ_H_INCLUDED
#define ATMEGA_CPUSTYLE_RV9CQQ_H_INCLUDED 1
...
// РђРїРїР°СЂР°С‚СѓСЂР° РєРѕРЅС‚СЂРѕР»Р»РµСЂР° СЃ РѕР±С‰РёРјРё РІС‹РІРѕРґР°РјРё РґР»СЏ HD44780 Рё I2C (РЅРµР»СЊР·СЏ РѕРґРЅРѕРІСЂРµРјРµРЅРЅРѕ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ)
// РќРѕРІС‹Р№ РєРѕРЅС‚СЂРѕР»Р»РµСЂ Explorer-Р°
// РџСЂРёС‘РјРЅРёРє "Р’РѕСЂРѕРЅС‘РЅРѕРє"
// РЎРёРЅС‚РµР·Р°С‚РѕСЂ "Р’РѕСЂРѕР±РµР№"

#if LCDMODE_SPI_NA
	#define LS020_RS_PORT PORTC
	#define LS020_RS_DDR DDRC
	#define LS020_RS	(1U << PC7)			// Pin 29 - D7 signal in HD44780 socket

#elif LCDMODE_SPI_RA
	#define LS020_RESET_PORT PORTC
	#define LS020_RESET_DDR DDRC
	#define LS020_RST	(1U << PC6)			// Pin 28 - D6 signal in HD44780 socket
	...
	#define UC1608_CSP 	(1U << PC3)			// Pin 23 - E signal on HD44780 socket - positive chipselect
	...
	#define	TARGET_DDSRESET_BIT	(1U << PC2)
...
#if WITHELKEY
	/* СЃРёРіРЅР°Р»С‹ РїРѕРґРєР»СЋС‡РµРЅРёСЏ СЌР»РµРєС‚СЂРѕРЅРЅРѕРіРѕ РєР»СЋС‡Р° */
	#define ELKEY_TARGET_PORT PORTC		// РІС…РѕРґС‹ РїСЂРѕС†РµСЃСЃРѕСЂР° - СЃРёРіРЅР°Р»С‹ СЌР»РµРєС‚СЂРѕРЅРЅРѕРіРѕ РєР»СЋС‡Р°
	#define ELKEY_TARGET_DDR DDRC		// РїРµСЂРµРєР»СЋС‡РµРЅРёРµ РЅР° РІРІРѕРґ - СЃРёРіРЅР°Р»С‹ СЌР»РµРєС‚СЂРѕРЅРЅРѕРіРѕ РєР»СЋС‡Р°
	#define ELKEY_TARGET_PIN PINC		// РІРІРѕРґ - СЃРёРіРЅР°Р»С‹ СЌР»РµРєС‚СЂРѕРЅРЅРѕРіРѕ РєР»СЋС‡Р°
...
//#endif
	...
	// РџСЂРµРґРїРѕР»Р°РіР°РµС‚СЃСЏ, С‡С‚Рѕ РІСЃРµ С‡РёРїСЃРµР»РµРєС‚С‹ РЅР°С…РѕРґСЏС‚СЃСЏ РЅР° РѕРґРЅРѕРј РїРѕСЂС‚Сѓ РІРІРѕРґР°-РІС‹РІРѕРґР°
	// Рё РёС… РјРѕРґРёС„РёРєР°С†РёСЏ РІРѕР·РјРѕР¶РЅР° РѕРґРЅРѕР№ Р°СЂРёС„РјРµС‚РёС‡РµСЃРєРѕР№ РѕРїРµСЂР°С†РёРµР№.
	...
	#define SPI_CSEL0 (1U << PB2)		// PIN 03 (DIP40) - DDS1
	#define SPI_CSEL7 (1U << PB4)		// PIN 05 (DIP40) - NVRAM

	// РІ РґР°РЅРЅСѓСЋ РјР°СЃРєСѓ РґРѕР»Р¶РЅС‹ Р±С‹С‚СЊ РІРєР»СЋС‡РµРЅС‹ РІСЃРµ РІС‹РІРѕРґС‹ С‡РёРїСЃРµР»РµРєС‚РѕРІ.
	#define SPI_ALLCS_BITS (SPI_CSEL0 | SPI_CSEL7)
	...
	// РґР°РЅРЅС‹Рµ СѓРїСЂР°РІР»РµРЅРёСЏ РїРµСЂРµРєСЋС‡РµРёРµРј РґРёР°РїР°Р·РѕРЅРѕРІ
	#define TARGET_BAND_DATA_PORT PORTA
	#define TARGET_BAND_DATA_DIR DDRA
	#define TARGET_BAND_DATAS_BIT_LOW PA0		// РєР°РєРѕР№ Р±РёС‚ РґР°РЅРЅС‹С… РјР»Р°РґС€РёР№ РІ СЃР»РѕРІРµ СЃС‡РёС‚Р°РЅРЅРѕРј СЃ РїРѕСЂС‚Р°
	#define TARGET_BAND_DATAS_BITS (0x0f << TARGET_BAND_DATAS_BIT_LOW)

	#define TARGET_BAND_DATA_SET(v) do { \
		TARGET_BAND_DATA_PORT = \
			(TARGET_BAND_DATA_PORT & ~ TARGET_BAND_DATAS_BITS) | \
			(((v) << TARGET_BAND_DATAS_BIT_LOW) & TARGET_BAND_DATAS_BITS); \
		} while (0)

	#define TARGET_BAND_DATA_INITIALIZE() do { \
		TARGET_BAND_DATA_DIR |= TARGET_BAND_DATAS_BITS; \
		} while (0)
