...
#ifndef ATMEGA_CPUSTYLE_V8B_H_INCLUDED
#define ATMEGA_CPUSTYLE_V8B_H_INCLUDED 1
...
// РђРїРїР°СЂР°С‚СѓСЂР° РєРѕРЅС‚СЂРѕР»Р»РµСЂР° РІ РєРѕСЂРїСѓСЃРµ DIP40/TQFP44 СЃ РѕР±С‰РёРјРё РІС‹РІРѕРґР°РјРё РґР»СЏ HD44780 Рё I2C (РЅРµ РѕРґРЅРѕРІСЂРµРјРµРЅРЅРѕ)
...
// РџСЂРёС‘РјРЅРёРє "Р’РѕСЂРѕРЅС‘РЅРѕРє"
	...
	#define LS020_RS	(1U << PC7)			// Pin 29 TQFP44 - D7 signal in HD44780 socket

#elif LCDMODE_SPI_RA
	#define LS020_RESET_PORT PORTC
	#define LS020_RESET_DDR DDRC
	#define LS020_RST	(1U << PC6)			// Pin 28 TQFP44 - D6 signal in HD44780 socket
	...
	#define LCD_STROBE_BIT (1U << PB3)	// Pin 04 TQFP44 - E signal on HD44780 socket - positive chipselect
...
#if LCDMODE_UC1608
	#define UC1608_CSP_PORT PORTB
	#define UC1608_CSP_DDR DDRB
	#define UC1608_CSP 	(1U << PB3)			// Pin 04 TQFP44 - E signal on HD44780 socket - positive chipselect
	...
	#define PTT_BIT_PTT (1U << PC5)		// СЃРѕРІРјРµС‰РµРЅРѕ СЃ D5 LCD HD44780

#endif /* WITHTX */

#if WITHCAT || WITHNMEA
	// РЎРёРіРЅР°Р»С‹ РїРµСЂРµРєР»СЋС‡РµРЅРёСЏ РЅР° РїРµСЂРµРґР°С‡Сѓ Рё РјР°РЅРёРїСѓР»СЏС†РёРё С‡РµСЂРµР· CAT РёРЅС‚РµСЂС„РµР№СЃ.
	#define FROMCAT_TARGET_PIN_RTS		PINC
	#define FROMCAT_TARGET_PORT_RTS		PORTC
	#define FROMCAT_TARGET_DDR_RTS		DDRC
	#define FROMCAT_BIT_RTS			(1U << PC4)	/* СЃРёРіРЅР°Р» RTS РѕС‚ FT232RL СЃРѕРІРјРµС‰РµРЅРѕ СЃ D4 LCD HD44780	*/
	/* РјР°РЅРёРїСѓР»СЏС†РёСЏ РѕС‚ РїРѕСЂС‚Р° RS-232, СЃРёРіРЅР°Р» PPS РѕС‚ GPS/GLONASS/GALILEO РјРѕРґСѓР»СЏ */
	#define FROMCAT_TARGET_PIN_DTR		PIND
	#define FROMCAT_TARGET_PORT_DTR		PORTD
	#define FROMCAT_TARGET_DDR_DTR		DDRD
	#define FROMCAT_BIT_DTR			(1U << PD4)	/* СЃРёРіРЅР°Р» DTR РѕС‚ FT232RL	*/
	...
	#define DTRPCMSK_PORT	PCMSK3			// PCMSK0 - PA, PCMSK1 - PB, PCMSK2 - PC, PCMSK3 - PD
	#define DTRPCICR_BIT	(1U << PCIE3)	// PCIE0 - PA, PCIE1 - PB, PCIE2 - PC, PCIE3 - PD
	#define DTRPCIVECT PCINT3_vect			// РІРµРєС‚РѕСЂ РѕР±СЂР°Р±РѕС‚С‡РёРєР°
#endif
...
#define SIDETONE_TARGET_BIT		(1U << PD7)
	...
	#define SPI_CSEL4 (1U << PB0)	// LS020 - РґРѕСЃС‚СѓРїРµРЅ - РµСЃР»Рё РЅРµ РёСЃРїРѕР»Р·СѓРµС‚СЃСЏ РёРЅРґРёРєР°С‚РѕСЂ HD44780 РёР»Рё UC1608	
	#define SPI_CSEL1 (1U << PB1)	// NVRAM - РґРѕСЃС‚СѓРїРµРЅ - РµСЃР»Рё РЅРµ РёСЃРїРѕР»Р·СѓРµС‚СЃСЏ РёРЅРґРёРєР°С‚РѕСЂ HD44780 РёР»Рё UC1608
	#define SPI_CSEL0 (1U << PB2)	// NC or DDS1
	//#define SPI_CSELX (1U << PB3)	// XXXX - РґРѕСЃС‚СѓРїРµРЅ - РµСЃР»Рё РЅРµ РёСЃРїРѕР»Р·СѓРµС‚СЃСЏ РёРЅРґРёРєР°С‚РѕСЂ HD44780 РёР»Рё UC1608
	...
	#define SPI_NAEN_BIT (1U << PB4)	// "0" - СЂР°Р·СЂРµС€РµРЅРёРµ РІС‹С…РѕРґР° CS
...
#endif /* ATMEGA_CPUSTYLE_V8B_H_INCLUDED */
