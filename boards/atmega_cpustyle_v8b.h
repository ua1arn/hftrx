...
#define LS020_RESET_SET(v) do { \
	...
	#define LS020_RESET	(1U << PC6)			// Pin 28 TQFP44 - D6 signal in HD44780 socket
	...
	#define PTT_BIT_PTT (1U << PC5)		// совмещено с D5 LCD HD44780
	...
	#define FROMCAT_BIT_RTS			(1U << PC4)	/* сигнал RTS от FT232RL совмещено с D4 LCD HD44780	*/
	/* манипуляция от порта RS-232, сигнал PPS от GPS/GLONASS/GALILEO модуля */
	#define FROMCAT_TARGET_PIN_DTR		PIND
	#define FROMCAT_TARGET_PORT_DTR		PORTD
	#define FROMCAT_TARGET_DDR_DTR		DDRD
	#define FROMCAT_BIT_DTR			(1U << PD4)	/* сигнал DTR от FT232RL	*/
	...
	#define DTRPCIVECT PCINT3_vect			// вектор обработчика
#endif
...
#define SIDETONE_TARGET_BIT		(1U << PD7)
	...
	#define SPI_NAEN_BIT (1U << PB4)	// "0" - разрешение выхода CS
