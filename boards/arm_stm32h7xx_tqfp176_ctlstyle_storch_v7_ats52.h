...
#define ARM_STM32H7XX_TQFP176_CTLSTYLE_STORCH_V7_ATS52_H_INCLUDED 1
	...
	{ 
		...
		REF = BOARD_ADCX2IN(2),
		PWRI = FWD,
		PWRMRRIX = BOARD_ADCMRRIN(1),	// кеш - индекc не должен повторяться в конфигурации
		REFMRRIX = BOARD_ADCMRRIN(2),	// кеш - индекc не должен повторяться в конфигурации
		FWDMRRIX = BOARD_ADCMRRIN(3),	// кеш - индекc не должен повторяться в конфигурации
		...
		PASENSEMRRIX = BOARD_ADCMRRIN(4),	// кеш - индекc не должен повторяться в конфигурации
			...
			XTHERMOMRRIX = BOARD_ADCMRRIN(5),	// кеш - индекc не должен повторяться в конфигурации
		#endif /* WITHTHERMOLEVEL */
