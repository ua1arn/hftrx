	...
	*/
	#define ENCODER_INITIALIZE() \
		do { \
			...
			/* arm_hardware_irqn_interrupt(5, 3, ARM_OVERREALTIME_PRIORITY, spool_encinterrupts, & encodr2); */ /* IRQ5, both edges */ \
			/* arm_hardware_irqn_interrupt(6, 3, ARM_OVERREALTIME_PRIORITY, spool_encinterrupts, & encodr2); */ /* IRQ6, both edges */ \
			...
			arm_hardware_irqn_interrupt(3, 3, ARM_OVERREALTIME_PRIORITY, spool_encinterrupts, & encodr1); /* IRQ3, both edges */ \
			arm_hardware_irqn_interrupt(4, 3, ARM_OVERREALTIME_PRIORITY, spool_encinterrupts, & encodr1); /* IRQ4, both edges */ \
		} while (0)
