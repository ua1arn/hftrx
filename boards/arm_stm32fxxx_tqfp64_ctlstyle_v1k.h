...
#define ARM_STM32FXXX_TQFP64_CTLSTYLE_V1K_H_INCLUDED 1
	...
	//#define WITHUSESAII2S	1	/* I2S PLL	*/
		...
		#define REF1_DIV 4			// ref freq = 2.000 MHz
			...
			#define REF1_MUL 168	// N СѓРјРЅРѕР¶РёС‚РµР»СЊ РІ PLL1
			//#define PLL1_P 4	// РґРµР»РёС‚РµР»СЊ РїРµСЂРµРґ SYSTEM CLOCK MUX РІ PLL1
			//#define PLL1_Q 7	// РґРµР»РёС‚РµР»СЊ РЅР° РІС‹С…РѕРґ 48 РњР“С†
		...
		#if 1
			// normal operation frequency
			#define REF1_MUL 84	// N СѓРјРЅРѕР¶РёС‚РµР»СЊ РІ PLL1
			//#define PLL1_P 4	// РґРµР»РёС‚РµР»СЊ РїРµСЂРµРґ SYSTEM CLOCK MUX РІ PLL1
			//#define PLL1_Q 7	// РґРµР»РёС‚РµР»СЊ РЅР° РІС‹С…РѕРґ 48 РњР“С†
			#define HARDWARE_FLASH_LATENCY FLASH_ACR_LATENCY_2WS
		#endif
