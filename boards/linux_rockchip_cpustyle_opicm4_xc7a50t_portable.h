...
#ifndef LINUX_ROCKCHIP_CPUSTYLE_OPICM4_XC7A50T_PORTABLE_H_INCLUDED
#define LINUX_ROCKCHIP_CPUSTYLE_OPICM4_XC7A50T_PORTABLE_H_INCLUDED 1
...
#define AXI_FAN_PWM_BASEADDR		0x0000B000
...
#define	targetadc1 cs0
#define targetctl1 cs1

#endif /* WITHSPIDEV */

#define LOUDSPEAKER_STATE(v) do { 		\
			rk356x_gpio3_set(25, v);	\
		} while (0)
...
#endif /* LINUX_ROCKCHIP_CPUSTYLE_OPICM4_XC7A50T_PORTABLE_H_INCLUDED */
