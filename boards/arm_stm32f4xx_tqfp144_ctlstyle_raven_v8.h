...
#ifndef ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V8_H_INCLUDED
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V8_H_INCLUDED 1
	...
	#define CTLREGMODE_RAVENDSP_V8	1	/* modem only */
	...
	//#define CODEC1_TYPE CODEC_TYPE_NAU8822L		// dummy codec initialization
	...
	//#define WITHMODEMIQLOOPBACK	1	/* РјРѕРґРµРј РїРѕР»СѓС‡Р°РµС‚ СЃРѕР±СЃС‚РІРµРЅРЅС‹Рµ РїРµСЂРµРґР°РІР°РµРјС‹Рµ РєРІР°РґСЂР°С‚СѓСЂС‹ */
		...
		#define	WITHBBOXFREQ	(26985000L + 100)		// С‡Р°СЃС‚РѕС‚Р° РїРѕСЃР»Рµ РІРєР»СЋС‡РµРЅРёСЏ
		...
		//#define	WITHBBOXMIKESRC	BOARD_TXAUDIO_NOISE
	#elif 0
		#define WITHBBOX	1	// Black Box mode - СѓСЃС‚СЂРѕР№СЃС‚РІРѕ Р±РµР· РѕСЂРіР°РЅРѕРІ СѓРїСЂР°РІР»РµРЅРёСЏ
	...
	#if 0
		/* Р”Р»СЏ РїСЂРѕРІРµСЂРѕРє СЃ РґРёСЃС‚Р°РЅС†РёРѕРЅРЅС‹Рј СѓРїСЂР°РІР»РµРЅРёРµРј */
		#define WITHCAT		1	/* РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ CAT */
		#define WITHCATEXT		1	/* РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ CAT */
	...
	#else
		/* Р¦РµР»РµРІР°СЏ РєРѕРЅС„РёРіСѓСЂР°С†РёСЏ */
...
#endif /* ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V8_H_INCLUDED */
