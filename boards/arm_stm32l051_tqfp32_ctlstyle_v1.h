...
#ifndef ARM_STM32L051_TQFP32_CTLSTYLE_V1_H_INCLUDED
#define ARM_STM32L051_TQFP32_CTLSTYLE_V1_H_INCLUDED 1
	...
	//#define LCDMODE_G1203H	1		/* 32*128 dots display with PCF8531 controller */
	//#define LCDMODE_M9546	1	/* Icons COG LCD module with PHILIPS PCF8576C chip */
	#define LCDMODE_PTE1206	1	/* 128*64 NT7538H-D/3N - РїСЂРѕРІРµСЂРµРЅРЅРѕ 8 MHz РЅР° SCLK */
	//#define LCDMODE_PTE1206_TOPDOWN	1	/* LCDMODE_ST7565S - РїРµСЂРµРІРµСЂРЅСѓС‚СЊ РёР·РѕР±СЂР°Р¶РµРЅРёРµ (РґР»СЏ РІС‹РІРѕРґРѕРІ СЃРІРµСЂС…Сѓ) */
	//#define LCDMODE_EM027BS013	1	/* e-inc EM027BS013 2.7вЂќ V230 V8 G2 Hot Melt PS */
	...
	//#define RTC1_TYPE RTC_TYPE_STM32FLxx	/* STM32FLxx internal RTC peripherial */
	...
	#define targetext1 SPI_CSEL_LCD 	/* external devices control */

	#define targetlcd SPI_CSEL_LCD 	/* LCD over SPI line devices control */ 
...
#endif /* ARM_STM32L051_TQFP32_CTLSTYLE_V1_H_INCLUDED */
