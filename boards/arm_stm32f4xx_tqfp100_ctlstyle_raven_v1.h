...
#define ARM_STM32F4XX_TQFP100_CTLSTYLE_RAVEN_V1_H_INCLUDED 1
	...
	#define CTLREGMODE_RAVENDSP_V1	1	/* "Р’РѕСЂРѕРЅС‘РЅРѕРє" СЃ DSP */
	...
	/* РќР°Р·РЅР°С‡РµРЅРёРµ Р±РёРѕРІ СѓРїСЂР°РІР»РµРЅРёСЏ РєРѕРјРјСѓС‚Р°С‚РѕСЂРѕРІ С„РёР»СЊС‚СЂРѕРІ */
	#define BOARD_FMUX_BYP_RX	0x80	// РІРєР»СЋС‡С‘РЅ bypass С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_BYP_OFF	0x01	// РІС‹РєР»СЋС‡РµРЅ bypass С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_6P0_RX	0x40	// РІРєР»СЋС‡С‘РЅ 6 РєР“С† С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_6P0_TX	0x02	// РІС‹РєР»СЋС‡РµРЅ 6 РєР“С† С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_3P1_RX	0x20	// РІРєР»СЋС‡С‘РЅ 3.1 РєР“С† С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_3P1_TX	0x04	// РІС‹РєР»СЋС‡РµРЅ 3.1 РєР“С† С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_0P5_RX	0x10	// РІРєР»СЋС‡С‘РЅ 0.5 РєР“С† С„РёР»СЊС‚СЂ РџР§
	#define BOARD_FMUX_0P5_OFF	0x08	// РІС‹РєР»СЋС‡РµРЅ 0.5 РєР“С† С„РёР»СЊС‚СЂ РџР§
	/* РєРѕРґС‹ С„РёР»СЊС‚СЂРѕРІ РІС‚РѕСЂРѕР№ РџР§, РІС‹РґР°РІР°РµРјС‹Рµ РЅР° РјСѓР»СЊС‚РёРїР»РµРєСЃРѕСЂС‹ ADG714 */
	/* Р’РєР»СЋС‡РёС‚СЊ РѕРґРёРЅ РёР· С„РёР»СЊС‚СЂРѕРІ РІ С‚СЂР°РєС‚ РїСЂРёС‘РјР° */
	...
	/* Р’РєР»СЋС‡РёС‚СЊ РѕРґРёРЅ РёР· С„РёР»СЊС‚СЂРѕРІ РІ С‚СЂР°РєС‚ РїРµСЂРµРґР°С‡Рё */
	...
	// РґР»СЏ РїСЏС‚Рё РІС…РѕРґРѕРІ РђР¦Рџ СЃ РєР»Р°РІРёР°С‚СѓСЂС‹
	...
	// РґР»СЏ С€РµСЃС‚Рё РІС…РѕРґРѕРІ РђР¦Рџ СЃ РєР»Р°РІРёР°С‚СѓСЂС‹
	...
	#define targetsdcard targetext2	/* Р—Р°РїРёСЃСЊ Р·РІСѓРєР° РЅР° SD CARD */
