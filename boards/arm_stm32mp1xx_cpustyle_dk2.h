...
#define PMIC_I2C_R (PMIC_I2C_W | 0x01)
	...
	#define	TWIHARD_INITIALIZE() do { \
			arm_hardware_pioz_periphopendrain_altfn2m(TARGET_TWI_TWCK, xxAF_I2C2);	/* I2C2_SCL AF=? */ \
			arm_hardware_pioz_periphopendrain_altfn2m(TARGET_TWI_TWD, xxAF_I2C2);	/* I2C2_SDA AF=? */ \
		} while (0)
	...
	#define	TWIHARD2_INITIALIZE() do { \
			arm_hardware_piod_periphopendrain_altfn2m(TARGET_TWI2_TWCK, xxAF_I2C2);	/* PD12 I2C1_SCL AF=? */ \
			arm_hardware_piof_periphopendrain_altfn2m(TARGET_TWI2_TWD, xxAF_I2C2);	/* PF15 I2C1_SDA AF=4 */ \
		} while (0) 
