...
// Маленькая плата контроллера с двумя AD9834 и 4 ГУН
// Без SPI_BIDIRECTIONAL и с возможной генерайией звуков.
...
// v6 only
	// в этой версии платы нет управления IORESET, IOUPDATE
	...
	#define	SPI_SCLK_BIT 0x01	// бит, через который идет синхронизация SPI
	#define	SPI_MOSI_BIT 0x02	// бит, через который идет вывод (или ввод в случае двунаправленного SPI).
