...
#ifndef ATMEGA_CPUSTYLE_V8A_H_INCLUDED
#define ATMEGA_CPUSTYLE_V8A_H_INCLUDED 1
...
#define SIDETONE_TARGET_BIT		(1U << PD7)
	...
	#define CS4272_RESET_INITIALIZE() do { \
			TARGET_CS4272_RESET_PORT |= TARGET_CS4272_RESET_BIT; \
			TARGET_CS4272_RESET_DDR |= TARGET_CS4272_RESET_BIT; \
		} while (0)

	#define LS020_RS_INITIALIZE() do { \
			LS020_RS_PORT |= LS020_RS; \
			LS020_RS_DDR |= LS020_RS; \
		} while(0)
