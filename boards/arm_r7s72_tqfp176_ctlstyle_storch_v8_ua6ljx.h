...
#define ARM_R7S72_TQFP176_CTLSTYLE_STORCH_V8_UA6LJX_H_INCLUDED 1
	...
	#define LCDMODE_PALETTE256	1	/* только главный экран, без PIP */
	//#define LCDMODE_RGB565	1	/* только главный экран, без PIP (но главный экран 16 бит) */
	...
	#define WITHFPGAIF_FRAMEBITS 256	// Полный размер фрейма для двух квадратур - канал трансивера
