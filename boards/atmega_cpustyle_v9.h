...
#define SPI_IOUPDATE_BIT (1U << PB4)	// IOUPDATE
		...
		#define LS020_RS			(1U << PC5)		// Pin 24 of TQFP44  RS индикатора LS020 при Si570

		//#define SPI_CSEL0 (1U << PC2)	/* Pin 21 of TQFP44  DDS1 - LO1 generator AD9951 или RESET LS020 при Si570 - Pin 21 of TQFP44 */
		...
		// Подключение LS020 по схеме Василия Ливний - на выводы TWI
		#undef WITHTWIHW
		#undef WITHTWISW
