...
#define SPI_IOUPDATE_BIT (1U << PB4)	// IOUPDATE
...
#if LCDMODE_HARD_SPI
	#if (defined (PLL1_TYPE) && (PLL1_TYPE == PLL_TYPE_SI570)) || WITHSI5351AREPLACE
		...
		// РїРѕРґРєР»СЋС‡РµРЅРёРµ РїРѕ РІРµСЂСЃРёРё "С‹" - LS020 Рё Si570 - РІРјРµСЃС‚Рѕ AD9951.
		#define LS020_RESET_PORT 	PORTC
		#define LS020_RESET_DDR 	DDRC
		#define LS020_RST			(1U << PC2)		// Pin 21 of TQFP44  RESET LS020 РїСЂРё Si570 - Р±С‹Р» CS AD9951

		#define LS020_RS_PORT 		PORTC
		#define LS020_RS_DDR 		DDRC
		#define LS020_RS			(1U << PC5)		// Pin 24 of TQFP44  RS РёРЅРґРёРєР°С‚РѕСЂР° LS020 РїСЂРё Si570

		//#define SPI_CSEL0 (1U << PC2)	/* Pin 21 of TQFP44  DDS1 - LO1 generator AD9951 РёР»Рё RESET LS020 РїСЂРё Si570 - Pin 21 of TQFP44 */
		...
		#define SPI_CSEL5 (1U << PC7)	/* Pin 26 of TQFP44  serial nvram */
			...
			#define SPI_ALLCS_BITS (SPI_CSEL1 | SPI_CSEL4 |             SPI_CSEL5)
			#define SPI_ALLCS_BITSNEG 0		// Р’С‹С…РѕРґС‹, Р°РєС‚РёРІРЅС‹Рµ РїСЂРё "1"

		#else

			#define SPI_ALLCS_BITS (SPI_CSEL1 | SPI_CSEL2 | SPI_CSEL4 | SPI_CSEL5)
			#define SPI_ALLCS_BITSNEG 0		// Р’С‹С…РѕРґС‹, Р°РєС‚РёРІРЅС‹Рµ РїСЂРё "1"
		...
		// РџРѕРґРєР»СЋС‡РµРЅРёРµ LS020 РїРѕ СЃС…РµРјРµ Р’Р°СЃРёР»РёСЏ Р›РёРІРЅРёР№ - РЅР° РІС‹РІРѕРґС‹ TWI
		#undef WITHTWIHW
		#undef WITHTWISW
		...
		#define LS020_RS_PORT 		PORTC
		#define LS020_RS_DDR 		DDRC
		#define LS020_RS			(1U << PC0)		// Pin 19 of TQFP44  

		// РєР»Р°СЃСЃРёС‡РµСЃРєР°СЏ РєРѕРЅС„РёРіСѓСЂР°С†РёСЏ
		#define SPI_CSEL0 (1U << PC2)	/* Pin 21 of TQFP44  DDS1 - LO1 generator AD9951 РёР»Рё RESET LS020 РїСЂРё Si570 - Pin 21 of TQFP44 */
		#define SPI_CSEL1 (1U << PC3)	/* Pin 22 of TQFP44  DDS2 - LO3 generator AD9834 - Pin 22 of TQFP44 */
		#define SPI_CSEL2 (1U << PC4)	/* Pin 23 of TQFP44  Р§РёРїСЃРµР»РµРєС‚ РёРЅРґРёРєР°С‚РѕСЂР° LS020 - Pin 23 of TQFP44 */
		#define SPI_CSEL3 (1U << PC5)	/* Pin 24 of TQFP44  unused */ 
		#define SPI_CSEL4 (1U << PC6)	/* Pin 25 of TQFP44  control register */
		#define SPI_CSEL5 (1U << PC7)	/* Pin 26 of TQFP44  serial nvram */
			...
			#define SPI_ALLCS_BITS (SPI_CSEL0 | SPI_CSEL1 |             SPI_CSEL3 | SPI_CSEL4 | SPI_CSEL5)
			#define SPI_ALLCS_BITSNEG 0		// Р’С‹С…РѕРґС‹, Р°РєС‚РёРІРЅС‹Рµ РїСЂРё "1"
