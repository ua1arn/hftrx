...
#ifndef ARM_ALW_V3S_CPUSTYLE_LICHEE0_H_INCLUDED
#define ARM_ALW_V3S_CPUSTYLE_LICHEE0_H_INCLUDED 1
...
/* Распределение битов в ARM контроллерах */
	...
	#define SMHCHARD_FREQ (allwnr_v3s_get_smhc0_freq())
	...
	#define SMHCHARD_FREQ (allwnr_v3s_get_smhc1_freq())
	#define WITHSDHCHW4BIT	1	/* Hardware SD HOST CONTROLLER в 4-bit bus width */
...
#define TARGET_ENC2BTN_BIT (UINT32_C(1) << 15)	// PE15 - second encoder button with pull-up
	...
	*/
	...
	#define HARDWARE_MIPIDSI_INITIALIZE() do { \
		...
		#define BOARD_TCONLCDFREQ (allwnr_v3s_get_tconlcd_freq())
		...
		#define BOARD_TCONTVFREQ (allwnr_v3s_get_tcontv_freq())
		...
		#define BOARD_TVEFREQ (allwnr_v3s_get_tve_freq())
	#endif
...
#endif /* ARM_ALW_V3S_CPUSTYLE_LICHEE0_H_INCLUDED */
