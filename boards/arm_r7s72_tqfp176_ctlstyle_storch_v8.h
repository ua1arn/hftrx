...
#define ARM_R7S72_TQFP176_CTLSTYLE_STORCH_V8_H_INCLUDED 1
	...
	//#define WITHDISPLAY_FPS		25	// скорость обновления частоты
	#define WITHDISPLAYSWR_FPS	20	// скорость обновления водопвда
	...
	#define WITHI2S_FRAMEBITS 32//64	// Полный размер фрейма для двух каналов - канал кодека
