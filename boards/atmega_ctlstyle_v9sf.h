...
#define ATMEGA_CTLSTYLE_V9SF_H_INCLUDED 1
	...
	#define CTLREGSTYLE_SW2013SF	1	//! СѓРїСЂР°РІР»СЏСЋС‰РёРµ СЂРµРіРёСЃС‚СЂС‹ Р±РµР· РїРѕРґСЃРІРµС‚РєРё c С†РІРµС‚РЅС‹Рј РґРёСЃРїР»РµРµРј Рё СЂРµРіСѓР»РёСЂРѕРІРєРѕР№ РІС‹С…РѕРґРЅРѕР№ РјРѕС‰РЅРѕСЃС‚Рё
	//#define CTLREGSTYLE_SW2013SF_V1	1	// for UT4UA СѓРїСЂР°РІР»СЏСЋС‰РёРµ СЂРµРіРёСЃС‚СЂС‹ c СЂРµРіСѓР»РёСЂРѕРІРєРѕР№ РїРѕРґСЃРІРµС‚РєРё RDX0154 Рё СЂРµРіСѓР»РёСЂРѕРІРєРѕР№ РІС‹С…РѕРґРЅРѕР№ РјРѕС‰РЅРѕСЃС‚Рё
...
{ 
	...
	#endif
	#if WITHSWRMTR && 1	// РћР±С‹С‡РЅС‹Р№ РІР°СЂРёР°РЅС‚
		PWRI = 0,		// РРЅРґРёРєР°С‚РѕСЂ РјРѕС‰РЅРѕСЃС‚Рё РїРµСЂРµРґР°С‚С‡РёРєР°
		FWD = 4, REF = 3,	// SWR-meter
	#endif
	#if WITHSWRMTR && 0	// US2IT
		PWRI = 4,		// РРЅРґРёРєР°С‚РѕСЂ РјРѕС‰РЅРѕСЃС‚Рё РїРµСЂРµРґР°С‚С‡РёРєР°
		FWD = 4, REF = 3,	// SWR-meter
	#endif
#endif /* WITHBARS */
