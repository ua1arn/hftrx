...
#ifndef ATMEGA_CTLSTYLE_V9SF_H_INCLUDED
#define ATMEGA_CTLSTYLE_V9SF_H_INCLUDED 1
	...
	#define CTLREGSTYLE_SW2013SF	1	//! управляющие регистры без подсветки c цветным дисплеем и регулировкой выходной мощности
	//#define CTLREGSTYLE_SW2013SF_V1	1	// for UT4UA управляющие регистры c регулировкой подсветки RDX0154 и регулировкой выходной мощности
...
{ 
	...
	#endif
	#if WITHSWRMTR && 1	// Обычный вариант
		PWRI = 0,		// Индикатор мощности передатчика
		FWD = 4, REF = 3,	// SWR-meter
	#endif
	#if WITHSWRMTR && 0	// US2IT
...
#endif /* ATMEGA_CTLSTYLE_V9SF_H_INCLUDED */
