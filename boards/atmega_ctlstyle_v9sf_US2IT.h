...
#define ATMEGA_CTLSTYLE_V9SF_US2IT_H_INCLUDED 1
	...
	#define CTLREGSTYLE_SW2013SF_V3	1	// 7-bit tuner for US2IT СѓРїСЂР°РІР»СЏСЋС‰РёРµ СЂРµРіРёСЃС‚СЂС‹ c СЂРµРіСѓР»РёСЂРѕРІРєРѕР№ РїРѕРґСЃРІРµС‚РєРё (Р±РµР· СѓРїСЂР°РІР»РµРЅРёСЏ РґРёР°РїР°Р·РѕРЅР°РјРё)
	...
	{ 
		...
		#endif
		#if WITHSWRMTR && 0	// РћР±С‹С‡РЅС‹Р№ РІР°СЂРёР°РЅС‚
			PWRI = 0,		// РРЅРґРёРєР°С‚РѕСЂ РјРѕС‰РЅРѕСЃС‚Рё РїРµСЂРµРґР°С‚С‡РёРєР°
