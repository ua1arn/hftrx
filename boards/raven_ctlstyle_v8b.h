...
// Приёмник "Воронёнок". up-conversion,  AD9951 + ADF4001
...
#define RAVEN_CTLSTYLE_V8B_H_INCLUDED 1
	...
	//#define KEYB_VERTICAL_REV_TOPDOWN	1	/* перевернутое расположение кнопок для плат "Воробей" и "Колибри" */
	// --- Особые варианты расположения кнопок на клавиатуре
	...
	#if FQMODEL_80455
		#define DDS1_CLK_DIV	1		/* Делитель опорной частоты перед подачей в DDS1 - аппаратно всегда 1 */
