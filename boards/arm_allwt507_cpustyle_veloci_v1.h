...
#ifndef ARM_ALW_T507_CPU_VELOCI_V1_H_INCLUDED
#define ARM_ALW_T507_CPU_VELOCI_V1_H_INCLUDED 1
...
//#define SPI_IOUPDATE_BIT		(UINT32_C(1) << 15)	// * PA15
	...
	#define FPGALOADER_SPEEDC SPIC_SPEED25M
	#define FPGAREG_V1_SPEEDC SPIC_SPEED25M
	#define SPIDF_SPEEDC 		SPIC_SPEED10M
	#define NVRAM_SPEEDC 		SPIC_SPEED10M
	...
	#define HARDWARE_SPI_CONNECT() do { \
			SPI_DRIVE(GPIO_DRV_3); /* FPGA image loader, FIR parameters loader. */ \
	} while (0)
...
#endif /* ARM_ALW_T507_CPU_VELOCI_V1_H_INCLUDED */
