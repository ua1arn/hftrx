/* $Id$ */
/* SW2012MINI V5 - с вольтметром и КСВ-метром, ATMega644, tuner, CW SPEED POT	*/
...
#ifndef ATMEGA_CTLSTYLE_V9CN5_RN3ZOB_H_INCLUDED
#define ATMEGA_CTLSTYLE_V9CN5_RN3ZOB_H_INCLUDED 1
	...
	#define CTLREGSTYLE_SW2012CN_RN3ZOB_V2 1 // с платой автотюнера
	...
	#define KEYBSTYLE_SW2012CN5_RN3ZOB_V2	1
	// --- Особые варианты расположения кнопок на клавиатуре
...
{ 
#if WITHPOTWPM
	POTWPM = 2,		// потенциометр управления скоростью передачи в телеграфе
#endif
...
#endif /* ATMEGA_CTLSTYLE_V9CN5_RN3ZOB_H_INCLUDED */
