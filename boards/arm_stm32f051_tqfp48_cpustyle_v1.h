...
// Плата с процессором STM32F051C6T6 (TQFP-48)
...
#define LS020_RESET_INITIALIZE() \
	do { \
		arm_hardware_piob_outputs2m(LS020_RESET, LS020_RESET); \
	} while (0)
...
/* Распределение битов в ARM контроллерах */
	...
	#define FROMCAT_BIT_DTR				(0u << 12)	/* сигнал DTR от FT232RL	*/
...
#define HARDWARE_SPI_CONNECT() do { \
		arm_hardware_pioa_altfn50(SPI_MOSI_BIT | SPI_SCLK_BIT | SPI_MISO_BIT, 0 /* AF_0 */); /* В этих процессорах и входы и выходы переключаются на ALT FN */ \
	} while (0)
