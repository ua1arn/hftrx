...
#define PION_DSP_CTLSTYLE_V1_H_INCLUDED 1
	...
	#define WITHUSESAIPLL	1	/* SAI PLL - for LTDC	*/
	...
	#if 1
		#define WITHTRANSPARENTIQ	1	/* РїСЂРѕС†РµСЃСЃРѕСЂ РїСЂРѕСЃС‚Рѕ РїРѕРґРґРµСЂР¶РёРІР°РµС‚ РґРІСѓРЅР°РїСЂР°РІР»РµРЅРЅС‹Р№ РѕР±РјРµРЅ РјРµР¶РґСѓ USB Рё FPGA */
	...
	// DDC Module 1
	#define WITHIFDACWIDTH	16 //32		// 1 Р±РёС‚ Р·РЅР°Рє Рё 31 Р±РёС‚ Р·РЅР°С‡Р°С‰РёС…
	#define WITHIFADCWIDTH	24 //32		// 1 Р±РёС‚ Р·РЅР°Рє Рё 31 Р±РёС‚ Р·РЅР°С‡Р°С‰РёС…
	...
	// USB РёРЅС‚РµСЂС„РµР№СЃ Рё РІСЃРµ РєРѕРґРµРєРё
	...
	#define targetlcd		SPI_CSEL1 	/* LCD over SPI line devices control */ 
	#define targetnvram		SPI_CSEL4	/* FM25L16B chip */
	#define targetcodec1	SPI_CSEL3 	/* CS4272 or different audio codec */
