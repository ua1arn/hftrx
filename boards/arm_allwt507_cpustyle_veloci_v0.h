...
//#define SPI_IOUPDATE_BIT		(UINT32_C(1) << 15)	// * PA15
	...
	#define HARDWARE_SPI1_INITIALIZE() do { \
		gpioX_prog(GPIOH, SPI_SCLK_BIT, GPIO_CFG_AF4, GPIO_DRV_1, GPIO_PULL_NONE); 	/* PH6 SPI1_CLK */ \
		gpioX_prog(GPIOH, SPI_MOSI_BIT, GPIO_CFG_AF4, GPIO_DRV_1, GPIO_PULL_NONE); 	/* PH7 SPI1_MOSI */ \
		gpioX_prog(GPIOH, SPI_MISO_BIT, GPIO_CFG_AF4, GPIO_DRV_1, GPIO_PULL_NONE); 	/* PH8 SPI1_MISO */ \
	} while (0)
