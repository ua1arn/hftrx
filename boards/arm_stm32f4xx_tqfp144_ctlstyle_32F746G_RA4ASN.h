...
#ifndef ARM_STM32F4XX_TQFP144_CTLSTYLE_32F746G_H_INCLUDED
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_32F746G_H_INCLUDED 1
	...
	//#define WITHSAICLOCKFROMPIN 1	// тактовая частота на SAI1 подается с внешнего генератора, в процессор вводится через MCK сигнал интерфейса
		...
		#define WITHCPUXOSC 25000000uL	/* Процессор тактирует внешний генератор 25.000 МГц */
		#define REF1_DIV 25			// ref freq = 1.0000 MHz
		...
		#define REF1_DIV 16			// ref freq = 2.000 MHz
	...
	#endif /* WITHPOTWPM */
	#if WITHPOTPOWER
		POTPOWER = 0,			// регулировка мощности
	#endif /* WITHPOTPOWER */

		ALCINIX = 0,		// PB1 ALC IN

	#if WITHCURRLEVEL
		PASENSEIX = 0,		// PA1 PA current sense - ACS712-05 chip
	#endif /* WITHCURRLEVEL */
...
#endif /* ARM_STM32F4XX_TQFP144_CTLSTYLE_32F746G_H_INCLUDED */
