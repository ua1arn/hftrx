/* $Id$ */
/* SW2012MINI V5 - с вольтметром и КСВ-метром	*/
...
#ifndef ATMEGA_CTLSTYLE_V9CN_H_INCLUDED
#define ATMEGA_CTLSTYLE_V9CN_H_INCLUDED 1
...
#endif /* ATMEGA_CTLSTYLE_V9CN_H_INCLUDED */
