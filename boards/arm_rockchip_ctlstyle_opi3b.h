...
#ifndef ARM_ALW_CTL_T507_V4_H_INCLUDED
#define ARM_ALW_CTL_T507_V4_H_INCLUDED 1
	...
	#define HARDWARE_ADDRSPACE_GB (16)	// xxxxxx Размер адресного пространства (для 4 ГБ памяти надо 8 ГБ - базовый адрес ОЗУ 0x40000000).
...
#endif /* ARM_ALW_CTL_T507_V4_H_INCLUDED */
