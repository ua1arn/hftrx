...
#define ATMEGA_CTLSTYLE_V9CN6_H_INCLUDED 1
	...
	{ 
		...
		FWD = 5, REF = 4,	// SWR-meter (REF=4 - РІС…РѕРґ СѓСЂРѕРІРЅСЏ РјРѕРґСѓР»СЏС†РёРё )
	#endif /* WITHBARS */
		KI0 = 6, // РєР»Р°РІРёР°С‚СѓСЂР°
	};
	...
	#define WITHATT2_10DB		1	// РЈРїСЂР°РІР»РµРЅРёРµ РґРІСѓС…РєР°СЃРєР°РґРЅС‹Рј Р°С‚С‚РµРЅСЋР°С‚РѕСЂРѕРј Р±РµР· СѓРїСЂР°РІР»РµРЅРёСЏ РЈР’Р§
	...
	#define BOARD_FILTER_1P8		BOARD_FILTERCODE_0	/* 1.8 kHz filter - СѓСЃС‚Р°РЅРѕРІР»РµРЅ РІРјРµСЃС‚Рѕ С„РёР»СЊС‚СЂР° 0.5 */
