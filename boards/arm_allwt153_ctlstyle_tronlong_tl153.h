...
#ifndef ARM_T153_CTLSTYLE_TL153_H_INCLUDED
#define ARM_T153_CTLSTYLE_TL153_H_INCLUDED 1
	...
	//#define CTLREGMODE_TL153	1	/* STM32MP157, дополнения для подключения трансвертора */
	...
	//#define WITHALTERNATIVEFONTS    1
		...
		#if WITHTHERMOLEVEL
			XTHERMOIX = BOARD_ADCX1IN(6),		// External thermo sensor ST LM235Z
		#endif /* WITHTHERMOLEVEL */
...
#endif /* ARM_T153_CTLSTYLE_TL153_H_INCLUDED */
