...
// описание аппаратуры "простой синтезатор на AD9835"
// Среди использующих ur5zvu@yandex.ru - RDX0077, Si570
...
#define ATMEGA_CTLSTYLE_V8S_UR3VBM_INCLUDED 1
	...
	#define CTLREGMODE16_UR3VBM	1		/* управляющий регистр 16 бит - для SIMPLE синтезатора на AD8932/AD8935/AD8933	*/
	//#define CTLREGMODE8_UR5YFV	1	/* 8 бит */
	//#define CTLREGMODE16_RN3ZOB	1		/* управляющий регистр 16 бит - для SIMPLE синтезатора на AD8932/AD8935/AD8933	*/
	//
	...
	#define KEYB_VERTICAL_UR3VBM	1	/* расположение кнопок для плат "Воробей" и "Колибри" */
	...
	//#define WITHPOTWPM		1	/* используется регулировка скорости передачи в телграфе потенциометром */
	...
	#define WITHSAMEBFO	1	/* использование общих настроек BFO для приёма и пережачи */
...
#define KI_COUNT 2	// количество используемых под клавиатуру соседних входов АЦП
