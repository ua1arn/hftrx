...
// UA1ARN
//
// РџР»Р°С‚Р° Р’РѕСЂРѕР±РµР№-2 (СЃ РјРµСЃС‚РѕРј РїРѕРґ РєРѕРґРµРє)
//
...
#define ARM_STM32FXXX_TQFP64_CTLSTYLE_V8B_H_INCLUDED 1
	...
	#define FQMODEL_TRX8M2CONV	1	// РџРµСЂРІР°СЏ РЅРёР·РєР°СЏ РџР§, РґР°Р»РµРµ Р­РњР¤ РЅР° 200/455/500 РєР“С†
	...
	#define CTLREGMODE24_V2	1		/* СѓРїСЂР°РІР»СЏСЋС‰РёР№ СЂРµРіРёСЃС‚СЂ 24 Р±РёС‚Р° - "Р’РѕСЂРѕР±РµР№-2" СЃ РєРѕРґРµРєРѕРј */
	...
	#define WITHPOTPBT		1	/* РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ СЂРµРіСѓР»РёСЂРѕРІРєР° СЃРјРµС‰РµРЅРёСЏ С‡Р°СЃС‚РѕС‚С‹ РџР§ (РґР»СЏ cСѓР¶РµРЅРёСЏ РїРѕР»РѕСЃС‹ РїСЂРѕРїСѓСЃРєР°РЅРёСЏ) РїРѕС‚РµРЅС†РёРѕРјРµС‚СЂРѕРј */
	...
	#define DDS3_TYPE DDS_TYPE_AD9834
		...
		#define DDS3_CLK_DIV	2		/* Р”РµР»РёС‚РµР»СЊ РѕРїРѕСЂРЅРѕР№ С‡Р°СЃС‚РѕС‚С‹ РїРµСЂРµРґ РїРѕРґР°С‡РµР№ РІ DDS3 */
	#else
		#define DDS1_CLK_DIV	1		/* Р”РµР»РёС‚РµР»СЊ РѕРїРѕСЂРЅРѕР№ С‡Р°СЃС‚РѕС‚С‹ РїРµСЂРµРґ РїРѕРґР°С‡РµР№ РІ DDS1 */
	...
	#endif
	#if WITHPOTWPM
			POTWPM = x,		// РїРѕС‚РµРЅС†РёРѕРјРµС‚СЂ СѓРїСЂР°РІР»РµРЅРёСЏ СЃРєРѕСЂРѕСЃС‚СЊСЋ РїРµСЂРµРґР°С‡Рё РІ С‚РµР»РµРіСЂР°С„Рµ
	#endif /* WITHPOTWPM */
	#if WITHPOTPBT
			POTPBT = 12,		// РїРѕС‚РµРЅС†РёРѕРјРµС‚СЂ СѓРїСЂР°РІР»РµРЅРёСЏ СЃРґРІРёРіРѕРј РїРѕР»РѕСЃС‹ РџР§
	#endif /* WITHPOTPBT */
