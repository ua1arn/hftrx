...
// UA1ARN
//
// DU VENT SI570+AD9834 (66MHz), LS020, ATMega32 - Р±РµР· РІРЅРµС€РЅРµРіРѕ РґРµС€РёС„СЂР°С‚РѕСЂР° Р°РґСЂРµСЃРѕРІ - atmega_cpustyle_v1a.h, 
// atmega_ctlstyle_v1a.h - РїРѕС…РѕР¶Р° РЅР° sw2011

#ifndef ATMEGA_CPUSTYLE_V1A_H_INCLUDED
#define ATMEGA_CPUSTYLE_V1A_H_INCLUDED 1
...
//#endif
	...
	#define TXPATH_BIT_ENABLE_SSB		(1U << PD5)		// TQFP44 - pin 14
	#define TXPATH_BIT_ENABLE_CW		(1U << PD6)		// TQFP44 - pin 15
	...
	#define LS020_RST	(1U << PC2)	/* Pin 21 of TQFP44  RESET LS020 РїСЂРё Si570 */
	...
	#define SPI_CSEL2 (1U << PC4)	/* Pin 23 of TQFP44  Р§РёРїСЃРµР»РµРєС‚ РёРЅРґРёРєР°С‚РѕСЂР° LS020 */
...
#endif /* ATMEGA_CPUSTYLE_V1A_H_INCLUDED */
