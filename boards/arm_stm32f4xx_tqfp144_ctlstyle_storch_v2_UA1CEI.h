...
#ifndef ARM_STM32F4XX_TQFP144_CTLSTYLE_STORCH_V1_H_UA1CE_INCLUDED
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_STORCH_V1_H_UA1CE_INCLUDED 1
	...
	#define CTLREGMODE_STORCH_V2_UA1CEI	1	/* "Воронёнок" с DSP и FPGA, SD-CARD, dual watch & PA on board */
	...
	#define KEYB_FPAMEL20_V0A_UA1CEI	1	/* 20 конпок на 5 линий - плата rfrontpanel_v0 + LCDMODE_UC1608 в нормальном расположении с новым расположением */
	// --- Особые варианты расположения кнопок на клавиатуре
...
#endif /* ARM_STM32F4XX_TQFP144_CTLSTYLE_STORCH_V1_H_UA1CE_INCLUDED */
