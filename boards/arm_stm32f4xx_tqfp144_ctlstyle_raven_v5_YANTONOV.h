...
// STM32F446ZET6, STM32F746ZGT6 с кодеком TLV320AIC23B и FPGA EP4CE22E22I7N
...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V5_YANTONOV_H_INCLUDED 1
	...
	#define CTLREGMODE_RAVENDSP_V5	1	/* "Воронёнок" с DSP и FPGA, SD-CARD, dual watch & PA on board */
	...
	//#define DSTYLE_UA1CEIMOD	1	// Расположение элементов экрана в трансиверах UA1CEI
	#define	FONTSTYLE_ITALIC	1	// Использовать альтернативный шрифт

	// +++ Особые варианты расположения кнопок на клавиатуре
	//#define KEYB_FPAMEL20_V0A_UA1CEI	1	/* 20 конпок на 5 линий - плата rfrontpanel_v0 + LCDMODE_UC1608 в нормальном расположении */
	...
	#define WITHUSEFAST		1	/* переключение вылкодера в режим FAST */
