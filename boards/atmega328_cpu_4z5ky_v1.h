...
#define WITHNMEA_USART1		1
	...
	#define LS020_RESET	(1U << PB0)			// D4 signal in HD44780 socket
	...
	#define	SPI0_MOSI_BIT (1U << PC2)	// бит, через который идет вывод (или ввод в случае двунаправленного SPI).

	#define SPI0_TARGET_CS_PORT PORTC
	#define SPI0_TARGET_CS_DDR DDRC
	#define SPI0_TARGET_CS_PIN PINC
	#define	SPI0_CS_BIT (1U << PC3)	// бит, через который идет выбор устройста SPI
	...
	#define	SPI1_SCLK_BIT (1U << PD5)	// бит, через который идет синхронизация SPI

	#define SPI1_TARGET_MOSI_PORT PORTD
	#define SPI1_TARGET_MOSI_DDR DDRD
	#define SPI1_TARGET_MOSI_PIN PIND
	#define	SPI1_MOSI_BIT (1U << PD4)	// бит, через который идет вывод (или ввод в случае двунаправленного SPI).

	#define SPI1_TARGET_CS_PORT PORTD
	#define SPI1_TARGET_CS_DDR DDRD
	#define SPI1_TARGET_CS_PIN PIND
	#define	SPI1_CS_BIT (1U << PD6)	// бит, через который идет выбор устройста SPI
