...
#define WITHNMEA_USART1		1
	...
	#define SPI0_TARGET_MOSI_PORT PORTC
	#define SPI0_TARGET_MOSI_DDR DDRC
	#define SPI0_TARGET_MOSI_PIN PINC
	#define	SPI0_MOSI_BIT (1U << PC2)	// Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ РІС‹РІРѕРґ (РёР»Рё РІРІРѕРґ РІ СЃР»СѓС‡Р°Рµ РґРІСѓРЅР°РїСЂР°РІР»РµРЅРЅРѕРіРѕ SPI).

	#define SPI0_TARGET_CS_PORT PORTC
	#define SPI0_TARGET_CS_DDR DDRC
	#define SPI0_TARGET_CS_PIN PINC
	#define	SPI0_CS_BIT (1U << PC3)	// Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ РІС‹Р±РѕСЂ СѓСЃС‚СЂРѕР№СЃС‚Р° SPI
	...
	#define	SPI1_SCLK_BIT (1U << PD5)	// Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ СЃРёРЅС…СЂРѕРЅРёР·Р°С†РёСЏ SPI

	#define SPI1_TARGET_MOSI_PORT PORTD
	#define SPI1_TARGET_MOSI_DDR DDRD
	#define SPI1_TARGET_MOSI_PIN PIND
	#define	SPI1_MOSI_BIT (1U << PD4)	// Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ РІС‹РІРѕРґ (РёР»Рё РІРІРѕРґ РІ СЃР»СѓС‡Р°Рµ РґРІСѓРЅР°РїСЂР°РІР»РµРЅРЅРѕРіРѕ SPI).

	#define SPI1_TARGET_CS_PORT PORTD
	#define SPI1_TARGET_CS_DDR DDRD
	#define SPI1_TARGET_CS_PIN PIND
	#define	SPI1_CS_BIT (1U << PD6)	// Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ РІС‹Р±РѕСЂ СѓСЃС‚СЂРѕР№СЃС‚Р° SPI
