...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V7_UY5UM_H_INCLUDED 1
	...
	#define KEYB_FPAMEL20_V0A_UY5UM	1	/* 20 РєРЅРѕРїРѕРє РЅР° 5 Р»РёРЅРёР№ - РїР»Р°С‚Р° rfrontpanel_v0 + LCDMODE_UC1608 РІ РЅРѕСЂРјР°Р»СЊРЅРѕРј СЂР°СЃРїРѕР»РѕР¶РµРЅРёРё СЃ РЅРѕРІС‹Рј СЂР°СЃРїРѕР»РѕР¶РµРЅРёРµРј */
	...
	#endif /* WITHPOTPOWER */
	#if WITHPOTNOTCH
		POTNOTCH = 1,			// СЂРµРіСѓР»РёСЂРѕРІРєР° С‡Р°СЃС‚РѕС‚С‹ NOTCH С„РёР»СЊС‚СЂР°
	#endif /* WITHPOTNOTCH */
	#if WITHPOTIFSHIFT
		POTIFSHIFT = xx,			// СЂРµРіСѓР»РёСЂРѕРІРєР° IF SHIFT
