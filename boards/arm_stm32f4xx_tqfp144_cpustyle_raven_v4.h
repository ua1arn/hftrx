...
// РўСЂР°РЅСЃРёРІРµСЂ СЃ DSP РѕР±СЂР°Р±РѕС‚РєРѕР№ "Р’РѕСЂРѕРЅС‘РЅРѕРє-2" РЅР° РїСЂРѕС†РµСЃСЃРѕСЂРµ STM32F429ZIT6 СЃ РєРѕРґРµРєРѕРј TLV320AIC23B Рё FPGA EP4CE22E22I7N
// Rmainunit_v2bm.pcb
...
#define LS020_RESET_INITIALIZE() \
	...
	#define ENCODER_INITIALIZE() \
		...
		// РРЅРёС†РёР°Р»РёР·РёСЂСѓСЋС‚СЃСЏ I2S2 Рё I2S2_EXT
		#define I2S2HW_INITIALIZE() do { \
			enum { \
				I2S2_MCK = (1U << 6),		/* PC6	*/ \
...
#define HARDWARE_SDIOPOWER_INITIALIZE()	do { \
	...
	#define HARDWARE_FPGA_LOADER_INITIALIZE() do { \
			...
			/*arm_hardware_pioc_inputs(1UL << 9); */ /* PC9 as input with pull-up - РґР»СЏ РїСЂРѕРІРµСЂРєРё РїРµСЂРµС…РѕРґ FPGA РІ user mode. */ \
		} while (0)
