...
#define WITHFPGAIF_SAI1_DUPLEX_MASTER	1		/* Получение квадратур и RTS96 от FPGA через SAI1 */
...
#define LS020_RESET_INITIALIZE() \
	do { \
		arm_hardware_pioe_outputs2m(LS020_RESET, LS020_RESET); \
	} while (0)
...
#define LS020_RESET_SET(v) do { \
	...
	#define LS020_RESET			(1u << 10)			// * PE10 D6 signal in HD44780 socket
