...
//#define WITHSDHCHW4BIT	1	/* Hardware SD HOST CONTROLLER РІ 4-bit bus width */
	...
	//#define WITHUSBHW_HOST	(& USB200)	/* РЅР° СЌС‚РѕРј СѓСЃС‚СЂРѕР№СЃС‚РІРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚СЃСЏ С„СѓРЅРєС†РёР»РЅР°Р»СЊРЅРѕСЃС‚СЊ HOST	*/
	...
	#define WITHUSBHWHIGHSPEED	1	/* РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РІСЃС‚СЂРѕРµРЅРЅР°СЏ РІ РїСЂРѕС†РµСЃСЃРѕСЂ РїРѕРґРґРµСЂР¶РєР° USB HS */
	#define WITHUSBHWHIGHSPEEDDESC	1	/* РўСЂРµР±СѓРµС‚СЃСЏ С„РѕСЂРјРёСЂРѕРІР°С‚СЊ РґРµСЃРєСЂРёРїС‚РѕСЂС‹ РєР°Рє РґР»СЏ HIGH SPEED */
	#define WITHUSBHW_DEVICE	(& USB201)	/* РЅР° СЌС‚РѕРј СѓСЃС‚СЂРѕР№СЃС‚РІРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚СЃСЏ С„СѓРЅРєС†РёР»РЅР°Р»СЊРЅРѕСЃС‚СЊ DEVUCE	*/
	//#define WITHUSBHW_HOST	(& USB200)	/* РЅР° СЌС‚РѕРј СѓСЃС‚СЂРѕР№СЃС‚РІРµ РїРѕРґРґРµСЂР¶РёРІР°РµС‚СЃСЏ С„СѓРЅРєС†РёР»РЅР°Р»СЊРЅРѕСЃС‚СЊ HOST	*/
...
#define LS020_RESET_INITIALIZE() \
	...
	#define ENCODER2_SHIFT 10	// РћС‚СЃСѓС‚СЃС‚РІРёРµ СЌС‚РѕРіРѕ Р·РЅР°С‡РµРЅРёСЏ РѕР·РЅР°С‡Р°РµС‚ С‡С‚Рѕ Р±РёС‚С‹ РЅРµ РїРѕРґСЂСЏРґ
	...
	#define ENCODER_SHIFT 8	// РћС‚СЃСѓС‚СЃС‚РІРёРµ СЌС‚РѕРіРѕ Р·РЅР°С‡РµРЅРёСЏ РѕР·РЅР°С‡Р°РµС‚ С‡С‚Рѕ Р±РёС‚С‹ РЅРµ РїРѕРґСЂСЏРґ
...
#define	SPI_SCLK_BIT			(1U << 12)	// * P6_12 Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ СЃРёРЅС…СЂРѕРЅРёР·Р°С†РёСЏ SPI RSPI1
...
#define	SPI_MOSI_BIT			(1U << 14)	// * P6_14 Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ РІС‹РІРѕРґ (РёР»Рё РІРІРѕРґ РІ СЃР»СѓС‡Р°Рµ РґРІСѓРЅР°РїСЂР°РІР»РµРЅРЅРѕРіРѕ SPI).RSPI1

#define SPI_TARGET_MISO_PIN		(R7S721_INPUT_PORT(6))		// was PINA 
#define	SPI_MISO_BIT			(1U << 15)	// * P6_15 Р±РёС‚, С‡РµСЂРµР· РєРѕС‚РѕСЂС‹Р№ РёРґРµС‚ РІРІРѕРґ СЃ SPI.RSPI1
	...
	*/
	...
	/* СѓРїСЂР°РІР»РµРЅРёРµ СЃРѕСЃС‚РѕСЏРЅРёРµРј СЃРёРіРЅР°Р»Р° MODE РїР°РЅРµР»Рё */
