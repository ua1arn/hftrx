...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_STORCH_V4_H_INCLUDED 1
	...
	//#define LCDMODE_S1D13781_REFOSC_MHZ	25	/* Частота генератора, установленного на контроллере дисплея */
	...
	#define WITHTXINHDISABLE	1	/* запретить реакцию на вход TX INHIBIT */
	// FPGA section
	...
	#elif 0
		#define WITHBBOX	1	// Black Box mode - устройство без органов управления
		//#define WITHBBOXFREQ	145425000L		// частота после включения
		//#define WITHBBOXFREQ	138025000L		// частота после включения
