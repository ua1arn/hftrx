...
#ifndef ARM_ALLW_F1333_CPUSTYLE_MANGO_PI_DCTRX_H_INCLUDED
#define ARM_ALLW_F1333_CPUSTYLE_MANGO_PI_DCTRX_H_INCLUDED 1
...
#define LS020_RESET_SET(v) do { \
	...
	#define I2S2HW_INITIALIZE(master) do { \
		arm_hardware_piob_updown((master) * UINT32_C(1) << 3, !! (master) * UINT32_C(1) << 3, ! (master) * UINT32_C(1) << 3);	/* PB3 sdout: 1 - master, 0: slave - после RESET вход в port mode */ \
...
#define TARGET_ENC2BTN_BIT (UINT32_C(1) << 15)	// PE15 - second encoder button with pull-up
	...
	// TWI1-SCK PG8 SCL UART1-RTS
	// TWI1-SDA PG9 SDA UART1-CTS
...
#endif /* ARM_ALLW_F1333_CPUSTYLE_MANGO_PI_DCTRX_H_INCLUDED */
