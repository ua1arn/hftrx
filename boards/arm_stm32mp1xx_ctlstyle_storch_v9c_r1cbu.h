...
#define ARM_STM32MP1_TFBGA361_CTLSTYLE_STORCH_V9C_H_INCLUDED 1
	...
	//#define WITHCPUXOSC 24000000u	/* На процессоре установлен генератор 24.000 МГц */
		...
		// PLL1, PLL2 VCOs
			...
			//#define PLL1DIVN	(stm32mp1_overdrived() ? 66 : 54)	// Auto select
				...
				//#define BOARD_DDR_CONFIG "stm32mp15-mx_2G.dtsi"	// 2x128k*16
				//#define BOARD_DDR_CONFIG "stm32mp15-mx_4G_x2.dtsi"	// 2x256k*16 2 x MT41K256M16TW-107 IT:P (FBGA Code D9SHG)
			#else
				// PLL2_1600
	...
	//#define LCDMODE_ARGB8888	1	/* только главный экран с двумя видеобуферами 32 бит ARGB8888, без PIP */
	...
	//#define LCDMODE_PALETTE256 1	/* только главный экран 8 бит (две страницы), L8, без PIP */
	#define LCDMODE_RGB565 1	/* только главный экран 16 бит (две страницы), без PIP */
	//#define LCDMODE_ARGB8888	1	/* только главный экран с тремя видеобуферами 32 бит ARGB8888, без PIP */
