...
/* Р Р°СЃРїСЂРµРґРµР»РµРЅРёРµ Р±РёС‚РѕРІ РІ ARM РєРѕРЅС‚СЂРѕР»Р»РµСЂР°С… */
	...
	#define HARDWARE_SDIOSENSE_WP() ((GPIOG->IDR & HARDWARE_SDIO_WP_BIT) != 0)	/* РїРѕР»СѓС‡РёС‚СЊ СЃРѕСЃС‚РѕСЏРЅРёРµ РґР°С‚С‡РёРєР° CARD WRITE PROTECT */
...
#define HARDWARE_SIDETONE_INITIALIZE() do { \
	...
	*/
	...
	#define TARGET_USBFS_VBUSON_BIT (1uL << 6)	// PC6 - РЅСѓР»С‘Рј РІРєР»СЋС‡РµРЅРёРµ РїРёС‚Р°РЅРёСЏ РґР»СЏ device
	...
	*/
	...
	#define HARDWARE_LTDC_SET_DISP(demode, state) do { \
		...
		/* while ((GPIOI->IDR & VSYNC) != 0) ; */ /* СЃС…РµРјР° СЃРёРЅС…СЂРѕРЅРёР·Р°С†РёРё СЃС‚РѕРёС‚ РЅР° РїР»Р°С‚Рµ РґРёСЃРїР»РµСЏ. РґРѕР¶РґР°С‚СЊСЃСЏ 0 */ \
		/* while ((GPIOI->IDR & VSYNC) == 0) ; */ /* РґРѕР¶РґР°С‚СЊСЃСЏ 1 */ \
		arm_hardware_pioe_outputs(DEmask, ((state) != 0) * DEmask);	/* DE=DISP, pin 31 - РјРѕР¶РЅРѕ РјРµРЅСЏС‚СЊ С‚РѕР»СЊРєРѕ РїСЂРё VSYNC=1 */ \
	} while (0)
#endif /* LCDMODE_LTDC */
