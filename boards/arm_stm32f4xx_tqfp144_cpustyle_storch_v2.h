...
// Рабочий вариант конфигурации.
// CAT и звук через USB, отладочная печать чрез USART2
...
/* Распределение битов в ARM контроллерах */
	...
	#define HARDWARE_SDIOPOWER_INITIALIZE()	do { \
		arm_hardware_pioe_outputs2m(HARDWARE_SDIOPOWER_BIT, 0); /* питание выключено */ \
		} while (0)
...
#define HARDWARE_SIDETONE_INITIALIZE() do { \
	...
	*/
	#define	USBD_FS_INITIALIZE() do { \
		...
		arm_hardware_pioa_outputs(TARGET_USBFS_VBUSON_BIT, TARGET_USBFS_VBUSON_BIT); /* начальное состояние - выключено */ \
		} while (0)
