...
#ifndef ARM_STM32F4XX_TQFP144_CPUSTYLE_STORCH_V2_H_INCLUDED
...
// Р Р°Р±РѕС‡РёР№ РІР°СЂРёР°РЅС‚ РєРѕРЅС„РёРіСѓСЂР°С†РёРё.
// CAT Рё Р·РІСѓРє С‡РµСЂРµР· USB, РѕС‚Р»Р°РґРѕС‡РЅР°СЏ РїРµС‡Р°С‚СЊ С‡СЂРµР· USART2
...
/* Р Р°СЃРїСЂРµРґРµР»РµРЅРёРµ Р±РёС‚РѕРІ РІ ARM РєРѕРЅС‚СЂРѕР»Р»РµСЂР°С… */
	...
	#define HARDWARE_SDIOPOWER_INITIALIZE()	do { \
		arm_hardware_pioe_outputs2m(HARDWARE_SDIOPOWER_BIT, 0); /* РїРёС‚Р°РЅРёРµ РІС‹РєР»СЋС‡РµРЅРѕ */ \
		} while (0)
...
#define HARDWARE_SIDETONE_INITIALIZE() do { \
	...
	*/
	#define	USBD_FS_INITIALIZE() do { \
		...
		arm_hardware_pioa_outputs(TARGET_USBFS_VBUSON_BIT, TARGET_USBFS_VBUSON_BIT); /* РЅР°С‡Р°Р»СЊРЅРѕРµ СЃРѕСЃС‚РѕСЏРЅРёРµ - РІС‹РєР»СЋС‡РµРЅРѕ */ \
		} while (0)
