...
#define ARM_STM32MP1_LFBGA354_CTLSTYLE_STORCH_V9A_H_INCLUDED 1
	...
	//#define LCDMODE_V2A	1	/* только главный экран с тремя видеобуферами 16 бит RGB565, без PIP */
	#define LCDMODE_V5A	1	/* только главный экран с тремя видеобуферами 32 бит RGB888, без PIP */
