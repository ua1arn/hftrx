...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V3_H_INCLUDED 1
	...
	#define FQMODEL_FPGA		1	// FPGA + IQ over I2S
	#if 0
		//#define DIRECT_63M9_X1		1	/* РўР°РєС‚РѕРІС‹Р№ РіРµРЅРµСЂР°С‚РѕСЂ РЅР° РїР»Р°С‚Рµ 63.955 РњР“С† */	
		...
		//#define DIRECT_12M288_X10	1	/* РўР°РєС‚РѕРІС‹Р№ РіРµРЅРµСЂР°С‚РѕСЂ 12.288 РњР“С† */	
	...
	#define CTLREGMODE_RAVENDSP_V3	1	/* "Р’РѕСЂРѕРЅС‘РЅРѕРє" СЃ DSP Рё FPGA */
	...
	#endif
	//#define WITHUSESDCARD 1			// Р’РєР»СЋС‡РµРЅРёРµ РїРѕРґРґРµСЂР¶РєРё SD CARD (РґР»СЏ V3 - РЅР°РІРµСЃРЅРѕР№ Р°РїРїР°СЂР°С‚СѓРѕР№)
...
#else
	KI0 = 0, KI1 = 1, KI2 = 2, KI3 = 3, KI4 = 6	// РєР»Р°РІРёР°С‚СѓСЂР°
#endif
};
