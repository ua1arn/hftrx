...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_RAVEN_V5_RA0CGS_H_INCLUDED 1
	...
	#if 0
		// при наличии внешнего кварцевого резонатора 16 МГц
	...
	#elif 1
		// при наличии внешнего кварцевого резонатора 12 МГц
	...
	#define WITHAUTOTUNEROWNSPI	1	/* Управление автотюнером на отдельном SPI target */
	#define SHORTSET7 1
	//#define FULLSET7 1
	...
	#define targetatu1	targetext2		/* тюнер на отдельном SPI target */
