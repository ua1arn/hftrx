...
#if LCDMODE_SPI_RN
	// Р­С‚Рё РєРѕРЅС‚СЂРѕР»Р»РµСЂС‹ С‚СЂРµР±СѓСЋС‚ RESET
...
#elif LCDMODE_SPI_NA
	// Р­С‚Рё РєРѕРЅС‚СЂРѕР»Р»РµСЂС‹ С‚СЂРµР±СѓСЋС‚ RS
	#define LS020_RS_PORT_S(v)		do { AT91C_BASE_PIOA->PIO_SODR = (v); } while (0)
	#define LS020_RS_PORT_C(v)		do { AT91C_BASE_PIOA->PIO_CODR = (v); } while (0)
	#define LS020_RS			AT91C_PIO_PA9			// D7 signal in HD44760 socket
...
#if LCDMODE_UC1608
	// Р­С‚Рё РєРѕРЅС‚СЂРѕР»Р»РµСЂС‹ С‚СЂРµР±СѓСЋС‚ РїРѕР»РѕР¶РёС‚РµР»СЊРЅС‹Р№ С‡РёРїСЃРµР»РµРєС‚ (С„РѕСЂРјРёСЂСѓРµС‚СЃСЏ РЅР° С‚РѕРј Р¶Рµ РІС‹РІРѕРґРµ С‡С‚Рѕ Рё EE Р Р’44780
...
/* Р Р°СЃРїСЂРµРґРµР»РµРЅРёРµ Р±РёС‚РѕРІ РІ ARM РєРѕРЅС‚СЂРѕР»Р»РµСЂР°С… */
	...
	#define FROMCAT_BIT_RTS				AT91C_PIO_PA24	/* СЃРёРіРЅР°Р» RTS РѕС‚ FT232RL	*/
	...
	#define FROMCAT_BIT_DTR				AT91C_PIO_PA27	/* СЃРёРіРЅР°Р» DTR РѕС‚ FT232RL	*/
...
#define SPI_A0 (AT91C_PIO_PA0)			// Р±РёС‚С‹ Р°РґСЂРµСЃР° РґР»СЏ РґРµС€РёС„СЂР°С‚РѕСЂР° SPI
