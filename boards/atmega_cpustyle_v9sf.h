...
//#endif
	...
	#define FROMCAT_BIT_RTS			(1U << PD4)	/* TQFP44 - PIN_13 СЃРёРіРЅР°Р» RTS РѕС‚ FT232RL	*/
	...
	#define FROMCAT_BIT_DTR			(1U << PB3)	/* TQFP44 - PIN_43 - СЃРёРіРЅР°Р» DTR РѕС‚ FT232RL	*/
...
#define SPI_IOUPDATE_BIT (1U << PB4)	// IOUPDATE
	...
	// С‚СЂРµР±СѓРµС‚СЃСЏ РѕСЃС‚Р°РІРёС‚СЊ СЃРІРѕР±РѕРґРЅС‹РјРё РґР»СЏ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РІС‹РІРѕРґС‹
	// Р°РїРїР°СЂР°С‚РЅРѕРіРѕ TWI / I2C РёРЅС‚РµСЂС„РµР№СЃР°.
	// 
	...
	#define SPI_CSEL2 (1U << PC4)	/* Pin 23 of TQFP44  Р§РёРїСЃРµР»РµРєС‚ РёРЅРґРёРєР°С‚РѕСЂР° LS020 - Pin 23 of TQFP44 */
