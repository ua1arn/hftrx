...
#ifndef ARM_ALLW_T113_CTLSTYLE_RA4ASN_H_INCLUDED
#define ARM_ALLW_T113_CTLSTYLE_RA4ASN_H_INCLUDED 1
	...
	#define CTLREGMODE_RA4ASN_BOARD	1
	#define WITHRFUNIT				1	// UA3REO RF-Unit rev.2
	...
	#define WITHRTS96 1		/* Получение от FPGA квадратур, возможно передача по USB и отображение спектра/водопада. */
		...
		#define WITHFFTSIZEAF 		512		/* Отображение спектра НЧ сигнвлв */
			...
			#define WITHUSEMALLOC		1	/* разрешение поддержки malloc/free/calloc/realloc */
			#define WITHAFGAINDEFAULT	(200 * BOARD_AFGAIN_MAX / 255)
...
#endif /* ARM_ALLW_T113_CTLSTYLE_RA4ASN_H_INCLUDED */
