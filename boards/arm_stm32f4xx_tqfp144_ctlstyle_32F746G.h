...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_32F746G_H_INCLUDED 1
	...
	#if 1
		// РїСЂРё РЅР°Р»РёС‡РёРё РІРЅРµС€РЅРµРіРѕ РіРµРЅРµСЂР°С‚РѕСЂР°
		#define WITHCPUXOSC 25000000uL	/* РџСЂРѕС†РµСЃСЃРѕСЂ С‚Р°РєС‚РёСЂСѓРµС‚ РІРЅРµС€РЅРёР№ РіРµРЅРµСЂР°С‚РѕСЂ 25.000 РњР“С† */
	...
	//#define CODEC_TYPE_WM8994_USE_8KS	1	/* РєРѕРґРµРє СЂР°Р±РѕС‚Р°РµС‚ СЃ sample rate 8 kHz */
	...
	#define WITHIFDACWIDTH	16		// 1 Р±РёС‚ Р·РЅР°Рє Рё 31 Р±РёС‚ Р·РЅР°С‡Р°С‰РёС…
	#define WITHIFADCWIDTH	16		// 1 Р±РёС‚ Р·РЅР°Рє Рё 31 Р±РёС‚ Р·РЅР°С‡Р°С‰РёС…
	...
	//#define WITHRTS192 1		/* РІРјРµСЃС‚Рѕ РІС‹С…РѕРґРЅРѕРіРѕ Р°СѓРґРёРѕСЃРёРіРЅР°Р»Р° РїРµСЂРµРґР°С‡Р° РєРІР°РґСЂР°С‚СѓСЂ РїРѕ USB */
	...
	#if WITHVOLTLEVEL 
		VOLTSOURCE = 0,		// PB0 РЎСЂРµРґРЅСЏСЏ С‚РѕС‡РєР° РґРµР»РёС‚РµР»СЏ РЅР°РїСЂСЏР¶РµРЅРёСЏ, РґР»СЏ РђРљР‘
	#endif /* WITHVOLTLEVEL */
	...
	#if WITHPOTWPM
		POTWPM = 0,			// PA6 РїРѕС‚РµРЅС†РёРѕРјРµС‚СЂ СѓРїСЂР°РІР»РµРЅРёСЏ СЃРєРѕСЂРѕСЃС‚СЊСЋ РїРµСЂРµРґР°С‡Рё РІ С‚РµР»РµРіСЂР°С„Рµ
	#endif /* WITHPOTWPM */
	#if WITHPOTPOWER
		POTPOWER = 0,			// СЂРµРіСѓР»РёСЂРѕРІРєР° РјРѕС‰РЅРѕСЃС‚Рё
	#endif /* WITHPOTPOWER */
