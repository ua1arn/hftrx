...
// STM32H743ZIT6, РєРѕРґРµРєРѕРј NAU8822L Рё FPGA EP4CE22E22I7N
...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_STORCH_V3_UT3NZ_H_INCLUDED 1
	...
	#define CTLREGMODE_STORCH_V3	1	/* "Р’РѕСЂРѕРЅС‘РЅРѕРє" СЃ DSP Рё FPGA, SD-CARD, dual watch & PA on board */
	...
	//#define WITHCURRLEVEL2	1	/* РѕС‚РѕР±СЂР°Р¶РµРЅРёРµ С‚РѕРєР° РѕРєРѕРЅРµС‡РЅРѕРіРѕ РєР°СЃРєР°РґР° 100W */
...
/*
	...
	WPM 1-СЃРєРѕСЂРѕСЃС‚СЊ cw

	AF 2-РіСЂРѕРјРєРѕСЃС‚СЊ РЅС‡
	RF 3-РјРѕС‰РЅРѕСЃС‚СЊ tx
	REFL 4-РЅРёС‡РµРіРѕ
	FORWARD 5-NOTCH
*/
	...
	#endif /* WITHPOTWPM */
	#if WITHPOTPOWER
		POTPOWER = 3,			// СЂРµРіСѓР»РёСЂРѕРІРєР° РјРѕС‰РЅРѕСЃС‚Рё
	#endif /* WITHPOTPOWER */
	#if WITHPOTNOTCH
		POTNOTCH = 9,			// СЂРµРіСѓР»РёСЂРѕРІРєР° С‡Р°СЃС‚РѕС‚С‹ NOTCH С„РёР»СЊС‚СЂР°
	#endif /* WITHPOTNOTCH */
