...
// STM32H743ZIT6, кодеком NAU8822L и FPGA EP4CE22E22I7N
...
#define ARM_STM32F4XX_TQFP144_CTLSTYLE_STORCH_V3_UT3NZ_H_INCLUDED 1
	...
	#define CTLREGMODE_STORCH_V3	1	/* "Воронёнок" с DSP и FPGA, SD-CARD, dual watch & PA on board */
	...
	#define WITHDISPLAYNOFILLSPECTRUM	1	/* не заливать заполнением площадь под графиком спектра */
