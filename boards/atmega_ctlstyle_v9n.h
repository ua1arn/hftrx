...
// UA1ARN
//
/* SW2011RDX с индикатором на встроенном преобразователе и ПЧ 6 МГц	*/

#ifndef ATMEGA_CTLSTYLE_V9N_H_INCLUDED
#define ATMEGA_CTLSTYLE_V9N_H_INCLUDED 1
	...
	//#define FQMODEL_45_IF8868_UHF144	1	// Для UT1ML
	#define FQMODEL_45_IF6000_UHF144	1	// SW2012MINI, SW2011V2
	#define CTLREGSTYLE_SW2011N	1	// управляющие регистры SW2011RDX
	...
	#define KEYBSTYLE_SW2011N	1	/*! */
	//#define KEYBSTYLE_SW2013SF	1	/* for ut4ua */
	// --- Особые варианты расположения кнопок на клавиатуре
...
#endif /* ATMEGA_CTLSTYLE_V9N_H_INCLUDED */
