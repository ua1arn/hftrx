...
#define	GPIOB_BASE	 ((uintptr_t) 0x01C2082C)
#define	GPIOC_BASE	 ((uintptr_t) 0x01C20858)
#define	GPIOD_BASE	 ((uintptr_t) 0x01C20884)
#define	GPIOE_BASE	 ((uintptr_t) 0x01C208B0)
#define	GPIOF_BASE	 ((uintptr_t) 0x01C208DC)
#define	GPIOG_BASE	 ((uintptr_t) 0x01C20908)
#define	GPIOH_BASE	 ((uintptr_t) 0x01C20934)
...
typedef struct CCU_Type
{
    ...
    volatile uint32_t PLL_DDR1_CTRL_REG;                                        /*!< Offset 0x04C PLL_DDR1 Control Register */
             uint32_t reserved_0x050 [0x0009];
