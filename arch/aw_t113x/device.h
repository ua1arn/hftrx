...
typedef enum IRQn
{
    ...
    USB0_DEVICE_IRQn = 61,                            /*!< USBOTG USB OTG Dual-Role Device controller */
...
#define GIC_DISTRIBUTOR_BASE ((uintptr_t) 0x03021000) /*!< GIC_DISTRIBUTOR GIC DISTRIBUTOR; GICD Base */
#define GIC_INTERFACE_BASE ((uintptr_t) 0x03022000)   /*!< GIC_INTERFACE GICC GIC CPU Interface Base */
...
#define USBOTG0_BASE ((uintptr_t) 0x04100000)         /*!< USBOTG USB OTG Dual-Role Device controller Base */
...
#define G2D_BASE ((uintptr_t) 0x05410000)             /*!< G2D_TOP Graphic 2D top Base */
...
{
    __IOM uint32_t AC_DAC_DPC;                        /*!< Offset 0x000 DAC Digital Part Control Register */
    __IOM uint32_t DAC_VOL_CTRL;                      /*!< Offset 0x004 DAC Volume Control Register */
         RESERVED(0x008[0x0010 - 0x0008], uint8_t)
    __IOM uint32_t AC_DAC_FIFOC;                      /*!< Offset 0x010 DAC FIFO Control Register */
    __IOM uint32_t AC_DAC_FIFOS;                      /*!< Offset 0x014 DAC FIFO Status Register */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t AC_DAC_TXDATA;                     /*!< Offset 0x020 DAC TX DATA Register */
    __IOM uint32_t AC_DAC_CNT;                        /*!< Offset 0x024 DAC TX FIFO Counter Register */
    __IOM uint32_t AC_DAC_DG;                         /*!< Offset 0x028 DAC Debug Register */
         RESERVED(0x02C[0x0030 - 0x002C], uint8_t)
    __IOM uint32_t AC_ADC_FIFOC;                      /*!< Offset 0x030 ADC FIFO Control Register */
    __IOM uint32_t ADC_VOL_CTRL1;                     /*!< Offset 0x034 ADC Volume Control1 Register */
    __IOM uint32_t AC_ADC_FIFOS;                      /*!< Offset 0x038 ADC FIFO Status Register */
         RESERVED(0x03C[0x0040 - 0x003C], uint8_t)
    __IOM uint32_t AC_ADC_RXDATA;                     /*!< Offset 0x040 ADC RX Data Register */
    __IOM uint32_t AC_ADC_CNT;                        /*!< Offset 0x044 ADC RX Counter Register */
         RESERVED(0x048[0x004C - 0x0048], uint8_t)
    __IOM uint32_t AC_ADC_DG;                         /*!< Offset 0x04C ADC Debug Register */
    __IOM uint32_t ADC_DIG_CTRL;                      /*!< Offset 0x050 ADC Digtial Control Register */
    __IOM uint32_t VRA1SPEEDUP_DOWN_CTRL;             /*!< Offset 0x054 VRA1 Speedup Down Control Register */
         RESERVED(0x058[0x00F0 - 0x0058], uint8_t)
    __IOM uint32_t AC_DAC_DAP_CTRL;                   /*!< Offset 0x0F0 DAC DAP Control Register */
         RESERVED(0x0F4[0x00F8 - 0x00F4], uint8_t)
    __IOM uint32_t AC_ADC_DAP_CTR;                    /*!< Offset 0x0F8 ADC DAP Control Register */
         RESERVED(0x0FC[0x0100 - 0x00FC], uint8_t)
    __IOM uint32_t AC_DAC_DRC_HHPFC;                  /*!< Offset 0x100 DAC DRC High HPF Coef Register */
    __IOM uint32_t AC_DAC_DRC_LHPFC;                  /*!< Offset 0x104 DAC DRC Low HPF Coef Register */
    __IOM uint32_t AC_DAC_DRC_CTRL;                   /*!< Offset 0x108 DAC DRC Control Register */
    __IOM uint32_t AC_DAC_DRC_LPFHAT;                 /*!< Offset 0x10C DAC DRC Left Peak Filter High Attack Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_LPFLAT;                 /*!< Offset 0x110 DAC DRC Left Peak Filter Low Attack Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_RPFHAT;                 /*!< Offset 0x114 DAC DRC Right Peak Filter High Attack Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_RPFLAT;                 /*!< Offset 0x118 DAC DRC Right Peak Filter Low Attack Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_LPFHRT;                 /*!< Offset 0x11C DAC DRC Left Peak Filter High Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_LPFLRT;                 /*!< Offset 0x120 DAC DRC Left Peak Filter Low Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_RPFHRT;                 /*!< Offset 0x124 DAC DRC Right Peak filter High Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_RPFLRT;                 /*!< Offset 0x128 DAC DRC Right Peak filter Low Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_LRMSHAT;                /*!< Offset 0x12C DAC DRC Left RMS Filter High Coef Register */
    __IOM uint32_t AC_DAC_DRC_LRMSLAT;                /*!< Offset 0x130 DAC DRC Left RMS Filter Low Coef Register */
    __IOM uint32_t AC_DAC_DRC_RRMSHAT;                /*!< Offset 0x134 DAC DRC Right RMS Filter High Coef Register */
    __IOM uint32_t AC_DAC_DRC_RRMSLAT;                /*!< Offset 0x138 DAC DRC Right RMS Filter Low Coef Register */
    __IOM uint32_t AC_DAC_DRC_HCT;                    /*!< Offset 0x13C DAC DRC Compressor Threshold High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LCT;                    /*!< Offset 0x140 DAC DRC Compressor Slope High Setting Register */
    __IOM uint32_t AC_DAC_DRC_HKC;                    /*!< Offset 0x144 DAC DRC Compressor Slope High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LKC;                    /*!< Offset 0x148 DAC DRC Compressor Slope Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_HOPC;                   /*!< Offset 0x14C DAC DRC Compresso */
    __IOM uint32_t AC_DAC_DRC_LOPC;                   /*!< Offset 0x150 DAC DRC Compressor Low Output at Compressor Threshold Register */
    __IOM uint32_t AC_DAC_DRC_HLT;                    /*!< Offset 0x154 DAC DRC Limiter Threshold High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LLT;                    /*!< Offset 0x158 DAC DRC Limiter Threshold Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_HKl;                    /*!< Offset 0x15C DAC DRC Limiter Slope High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LKl;                    /*!< Offset 0x160 DAC DRC Limiter Slope Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_HOPL;                   /*!< Offset 0x164 DAC DRC Limiter High Output at Limiter Threshold */
    __IOM uint32_t AC_DAC_DRC_LOPL;                   /*!< Offset 0x168 DAC DRC Limiter Low Output at Limiter Threshold */
    __IOM uint32_t AC_DAC_DRC_HET;                    /*!< Offset 0x16C DAC DRC Expander Threshold High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LET;                    /*!< Offset 0x170 DAC DRC Expander Threshold Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_HKE;                    /*!< Offset 0x174 DAC DRC Expander Slope High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LKE;                    /*!< Offset 0x178 DAC DRC Expander Slope Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_HOPE;                   /*!< Offset 0x17C DAC DRC Expander High Output at Expander Threshold */
    __IOM uint32_t AC_DAC_DRC_LOPE;                   /*!< Offset 0x180 DAC DRC Expander Low Output at Expander Threshold */
    __IOM uint32_t AC_DAC_DRC_HKN;                    /*!< Offset 0x184 DAC DRC Linear Slope High Setting Register */
    __IOM uint32_t AC_DAC_DRC_LKN;                    /*!< Offset 0x188 DAC DRC Linear Slope Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_SFHAT;                  /*!< Offset 0x18C DAC DRC Smooth filter Gain High Attack Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_SFLAT;                  /*!< Offset 0x190 DAC DRC Smooth filter Gain Low Attack Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_SFHRT;                  /*!< Offset 0x194 DAC DRC Smooth filter Gain High Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_SFLRT;                  /*!< Offset 0x198 DAC DRC Smooth filter Gain Low Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_MXGHS;                  /*!< Offset 0x19C DAC DRC MAX Gain High Setting Register */
    __IOM uint32_t AC_DAC_DRC_MXGLS;                  /*!< Offset 0x1A0 DAC DRC MAX Gain Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_MNGHS;                  /*!< Offset 0x1A4 DAC DRC MIN Gain High Setting Register */
    __IOM uint32_t AC_DAC_DRC_MNGLS;                  /*!< Offset 0x1A8 DAC DRC MIN Gain Low Setting Register */
    __IOM uint32_t AC_DAC_DRC_EPSHC;                  /*!< Offset 0x1AC DAC DRC Expander Smooth Time High Coef Register */
    __IOM uint32_t AC_DAC_DRC_EPSLC;                  /*!< Offset 0x1B0 DAC DRC Expander Smooth Time Low Coef Register */
         RESERVED(0x1B4[0x01B8 - 0x01B4], uint8_t)
    __IOM uint32_t AC_DAC_DRC_HPFHGAIN;               /*!< Offset 0x1B8 DAC DRC HPF Gain High Coef Register */
    __IOM uint32_t AC_DAC_DRC_HPFLGAIN;               /*!< Offset 0x1BC DAC DRC HPF Gain Low Coef Register */
         RESERVED(0x1C0[0x0200 - 0x01C0], uint8_t)
    __IOM uint32_t AC_ADC_DRC_HHPFC;                  /*!< Offset 0x200 ADC DRC High HPF Coef Register */
    __IOM uint32_t AC_ADC_DRC_LHPFC;                  /*!< Offset 0x204 ADC DRC Low HPF Coef Register */
    __IOM uint32_t AC_ADC_DRC_CTRL;                   /*!< Offset 0x208 ADC DRC Control Register */
    __IOM uint32_t AC_ADC_DRC_LPFHAT;                 /*!< Offset 0x20C ADC DRC Left Peak Filter High Attack Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_LPFLAT;                 /*!< Offset 0x210 ADC DRC Left Peak Filter Low Attack Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_RPFHAT;                 /*!< Offset 0x214 ADC DRC Right Peak Filter High Attack Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_RPFLAT;                 /*!< Offset 0x218 ADC DRC Right Peak Filter Low Attack Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_LPFHRT;                 /*!< Offset 0x21C ADC DRC Left Peak Filter High Release Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_LPFLRT;                 /*!< Offset 0x220 ADC DRC Left Peak Filter Low Release Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_RPFHRT;                 /*!< Offset 0x224 ADC DRC Right Peak Filter High Release Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_RPFLRT;                 /*!< Offset 0x228 ADC DRC Right Peak Filter Low Release Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_LRMSHAT;                /*!< Offset 0x22C ADC DRC Left RMS Filter High Coef Register */
    __IOM uint32_t AC_ADC_DRC_LRMSLAT;                /*!< Offset 0x230 ADC DRC Left RMS Filter Low Coef Register */
    __IOM uint32_t AC_ADC_DRC_RRMSHAT;                /*!< Offset 0x234 ADC DRC Right RMS Filter High Coef Register */
    __IOM uint32_t AC_ADC_DRC_RRMSLAT;                /*!< Offset 0x238 ADC DRC Right RMS Filter Low Coef Register */
    __IOM uint32_t AC_ADC_DRC_HCT;                    /*!< Offset 0x23C ADC DRC Compressor Threshold High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LCT;                    /*!< Offset 0x240 ADC DRC Compressor Slope High Setting Register */
    __IOM uint32_t AC_ADC_DRC_HKC;                    /*!< Offset 0x244 ADC DRC Compressor Slope High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LKC;                    /*!< Offset 0x248 ADC DRC Compressor Slope Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_HOPC;                   /*!< Offset 0x24C ADC DRC Compressor High Output at Compressor Threshold Register */
    __IOM uint32_t AC_ADC_DRC_LOPC;                   /*!< Offset 0x250 ADC DRC Compressor Low Output at Compressor Threshold Register */
    __IOM uint32_t AC_ADC_DRC_HLT;                    /*!< Offset 0x254 ADC DRC Limiter Threshold High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LLT;                    /*!< Offset 0x258 ADC DRC Limiter Threshold Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_HKl;                    /*!< Offset 0x25C ADC DRC Limiter Slope High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LKl;                    /*!< Offset 0x260 ADC DRC Limiter Slope Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_HOPL;                   /*!< Offset 0x264 ADC DRC Limiter High Output at Limiter Threshold */
    __IOM uint32_t AC_ADC_DRC_LOPL;                   /*!< Offset 0x268 ADC DRC Limiter Low Output at Limiter Threshold */
    __IOM uint32_t AC_ADC_DRC_HET;                    /*!< Offset 0x26C ADC DRC Expander Threshold High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LET;                    /*!< Offset 0x270 ADC DRC Expander Threshold Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_HKE;                    /*!< Offset 0x274 ADC DRC Expander Slope High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LKE;                    /*!< Offset 0x278 ADC DRC Expander Slope Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_HOPE;                   /*!< Offset 0x27C ADC DRC Expander High Output at Expander Threshold */
    __IOM uint32_t AC_ADC_DRC_LOPE;                   /*!< Offset 0x280 ADC DRC Expander Low Output at Expander Threshold */
    __IOM uint32_t AC_ADC_DRC_HKN;                    /*!< Offset 0x284 ADC DRC Linear Slope High Setting Register */
    __IOM uint32_t AC_ADC_DRC_LKN;                    /*!< Offset 0x288 ADC DRC Linear Slope Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_SFHAT;                  /*!< Offset 0x28C ADC DRC Smooth filter Gain High Attack Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_SFLAT;                  /*!< Offset 0x290 ADC DRC Smooth filter Gain Low Attack Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_SFHRT;                  /*!< Offset 0x294 ADC DRC Smooth filter Gain High Release Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_SFLRT;                  /*!< Offset 0x298 ADC DRC Smooth filter Gain Low Release Time Coef Register */
    __IOM uint32_t AC_ADC_DRC_MXGHS;                  /*!< Offset 0x29C ADC DRC MAX Gain High Setting Register */
    __IOM uint32_t AC_ADC_DRC_MXGLS;                  /*!< Offset 0x2A0 ADC DRC MAX Gain Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_MNGHS;                  /*!< Offset 0x2A4 ADC DRC MIN Gain High Setting Register */
    __IOM uint32_t AC_ADC_DRC_MNGLS;                  /*!< Offset 0x2A8 ADC DRC MIN Gain Low Setting Register */
    __IOM uint32_t AC_ADC_DRC_EPSHC;                  /*!< Offset 0x2AC ADC DRC Expander Smooth Time High Coef Register */
    __IOM uint32_t AC_ADC_DRC_EPSLC;                  /*!< Offset 0x2B0 ADC DRC Expander Smooth Time Low Coef Register */
         RESERVED(0x2B4[0x02B8 - 0x02B4], uint8_t)
    __IOM uint32_t AC_ADC_DRC_HPFHGAIN;               /*!< Offset 0x2B8 ADC DRC HPF Gain High Coef Register */
    __IOM uint32_t AC_ADC_DRC_HPFLGAIN;               /*!< Offset 0x2BC ADC DRC HPF Gain Low Coef Register */
         RESERVED(0x2C0[0x0300 - 0x02C0], uint8_t)
    __IOM uint32_t ADC1_REG;                          /*!< Offset 0x300 ADC1 Analog Control Register */
    __IOM uint32_t ADC2_REG;                          /*!< Offset 0x304 ADC2 Analog Control Register */
    __IOM uint32_t ADC3_REG;                          /*!< Offset 0x308 ADC3 Analog Control Register */
         RESERVED(0x30C[0x0310 - 0x030C], uint8_t)
    __IOM uint32_t DAC_REG;                           /*!< Offset 0x310 DAC Analog Control Register */
         RESERVED(0x314[0x0318 - 0x0314], uint8_t)
    __IOM uint32_t MICBIAS_REG;                       /*!< Offset 0x318 MICBIAS Analog Control Register */
    __IOM uint32_t RAMP_REG;                          /*!< Offset 0x31C BIAS Analog Control Register */
    __IOM uint32_t BIAS_REG;                          /*!< Offset 0x320 BIAS Analog Control Register */
         RESERVED(0x324[0x0328 - 0x0324], uint8_t)
    __IOM uint32_t HMIC_CTRL;                         /*!< Offset 0x328 * HMIC Control Register */
    __IOM uint32_t HMIC_STS;                          /*!< Offset 0x32C * HMIC Status Register ( */
    __IOM uint32_t ADC5_REG;                          /*!< Offset 0x330 ADC5 Analog Control Register */
         RESERVED(0x334[0x0340 - 0x0334], uint8_t)
    __IOM uint32_t HP2_REG;                           /*!< Offset 0x340 * Headphone2 Analog Control Register */
         RESERVED(0x344[0x0348 - 0x0344], uint8_t)
    __IOM uint32_t POWER_REG;                         /*!< Offset 0x348 * POWER Analog Control Register */
    __IOM uint32_t ADC_CUR_REG;                       /*!< Offset 0x34C * ADC Current Analog Control Register */
...
{
    __IOM uint32_t C0_RST_CTRL;                       /*!< Offset 0x000 Cluster 0 Reset Control Register */
         RESERVED(0x004[0x0010 - 0x0004], uint8_t)
    __IOM uint32_t C0_CTRL_REG0;                      /*!< Offset 0x010 Cluster 0 Control Register0 */
    __IOM uint32_t C0_CTRL_REG1;                      /*!< Offset 0x014 Cluster 0 Control Register1 */
    __IOM uint32_t C0_CTRL_REG2;                      /*!< Offset 0x018 Cluster 0 Control Register2 */
         RESERVED(0x01C[0x0024 - 0x001C], uint8_t)
    __IOM uint32_t CACHE_CFG_REG;                     /*!< Offset 0x024 Cache Configuration Register */
         RESERVED(0x028[0x0080 - 0x0028], uint8_t)
    __IOM uint32_t C0_CPU_STATUS;                     /*!< Offset 0x080 Cluster 0 CPU Status Register */
    __IOM uint32_t L2_STATUS_REG;                     /*!< Offset 0x084 Cluster 0 L2 Status Register */
         RESERVED(0x088[0x00C0 - 0x0088], uint8_t)
    __IOM uint32_t DBG_REG0;                          /*!< Offset 0x0C0 Cluster 0 Debug Control Register0 */
    __IOM uint32_t DBG_REG1;                          /*!< Offset 0x0C4 Cluster 0 Debug Control Register1 */
         RESERVED(0x0C8[0x00D0 - 0x00C8], uint8_t)
    __IOM uint32_t AXI_MNT_CTRL_REG;                  /*!< Offset 0x0D0 AXI Monitor Control Register */
    __IOM uint32_t AXI_MNT_PRD_REG;                   /*!< Offset 0x0D4 AXI Monitor Period Register */
    __IOM uint32_t AXI_MNT_RLTCY_REG;                 /*!< Offset 0x0D8 AXI Monitor Read Total Latency Register */
    __IOM uint32_t AXI_MNT_WLTCY_REG;                 /*!< Offset 0x0DC AXI Monitor Write Total Latency Register */
    __IOM uint32_t AXI_MNT_RREQ_REG;                  /*!< Offset 0x0E0 AXI Monitor Read Request Times Register */
    __IOM uint32_t AXI_MNT_WREQ_REG;                  /*!< Offset 0x0E4 AXI Monitor Write Request Times Register */
    __IOM uint32_t AXI_MNT_RBD_REG;                   /*!< Offset 0x0E8 AXI Monitor Read Bandwidth Register */
    __IOM uint32_t AXI_MNT_WBD_REG;                   /*!< Offset 0x0EC AXI Monitor Write Bandwidth Register */
...
{
    __IOM uint32_t CAN_MSEL;                          /*!< Offset 0x000 CAN mode select register */
    __IOM uint32_t CAN_CMD;                           /*!< Offset 0x004 CAN command register */
    __IOM uint32_t CAN_STA;                           /*!< Offset 0x008 CAN status register */
    __IOM uint32_t CAN_INT;                           /*!< Offset 0x00C CAN interrupt register */
    __IOM uint32_t CAN_INTEN;                         /*!< Offset 0x010 CAN interrupt enable register */
    __IOM uint32_t CAN_BUSTIME;                       /*!< Offset 0x014 CAN bus timing register */
    __IOM uint32_t CAN_TEWL;                          /*!< Offset 0x018 CAN TX error warning limit register */
    __IOM uint32_t CAN_ERRC;                          /*!< Offset 0x01C CAN error counter register */
    __IOM uint32_t CAN_RMCNT;                         /*!< Offset 0x020 CAN receive message counter register */
    __IOM uint32_t CAN_RBUF_SADDR;                    /*!< Offset 0x024 CAN receive buffer start address register */
    __IOM uint32_t CAN_ACPC;                          /*!< Offset 0x028 CAN acceptance code 0 register(reset mode) */
    __IOM uint32_t CAN_ACPM;                          /*!< Offset 0x02C CAN acceptance mask 0 register(reset mode) */
         RESERVED(0x030[0x0040 - 0x0030], uint8_t)
    __IOM uint32_t CAN_TRBUF [0x00D];                 /*!< Offset 0x040 CAN TX/RX message buffer N (n=0..12) register */
    ...
    __IOM uint32_t CAN_VERSION;                       /*!< Offset 0x300 CAN Version Register */
...
{
    __IOM uint32_t PLL_CPU_CTRL_REG;                  /*!< Offset 0x000 PLL_CPU Control Register */
         RESERVED(0x004[0x0010 - 0x0004], uint8_t)
    __IOM uint32_t PLL_DDR_CTRL_REG;                  /*!< Offset 0x010 PLL_DDR Control Register */
         RESERVED(0x014[0x0020 - 0x0014], uint8_t)
    __IOM uint32_t PLL_PERI_CTRL_REG;                 /*!< Offset 0x020 PLL_PERI Control Register */
         RESERVED(0x024[0x0040 - 0x0024], uint8_t)
    __IOM uint32_t PLL_VIDEO0_CTRL_REG;               /*!< Offset 0x040 PLL_VIDEO0 Control Register */
         RESERVED(0x044[0x0048 - 0x0044], uint8_t)
    __IOM uint32_t PLL_VIDEO1_CTRL_REG;               /*!< Offset 0x048 PLL_VIDEO1 Control Register */
         RESERVED(0x04C[0x0058 - 0x004C], uint8_t)
    __IOM uint32_t PLL_VE_CTRL_REG;                   /*!< Offset 0x058 PLL_VE Control Register */
         RESERVED(0x05C[0x0078 - 0x005C], uint8_t)
    __IOM uint32_t PLL_AUDIO0_CTRL_REG;               /*!< Offset 0x078 PLL_AUDIO0 Control Register */
         RESERVED(0x07C[0x0080 - 0x007C], uint8_t)
    __IOM uint32_t PLL_AUDIO1_CTRL_REG;               /*!< Offset 0x080 PLL_AUDIO1 Control Register */
         RESERVED(0x084[0x0110 - 0x0084], uint8_t)
    __IOM uint32_t PLL_DDR_PAT0_CTRL_REG;             /*!< Offset 0x110 PLL_DDR Pattern0 Control Register */
    __IOM uint32_t PLL_DDR_PAT1_CTRL_REG;             /*!< Offset 0x114 PLL_DDR Pattern1 Control Register */
         RESERVED(0x118[0x0120 - 0x0118], uint8_t)
    __IOM uint32_t PLL_PERI_PAT0_CTRL_REG;            /*!< Offset 0x120 PLL_PERI Pattern0 Control Register */
    __IOM uint32_t PLL_PERI_PAT1_CTRL_REG;            /*!< Offset 0x124 PLL_PERI Pattern1 Control Register */
         RESERVED(0x128[0x0140 - 0x0128], uint8_t)
    __IOM uint32_t PLL_VIDEO0_PAT0_CTRL_REG;          /*!< Offset 0x140 PLL_VIDEO0 Pattern0 Control Register */
    __IOM uint32_t PLL_VIDEO0_PAT1_CTRL_REG;          /*!< Offset 0x144 PLL_VIDEO0 Pattern1 Control Register */
    ...
    __IOM uint32_t PLL_VE_PAT0_CTRL_REG;              /*!< Offset 0x158 PLL_VE Pattern0 Control Register */
    __IOM uint32_t PLL_VE_PAT1_CTRL_REG;              /*!< Offset 0x15C PLL_VE Pattern1 Control Register */
         RESERVED(0x160[0x0178 - 0x0160], uint8_t)
    __IOM uint32_t PLL_AUDIO0_PAT0_CTRL_REG;          /*!< Offset 0x178 PLL_AUDIO0 Pattern0 Control Register */
    __IOM uint32_t PLL_AUDIO0_PAT1_CTRL_REG;          /*!< Offset 0x17C PLL_AUDIO0 Pattern1 Control Register */
    __IOM uint32_t PLL_AUDIO1_PAT0_CTRL_REG;          /*!< Offset 0x180 PLL_AUDIO1 Pattern0 Control Register */
    __IOM uint32_t PLL_AUDIO1_PAT1_CTRL_REG;          /*!< Offset 0x184 PLL_AUDIO1 Pattern1 Control Register */
         RESERVED(0x188[0x0300 - 0x0188], uint8_t)
    __IOM uint32_t PLL_CPU_BIAS_REG;                  /*!< Offset 0x300 PLL_CPU Bias Register */
         RESERVED(0x304[0x0310 - 0x0304], uint8_t)
    __IOM uint32_t PLL_DDR_BIAS_REG;                  /*!< Offset 0x310 PLL_DDR Bias Register */
         RESERVED(0x314[0x0320 - 0x0314], uint8_t)
    __IOM uint32_t PLL_PERI_BIAS_REG;                 /*!< Offset 0x320 PLL_PERI Bias Register */
         RESERVED(0x324[0x0340 - 0x0324], uint8_t)
    __IOM uint32_t PLL_VIDEO0_BIAS_REG;               /*!< Offset 0x340 PLL_VIDEO0 Bias Register */
         RESERVED(0x344[0x0348 - 0x0344], uint8_t)
    __IOM uint32_t PLL_VIDEO1_BIAS_REG;               /*!< Offset 0x348 PLL_VIDEO1 Bias Register */
         RESERVED(0x34C[0x0358 - 0x034C], uint8_t)
    __IOM uint32_t PLL_VE_BIAS_REG;                   /*!< Offset 0x358 PLL_VE Bias Register */
         RESERVED(0x35C[0x0378 - 0x035C], uint8_t)
    __IOM uint32_t PLL_AUDIO0_BIAS_REG;               /*!< Offset 0x378 PLL_AUDIO0 Bias Register */
         RESERVED(0x37C[0x0380 - 0x037C], uint8_t)
    __IOM uint32_t PLL_AUDIO1_BIAS_REG;               /*!< Offset 0x380 PLL_AUDIO1 Bias Register */
         RESERVED(0x384[0x0400 - 0x0384], uint8_t)
    __IOM uint32_t PLL_CPU_TUN_REG;                   /*!< Offset 0x400 PLL_CPU Tuning Register */
         RESERVED(0x404[0x0500 - 0x0404], uint8_t)
    __IOM uint32_t CPU_AXI_CFG_REG;                   /*!< Offset 0x500 CPU_AXI Configuration Register */
    __IOM uint32_t CPU_GATING_REG;                    /*!< Offset 0x504 CPU_GATING Configuration Register */
         RESERVED(0x508[0x0510 - 0x0508], uint8_t)
    __IOM uint32_t PSI_CLK_REG;                       /*!< Offset 0x510 PSI Clock Register */
         RESERVED(0x514[0x0520 - 0x0514], uint8_t)
    __IOM uint32_t APB0_CLK_REG;                      /*!< Offset 0x520 APB0 Clock Register */
    __IOM uint32_t APB1_CLK_REG;                      /*!< Offset 0x524 APB1 Clock Register */
         RESERVED(0x528[0x0540 - 0x0528], uint8_t)
    __IOM uint32_t MBUS_CLK_REG;                      /*!< Offset 0x540 MBUS Clock Register */
         RESERVED(0x544[0x0600 - 0x0544], uint8_t)
    __IOM uint32_t DE_CLK_REG;                        /*!< Offset 0x600 DE Clock Register */
         RESERVED(0x604[0x060C - 0x0604], uint8_t)
    __IOM uint32_t DE_BGR_REG;                        /*!< Offset 0x60C DE Bus Gating Reset Register */
         RESERVED(0x610[0x0620 - 0x0610], uint8_t)
    __IOM uint32_t DI_CLK_REG;                        /*!< Offset 0x620 DI Clock Register */
         RESERVED(0x624[0x062C - 0x0624], uint8_t)
    __IOM uint32_t DI_BGR_REG;                        /*!< Offset 0x62C DI Bus Gating Reset Register */
    __IOM uint32_t G2D_CLK_REG;                       /*!< Offset 0x630 G2D Clock Register */
         RESERVED(0x634[0x063C - 0x0634], uint8_t)
    __IOM uint32_t G2D_BGR_REG;                       /*!< Offset 0x63C G2D Bus Gating Reset Register */
         RESERVED(0x640[0x0680 - 0x0640], uint8_t)
    __IOM uint32_t CE_CLK_REG;                        /*!< Offset 0x680 CE Clock Register */
         RESERVED(0x684[0x068C - 0x0684], uint8_t)
    __IOM uint32_t CE_BGR_REG;                        /*!< Offset 0x68C CE Bus Gating Reset Register */
    __IOM uint32_t VE_CLK_REG;                        /*!< Offset 0x690 VE Clock Register */
         RESERVED(0x694[0x069C - 0x0694], uint8_t)
    __IOM uint32_t VE_BGR_REG;                        /*!< Offset 0x69C VE Bus Gating Reset Register */
         RESERVED(0x6A0[0x070C - 0x06A0], uint8_t)
    __IOM uint32_t DMA_BGR_REG;                       /*!< Offset 0x70C DMA Bus Gating Reset Register */
         RESERVED(0x710[0x071C - 0x0710], uint8_t)
    __IOM uint32_t MSGBOX_BGR_REG;                    /*!< Offset 0x71C MSGBOX Bus Gating Reset Register */
         RESERVED(0x720[0x072C - 0x0720], uint8_t)
    __IOM uint32_t SPINLOCK_BGR_REG;                  /*!< Offset 0x72C SPINLOCK Bus Gating Reset Register */
         RESERVED(0x730[0x073C - 0x0730], uint8_t)
    __IOM uint32_t HSTIMER_BGR_REG;                   /*!< Offset 0x73C HSTIMER Bus Gating Reset Register */
    __IOM uint32_t AVS_CLK_REG;                       /*!< Offset 0x740 AVS Clock Register */
         RESERVED(0x744[0x078C - 0x0744], uint8_t)
    __IOM uint32_t DBGSYS_BGR_REG;                    /*!< Offset 0x78C DBGSYS Bus Gating Reset Register */
         RESERVED(0x790[0x07AC - 0x0790], uint8_t)
    __IOM uint32_t PWM_BGR_REG;                       /*!< Offset 0x7AC PWM Bus Gating Reset Register */
         RESERVED(0x7B0[0x07BC - 0x07B0], uint8_t)
    __IOM uint32_t IOMMU_BGR_REG;                     /*!< Offset 0x7BC IOMMU Bus Gating Reset Register */
         RESERVED(0x7C0[0x0800 - 0x07C0], uint8_t)
    __IOM uint32_t DRAM_CLK_REG;                      /*!< Offset 0x800 DRAM Clock Register */
    __IOM uint32_t MBUS_MAT_CLK_GATING_REG;           /*!< Offset 0x804 MBUS Master Clock Gating Register */
         RESERVED(0x808[0x080C - 0x0808], uint8_t)
    __IOM uint32_t DRAM_BGR_REG;                      /*!< Offset 0x80C DRAM Bus Gating Reset Register */
         RESERVED(0x810[0x0830 - 0x0810], uint8_t)
    __IOM uint32_t SMHC0_CLK_REG;                     /*!< Offset 0x830 SMHC0 Clock Register */
    __IOM uint32_t SMHC1_CLK_REG;                     /*!< Offset 0x834 SMHC1 Clock Register */
    __IOM uint32_t SMHC2_CLK_REG;                     /*!< Offset 0x838 SMHC2 Clock Register */
         RESERVED(0x83C[0x084C - 0x083C], uint8_t)
    __IOM uint32_t SMHC_BGR_REG;                      /*!< Offset 0x84C SMHC Bus Gating Reset Register */
         RESERVED(0x850[0x090C - 0x0850], uint8_t)
    __IOM uint32_t UART_BGR_REG;                      /*!< Offset 0x90C UART Bus Gating Reset Register */
         RESERVED(0x910[0x091C - 0x0910], uint8_t)
    __IOM uint32_t TWI_BGR_REG;                       /*!< Offset 0x91C TWI Bus Gating Reset Register */
         RESERVED(0x920[0x092C - 0x0920], uint8_t)
    __IOM uint32_t CAN_BGR_REG;                       /*!< Offset 0x92C CAN Bus Gating Reset Register */
         RESERVED(0x930[0x0940 - 0x0930], uint8_t)
    __IOM uint32_t SPI0_CLK_REG;                      /*!< Offset 0x940 SPI0 Clock Register */
    __IOM uint32_t SPI1_CLK_REG;                      /*!< Offset 0x944 SPI1 Clock Register */
         RESERVED(0x948[0x096C - 0x0948], uint8_t)
    __IOM uint32_t SPI_BGR_REG;                       /*!< Offset 0x96C SPI Bus Gating Reset Register */
    __IOM uint32_t EMAC_25M_CLK_REG;                  /*!< Offset 0x970 EMAC_25M Clock Register */
         RESERVED(0x974[0x097C - 0x0974], uint8_t)
    __IOM uint32_t EMAC_BGR_REG;                      /*!< Offset 0x97C EMAC Bus Gating Reset Register */
         RESERVED(0x980[0x09C0 - 0x0980], uint8_t)
    __IOM uint32_t IRTX_CLK_REG;                      /*!< Offset 0x9C0 IRTX Clock Register */
         RESERVED(0x9C4[0x09CC - 0x09C4], uint8_t)
    __IOM uint32_t IRTX_BGR_REG;                      /*!< Offset 0x9CC IRTX Bus Gating Reset Register */
         RESERVED(0x9D0[0x09EC - 0x09D0], uint8_t)
    __IOM uint32_t GPADC_BGR_REG;                     /*!< Offset 0x9EC GPADC Bus Gating Reset Register */
         RESERVED(0x9F0[0x09FC - 0x09F0], uint8_t)
    __IOM uint32_t THS_BGR_REG;                       /*!< Offset 0x9FC THS Bus Gating Reset Register */
         RESERVED(0xA00[0x0A14 - 0x0A00], uint8_t)
    __IOM uint32_t I2S1_CLK_REG;                      /*!< Offset 0xA14 I2S1 Clock Register */
    __IOM uint32_t I2S2_CLK_REG;                      /*!< Offset 0xA18 I2S2 Clock Register */
    __IOM uint32_t I2S2_ASRC_CLK_REG;                 /*!< Offset 0xA1C I2S2_ASRC Clock Register */
    __IOM uint32_t I2S_BGR_REG;                       /*!< Offset 0xA20 I2S Bus Gating Reset Register */
    __IOM uint32_t OWA_TX_CLK_REG;                    /*!< Offset 0xA24 OWA_TX Clock Register */
         RESERVED(0xA28[0x0A2C - 0x0A28], uint8_t)
    __IOM uint32_t OWA_BGR_REG;                       /*!< Offset 0xA2C OWA Bus Gating Reset Register */
         RESERVED(0xA30[0x0A40 - 0x0A30], uint8_t)
    __IOM uint32_t DMIC_CLK_REG;                      /*!< Offset 0xA40 DMIC Clock Register */
         RESERVED(0xA44[0x0A4C - 0x0A44], uint8_t)
    __IOM uint32_t DMIC_BGR_REG;                      /*!< Offset 0xA4C DMIC Bus Gating Reset Register */
    __IOM uint32_t AUDIO_CODEC_DAC_CLK_REG;           /*!< Offset 0xA50 AUDIO_CODEC_DAC Clock Register */
    __IOM uint32_t AUDIO_CODEC_ADC_CLK_REG;           /*!< Offset 0xA54 AUDIO_CODEC_ADC Clock Register */
         RESERVED(0xA58[0x0A5C - 0x0A58], uint8_t)
    __IOM uint32_t AUDIO_CODEC_BGR_REG;               /*!< Offset 0xA5C AUDIO_CODEC Bus Gating Reset Register */
         RESERVED(0xA60[0x0A70 - 0x0A60], uint8_t)
    __IOM uint32_t USB0_CLK_REG;                      /*!< Offset 0xA70 USB0 Clock Register */
    __IOM uint32_t USB1_CLK_REG;                      /*!< Offset 0xA74 USB1 Clock Register */
         RESERVED(0xA78[0x0A8C - 0x0A78], uint8_t)
    __IOM uint32_t USB_BGR_REG;                       /*!< Offset 0xA8C USB Bus Gating Reset Register */
         RESERVED(0xA90[0x0ABC - 0x0A90], uint8_t)
    __IOM uint32_t DPSS_TOP_BGR_REG;                  /*!< Offset 0xABC DPSS_TOP Bus Gating Reset Register */
         RESERVED(0xAC0[0x0B24 - 0x0AC0], uint8_t)
    __IOM uint32_t DSI_CLK_REG;                       /*!< Offset 0xB24 DSI Clock Register */
         RESERVED(0xB28[0x0B4C - 0x0B28], uint8_t)
    __IOM uint32_t DSI_BGR_REG;                       /*!< Offset 0xB4C DSI Bus Gating Reset Register */
         RESERVED(0xB50[0x0B60 - 0x0B50], uint8_t)
    __IOM uint32_t TCONLCD_CLK_REG;                   /*!< Offset 0xB60 TCONLCD Clock Register */
         RESERVED(0xB64[0x0B7C - 0x0B64], uint8_t)
    __IOM uint32_t TCONLCD_BGR_REG;                   /*!< Offset 0xB7C TCONLCD Bus Gating Reset Register */
    __IOM uint32_t TCONTV_CLK_REG;                    /*!< Offset 0xB80 TCONTV Clock Register */
         RESERVED(0xB84[0x0B9C - 0x0B84], uint8_t)
    __IOM uint32_t TCONTV_BGR_REG;                    /*!< Offset 0xB9C TCONTV Bus Gating Reset Register */
         RESERVED(0xBA0[0x0BAC - 0x0BA0], uint8_t)
    __IOM uint32_t LVDS_BGR_REG;                      /*!< Offset 0xBAC LVDS Bus Gating Reset Register */
    __IOM uint32_t TVE_CLK_REG;                       /*!< Offset 0xBB0 TVE Clock Register */
         RESERVED(0xBB4[0x0BBC - 0x0BB4], uint8_t)
    __IOM uint32_t TVE_BGR_REG;                       /*!< Offset 0xBBC TVE Bus Gating Reset Register */
    __IOM uint32_t TVD_CLK_REG;                       /*!< Offset 0xBC0 TVD Clock Register */
         RESERVED(0xBC4[0x0BDC - 0x0BC4], uint8_t)
    __IOM uint32_t TVD_BGR_REG;                       /*!< Offset 0xBDC TVD Bus Gating Reset Register */
         RESERVED(0xBE0[0x0BF0 - 0x0BE0], uint8_t)
    __IOM uint32_t LEDC_CLK_REG;                      /*!< Offset 0xBF0 LEDC Clock Register */
         RESERVED(0xBF4[0x0BFC - 0x0BF4], uint8_t)
    __IOM uint32_t LEDC_BGR_REG;                      /*!< Offset 0xBFC LEDC Bus Gating Reset Register */
         RESERVED(0xC00[0x0C04 - 0x0C00], uint8_t)
    __IOM uint32_t CSI_CLK_REG;                       /*!< Offset 0xC04 CSI Clock Register */
    __IOM uint32_t CSI_MASTER_CLK_REG;                /*!< Offset 0xC08 CSI Master Clock Register */
         RESERVED(0xC0C[0x0C1C - 0x0C0C], uint8_t)
    __IOM uint32_t CSI_BGR_REG;                       /*!< Offset 0xC1C CSI Bus Gating Reset Register */
         RESERVED(0xC20[0x0C50 - 0x0C20], uint8_t)
    __IOM uint32_t TPADC_CLK_REG;                     /*!< Offset 0xC50 TPADC Clock Register */
         RESERVED(0xC54[0x0C5C - 0x0C54], uint8_t)
    __IOM uint32_t TPADC_BGR_REG;                     /*!< Offset 0xC5C TPADC Bus Gating Reset Register */
         RESERVED(0xC60[0x0C70 - 0x0C60], uint8_t)
    __IOM uint32_t DSP_CLK_REG;                       /*!< Offset 0xC70 DSP Clock Register */
         RESERVED(0xC74[0x0C7C - 0x0C74], uint8_t)
    __IOM uint32_t DSP_BGR_REG;                       /*!< Offset 0xC7C DSP Bus Gating Reset Register */
         RESERVED(0xC80[0x0D00 - 0x0C80], uint8_t)
    __IOM uint32_t RISC_CLK_REG;                      /*!< Offset 0xD00 RISC Clock Register */
    __IOM uint32_t RISC_GATING_REG;                   /*!< Offset 0xD04 RISC Gating Configuration Register */
         RESERVED(0xD08[0x0D0C - 0x0D08], uint8_t)
    __IOM uint32_t RISC_CFG_BGR_REG;                  /*!< Offset 0xD0C RISC_CFG Bus Gating Reset Register */
         RESERVED(0xD10[0x0F04 - 0x0D10], uint8_t)
    __IOM uint32_t PLL_LOCK_DBG_CTRL_REG;             /*!< Offset 0xF04 PLL Lock Debug Control Register */
    __IOM uint32_t FRE_DET_CTRL_REG;                  /*!< Offset 0xF08 Frequency Detect Control Register */
    __IOM uint32_t FRE_UP_LIM_REG;                    /*!< Offset 0xF0C Frequency Up Limit Register */
    __IOM uint32_t FRE_DOWN_LIM_REG;                  /*!< Offset 0xF10 Frequency Down Limit Register */
         RESERVED(0xF14[0x0F20 - 0x0F14], uint8_t)
    __IOM uint32_t RISC_RST_REG;                      /*!< Offset 0xF20 RISC LOCK RESET Register */
         RESERVED(0xF24[0x0F30 - 0x0F24], uint8_t)
    __IOM uint32_t CCU_FAN_GATE_REG;                  /*!< Offset 0xF30 CCU FANOUT CLOCK GATE Register */
    __IOM uint32_t CLK27M_FAN_REG;                    /*!< Offset 0xF34 CLK27M FANOUT Register */
    __IOM uint32_t PCLK_FAN_REG;                      /*!< Offset 0xF38 PCLK FANOUT Register */
    __IOM uint32_t CCU_FAN_REG;                       /*!< Offset 0xF3C CCU FANOUT Register */
...
{
    __IOM uint32_t CIR_TGLR;                          /*!< Offset 0x000 CIR Transmit Global Register */
    __IOM uint32_t CIR_TMCR;                          /*!< Offset 0x004 CIR Transmit Modulation Control Register */
    __IOM uint32_t CIR_TCR;                           /*!< Offset 0x008 CIR Transmit Control Register */
    __IOM uint32_t CIR_IDC_H;                         /*!< Offset 0x00C CIR Transmit Idle Duration Threshold High Bit Register */
    __IOM uint32_t CIR_IDC_L;                         /*!< Offset 0x010 CIR Transmit Idle Duration Threshold Low Bit Register */
    __IOM uint32_t CIR_TICR_H;                        /*!< Offset 0x014 CIR Transmit Idle Counter High Bit Register */
    __IOM uint32_t CIR_TICR_L;                        /*!< Offset 0x018 CIR Transmit Idle Counter Low Bit Register */
         RESERVED(0x01C[0x0020 - 0x001C], uint8_t)
    __IOM uint32_t CIR_TEL;                           /*!< Offset 0x020 CIR TX FIFO Empty Level Register */
    __IOM uint32_t CIR_TXINT;                         /*!< Offset 0x024 CIR Transmit Interrupt Control Register */
    __IOM uint32_t CIR_TAC;                           /*!< Offset 0x028 CIR Transmit FIFO Available Counter Register */
    __IOM uint32_t CIR_TXSTA;                         /*!< Offset 0x02C CIR Transmit Status Register */
    __IOM uint32_t CIR_TXT;                           /*!< Offset 0x030 CIR Transmit Threshold Register */
    __IOM uint32_t CIR_DMA;                           /*!< Offset 0x034 CIR DMA Control Register */
         RESERVED(0x038[0x0080 - 0x0038], uint8_t)
    __IOM uint32_t CIR_TXFIFO;                        /*!< Offset 0x080 CIR Transmit FIFO Data Register */
...
{
    __IOM uint32_t CCU_CLK_MODE_REG;                  /*!< Offset 0x000 CCU Clock Mode Register */
    __IOM uint32_t CCU_PARSER_CLK_EN_REG;             /*!< Offset 0x004 CCU Parser Clock Enable Register */
         RESERVED(0x008[0x000C - 0x0008], uint8_t)
    __IOM uint32_t CCU_POST0_CLK_EN_REG;              /*!< Offset 0x00C CCU Post0 Clock Enable Register */
...
{
    __IOM uint32_t CSIC_DMA_EN_REG;                   /*!< Offset 0x000 CSIC DMA Enable Register */
    __IOM uint32_t CSIC_DMA_CFG_REG;                  /*!< Offset 0x004 CSIC DMA Configuration Register */
         RESERVED(0x008[0x0010 - 0x0008], uint8_t)
    __IOM uint32_t CSIC_DMA_HSIZE_REG;                /*!< Offset 0x010 CSIC DMA Horizontal Size Register */
    __IOM uint32_t CSIC_DMA_VSIZE_REG;                /*!< Offset 0x014 CSIC DMA Vertical Size Register */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t CSIC_DMA_F0_BUFA_REG;              /*!< Offset 0x020 CSIC DMA FIFO 0 Output Buffer-A Address Register */
    __IOM uint32_t CSIC_DMA_F0_BUFA_RESULT_REG;       /*!< Offset 0x024 CSIC DMA FIFO 0 Output Buffer-A Address Result Register */
    __IOM uint32_t CSIC_DMA_F1_BUFA_REG;              /*!< Offset 0x028 CSIC DMA FIFO 1 Output Buffer-A Address Register */
    __IOM uint32_t CSIC_DMA_F1_BUFA_RESULT_REG;       /*!< Offset 0x02C CSIC DMA FIFO 1 Output Buffer-A Address Result Register */
    __IOM uint32_t CSIC_DMA_F2_BUFA_REG;              /*!< Offset 0x030 CSIC DMA FIFO 2 Output Buffer-A Address Register */
    __IOM uint32_t CSIC_DMA_F2_BUFA_RESULT_REG;       /*!< Offset 0x034 CSIC DMA FIFO 2 Output Buffer-A Address Result Register */
    __IOM uint32_t CSIC_DMA_BUF_LEN_REG;              /*!< Offset 0x038 CSIC DMA Buffer Length Register */
    __IOM uint32_t CSIC_DMA_FLIP_SIZE_REG;            /*!< Offset 0x03C CSIC DMA Flip Size Register */
    __IOM uint32_t CSIC_DMA_VI_TO_TH0_REG;            /*!< Offset 0x040 CSIC DMA Video Input Timeout Threshold0 Register */
    __IOM uint32_t CSIC_DMA_VI_TO_TH1_REG;            /*!< Offset 0x044 CSIC DMA Video Input Timeout Threshold1 Register */
    __IOM uint32_t CSIC_DMA_VI_TO_CNT_VAL_REG;        /*!< Offset 0x048 CSIC DMA Video Input Timeout Counter Value Register */
    __IOM uint32_t CSIC_DMA_CAP_STA_REG;              /*!< Offset 0x04C CSIC DMA Capture Status Register */
    __IOM uint32_t CSIC_DMA_INT_EN_REG;               /*!< Offset 0x050 CSIC DMA Interrupt Enable Register */
    __IOM uint32_t CSIC_DMA_INT_STA_REG;              /*!< Offset 0x054 CSIC DMA Interrupt Status Register */
    __IOM uint32_t CSIC_DMA_LINE_CNT_REG;             /*!< Offset 0x058 CSIC DMA LINE Counter Register */
    __IOM uint32_t CSIC_DMA_FRM_CNT_REG;              /*!< Offset 0x05C CSIC DMA Frame Counter Register */
    __IOM uint32_t CSIC_DMA_FRM_CLK_CNT_REG;          /*!< Offset 0x060 CSIC DMA Frame Clock Counter Register */
    __IOM uint32_t CSIC_DMA_ACC_ITNL_CLK_CNT_REG;     /*!< Offset 0x064 CSIC DMA Accumulated And Internal Clock Counter Register */
    __IOM uint32_t CSIC_DMA_FIFO_STAT_REG;            /*!< Offset 0x068 CSIC DMA FIFO Statistic Register */
    __IOM uint32_t CSIC_DMA_FIFO_THRS_REG;            /*!< Offset 0x06C CSIC DMA FIFO Threshold Register */
    __IOM uint32_t CSIC_DMA_PCLK_STAT_REG;            /*!< Offset 0x070 CSIC DMA PCLK Statistic Register */
         RESERVED(0x074[0x0080 - 0x0074], uint8_t)
    __IOM uint32_t CSIC_DMA_BUF_ADDR_FIFO0_ENTRY_REG; /*!< Offset 0x080 CSIC DMA BUF Address FIFO0 Entry Register */
    __IOM uint32_t CSIC_DMA_BUF_ADDR_FIFO1_ENTRY_REG; /*!< Offset 0x084 CSIC DMA BUF Address FIFO1 Entry Register */
    __IOM uint32_t CSIC_DMA_BUF_ADDR_FIFO2_ENTRY_REG; /*!< Offset 0x088 CSIC DMA BUF Address FIFO2 Entry Register */
    __IOM uint32_t CSIC_DMA_BUF_TH_REG;               /*!< Offset 0x08C CSIC DMA BUF Threshold Register */
    __IOM uint32_t CSIC_DMA_BUF_ADDR_FIFO_CON_REG;    /*!< Offset 0x090 CSIC DMA BUF Address FIFO Content Register */
    __IOM uint32_t CSIC_DMA_STORED_FRM_CNT_REG;       /*!< Offset 0x094 CSIC DMA Stored Frame Counter Register */
         RESERVED(0x098[0x01F4 - 0x0098], uint8_t)
    __IOM uint32_t CSIC_FEATURE_REG;                  /*!< Offset 0x1F4 CSIC DMA Feature List Register */
...
{
    __IOM uint32_t PRS_EN_REG;                        /*!< Offset 0x000 Parser Enable Register */
    __IOM uint32_t PRS_NCSIC_IF_CFG_REG;              /*!< Offset 0x004 Parser NCSIC Interface Configuration Register */
         RESERVED(0x008[0x000C - 0x0008], uint8_t)
    __IOM uint32_t PRS_CAP_REG;                       /*!< Offset 0x00C Parser Capture Register */
    __IOM uint32_t CSIC_PRS_SIGNAL_STA_REG;           /*!< Offset 0x010 CSIC Parser Signal Status Register */
    __IOM uint32_t CSIC_PRS_NCSIC_BT656_HEAD_CFG_REG; /*!< Offset 0x014 CSIC Parser NCSIC BT656 Header Configuration Register */
         RESERVED(0x018[0x0024 - 0x0018], uint8_t)
    __IOM uint32_t PRS_C0_INFMT_REG;                  /*!< Offset 0x024 Parser Channel_0 Input Format Register */
    __IOM uint32_t PRS_C0_OUTPUT_HSIZE_REG;           /*!< Offset 0x028 Parser Channel_0 Output Horizontal Size Register */
    __IOM uint32_t PRS_C0_OUTPUT_VSIZE_REG;           /*!< Offset 0x02C Parser Channel_0 Output Vertical Size Register */
    __IOM uint32_t PRS_C0_INPUT_PARA0_REG;            /*!< Offset 0x030 Parser Channel_0 Input Parameter0 Register */
    __IOM uint32_t PRS_C0_INPUT_PARA1_REG;            /*!< Offset 0x034 Parser Channel_0 Input Parameter1 Register */
    __IOM uint32_t PRS_C0_INPUT_PARA2_REG;            /*!< Offset 0x038 Parser Channel_0 Input Parameter2 Register */
    __IOM uint32_t PRS_C0_INPUT_PARA3_REG;            /*!< Offset 0x03C Parser Channel_0 Input Parameter3 Register */
    __IOM uint32_t PRS_C0_INT_EN_REG;                 /*!< Offset 0x040 Parser Channel_0 Interrupt Enable Register */
    __IOM uint32_t PRS_C0_INT_STA_REG;                /*!< Offset 0x044 Parser Channel_0 Interrupt Status Register */
    __IOM uint32_t PRS_CH0_LINE_TIME_REG;             /*!< Offset 0x048 Parser Channel_0 Line Time Register */
         RESERVED(0x04C[0x0124 - 0x004C], uint8_t)
    __IOM uint32_t PRS_C1_INFMT_REG;                  /*!< Offset 0x124 Parser Channel_1 Input Format Register */
    __IOM uint32_t PRS_C1_OUTPUT_HSIZE_REG;           /*!< Offset 0x128 Parser Channel_1 Output Horizontal Size Register */
    __IOM uint32_t PRS_C1_OUTPUT_VSIZE_REG;           /*!< Offset 0x12C Parser Channel_1 Output Vertical Size Register */
    __IOM uint32_t PRS_C1_INPUT_PARA0_REG;            /*!< Offset 0x130 Parser Channel_1 Input Parameter0 Register */
    __IOM uint32_t PRS_C1_INPUT_PARA1_REG;            /*!< Offset 0x134 Parser Channel_1 Input Parameter1 Register */
    __IOM uint32_t PRS_C1_INPUT_PARA2_REG;            /*!< Offset 0x138 Parser Channel_1 Input Parameter2 Register */
    __IOM uint32_t PRS_C1_INPUT_PARA3_REG;            /*!< Offset 0x13C Parser Channel_1 Input Parameter3 Register */
    __IOM uint32_t PRS_C1_INT_EN_REG;                 /*!< Offset 0x140 Parser Channel_1 Interrupt Enable Register */
    __IOM uint32_t PRS_C1_INT_STA_REG;                /*!< Offset 0x144 Parser Channel_1 Interrupt Status Register */
    __IOM uint32_t PRS_CH1_LINE_TIME_REG;             /*!< Offset 0x148 Parser Channel_1 Line Time Register */
         RESERVED(0x14C[0x0224 - 0x014C], uint8_t)
    __IOM uint32_t PRS_C2_INFMT_REG;                  /*!< Offset 0x224 Parser Channel_2 Input Format Register */
    __IOM uint32_t PRS_C2_OUTPUT_HSIZE_REG;           /*!< Offset 0x228 Parser Channel_2 Output Horizontal Size Register */
    __IOM uint32_t PRS_C2_OUTPUT_VSIZE_REG;           /*!< Offset 0x22C Parser Channel_2 Output Vertical Size Register */
    __IOM uint32_t PRS_C2_INPUT_PARA0_REG;            /*!< Offset 0x230 Parser Channel_2 Input Parameter0 Register */
    __IOM uint32_t PRS_C2_INPUT_PARA1_REG;            /*!< Offset 0x234 Parser Channel_2 Input Parameter1 Register */
    __IOM uint32_t PRS_C2_INPUT_PARA2_REG;            /*!< Offset 0x238 Parser Channel_2 Input Parameter2 Register */
    __IOM uint32_t PRS_C2_INPUT_PARA3_REG;            /*!< Offset 0x23C Parser Channel_2 Input Parameter3 Register */
    __IOM uint32_t PRS_C2_INT_EN_REG;                 /*!< Offset 0x240 Parser Channel_2 Interrupt Enable Register */
    __IOM uint32_t PRS_C2_INT_STA_REG;                /*!< Offset 0x244 Parser Channel_2 Interrupt Status Register */
    __IOM uint32_t PRS_CH2_LINE_TIME_REG;             /*!< Offset 0x248 Parser Channel_2 Line Time Register */
         RESERVED(0x24C[0x0324 - 0x024C], uint8_t)
    __IOM uint32_t PRS_C3_INFMT_REG;                  /*!< Offset 0x324 Parser Channel_3 Input Format Register */
    __IOM uint32_t PRS_C3_OUTPUT_HSIZE_REG;           /*!< Offset 0x328 Parser Channel_3 Output Horizontal Size Register */
    __IOM uint32_t PRS_C3_OUTPUT_VSIZE_REG;           /*!< Offset 0x32C Parser Channel_3 Output Vertical Size Register */
    __IOM uint32_t PRS_C3_INPUT_PARA0_REG;            /*!< Offset 0x330 Parser Channel_3 Input Parameter0 Register */
    __IOM uint32_t PRS_C3_INPUT_PARA1_REG;            /*!< Offset 0x334 Parser Channel_3 Input Parameter1 Register */
    __IOM uint32_t PRS_C3_INPUT_PARA2_REG;            /*!< Offset 0x338 Parser Channel_3 Input Parameter2 Register */
    __IOM uint32_t PRS_C3_INPUT_PARA3_REG;            /*!< Offset 0x33C Parser Channel_3 Input Parameter3 Register */
    __IOM uint32_t PRS_C3_INT_EN_REG;                 /*!< Offset 0x340 Parser Channel_3 Interrupt Enable Register */
    __IOM uint32_t PRS_C3_INT_STA_REG;                /*!< Offset 0x344 Parser Channel_3 Interrupt Status Register */
    __IOM uint32_t PRS_CH3_LINE_TIME_REG;             /*!< Offset 0x348 Parser Channel_3 Line Time Register */
         RESERVED(0x34C[0x0500 - 0x034C], uint8_t)
    __IOM uint32_t CSIC_PRS_NCSIC_RX_SIGNAL0_DLY_ADJ_REG;/*!< Offset 0x500 CSIC Parser NCSIC RX Signal0 Delay Adjust Register */
         RESERVED(0x504[0x0514 - 0x0504], uint8_t)
    __IOM uint32_t CSIC_PRS_NCSIC_RX_SIGNAL5_DLY_ADJ_REG;/*!< Offset 0x514 CSIC Parser NCSIC RX Signal5 Delay Adjust Register */
    __IOM uint32_t CSIC_PRS_NCSIC_RX_SIGNAL6_DLY_ADJ_REG;/*!< Offset 0x518 CSIC Parser NCSIC RX Signal6 Delay Adjust Register */
...
{
    __IOM uint32_t CSIC_TOP_EN_REG;                   /*!< Offset 0x000 CSIC TOP Enable Register */
    __IOM uint32_t CSIC_PTN_GEN_EN_REG;               /*!< Offset 0x004 CSIC Pattern Generation Enable Register */
    __IOM uint32_t CSIC_PTN_CTRL_REG;                 /*!< Offset 0x008 CSIC Pattern Control Register */
         RESERVED(0x00C[0x0020 - 0x000C], uint8_t)
    __IOM uint32_t CSIC_PTN_LEN_REG;                  /*!< Offset 0x020 CSIC Pattern Generation Length Register */
    __IOM uint32_t CSIC_PTN_ADDR_REG;                 /*!< Offset 0x024 CSIC Pattern Generation Address Register */
    __IOM uint32_t CSIC_PTN_ISP_SIZE_REG;             /*!< Offset 0x028 CSIC Pattern ISP Size Register */
         RESERVED(0x02C[0x00A0 - 0x002C], uint8_t)
    __IOM uint32_t CSIC_DMA0_INPUT_SEL_REG;           /*!< Offset 0x0A0 CSIC DMA0 Input Select Register */
    __IOM uint32_t CSIC_DMA1_INPUT_SEL_REG;           /*!< Offset 0x0A4 CSIC DMA1 Input Select Register */
         RESERVED(0x0A8[0x00DC - 0x00A8], uint8_t)
    __IOM uint32_t CSIC_BIST_CS_REG;                  /*!< Offset 0x0DC CSIC BIST CS Register */
    __IOM uint32_t CSIC_BIST_CONTROL_REG;             /*!< Offset 0x0E0 CSIC BIST Control Register */
    __IOM uint32_t CSIC_BIST_START_REG;               /*!< Offset 0x0E4 CSIC BIST Start Register */
    __IOM uint32_t CSIC_BIST_END_REG;                 /*!< Offset 0x0E8 CSIC BIST End Register */
    __IOM uint32_t CSIC_BIST_DATA_MASK_REG;           /*!< Offset 0x0EC CSIC BIST Data Mask Register */
    __IOM uint32_t CSIC_MBUS_REQ_MAX_REG;             /*!< Offset 0x0F0 CSIC MBUS REQ MAX Register */
         RESERVED(0x0F4[0x0100 - 0x00F4], uint8_t)
    __IOM uint32_t CSIC_MULF_MOD_REG;                 /*!< Offset 0x100 CSIC Multi-Frame Mode Register */
    __IOM uint32_t CSIC_MULF_INT_REG;                 /*!< Offset 0x104 CSIC Multi-Frame Interrupt Register */
...
typedef struct DE_BLD_Type
{
    ...
    __IOM uint32_t BLD_MODE [0x006];                  /*!< Offset 0x090 BLD_CTL SUN8I_MIXER_BLEND_MODE */
...
typedef struct DE_DEP_Type
{
    struct
    {
        __IOM uint32_t CFG;                           /*!< Offset 0x000  */
...
{
    __IOM uint32_t GATE_CFG;                          /*!< Offset 0x000 SCLK_GATE DE SCLK Gating Register */
    __IOM uint32_t BUS_CFG;                           /*!< Offset 0x004 ? HCLK_GATE ? DE HCLK Gating Register */
    __IOM uint32_t RST_CFG;                           /*!< Offset 0x008 AHB_RESET DE AHB Reset register */
    __IOM uint32_t DIV_CFG;                           /*!< Offset 0x00C SCLK_DIV DE SCLK Division register */
    __IOM uint32_t SEL_CFG;                           /*!< Offset 0x010 ? DE2TCON ? MUX register - lower bit swap DE outputs */
         RESERVED(0x014[0x0024 - 0x0014], uint8_t)
    __IOM uint32_t DE_IP_CFG;                         /*!< Offset 0x024 DE IP Configure Register */
...
typedef struct DE_VEP_Type
{
    ...
    struct
    {
        __IOM uint32_t CFG;                           /*!< Offset 0x800  */
             RESERVED(0x004[0x0800 - 0x0004], uint8_t)
    } PEAK [0x001];                                   /*!< Offset 0x800  */
    struct
    {
        __IOM uint32_t CFG;                           /*!< Offset 0x1000  */
             RESERVED(0x004[0x0800 - 0x0004], uint8_t)
    } LCTI [0x001];                                   /*!< Offset 0x1000  */
    struct
    {
        __IOM uint32_t CFG;                           /*!< Offset 0x1800  */
             RESERVED(0x004[0x0800 - 0x0004], uint8_t)
    } BLS [0x001];                                    /*!< Offset 0x1800  */
    struct
    {
        __IOM uint32_t CFG;                           /*!< Offset 0x2000  */
             RESERVED(0x004[0x0800 - 0x0004], uint8_t)
    } FCC [0x001];                                    /*!< Offset 0x2000  */
         RESERVED(0x2800[0x7000 - 0x2800], uint8_t)
    struct
    {
        __IOM uint32_t CFG;                           /*!< Offset 0x7000  */
...
{
    __IOM uint32_t TV_CLK_SRC_RGB_SRC;                /*!< Offset 0x000 tcon_tv_setup TCON_TV Clock Select and RGB Source Select Register */
    __IOM uint32_t dsi_src_select;                    /*!< Offset 0x004 dsi_src_select bit 4: dsi1_src_sel bit 0: dsi0_src_sel */
         RESERVED(0x008[0x001C - 0x0008], uint8_t)
    __IOM uint32_t DE_PORT_PERH_SEL;                  /*!< Offset 0x01C DE Source Select TCON R Register */
    __IOM uint32_t MODULE_GATING;                     /*!< Offset 0x020 TCON Output to LVDS/DSI/TVE/HDMI Gating Register */
...
{
    __IOM uint32_t DMAC_IRQ_EN_REG0;                  /*!< Offset 0x000 DMAC IRQ Enable Register 0 */
    __IOM uint32_t DMAC_IRQ_EN_REG1;                  /*!< Offset 0x004 DMAC IRQ Enable Register 1 */
         RESERVED(0x008[0x0010 - 0x0008], uint8_t)
    __IOM uint32_t DMAC_IRQ_PEND_REG0;                /*!< Offset 0x010 DMAC IRQ Pending Register 0 */
    __IOM uint32_t DMAC_IRQ_PEND_REG1;                /*!< Offset 0x014 DMAC IRQ Pending Register 1 */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
...
{
    __IOM uint32_t DSI_CTL_REG;                       /*!< Offset 0x000 dsi_gctl 0x00 - 0x0c */
    __IOM uint32_t DSI_GINT0_REG;                     /*!< Offset 0x004 dsi_gint0  */
    __IOM uint32_t DSI_GINT1_REG;                     /*!< Offset 0x008 dsi_gint1  */
    __IOM uint32_t DSI_BASIC_CTL_REG;                 /*!< Offset 0x00C dsi_basic_ctl  */
    __IOM uint32_t DSI_BASIC_CTL0_REG;                /*!< Offset 0x010 dsi_basic_ctl0 0x10 - 0x1c */
    __IOM uint32_t DSI_BASIC_CTL1_REG;                /*!< Offset 0x014 dsi_basic_ctl1  */
    __IOM uint32_t DSI_BASIC_SIZE0_REG;               /*!< Offset 0x018 dsi_basic_size0  */
    __IOM uint32_t DSI_BASIC_SIZE1_REG;               /*!< Offset 0x01C dsi_basic_size1  */
    __IOM uint32_t DSI_BASIC_INST0_REG [0x008];       /*!< Offset 0x020 dsi_inst_func[8] 0x20 - 0x3c */
    __IOM uint32_t DSI_INST_LOOP_SEL_REG;             /*!< Offset 0x040 dsi_inst_loop_sel 0x40 - 0x5c */
    __IOM uint32_t DSI_INST_LOOP_NUM_REG;             /*!< Offset 0x044 dsi_inst_loop_num  */
    __IOM uint32_t DSI_INST_JUMP_SEL_REG;             /*!< Offset 0x048 dsi_inst_jump_sel  */
    __IOM uint32_t DSI_INST_JUMP_CFG_REG [0x002];     /*!< Offset 0x04C dsi_inst_jump_cfg[2]  */
    __IOM uint32_t DSI_INST_LOOP_NUM2_REG;            /*!< Offset 0x054 dsi_inst_loop_num2  */
         RESERVED(0x058[0x0060 - 0x0058], uint8_t)
    __IOM uint32_t DSI_TRANS_START_REG;               /*!< Offset 0x060 dsi_trans_start 0x60 - 0x6c */
         RESERVED(0x064[0x0078 - 0x0064], uint8_t)
    __IOM uint32_t DSI_TRANS_ZERO_REG;                /*!< Offset 0x078 dsi_trans_zero  */
    __IOM uint32_t DSI_TCON_DRQ_REG;                  /*!< Offset 0x07C dsi_tcon_drq  */
    __IOM uint32_t DSI_PIXEL_CTL0_REG;                /*!< Offset 0x080 dsi_pixel_ctl0 0x80 - 0x8c */
    __IOM uint32_t DSI_PIXEL_CTL1_REG;                /*!< Offset 0x084 dsi_pixel_ctl1  */
         RESERVED(0x088[0x0090 - 0x0088], uint8_t)
    __IOM uint32_t DSI_PIXEL_PH_REG;                  /*!< Offset 0x090 dsi_pixel_ph 0x90 - 0x9c */
    __IOM uint32_t DSI_PIXEL_PD_REG;                  /*!< Offset 0x094 dsi_pixel_pd  */
    __IOM uint32_t DSI_PIXEL_PF0_REG;                 /*!< Offset 0x098 dsi_pixel_pf0  */
    __IOM uint32_t DSI_PIXEL_PF1_REG;                 /*!< Offset 0x09C dsi_pixel_pf1  */
         RESERVED(0x0A0[0x00B0 - 0x00A0], uint8_t)
    __IOM uint32_t DSI_SYNC_HSS_REG;                  /*!< Offset 0x0B0 dsi_sync_hss 0xb0 - 0xbc */
    __IOM uint32_t DSI_SYNC_HSE_REG;                  /*!< Offset 0x0B4 dsi_sync_hse  */
    __IOM uint32_t DSI_SYNC_VSS_REG;                  /*!< Offset 0x0B8 dsi_sync_vss  */
    __IOM uint32_t DSI_SYNC_VSE_REG;                  /*!< Offset 0x0BC dsi_sync_vse  */
    __IOM uint32_t DSI_BLK_HSA0_REG;                  /*!< Offset 0x0C0 dsi_blk_hsa0 0xc0 - 0xcc */
    __IOM uint32_t DSI_BLK_HSA1_REG;                  /*!< Offset 0x0C4 dsi_blk_hsa1  */
    __IOM uint32_t DSI_BLK_HBP0_REG;                  /*!< Offset 0x0C8 dsi_blk_hbp0  */
    __IOM uint32_t DSI_BLK_HBP1_REG;                  /*!< Offset 0x0CC dsi_blk_hbp1  */
    __IOM uint32_t DSI_BLK_HFP0_REG;                  /*!< Offset 0x0D0 dsi_blk_hfp0 0xd0 - 0xdc */
    __IOM uint32_t DSI_BLK_HFP1_REG;                  /*!< Offset 0x0D4 dsi_blk_hfp1  */
         RESERVED(0x0D8[0x00E0 - 0x00D8], uint8_t)
    __IOM uint32_t DSI_BLK_HBLK0_REG;                 /*!< Offset 0x0E0 dsi_blk_hblk0 0xe0 - 0xec */
    __IOM uint32_t DSI_BLK_HBLK1_REG;                 /*!< Offset 0x0E4 dsi_blk_hblk1  */
    __IOM uint32_t DSI_BLK_VBLK0_REG;                 /*!< Offset 0x0E8 dsi_blk_vblk0  */
    __IOM uint32_t DSI_BLK_VBLK1_REG;                 /*!< Offset 0x0EC dsi_blk_vblk1  */
    __IOM uint32_t DSI_BURST_LINE_REG;                /*!< Offset 0x0F0 dsi_burst_line 0xf0 - 0x1fc */
    __IOM uint32_t DSI_BURST_DRQ_REG;                 /*!< Offset 0x0F4 dsi_burst_drq  */
         RESERVED(0x0F8[0x0200 - 0x00F8], uint8_t)
    __IOM uint32_t DSI_CMD_CTL_REG;                   /*!< Offset 0x200 dsi_cmd_ctl 0x200 - 0x23c */
         RESERVED(0x204[0x0240 - 0x0204], uint8_t)
    __IOM uint32_t DSI_CMD_RX_REG [0x008];            /*!< Offset 0x240 dsi_cmd_rx[8] 0x240 - 0x2dc */
         RESERVED(0x260[0x02E0 - 0x0260], uint8_t)
    __IOM uint32_t DSI_DEBUG_VIDEO0_REG;              /*!< Offset 0x2E0 dsi_debug_video0 0x2e0 - 0x2ec */
    __IOM uint32_t DSI_DEBUG_VIDEO1_REG;              /*!< Offset 0x2E4 dsi_debug_video1  */
         RESERVED(0x2E8[0x02F0 - 0x02E8], uint8_t)
    __IOM uint32_t DSI_DEBUG_INST_REG;                /*!< Offset 0x2F0 dsi_debug_inst 0x2f0 - 0x2fc */
    __IOM uint32_t DSI_DEBUG_FIFO_REG;                /*!< Offset 0x2F4 dsi_debug_fifo  */
    __IOM uint32_t DSI_DEBUG_DATA_REG;                /*!< Offset 0x2F8 dsi_debug_data  */
         RESERVED(0x2FC[0x0300 - 0x02FC], uint8_t)
    __IOM uint32_t DSI_CMD_TX_REG [0x040];            /*!< Offset 0x300 dsi_cmd_tx[64] 0x300 - 0x3fc */
...
{
    __IOM uint32_t DPHY_GCTL_REG;                     /*!< Offset 0x000  */
    __IOM uint32_t DPHY_TX_CTL_REG;                   /*!< Offset 0x004  */
    __IOM uint32_t DPHY_RX_CTL_REG;                   /*!< Offset 0x008  */
         RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
    __IOM uint32_t DPHY_TX_TIME0_REG;                 /*!< Offset 0x010  */
    __IOM uint32_t DPHY_TX_TIME1_REG;                 /*!< Offset 0x014  */
    __IOM uint32_t DPHY_TX_TIME2_REG;                 /*!< Offset 0x018  */
    __IOM uint32_t DPHY_TX_TIME3_REG;                 /*!< Offset 0x01C  */
    __IOM uint32_t DPHY_TX_TIME4_REG;                 /*!< Offset 0x020  */
         RESERVED(0x024[0x0030 - 0x0024], uint8_t)
    __IOM uint32_t DPHY_RX_TIME0_REG;                 /*!< Offset 0x030  */
    __IOM uint32_t DPHY_RX_TIME1_REG;                 /*!< Offset 0x034  */
    __IOM uint32_t DPHY_RX_TIME2_REG;                 /*!< Offset 0x038  */
         RESERVED(0x03C[0x0040 - 0x003C], uint8_t)
    __IOM uint32_t DPHY_RX_TIME3_REG;                 /*!< Offset 0x040  */
         RESERVED(0x044[0x004C - 0x0044], uint8_t)
    __IOM uint32_t DPHY_ANA0_REG;                     /*!< Offset 0x04C  */
    __IOM uint32_t DPHY_ANA1_REG;                     /*!< Offset 0x050  */
    __IOM uint32_t DPHY_ANA2_REG;                     /*!< Offset 0x054  */
    __IOM uint32_t DPHY_ANA3_REG;                     /*!< Offset 0x058  */
    __IOM uint32_t DPHY_ANA4_REG;                     /*!< Offset 0x05C  */
    __IOM uint32_t DPHY_INT_EN0_REG;                  /*!< Offset 0x060  */
    __IOM uint32_t DPHY_INT_EN1_REG;                  /*!< Offset 0x064  */
    __IOM uint32_t DPHY_INT_EN2_REG;                  /*!< Offset 0x068  */
         RESERVED(0x06C[0x0070 - 0x006C], uint8_t)
    __IOM uint32_t DPHY_INT_PD0_REG;                  /*!< Offset 0x070  */
    __IOM uint32_t DPHY_INT_PD1_REG;                  /*!< Offset 0x074  */
    __IOM uint32_t DPHY_INT_PD2_REG;                  /*!< Offset 0x078  */
         RESERVED(0x07C[0x00E0 - 0x007C], uint8_t)
    __IOM uint32_t DPHY_DBG0_REG;                     /*!< Offset 0x0E0  */
    __IOM uint32_t DPHY_DBG1_REG;                     /*!< Offset 0x0E4  */
    __IOM uint32_t DPHY_DBG2_REG;                     /*!< Offset 0x0E8  */
    __IOM uint32_t DPHY_DBG3_REG;                     /*!< Offset 0x0EC  */
    __IOM uint32_t DPHY_DBG4_REG;                     /*!< Offset 0x0F0  */
    __IOM uint32_t DPHY_DBG5_REG;                     /*!< Offset 0x0F4  */
    __IOM uint32_t DPHY_TX_SKEW_REG0;                 /*!< Offset 0x0F8  */
    __IOM uint32_t DPHY_TX_SKEW_REG1;                 /*!< Offset 0x0FC  */
    __IOM uint32_t DPHY_TX_SKEW_REG2;                 /*!< Offset 0x100  */
    __IOM uint32_t DPHY_PLL_REG0;                     /*!< Offset 0x104  */
    __IOM uint32_t DPHY_PLL_REG1;                     /*!< Offset 0x108  */
    __IOM uint32_t DPHY_PLL_REG2;                     /*!< Offset 0x10C  */
    __IOM uint32_t COMBO_PHY_REG0;                    /*!< Offset 0x110 The TCON LCD0 PHY0 is controlled by COMBO_PHY_REG (reg0x1110, reg0x1114) */
    __IOM uint32_t COMBO_PHY_REG1;                    /*!< Offset 0x114 The TCON LCD0 PHY0 is controlled by COMBO_PHY_REG (reg0x1110, reg0x1114) */
    __IOM uint32_t COMBO_PHY_REG2;                    /*!< Offset 0x118  */
...
{
    __IOM uint32_t DSP_ALT_RESET_VEC_REG;             /*!< Offset 0x000 DSP Reset Control Register */
    __IOM uint32_t DSP_CTRL_REG0;                     /*!< Offset 0x004 DSP Control Register0 */
         RESERVED(0x008[0x000C - 0x0008], uint8_t)
    __IOM uint32_t DSP_PRID_REG;                      /*!< Offset 0x00C DSP PRID Register */
    __IOM uint32_t DSP_STAT_REG;                      /*!< Offset 0x010 DSP STAT Register */
    __IOM uint32_t DSP_BIST_CTRL_REG;                 /*!< Offset 0x014 DSP BIST CTRL Register */
         RESERVED(0x018[0x001C - 0x0018], uint8_t)
    __IOM uint32_t DSP_JTRST_REG;                     /*!< Offset 0x01C DSP JTAG CONFIG RESET Register */
    __IOM uint32_t DSP_VER_REG;                       /*!< Offset 0x020 DSP Version Register */
...
{
    __IOM uint32_t VECTOR;                            /*!< Offset 0x000  */
    __IOM uint32_t BASE_ADDR;                         /*!< Offset 0x004  */
         RESERVED(0x008[0x000C - 0x0008], uint8_t)
    __IOM uint32_t CONTROL;                           /*!< Offset 0x00C  */
         RESERVED(0x010[0x0014 - 0x0010], uint8_t)
    __IOM uint32_t PENDING [0x003];                   /*!< Offset 0x014  */
         RESERVED(0x020[0x0040 - 0x0020], uint8_t)
    __IOM uint32_t ENABLE [0x003];                    /*!< Offset 0x040  */
         RESERVED(0x04C[0x0050 - 0x004C], uint8_t)
    __IOM uint32_t MASK [0x003];                      /*!< Offset 0x050  */
         RESERVED(0x05C[0x0070 - 0x005C], uint8_t)
    __IOM uint32_t FAST_FORCING;                      /*!< Offset 0x070  */
         RESERVED(0x074[0x0080 - 0x0074], uint8_t)
    __IOM uint32_t PRIORITY [0x002];                  /*!< Offset 0x080  */
         RESERVED(0x088[0x00C0 - 0x0088], uint8_t)
    __IOM uint32_t GROUP_CONFIG [0x004];              /*!< Offset 0x0C0  */
...
typedef struct GPIOBLOCK_Type
{
    ...
    __IOM uint32_t PIO_POW_MOD_SEL;                   /*!< Offset 0x340 PIO Group Withstand Voltage Mode Select Register */
    __IOM uint32_t PIO_POW_MS_CTL;                    /*!< Offset 0x344 PIO Group Withstand Voltage Mode Select Control Register */
    __IOM uint32_t PIO_POW_VAL;                       /*!< Offset 0x348 PIO Group Power Value Register */
...
{
    __IOM uint32_t DBG_CTRL;                          /*!< Offset 0x000 DBG_CTRL */
    __IOM uint32_t REXT_CTRL;                         /*!< Offset 0x004 REXT_CTRL */
         RESERVED(0x008[0x0010 - 0x0008], uint8_t)
    __IOM uint32_t READ_EN;                           /*!< Offset 0x010 READ_EN */
    __IOM uint32_t UNSCRAMBLE;                        /*!< Offset 0x014 UNSCRAMBLE */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t ANA_CFG1;                          /*!< Offset 0x020 ANA_CFG1 */
    __IOM uint32_t ANA_CFG2;                          /*!< Offset 0x024 ANA_CFG2 */
    __IOM uint32_t ANA_CFG3;                          /*!< Offset 0x028 ANA_CFG3 */
    __IOM uint32_t PLL_CFG1;                          /*!< Offset 0x02C ANA_CFG1 */
    __IOM uint32_t PLL_CFG2;                          /*!< Offset 0x030 PLL_CFG2 */
    __IOM uint32_t PLL_CFG3;                          /*!< Offset 0x034 PLL_CFG3 */
    __IOM uint32_t ANA_STS;                           /*!< Offset 0x038 ANA_STS */
    __IOM uint32_t CEC;                               /*!< Offset 0x03C CEC */
...
typedef struct I2S_PCM_Type
{
    ...
    __IOM uint32_t ASRCCFG;                           /*!< Offset 0x08C ASRC Enable Register */
...
{
    __IOM uint32_t LEDC_CTRL_REG;                     /*!< Offset 0x000 LEDC Control Register */
    __IOM uint32_t LED_T01_TIMING_CTRL_REG;           /*!< Offset 0x004 LEDC T0 & T1 Timing Control Register */
    __IOM uint32_t LEDC_DATA_FINISH_CNT_REG;          /*!< Offset 0x008 LEDC Data Finish Counter Register */
    __IOM uint32_t LED_RESET_TIMING_CTRL_REG;         /*!< Offset 0x00C LEDC Reset Timing Control Register */
    __IOM uint32_t LEDC_WAIT_TIME0_CTRL_REG;          /*!< Offset 0x010 LEDC Wait Time0 Control Register */
    __IOM uint32_t LEDC_DATA_REG;                     /*!< Offset 0x014 LEDC Data Register */
    __IOM uint32_t LEDC_DMA_CTRL_REG;                 /*!< Offset 0x018 LEDC DMA Control Register */
    __IOM uint32_t LEDC_INT_CTRL_REG;                 /*!< Offset 0x01C LEDC Interrupt Control Register */
    __IOM uint32_t LEDC_INT_STS_REG;                  /*!< Offset 0x020 LEDC Interrupt Status Register */
         RESERVED(0x024[0x0028 - 0x0024], uint8_t)
    __IOM uint32_t LEDC_WAIT_TIME1_CTRL_REG;          /*!< Offset 0x028 LEDC Wait Time1 Control Register */
         RESERVED(0x02C[0x0030 - 0x002C], uint8_t)
    __IOM uint32_t LEDC_FIFO_DATA_REG [0x020];        /*!< Offset 0x030 LEDC FIFO Data Registers array */
...
{
    __IOM uint32_t MCTL_COM_WORK_MODE0;               /*!< Offset 0x000 Reg_000 */
    __IOM uint32_t MCTL_COM_WORK_MODE1;               /*!< Offset 0x004 Reg_004 */
    __IOM uint32_t MCTL_COM_DBGCR;                    /*!< Offset 0x008 Reg_008 */
    __IOM uint32_t MCTL_COM_TMR;                      /*!< Offset 0x00C Reg_00C */
         RESERVED(0x010[0x0014 - 0x0010], uint8_t)
    __IOM uint32_t MCTL_COM_CCCR;                     /*!< Offset 0x014 Reg_014 */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t MCTL_COM_MAER0;                    /*!< Offset 0x020 Reg_020 */
    __IOM uint32_t MCTL_COM_MAER1;                    /*!< Offset 0x024 Reg_024 */
    __IOM uint32_t MCTL_COM_MAER2;                    /*!< Offset 0x028 Reg_028 */
         RESERVED(0x02C[0x0500 - 0x002C], uint8_t)
    __IOM uint32_t MCTL_COM_REMAP0;                   /*!< Offset 0x500 REMAP0 */
    __IOM uint32_t MCTL_COM_REMAP1;                   /*!< Offset 0x504 REMAP1 */
    __IOM uint32_t MCTL_COM_REMAP2;                   /*!< Offset 0x508 REMAP2 */
    __IOM uint32_t MCTL_COM_REMAP3;                   /*!< Offset 0x50C REMAP3 */
...
{
    __IOM uint32_t MCTL_PHY_PIR;                      /*!< Offset 0x000  */
    __IOM uint32_t MCTL_PHY_PWRCTL;                   /*!< Offset 0x004  */
    __IOM uint32_t MCTL_PHY_MRCTRL0;                  /*!< Offset 0x008  */
    __IOM uint32_t MCTL_PHY_CLKEN;                    /*!< Offset 0x00C  */
    __IOM uint32_t MCTL_PHY_PGSR0;                    /*!< Offset 0x010  */
    __IOM uint32_t MCTL_PHY_PGSR1;                    /*!< Offset 0x014  */
    __IOM uint32_t MCTL_PHY_STATR;                    /*!< Offset 0x018  */
         RESERVED(0x01C[0x002C - 0x001C], uint8_t)
    __IOM uint32_t MCTL_PHY_LP3MR11;                  /*!< Offset 0x02C  */
    __IOM uint32_t MCTL_PHY_DRAM_MR0;                 /*!< Offset 0x030  */
    __IOM uint32_t MCTL_PHY_DRAM_MR1;                 /*!< Offset 0x034  */
    __IOM uint32_t MCTL_PHY_DRAM_MR2;                 /*!< Offset 0x038  */
    __IOM uint32_t MCTL_PHY_DRAM_MR3;                 /*!< Offset 0x03C  */
         RESERVED(0x040[0x0044 - 0x0040], uint8_t)
    __IOM uint32_t MCTL_PHY_PTR0;                     /*!< Offset 0x044  */
         RESERVED(0x048[0x004C - 0x0048], uint8_t)
    __IOM uint32_t MCTL_PHY_PTR2;                     /*!< Offset 0x04C  */
    __IOM uint32_t MCTL_PHY_PTR3;                     /*!< Offset 0x050  */
    __IOM uint32_t MCTL_PHY_PTR4;                     /*!< Offset 0x054  */
    __IOM uint32_t MCTL_PHY_DRAMTMG0;                 /*!< Offset 0x058  */
    __IOM uint32_t MCTL_PHY_DRAMTMG1;                 /*!< Offset 0x05C  */
    __IOM uint32_t MCTL_PHY_DRAMTMG2;                 /*!< Offset 0x060  */
    __IOM uint32_t MCTL_PHY_DRAMTMG3;                 /*!< Offset 0x064  */
    __IOM uint32_t MCTL_PHY_DRAMTMG4;                 /*!< Offset 0x068  */
    __IOM uint32_t MCTL_PHY_DRAMTMG5;                 /*!< Offset 0x06C  */
    __IOM uint32_t MCTL_PHY_DRAMTMG6;                 /*!< Offset 0x070  */
    __IOM uint32_t MCTL_PHY_DRAMTMG7;                 /*!< Offset 0x074  */
    __IOM uint32_t MCTL_PHY_DRAMTMG8;                 /*!< Offset 0x078  */
    __IOM uint32_t MCTL_PHY_ODTCFG;                   /*!< Offset 0x07C  */
    __IOM uint32_t MCTL_PHY_PITMG0;                   /*!< Offset 0x080  */
    __IOM uint32_t MCTL_PHY_PITMG1;                   /*!< Offset 0x084  */
    __IOM uint32_t MCTL_PHY_LPTPR;                    /*!< Offset 0x088  */
    __IOM uint32_t MCTL_PHY_RFSHCTL0;                 /*!< Offset 0x08C  */
    __IOM uint32_t MCTL_PHY_RFSHTMG;                  /*!< Offset 0x090  */
    __IOM uint32_t MCTL_PHY_RFSHCTL1;                 /*!< Offset 0x094  */
    __IOM uint32_t MCTL_PHY_PWRTMG;                   /*!< Offset 0x098  */
    __IOM uint32_t MCTL_PHY_ASRC;                     /*!< Offset 0x09C  */
    __IOM uint32_t MCTL_PHY_ASRTC;                    /*!< Offset 0x0A0  */
         RESERVED(0x0A4[0x00B8 - 0x00A4], uint8_t)
    __IOM uint32_t MCTL_PHY_VTFCR;                    /*!< Offset 0x0B8  */
    __IOM uint32_t MCTL_PHY_DQSGMR;                   /*!< Offset 0x0BC  */
    __IOM uint32_t MCTL_PHY_DTCR;                     /*!< Offset 0x0C0  */
    __IOM uint32_t MCTL_PHY_DTAR0;                    /*!< Offset 0x0C4  */
         RESERVED(0x0C8[0x0100 - 0x00C8], uint8_t)
    __IOM uint32_t MCTL_PHY_PGCR0;                    /*!< Offset 0x100  */
    __IOM uint32_t MCTL_PHY_PGCR1;                    /*!< Offset 0x104  */
    __IOM uint32_t MCTL_PHY_PGCR2;                    /*!< Offset 0x108  */
    __IOM uint32_t MCTL_PHY_PGCR3;                    /*!< Offset 0x10C  */
    __IOM uint32_t MCTL_PHY_IOVCR0;                   /*!< Offset 0x110  */
    __IOM uint32_t MCTL_PHY_IOVCR1;                   /*!< Offset 0x114  */
         RESERVED(0x118[0x011C - 0x0118], uint8_t)
    __IOM uint32_t MCTL_PHY_DXCCR;                    /*!< Offset 0x11C  */
    __IOM uint32_t MCTL_PHY_ODTMAP;                   /*!< Offset 0x120  */
    __IOM uint32_t MCTL_PHY_ZQCTL0;                   /*!< Offset 0x124  */
    __IOM uint32_t MCTL_PHY_ZQCTL1;                   /*!< Offset 0x128  */
         RESERVED(0x12C[0x0140 - 0x012C], uint8_t)
    __IOM uint32_t MCTL_PHY_ZQCR;                     /*!< Offset 0x140  */
    __IOM uint32_t MCTL_PHY_ZQSR;                     /*!< Offset 0x144  */
    __IOM uint32_t MCTL_PHY_ZQDR0;                    /*!< Offset 0x148  */
    __IOM uint32_t MCTL_PHY_ZQDR1;                    /*!< Offset 0x14C  */
    __IOM uint32_t MCTL_PHY_ZQDR2;                    /*!< Offset 0x150  */
         RESERVED(0x154[0x01C0 - 0x0154], uint8_t)
    __IOM uint32_t MCTL_PHY_SCHED;                    /*!< Offset 0x1C0  */
    __IOM uint32_t MCTL_PHY_PERFHPR0;                 /*!< Offset 0x1C4  */
    __IOM uint32_t MCTL_PHY_PERFHPR1;                 /*!< Offset 0x1C8  */
    __IOM uint32_t MCTL_PHY_PERFLPR0;                 /*!< Offset 0x1CC  */
    __IOM uint32_t MCTL_PHY_PERFLPR1;                 /*!< Offset 0x1D0  */
    __IOM uint32_t MCTL_PHY_PERFWR0;                  /*!< Offset 0x1D4  */
    __IOM uint32_t MCTL_PHY_PERFWR1;                  /*!< Offset 0x1D8  */
         RESERVED(0x1DC[0x0200 - 0x01DC], uint8_t)
    __IOM uint32_t MCTL_PHY_ACMDLR;                   /*!< Offset 0x200  */
    __IOM uint32_t MCTL_PHY_ACLDLR;                   /*!< Offset 0x204  */
    __IOM uint32_t MCTL_PHY_ACIOCR0;                  /*!< Offset 0x208  */
...
typedef struct RISC_CFG_Type
{
    ...
    __IOM uint32_t RISC_STA_ADD0_REG;                 /*!< Offset 0x004 RISC Start Address0 Register */
    __IOM uint32_t RISC_STA_ADD1_REG;                 /*!< Offset 0x008 RISC Start Address1 Register */
         RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
    __IOM uint32_t RF1P_CFG_REG;                      /*!< Offset 0x010 RF1P Configuration Register */
         RESERVED(0x014[0x001C - 0x0014], uint8_t)
    __IOM uint32_t ROM_CFG_REG;                       /*!< Offset 0x01C ROM Configuration Register */
    __IOM uint32_t WAKEUP_EN_REG;                     /*!< Offset 0x020 Wakeup Enable Register */
    __IOM uint32_t WAKEUP_MASK_REG [0x005];           /*!< Offset 0x024 Wakeup Mask0..Mask4 Register */
         RESERVED(0x038[0x0040 - 0x0038], uint8_t)
    __IOM uint32_t TS_TMODE_SEL_REG;                  /*!< Offset 0x040 Timestamp Test Mode Select Register */
    __IOM uint32_t SRAM_ADDR_TWIST_REG;               /*!< Offset 0x044 SRAM Address Twist Register */
    __IOM uint32_t WORK_MODE_REG;                     /*!< Offset 0x048 Work Mode Register */
         RESERVED(0x04C[0x0050 - 0x004C], uint8_t)
    __IOM uint32_t RETITE_PC0_REG;                    /*!< Offset 0x050 Retire PC0 Register */
    __IOM uint32_t RETITE_PC1_REG;                    /*!< Offset 0x054 Retire PC1 Register */
         RESERVED(0x058[0x0060 - 0x0058], uint8_t)
    __IOM uint32_t IRQ_MODE_REG [0x005];              /*!< Offset 0x060 IRQ Mode0..Mode4 Register */
         RESERVED(0x074[0x0104 - 0x0074], uint8_t)
    __IOM uint32_t RISC_AXI_PMU_CTRL;                 /*!< Offset 0x104 RISC AXI PMU Control Register */
    __IOM uint32_t RISC_AXI_PMU_PRD;                  /*!< Offset 0x108 RISC AXI PMU Period Register */
    __IOM uint32_t RISC_AXI_PMU_LAT_RD;               /*!< Offset 0x10C RISC AXI PMU Read Latency Register */
    __IOM uint32_t RISC_AXI_PMU_LAT_WR;               /*!< Offset 0x110 RISC AXI PMU Write Latency Register */
    __IOM uint32_t RISC_AXI_PMU_REQ_RD;               /*!< Offset 0x114 RISC AXI PMU Read Request Register */
    __IOM uint32_t RISC_AXI_PMU_REQ_WR;               /*!< Offset 0x118 RISC AXI PMU Write Request Register */
    __IOM uint32_t RISC_AXI_PMU_BW_RD;                /*!< Offset 0x11C RISC AXI PMU Read Bandwidth Register */
    __IOM uint32_t RISC_AXI_PMU_BW_WR;                /*!< Offset 0x120 RISC AXI PMU Write Bandwidth Register */
...
typedef struct RTC_Type
{
    ...
    __IOM uint32_t LOSC_AUTO_SWT_STA_REG;             /*!< Offset 0x004 Low Oscillator Auto Switch Status Register */
    __IOM uint32_t INTOSC_CLK_PRESCAL_REG;            /*!< Offset 0x008 Internal OSC Clock Pre-scaler Register */
         RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
    ...
    __IOM uint32_t RTC_HH_MM_SS_REG;                  /*!< Offset 0x014 RTC Hour-Minute-Second Register */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t ALARM0_DAY_SET_REG;                /*!< Offset 0x020 Alarm 0 Day Setting Register */
    ...
    __IOM uint32_t ALARM_CONFIG_REG;                  /*!< Offset 0x050 Alarm Configuration Register */
         RESERVED(0x054[0x0060 - 0x0054], uint8_t)
    __IOM uint32_t F32K_FOUT_CTRL_GATING_REG;         /*!< Offset 0x060 32K Fanout Control Gating Register */
         RESERVED(0x064[0x0100 - 0x0064], uint8_t)
    __IOM uint32_t GP_DATA_REG [0x008];               /*!< Offset 0x100 General Purpose Register (N=0 to 7) */
    __IOM uint32_t FBOOT_INFO_REG0;                   /*!< Offset 0x120 Fast Boot Information Register0 */
    __IOM uint32_t FBOOT_INFO_REG1;                   /*!< Offset 0x124 Fast Boot Information Register1 */
         RESERVED(0x128[0x0160 - 0x0128], uint8_t)
    __IOM uint32_t DCXO_CTRL_REG;                     /*!< Offset 0x160 DCXO Control Register */
         RESERVED(0x164[0x0190 - 0x0164], uint8_t)
    __IOM uint32_t RTC_VIO_REG;                       /*!< Offset 0x190 RTC_VIO Regulation Register */
...
{
    __IOM uint32_t REGxx;                             /*!< Offset 0x000 Bit 31 and bit 0 R/W, bit 0 can be related to RISC-C vore */
         RESERVED(0x004[0x01C0 - 0x0004], uint8_t)
    __IOM uint32_t HOTPLUGFLAG;                       /*!< Offset 0x1C0 The Hotplug Flag Register is 0x070005C0. */
    __IOM uint32_t SOFTENTRY [0x004];                 /*!< Offset 0x1C4 The Soft Entry Address Register of CPUx (x=0..1) */
    __IOM uint32_t SUP_STAN_FLAG;                     /*!< Offset 0x1D4 Super Standby Flag (bit 16) */
         RESERVED(0x1D8[0x01DC - 0x01D8], uint8_t)
    __IOM uint32_t RV_HOTPLUGFLAG;                    /*!< Offset 0x1DC RV The Hotplug Flag Register (key value 0xFA50392F) */
    __IOM uint32_t RC_SOFTENTRY [0x004];              /*!< Offset 0x1E0 RV The Soft Entry Address Register */
...
typedef struct R_PRCM_Type
{
    ...
    __IOM uint32_t VDD_SYS_PWROFF_GATING_REG;         /*!< Offset 0x250  */
    __IOM uint32_t ANALOG_PWROFF_GATING_REG;          /*!< Offset 0x254  */
...
typedef struct SID_Type
{
    ...
    __IOM uint32_t SID_RKEY3;                         /*!< Offset 0x00C Securiy root key[127:96] */
         RESERVED(0x010[0x0014 - 0x0010], uint8_t)
    __IOM uint32_t SID_THS;                           /*!< Offset 0x014 [27:16]: The calibration value of the T-sensor. */
    ...
    __IOM uint32_t SID_DATA [0x004];                  /*!< Offset 0x200 SID data (xfel display as 'sid' replay) */
    __IOM uint32_t BOOT_MODE;                         /*!< Offset 0x210 [27:16]: eFUSE boot select status, [0]: 0: GPIO boot select, 1: eFuse boot select */
    __IOM uint32_t SID_UNDOC [0x1FB];                 /*!< Offset 0x214  */
...
typedef struct SMHC_Type
{
    ...
    __IOM uint32_t SMHC_CSDC;                         /*!< Offset 0x054 CRC Status Detect Control Registers */
    __IOM uint32_t SMHC_A12A;                         /*!< Offset 0x058 Auto Command 12 Argument Register */
    __IOM uint32_t SMHC_NTSR;                         /*!< Offset 0x05C SD New Timing Set Register */
    ...
    __IOM uint32_t SMHC_SFC;                          /*!< Offset 0x104 Sample FIFO Control Register */
    __IOM uint32_t SMHC_A23A;                         /*!< Offset 0x108 Auto Command 23 Argument Register */
    ...
    __IOM uint32_t SMHC_EXT_CMD;                      /*!< Offset 0x138 Extended Command Register */
    __IOM uint32_t SMHC_EXT_RESP;                     /*!< Offset 0x13C Extended Response Register */
    ...
    __IOM uint32_t SMHC_HS400_DL;                     /*!< Offset 0x14C HS400 Delay Control Register */
         RESERVED(0x150[0x0200 - 0x0150], uint8_t)
...
typedef struct SYS_CFG_Type
{
    ...
    __IOM uint32_t DSP_BOOT_RAMMAP_REG;               /*!< Offset 0x008 DSP Boot SRAM Remap Control Register */
    ...
    __IOM uint32_t SYS_LDO_CTRL_REG;                  /*!< Offset 0x150 System LDO Control Register */
         RESERVED(0x154[0x0160 - 0x0154], uint8_t)
    __IOM uint32_t RESCAL_CTRL_REG;                   /*!< Offset 0x160 Resistor Calibration Control Register */
         RESERVED(0x164[0x0168 - 0x0164], uint8_t)
    __IOM uint32_t RES240_CTRL_REG;                   /*!< Offset 0x168 240ohms Resistor Manual Control Register */
    __IOM uint32_t RESCAL_STATUS_REG;                 /*!< Offset 0x16C Resistor Calibration Status Register */
         RESERVED(0x170[0x021C - 0x0170], uint8_t)
    __IOM uint32_t SYS_LDOB_SID;                      /*!< Offset 0x21C  */
         RESERVED(0x220[0x0228 - 0x0220], uint8_t)
    __IOM uint32_t SYS_EFUSE_REG;                     /*!< Offset 0x228  */
...
typedef struct TCON_LCD_Type
{
    ...
    __IOM uint32_t LCD_FRM_SEED_REG [0x006];          /*!< Offset 0x014 LCD FRM Seed Register (N=0,1,2,3,4,5) */
    __IOM uint32_t LCD_FRM_TAB_REG [0x004];           /*!< Offset 0x02C LCD FRM Table Register (N=0,1,2,3) */
    ...
    __IOM uint32_t LCD_LVDS_IF_REG;                   /*!< Offset 0x084 LCD LVDS Configure Register */
    ...
    __IOM uint32_t LCD_CEU_CTL_REG;                   /*!< Offset 0x100 LCD CEU Control Register */
         RESERVED(0x104[0x0110 - 0x0104], uint8_t)
    __IOM uint32_t LCD_CEU_COEF_MUL_REG [0x003];      /*!< Offset 0x110 LCD CEU Coefficient Register0 0x0110+N*0x04 (N=0..10) N=0: Rr, N=1: Rg, N=2: Rb, N=4: Gr, N=5: Gg, N=6: Gb, N=8: Br, N=9: Bg, N=10: Bb */
    __IOM uint32_t LCD_CEU_COEF_ADD0_REG;             /*!< Offset 0x11C LCD CEU Coefficient Register1 0x011C+N*0x10 (N=0,1,2) N=0: Rc, N=1: Gc, N=2: Bc */
         RESERVED(0x120[0x012C - 0x0120], uint8_t)
    __IOM uint32_t LCD_CEU_COEF_ADD1_REG;             /*!< Offset 0x12C LCD CEU Coefficient Register1 0x011C+N*0x10 (N=0,1,2) */
         RESERVED(0x130[0x013C - 0x0130], uint8_t)
    __IOM uint32_t LCD_CEU_COEF_ADD2_REG;             /*!< Offset 0x13C LCD CEU Coefficient Register1 0x011C+N*0x10 (N=0,1,2) */
    ...
    __IOM uint32_t LCD_CPU_TRIx_REG [0x006];          /*!< Offset 0x160 LCD CPU Panel Trigger Register0 */
         RESERVED(0x178[0x0180 - 0x0178], uint8_t)
    ...
    __IOM uint32_t LCD_LVDS_ANA_REG [0x002];          /*!< Offset 0x220 LCD LVDS Analog Register N */
         RESERVED(0x228[0x0230 - 0x0228], uint8_t)
    __IOM uint32_t LCD_SYNC_CTL_REG;                  /*!< Offset 0x230 LCD Sync Control Register */
    __IOM uint32_t LCD_SYNC_POS_REG;                  /*!< Offset 0x234 LCD Sync Position Register */
    __IOM uint32_t LCD_SLAVE_STOP_POS_REG;            /*!< Offset 0x238 LCD Slave Stop Position Register */
         RESERVED(0x23C[0x0400 - 0x023C], uint8_t)
    __IOM uint32_t LCD_GAMMA_TABLE_REG [0x100];       /*!< Offset 0x400 LCD Gamma Table Register */
...
typedef struct TCON_TV_Type
{
    ...
    __IOM uint32_t TV_BASIC3_REG;                     /*!< Offset 0x0A0 TV Basic Timing Register3 */
    ...
    __IOM uint32_t TV_IO_POL_REG;                     /*!< Offset 0x0B8 TV SYNC Signal Polarity Register was: 0x0088 */
    __IOM uint32_t TV_IO_TRI_REG;                     /*!< Offset 0x0BC TV SYNC Signal IO Control Register was: 0x008C */
    ...
    __IOM uint32_t TV_CEU_CTL_REG;                    /*!< Offset 0x100 TV CEU Control Register */
         RESERVED(0x104[0x0110 - 0x0104], uint8_t)
    __IOM uint32_t TV_CEU_COEF_MUL_REG [0x00B];       /*!< Offset 0x110 TV CEU Coefficient Register0 0x0110+N*0x04(N=0-10) */
         RESERVED(0x13C[0x0140 - 0x013C], uint8_t)
    __IOM uint32_t TV_CEU_COEF_RANG_REG [0x003];      /*!< Offset 0x140 TV CEU Coefficient Register2 0x0140+N*0x04(N=0-2) */
    ...
    __IOM uint32_t TV_DATA_IO_POL0_REG;               /*!< Offset 0x330 TCON Data IO Polarity Control0 */
    __IOM uint32_t TV_DATA_IO_POL1_REG;               /*!< Offset 0x334 TCON Data IO Polarity Control1 */
    __IOM uint32_t TV_DATA_IO_TRI0_REG;               /*!< Offset 0x338 TCON Data IO Enable Control0 */
    __IOM uint32_t TV_DATA_IO_TRI1_REG;               /*!< Offset 0x33C TCON Data IO Enable Control1 */
...
typedef struct TIMER_Type
{
    ...
    __IOM uint32_t WDOG_SOFT_RST_REG;                 /*!< Offset 0x0A8 Watchdog Software Reset Register */
    ...
    __IOM uint32_t WDOG_OUTPUT_CFG_REG;               /*!< Offset 0x0BC Watchdog Output Configuration Register */
    __IOM uint32_t AVS_CNT_CTL_REG;                   /*!< Offset 0x0C0 AVS Control Register */
    __IOM uint32_t AVS_CNT0_REG;                      /*!< Offset 0x0C4 AVS Counter 0 Register */
    __IOM uint32_t AVS_CNT1_REG;                      /*!< Offset 0x0C8 AVS Counter 1 Register */
    __IOM uint32_t AVS_CNT_DIV_REG;                   /*!< Offset 0x0CC AVS Divisor Register */
...
{
    __IOM uint32_t TVD_EN;                            /*!< Offset 0x000 TVD MODULE CONTROL Register */
    __IOM uint32_t TVD_MODE;                          /*!< Offset 0x004 TVD MODE CONTROL Register */
    __IOM uint32_t TVD_CLAMP_AGC1;                    /*!< Offset 0x008 TVD CLAMP & AGC CONTROL Register1 */
    __IOM uint32_t TVD_CLAMP_AGC2;                    /*!< Offset 0x00C TVD CLAMP & AGC CONTROL Register2 */
    __IOM uint32_t TVD_HLOCK1;                        /*!< Offset 0x010 TVD HLOCK CONTROL Register1 */
    __IOM uint32_t TVD_HLOCK2;                        /*!< Offset 0x014 TVD HLOCK CONTROL Register2 */
    __IOM uint32_t TVD_HLOCK3;                        /*!< Offset 0x018 TVD HLOCK CONTROL Register3 */
    __IOM uint32_t TVD_HLOCK4;                        /*!< Offset 0x01C TVD HLOCK CONTROL Register4 */
    __IOM uint32_t TVD_HLOCK5;                        /*!< Offset 0x020 TVD HLOCK CONTROL Register5 */
    __IOM uint32_t TVD_VLOCK1;                        /*!< Offset 0x024 TVD VLOCK CONTROL Register1 */
    __IOM uint32_t TVD_VLOCK2;                        /*!< Offset 0x028 TVD VLOCK CONTROL Register2 */
         RESERVED(0x02C[0x0030 - 0x002C], uint8_t)
    __IOM uint32_t TVD_CLOCK1;                        /*!< Offset 0x030 TVD CHROMA LOCK CONTROL Register1 */
    __IOM uint32_t TVD_CLOCK2;                        /*!< Offset 0x034 TVD CHROMA LOCK CONTROL Register2 */
         RESERVED(0x038[0x0040 - 0x0038], uint8_t)
    __IOM uint32_t TVD_YC_SEP1;                       /*!< Offset 0x040 TVD YC SEPERATION CONROL Register1 */
    __IOM uint32_t TVD_YC_SEP2;                       /*!< Offset 0x044 TVD YC SEPERATION CONROL Register2 */
         RESERVED(0x048[0x0050 - 0x0048], uint8_t)
    __IOM uint32_t TVD_ENHANCE1;                      /*!< Offset 0x050 TVD ENHANCEMENT CONTROL Register1 */
    __IOM uint32_t TVD_ENHANCE2;                      /*!< Offset 0x054 TVD ENHANCEMENT CONTROL Register2 */
    __IOM uint32_t TVD_ENHANCE3;                      /*!< Offset 0x058 TVD ENHANCEMENT CONTROL Register3 */
         RESERVED(0x05C[0x0060 - 0x005C], uint8_t)
    __IOM uint32_t TVD_WB1;                           /*!< Offset 0x060 TVD WB DMA CONTROL Register1 */
    __IOM uint32_t TVD_WB2;                           /*!< Offset 0x064 TVD WB DMA CONTROL Register2 */
    __IOM uint32_t TVD_WB3;                           /*!< Offset 0x068 TVD WB DMA CONTROL Register3 */
    __IOM uint32_t TVD_WB4;                           /*!< Offset 0x06C TVD WB DMA CONTROL Register4 */
         RESERVED(0x070[0x0080 - 0x0070], uint8_t)
    __IOM uint32_t TVD_IRQ_CTL;                       /*!< Offset 0x080 TVD DMA Interrupt Control Register */
         RESERVED(0x084[0x0090 - 0x0084], uint8_t)
    __IOM uint32_t TVD_IRQ_STATUS;                    /*!< Offset 0x090 TVD DMA Interrupt Status Register */
         RESERVED(0x094[0x0100 - 0x0094], uint8_t)
    __IOM uint32_t TVD_DEBUG1;                        /*!< Offset 0x100 TVD DEBUG CONTROL Register1 */
         RESERVED(0x104[0x0180 - 0x0104], uint8_t)
    __IOM uint32_t TVD_STATUS1;                       /*!< Offset 0x180 TVD DEBUG STATUS Register1 */
    __IOM uint32_t TVD_STATUS2;                       /*!< Offset 0x184 TVD DEBUG STATUS Register2 */
    __IOM uint32_t TVD_STATUS3;                       /*!< Offset 0x188 TVD DEBUG STATUS Register3 */
    __IOM uint32_t TVD_STATUS4;                       /*!< Offset 0x18C TVD DEBUG STATUS Register4 */
    __IOM uint32_t TVD_STATUS5;                       /*!< Offset 0x190 TVD DEBUG STATUS Register5 */
    __IOM uint32_t TVD_STATUS6;                       /*!< Offset 0x194 TVD DEBUG STATUS Register6 */
...
{
    __IOM uint32_t TVD_TOP_MAP;                       /*!< Offset 0x000 TVD TOP MAP Register */
         RESERVED(0x004[0x0008 - 0x0004], uint8_t)
    __IOM uint32_t TVD_3D_CTL1;                       /*!< Offset 0x008 TVD 3D DMA CONTROL Register1 */
    __IOM uint32_t TVD_3D_CTL2;                       /*!< Offset 0x00C TVD 3D DMA CONTROL Register2 */
    __IOM uint32_t TVD_3D_CTL3;                       /*!< Offset 0x010 TVD 3D DMA CONTROL Register3 */
    __IOM uint32_t TVD_3D_CTL4;                       /*!< Offset 0x014 TVD 3D DMA CONTROL Register4 */
    __IOM uint32_t TVD_3D_CTL5;                       /*!< Offset 0x018 TVD 3D DMA CONTROL Register5 */
         RESERVED(0x01C[0x0020 - 0x001C], uint8_t)
    struct
    {
             RESERVED(0x000[0x0004 - 0x0000], uint8_t)
        __IOM uint32_t TVD_TOP_CTL;                   /*!< Offset 0x024 TVD TOP CONTROL Register */
        __IOM uint32_t TVD_ADC_CTL;                   /*!< Offset 0x028 TVD ADC CONTROL Register */
        __IOM uint32_t TVD_ADC_CFG;                   /*!< Offset 0x02C TVD ADC CONFIGURATION Register */
...
{
         RESERVED(0x000[0x0020 - 0x0000], uint8_t)
    __IOM uint32_t TVE_DAC_MAP;                       /*!< Offset 0x020 TV Encoder DAC MAP Register */
    __IOM uint32_t TVE_DAC_STATUS;                    /*!< Offset 0x024 TV Encoder DAC STAUTS Register */
    struct
    {
        __IOM uint32_t TVE_DAC_CFG0;                  /*!< Offset 0x028 TV Encoder DAC CFG0 Register */
        __IOM uint32_t TVE_DAC_CFG1;                  /*!< Offset 0x02C TV Encoder DAC CFG1 Register */
        __IOM uint32_t TVE_DAC_CFG2;                  /*!< Offset 0x030 TV Encoder DAC CFG2 Register */
        __IOM uint32_t TVE_DAC_CFG3;                  /*!< Offset 0x034 TV Encoder DAC CFG3 Register */
             RESERVED(0x010[0x0020 - 0x0010], uint8_t)
    } CH [0x001];                                     /*!< Offset 0x028 Channel [0..?] */
         RESERVED(0x048[0x00F0 - 0x0048], uint8_t)
    __IOM uint32_t TVE_DAC_TEST;                      /*!< Offset 0x0F0 TV Encoder DAC TEST Register */
...
{
    __IOM uint32_t TVE_000_REG;                       /*!< Offset 0x000 TV Encoder Clock Gating Register */
    __IOM uint32_t TVE_004_REG;                       /*!< Offset 0x004 TV Encoder Configuration Register */
    __IOM uint32_t TVE_008_REG;                       /*!< Offset 0x008 TV Encoder DAC Register1 */
    __IOM uint32_t TVE_00C_REG;                       /*!< Offset 0x00C TV Encoder Notch and DAC Delay Register */
    __IOM uint32_t TVE_010_REG;                       /*!< Offset 0x010 TV Encoder Chroma Frequency Register */
    __IOM uint32_t TVE_014_REG;                       /*!< Offset 0x014 TV Encoder Front/Back Porch Register */
    __IOM uint32_t TVE_018_REG;                       /*!< Offset 0x018 TV Encoder HD Mode VSYNC Register */
    __IOM uint32_t TVE_01C_REG;                       /*!< Offset 0x01C TV Encoder Line Number Register */
    __IOM uint32_t TVE_020_REG;                       /*!< Offset 0x020 TV Encoder Level Register */
    __IOM uint32_t TVE_024_REG;                       /*!< Offset 0x024 TV Encoder DAC Register2 */
         RESERVED(0x028[0x0030 - 0x0028], uint8_t)
    __IOM uint32_t TVE_030_REG;                       /*!< Offset 0x030 TV Encoder Auto Detection Enable Register */
    __IOM uint32_t TVE_034_REG;                       /*!< Offset 0x034 TV Encoder Auto Detection Interrupt Status Register */
    __IOM uint32_t TVE_038_REG;                       /*!< Offset 0x038 TV Encoder Auto Detection Status Register */
    __IOM uint32_t TVE_03C_REG;                       /*!< Offset 0x03C TV Encoder Auto Detection De-bounce Setting Register */
         RESERVED(0x040[0x00F8 - 0x0040], uint8_t)
    __IOM uint32_t TVE_0F8_REG;                       /*!< Offset 0x0F8 TV Encoder Auto Detect Configuration Register0 */
    __IOM uint32_t TVE_0FC_REG;                       /*!< Offset 0x0FC TV Encoder Auto Detect Configuration Register1 */
    __IOM uint32_t TVE_100_REG;                       /*!< Offset 0x100 TV Encoder Color Burst Phase Reset Configuration Register */
    __IOM uint32_t TVE_104_REG;                       /*!< Offset 0x104 TV Encoder VSYNC Number Register */
    __IOM uint32_t TVE_108_REG;                       /*!< Offset 0x108 TV Encoder Notch Filter Frequency Register */
    __IOM uint32_t TVE_10C_REG;                       /*!< Offset 0x10C TV Encoder Cb/Cr Level/Gain Register */
    __IOM uint32_t TVE_110_REG;                       /*!< Offset 0x110 TV Encoder Tint and Color Burst Phase Register */
    __IOM uint32_t TVE_114_REG;                       /*!< Offset 0x114 TV Encoder Burst Width Register */
    __IOM uint32_t TVE_118_REG;                       /*!< Offset 0x118 TV Encoder Cb/Cr Gain Register */
    __IOM uint32_t TVE_11C_REG;                       /*!< Offset 0x11C TV Encoder Sync and VBI Level Register */
    __IOM uint32_t TVE_120_REG;                       /*!< Offset 0x120 TV Encoder White Level Register */
    __IOM uint32_t TVE_124_REG;                       /*!< Offset 0x124 TV Encoder Video Active Line Register */
    __IOM uint32_t TVE_128_REG;                       /*!< Offset 0x128 TV Encoder Video Chroma BW and CompGain Register */
    __IOM uint32_t TVE_12C_REG;                       /*!< Offset 0x12C TV Encoder Register */
    __IOM uint32_t TVE_130_REG;                       /*!< Offset 0x130 TV Encoder Re-sync Parameters Register */
    __IOM uint32_t TVE_134_REG;                       /*!< Offset 0x134 TV Encoder Slave Parameter Register */
    __IOM uint32_t TVE_138_REG;                       /*!< Offset 0x138 TV Encoder Configuration Register0 */
    __IOM uint32_t TVE_13C_REG;                       /*!< Offset 0x13C TV Encoder Configuration Register1 */
         RESERVED(0x140[0x0380 - 0x0140], uint8_t)
    __IOM uint32_t TVE_380_REG;                       /*!< Offset 0x380 TV Encoder Low Pass Control Register */
    __IOM uint32_t TVE_384_REG;                       /*!< Offset 0x384 TV Encoder Low Pass Filter Control Register */
    __IOM uint32_t TVE_388_REG;                       /*!< Offset 0x388 TV Encoder Low Pass Gain Register */
    __IOM uint32_t TVE_38C_REG;                       /*!< Offset 0x38C TV Encoder Low Pass Gain Control Register */
    __IOM uint32_t TVE_390_REG;                       /*!< Offset 0x390 TV Encoder Low Pass Shoot Control Register */
    __IOM uint32_t TVE_394_REG;                       /*!< Offset 0x394 TV Encoder Low Pass Coring Register */
         RESERVED(0x398[0x03A0 - 0x0398], uint8_t)
    __IOM uint32_t TVE_3A0_REG;                       /*!< Offset 0x3A0 TV Encoder Noise Reduction Register */
...
{
    __IOM uint32_t USB_CTRL;                          /*!< Offset 0x000 HCI Interface Register (HCI_Interface) */
    __IOM uint32_t USBPHY_PHYCTL;                     /*!< Offset 0x004 USBPHY_PHYCTL */
