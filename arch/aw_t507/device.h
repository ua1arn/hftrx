...
#pragma once
#ifndef HEADER__13407CD6_4A45_4d15_9E8C_7F0C1F8E0873__INCLUDED
#define HEADER__13407CD6_4A45_4d15_9E8C_7F0C1F8E0873__INCLUDED
#include <stdint.h>
...
typedef struct AHUB_Type
{
    ...
    __IOM uint32_t AHUB_RST;                          /*!< Offset 0x008 AHUB Reset */
    __IOM uint32_t AHUB_GAT;                          /*!< Offset 0x00C AHUB Gating */
    struct
    {
        __IOM uint32_t APBIF_TXn_CTRL;                /*!< Offset 0x010 APBIF TXn Control */
        __IOM uint32_t APBIF_TXnIRQ_CTRL;             /*!< Offset 0x014 APBIF TXn DMA & Interrupt Control */
        __IOM uint32_t APBIF_TXnIRQ_STS;              /*!< Offset 0x018 AHUB APBIF TXn DMA & Interrupt Status */
             RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
        __IOM uint32_t APBIF_TXnFIFO_CTRL;            /*!< Offset 0x020 AHUB APBIF TXn FIFO Control */
        __IOM uint32_t APBIF_TXnFIFO_STS;             /*!< Offset 0x024 APBIF TXn FIFO Status */
             RESERVED(0x018[0x0020 - 0x0018], uint8_t)
        __IOM uint32_t APBIF_TXnFIFO;                 /*!< Offset 0x030 APBIF TXn FIFO */
        __IOM uint32_t APBIF_TXnFIFO_CNT;             /*!< Offset 0x034 APBIF TXn FIFO Counter */
             RESERVED(0x028[0x0030 - 0x0028], uint8_t)
    } APBIF_TX [0x003];                               /*!< Offset 0x010 APBIF TX (n=0~2) */
         RESERVED(0x0A0[0x0100 - 0x00A0], uint8_t)
    struct
    {
        __IOM uint32_t APBIF_RXn_CTRL;                /*!< Offset 0x100 APBIF RXn Control */
        __IOM uint32_t APBIF_RXnIRQ_CTRL;             /*!< Offset 0x104 APBIF RXn DMA & Interrupt Control */
        __IOM uint32_t APBIF_RXnIRQ_STS;              /*!< Offset 0x108 APBIF RXn DMA & Interrupt Status */
             RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
        __IOM uint32_t APBIF_RXnFIFO_CTRL;            /*!< Offset 0x110 APBIF RXn FIFO Control */
        __IOM uint32_t APBIF_RXnFIFO_STS;             /*!< Offset 0x114 APBIF RX0 FIFO Status */
        __IOM uint32_t APBIF_RXn_CONT;                /*!< Offset 0x118 APBIF RXn Contact Select */
             RESERVED(0x01C[0x0020 - 0x001C], uint8_t)
        __IOM uint32_t APBIF_RXnFIFO;                 /*!< Offset 0x120 APBIF RXn FIFO */
        __IOM uint32_t APBIF_RXnFIFO_CNT;             /*!< Offset 0x124 APBIF RXn FIFO Counter */
             RESERVED(0x028[0x0030 - 0x0028], uint8_t)
    } APBIF_RX [0x003];                               /*!< Offset 0x100 APBIF RX (n=0~2) */
         RESERVED(0x190[0x0A00 - 0x0190], uint8_t)
    struct
    {
        __IOM uint32_t DAMn_CTRL;                     /*!< Offset 0xA00 DAM Control */
             RESERVED(0x004[0x0010 - 0x0004], uint8_t)
        __IOM uint32_t DAMn_RXx_SRC [0x003];          /*!< Offset 0xA10 DAM RXDIF0..RXDIF2 Source Select */
             RESERVED(0x01C[0x0030 - 0x001C], uint8_t)
        __IOM uint32_t DAMn_MIX_CTRLx [0x008];        /*!< Offset 0xA30 DAM MIX Control 0..7 */
        __IOM uint32_t DAMn_GAIN_CTRLx [0x008];       /*!< Offset 0xA50 DAM GAIN Control 0..7 */
...
typedef struct AUDIO_CODEC_Type
{
    ...
    __IOM uint32_t AC_DAC_DG;                         /*!< Offset 0x028 DAC Debug Register */
         RESERVED(0x02C[0x00F0 - 0x002C], uint8_t)
    ...
    __IOM uint32_t AC_DAC_DRC_HOPC;                   /*!< Offset 0x14C DAC DRC Compressor High Output at Compressor Threshold Register */
    ...
    __IOM uint32_t AC_DAC_DRC_SFHAT;                  /*!< Offset 0x18C DAC DRC Smooth Filter */
    __IOM uint32_t AC_DAC_DRC_SFLAT;                  /*!< Offset 0x190 DAC DRC Smooth Filter */
    __IOM uint32_t AC_DAC_DRC_SFHRT;                  /*!< Offset 0x194 DAC DRC Smooth Filter Gain High Release Time Coef Register */
    __IOM uint32_t AC_DAC_DRC_SFLRT;                  /*!< Offset 0x198 DAC DRC Smooth Filter */
    ...
    __IOM uint32_t AC_DAC_DRC_HPFLGAIN;               /*!< Offset 0x1BC DAC DRC HPF Gain Low Coef Register */
         RESERVED(0x1C0[0x0310 - 0x01C0], uint8_t)
    __IOM uint32_t DAC_REG;                           /*!< Offset 0x310 DAC Analog Control Register */
    __IOM uint32_t MIXER_REG;                         /*!< Offset 0x314 MIXER Analog Control Register */
         RESERVED(0x318[0x031C - 0x0318], uint8_t)
    __IOM uint32_t RAMP_REG;                          /*!< Offset 0x31C RAMP Control Register */
} AUDIO_CODEC_TypeDef; /* size of structure = 0x320 */
/*
 * @brief C0_CPUX_CFG
 */
/*!< C0_CPUX_CFG T507/H618 Cluster 0 Configuration Register List */
...
typedef struct C0_CPUX_CFG_H616_Type
{
    ...
    struct
    {
        ...
        __IOM uint32_t HIGH;                          /*!< Offset 0x044 Reset Vector Base Address Registerx_H */
         ...
         RESERVED(0x060[0x0080 - 0x0060], uint8_t)
    __IOM uint32_t C0_CPU_STATUS;                     /*!< Offset 0x080 Cluster 0 CPU Status Register */
    __IOM uint32_t L2_STATUS_REG;                     /*!< Offset 0x084 Cluster 0 L2 Status Register */
         RESERVED(0x088[0x00C0 - 0x0088], uint8_t)
    __IOM uint32_t DBG_REG0;                          /*!< Offset 0x0C0 Cluster 0 Debug State Register0 */
    __IOM uint32_t DBG_REG1;                          /*!< Offset 0x0C4 Cluster 0 Debug State Register1 */
...
typedef struct CCU_Type
{
    __IOM uint32_t PLL_CPUX_CTRL_REG;                 /*!< Offset 0x000 PLL_CPUX Control Register */
         RESERVED(0x004[0x0010 - 0x0004], uint8_t)
    __IOM uint32_t PLL_DDR0_CTRL_REG;                 /*!< Offset 0x010 PLL_DDR0 Control Register */
         RESERVED(0x014[0x0018 - 0x0014], uint8_t)
    __IOM uint32_t PLL_DDR1_CTRL_REG;                 /*!< Offset 0x018 PLL_DDR1 Control Register */
         RESERVED(0x01C[0x0020 - 0x001C], uint8_t)
    ...
    __IOM uint32_t PLL_GPU0_CTRL_REG;                 /*!< Offset 0x030 PLL_GPU0 Control Register */
    ...
    __IOM uint32_t PLL_DE_CTRL_REG;                   /*!< Offset 0x060 PLL_DE Control Register */
    ...
    __IOM uint32_t PLL_CSI_CTRL_REG;                  /*!< Offset 0x0E0 PLL_CSI Control Register */
         RESERVED(0x0E4[0x0110 - 0x00E4], uint8_t)
    __IOM uint32_t PLL_DDR0_PAT_CTRL_REG;             /*!< Offset 0x110 PLL_DDR0 Pattern Control Register */
         RESERVED(0x114[0x0118 - 0x0114], uint8_t)
    __IOM uint32_t PLL_DDR1_PAT_CTRL_REG;             /*!< Offset 0x118 PLL_DDR1 Pattern Control Register */
    ...
    __IOM uint32_t PLL_DE_PAT0_CTRL_REG;              /*!< Offset 0x160 PLL_DE Pattern0 Control Register */
    __IOM uint32_t PLL_DE_PAT1_CTRL_REG;              /*!< Offset 0x164 PLL_DE Pattern1 Control Register */
    ...
    __IOM uint32_t PLL_CSI_PAT0_CTRL_REG;             /*!< Offset 0x1E0 PLL_CSI Pattern0 Control Register */
    __IOM uint32_t PLL_CSI_PAT1_CTRL_REG;             /*!< Offset 0x1E4 PLL_CSI Pattern1 Control Register */
    ...
    __IOM uint32_t PLL_DDR0_BIAS_REG;                 /*!< Offset 0x310 PLL_DDR0 Bias Register */
         RESERVED(0x314[0x0318 - 0x0314], uint8_t)
    __IOM uint32_t PLL_DDR1_BIAS_REG;                 /*!< Offset 0x318 PLL_DDR1 Bias Register */
    ...
    __IOM uint32_t PLL_DE_BIAS_REG;                   /*!< Offset 0x360 PLL_DE Bias Register */
    ...
    __IOM uint32_t PLL_CSI_BIAS_REG;                  /*!< Offset 0x3E0 PLL_CSI Bias Register */
    ...
    __IOM uint32_t CPUX_AXI_CFG_REG;                  /*!< Offset 0x500 CPUX_AXI Configuration Register */
    ...
    __IOM uint32_t GPU_CLK0_REG;                      /*!< Offset 0x670 GPU Clock0 Register */
    __IOM uint32_t GPU_CLK1_REG;                      /*!< Offset 0x674 GPU Clock1 Register */
    ...
    __IOM uint32_t EPHY_25M_CLK_REG;                  /*!< Offset 0x970 EPHY_25M Clock Register */
    ...
    __IOM uint32_t TS_CLK_REG;                        /*!< Offset 0x9B0 TS Clock Register */
         RESERVED(0x9B4[0x09BC - 0x09B4], uint8_t)
    __IOM uint32_t TS_BGR_REG;                        /*!< Offset 0x9BC TS Bus Gating Reset Register */
    ...
    __IOM uint32_t OWA_CLK_REG;                       /*!< Offset 0xA20 OWA Clock Register */
    ...
    __IOM uint32_t AUDIO_CODEC_1X_CLK_REG;            /*!< Offset 0xA50 AUDIO CODEC 1X Clock Register */
    __IOM uint32_t AUDIO_CODEC_4X_CLK_REG;            /*!< Offset 0xA54 AUDIO CODEC 4X Clock Register */
    ...
    __IOM uint32_t AUDIO_HUB_CLK_REG;                 /*!< Offset 0xA60 AUDIO_HUB Clock Register */
         RESERVED(0xA64[0x0A6C - 0x0A64], uint8_t)
    __IOM uint32_t AUDIO_HUB_BGR_REG;                 /*!< Offset 0xA6C AUDIO_HUB Bus Gating Reset Register */
    __IOM uint32_t USB0_CLK_REG;                      /*!< Offset 0xA70 USB0 Clock Register */
    __IOM uint32_t USB1_CLK_REG;                      /*!< Offset 0xA74 USB1 Clock Register */
    __IOM uint32_t USB2_CLK_REG;                      /*!< Offset 0xA78 USB2 Clock Register */
    __IOM uint32_t USB3_CLK_REG;                      /*!< Offset 0xA7C USB3 Clock Register */
    ...
    __IOM uint32_t HDMI0_CLK_REG;                     /*!< Offset 0xB00 HDMI0 Clock Register */
    __IOM uint32_t HDMI0_SLOW_CLK_REG;                /*!< Offset 0xB04 HDMI0 Slow Clock Register */
         RESERVED(0xB08[0x0B10 - 0x0B08], uint8_t)
    __IOM uint32_t HDMI_CEC_CLK_REG;                  /*!< Offset 0xB10 HDMI CEC Clock Register */
         RESERVED(0xB14[0x0B1C - 0x0B14], uint8_t)
    __IOM uint32_t HDMI_BGR_REG;                      /*!< Offset 0xB1C HDMI Bus Gating Reset Register */
    ...
    __IOM uint32_t TCON_LCD1_CLK_REG;                 /*!< Offset 0xB64 TCON LCD1 Clock Register */
         RESERVED(0xB68[0x0B7C - 0x0B68], uint8_t)
    __IOM uint32_t TCON_LCD_BGR_REG;                  /*!< Offset 0xB7C TCON LCD BUS GATING RESET Register */
    __IOM uint32_t TCON_TV0_CLK_REG;                  /*!< Offset 0xB80 TCON TV0 Clock Register */
    __IOM uint32_t TCON_TV1_CLK_REG;                  /*!< Offset 0xB84 TCON TV1 Clock Register */
         RESERVED(0xB88[0x0B9C - 0x0B88], uint8_t)
    __IOM uint32_t TCON_TV_BGR_REG;                   /*!< Offset 0xB9C TCON TV GATING RESET Register */
         RESERVED(0xBA0[0x0BAC - 0x0BA0], uint8_t)
    __IOM uint32_t LVDS_BGR_REG;                      /*!< Offset 0xBAC LVDS BUS GATING RESET Register */
    __IOM uint32_t TVE0_CLK_REG;                      /*!< Offset 0xBB0 TVE0 Clock Register */
    ...
    __IOM uint32_t CSI_TOP_CLK_REG;                   /*!< Offset 0xC04 CSI TOP Clock Register */
    __IOM uint32_t CSI_MST_CLK0_REG;                  /*!< Offset 0xC08 CSI_Master Clock0 Register */
    __IOM uint32_t CSI_MST_CLK1_REG;                  /*!< Offset 0xC0C CSI_Master Clock1 Register */
         RESERVED(0xC10[0x0C2C - 0x0C10], uint8_t)
    __IOM uint32_t CSI_BGR_REG;                       /*!< Offset 0xC2C CSI Bus Gating Reset Register */
         RESERVED(0xC30[0x0C40 - 0x0C30], uint8_t)
    __IOM uint32_t HDMI_HDCP_CLK_REG;                 /*!< Offset 0xC40 HDMI HDCP Clock Register */
         RESERVED(0xC44[0x0C4C - 0x0C44], uint8_t)
    __IOM uint32_t HDMI_HDCP_BGR_REG;                 /*!< Offset 0xC4C HDMI HDCP Bus Gating Reset Register */
    ...
    __IOM uint32_t CCU_24M_27M_CLK_OUTPUT_REG;        /*!< Offset 0xF20 24M or 27M Clock Output Register */
...
typedef struct CE_Type
{
    ...
    __IOM uint32_t CE_ESR;                            /*!< Offset 0x018 Error Status Register */
         RESERVED(0x01C[0x0024 - 0x001C], uint8_t)
    __IOM uint32_t CE_SCSA;                           /*!< Offset 0x024 Symmetric Algorithm DMA Current Source Address */
    __IOM uint32_t CE_SCDA;                           /*!< Offset 0x028 Symmetric Algorithm DMA Current Destination Address */
         RESERVED(0x02C[0x0034 - 0x002C], uint8_t)
    __IOM uint32_t CE_HCSA;                           /*!< Offset 0x034 HASH Algorithm DMA Current Source Address */
    __IOM uint32_t CE_HCDA;                           /*!< Offset 0x038 HASH Algorithm DMA Current Destination Address */
         RESERVED(0x03C[0x0044 - 0x003C], uint8_t)
    __IOM uint32_t CE_ACSA;                           /*!< Offset 0x044 Asymmetric Algorithm DMA Current Source Address */
    __IOM uint32_t CE_ACDA;                           /*!< Offset 0x048 Asymmetric Algorithm DMA Current Destination Address */
         RESERVED(0x04C[0x0054 - 0x004C], uint8_t)
    __IOM uint32_t CE_XCSA;                           /*!< Offset 0x054 XTS Algorithm DMA Current Source Address */
    __IOM uint32_t CE_XCDA;                           /*!< Offset 0x058 XTS Algorithm DMA Current Destination Address */
...
typedef struct CPU_SUBSYS_CTRL_Type
{
    ...
    __IOM uint32_t GENER_CTRL_REG1;                   /*!< Offset 0x004 General Control Register1 */
...
typedef struct CSI_Type
{
    ...
    __IOM uint32_t CCU_POST1_CLK_EN_REG;              /*!< Offset 0x010 CCU Post1 Clock Enable Register  */
...
typedef struct CSIC_PARSER_Type
{
    ...
    __IOM uint32_t PRS_MCSIC_IF_CFG_REG;              /*!< Offset 0x008 Parser MCSIC Interface Configuration Register  */
    __IOM uint32_t PRS_CAP_REG;                       /*!< Offset 0x00C Parser Capture Register  */
    __IOM uint32_t PRS_SIGNAL_STA_REG;                /*!< Offset 0x010 Parser Signal Status Register  */
    __IOM uint32_t PRS_NCSIC_BT656_HEAD_CFG_REG;      /*!< Offset 0x014 Parser NCSIC BT656 Header Configuration Register  */
    ...
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL0_DLY_ADJ_REG;  /*!< Offset 0x500 Parser NCSIC RX Signal0 Delay Adjust Register  */
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL1_DLY_ADJ_REG;  /*!< Offset 0x504 Parser NCSIC RX Signal1 Delay Adjust Register  */
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL2_DLY_ADJ_REG;  /*!< Offset 0x508 Parser NCSIC RX Signal2 Delay Adjust Register  */
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL3_DLY_ADJ_REG;  /*!< Offset 0x50C Parser NCSIC RX Signal3 Delay Adjust Register  */
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL4_DLY_ADJ_REG;  /*!< Offset 0x510 Parser NCSIC RX Signal4 Delay Adjust Register  */
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL5_DLY_ADJ_REG;  /*!< Offset 0x514 Parser NCSIC RX Signal5 Delay Adjust Register  */
    __IOM uint32_t PRS_NCSIC_RX_SIGNAL6_DLY_ADJ_REG;  /*!< Offset 0x518 Parser NCSIC RX Signal6 Delay Adjust Register  */
         RESERVED(0x51C[0x0520 - 0x051C], uint8_t)
    __IOM uint32_t PRS_NCSIC_SYNC_EN_REG;             /*!< Offset 0x520 Parser NCSIC SYNC Enable Register  */
    __IOM uint32_t PRS_NCSIC_SYNC_CFG_REG;            /*!< Offset 0x524 Parser NCSIC SYNC CFG Register  */
    __IOM uint32_t PRS_NCSIC_SYNC_WAIT_N_REG;         /*!< Offset 0x528 Parser NCSIC SYNC WAIT N Register  */
    __IOM uint32_t PRS_NCSIC_SYNC_WAIT_M_REG;         /*!< Offset 0x52C Parser NCSIC SYNC WAIT M Register  */
...
typedef struct CSIC_TOP_Type
{
    ...
    __IOM uint32_t CSIC_DMA2_INPUT_SEL_REG;           /*!< Offset 0x0A8 CSIC DMA2 Input Select Register  */
    __IOM uint32_t CSIC_DMA3_INPUT_SEL_REG;           /*!< Offset 0x0AC CSIC DMA3 Input Select Register  */
...
{
    __IOM uint32_t CCI_CTRL;                          /*!< Offset 0x000 CCI Control Register  */
    __IOM uint32_t CCI_CFG;                           /*!< Offset 0x004 CCI Transmission Configuration Register  */
    __IOM uint32_t CCI_FMT;                           /*!< Offset 0x008 CCI Packet Format Register  */
    __IOM uint32_t CCI_BUS_CTRL;                      /*!< Offset 0x00C CCI Bus Control Register  */
         RESERVED(0x010[0x0014 - 0x0010], uint8_t)
    __IOM uint32_t CCI_INT_CTRL;                      /*!< Offset 0x014 CCI Interrupt Control Register  */
    __IOM uint32_t CCI_LC_TRIG;                       /*!< Offset 0x018 CCI Line Counter Trigger Register  */
         RESERVED(0x01C[0x0100 - 0x001C], uint8_t)
    __IOM uint32_t CCI_FIFO_ACC [0x010];              /*!< Offset 0x100 CCI FIFO Access Register  */
         RESERVED(0x140[0x0200 - 0x0140], uint8_t)
    __IOM uint32_t CCI_RSV_REG [0x009];               /*!< Offset 0x200 CCI Reserved Register */
...
{
    __IOM uint32_t TV_CLK_SRC_RGB_SRC;                /*!< Offset 0x000 TCON_TV CClock SSelect and RGB Source S Select Register */
...
typedef struct DMIC_Type
{
    ...
    __IOM uint32_t DMIC_RXFIFO_CTR;                   /*!< Offset 0x01C DMIC RX FIFO Control Register */
    __IOM uint32_t DMIC_RXFIFO_STA;                   /*!< Offset 0x020 DMIC RX FIFO Status Register */
    ...
    __IOM uint32_t DATA0_DATA1_VOL_CTR;               /*!< Offset 0x030 Data 0 and Data 1 Volume Control Register */
    __IOM uint32_t DATA2_DATA3_VOL_CTR;               /*!< Offset 0x034 Data 2 and Data 3 Volume Control Register */
    __IOM uint32_t HPF_EN_CTR;                        /*!< Offset 0x038 High Pass Filter Enable Control Register */
    __IOM uint32_t HPF_COEF_REG;                      /*!< Offset 0x03C High Pass Filter Coef Register */
...
typedef struct EMAC_Type
{
    ...
    __IOM uint32_t EMAC_TX_CTL1;                      /*!< Offset 0x014  */
    ...
    __IOM uint32_t EMAC_RGMII_STA;                    /*!< Offset 0x0D0 EMAC RGMII Status Register */
         RESERVED(0x0D4[0x10000 - 0x00D4], uint8_t)
...
{
    __IOM uint32_t G2D_SCLK_GATE;                     /*!< Offset 0x000  */
    __IOM uint32_t G2D_HCLK_GATE;                     /*!< Offset 0x004  */
    __IOM uint32_t G2D_AHB_RST;                       /*!< Offset 0x008  */
    __IOM uint32_t G2D_SCLK_DIV;                      /*!< Offset 0x00C  */
...
typedef struct GPADC_Type
{
    ...
    __IOM uint32_t GP_CS_EN;                          /*!< Offset 0x008 GPADC */
    ...
    __IOM uint32_t GP_CH1_CMP_DATA;                   /*!< Offset 0x044 GPADC CH1 Compare Data Register */
    __IOM uint32_t GP_CH2_CMP_DATA;                   /*!< Offset 0x048 GPADC CH2 Compare Data Register */
    __IOM uint32_t GP_CH3_CMP_DATA;                   /*!< Offset 0x04C GPADC CH3 Compare Data Register */
...
{
    __IM  uint32_t ID;                                /*!< Offset 0x000 (RO) GPU and revision identifier */
    __IM  uint32_t L2_FEATURES;                       /*!< Offset 0x004 (RO) Level 2 cache features */
    __IM  uint32_t CORE_FEATURES;                     /*!< Offset 0x008 (RO) Shader Core Features ??? */
    __IM  uint32_t TILER_FEATURES;                    /*!< Offset 0x00C (RO) Tiler Features */
    __IM  uint32_t MEM_FEATURES;                      /*!< Offset 0x010 (RO) Memory system features */
    __IM  uint32_t MMU_FEATURES;                      /*!< Offset 0x014 (RO) MMU features */
    __IM  uint32_t AS_PRESENT;                        /*!< Offset 0x018 (RO) Address space slots present */
         RESERVED(0x01C[0x0020 - 0x001C], uint8_t)
    __IOM uint32_t GPU_IRQ_RAWSTAT;                   /*!< Offset 0x020 (RW) */
    __OM  uint32_t GPU_IRQ_CLEAR;                     /*!< Offset 0x024 (WO) */
    __IOM uint32_t GPU_IRQ_MASK;                      /*!< Offset 0x028 (RW) */
    __IM  uint32_t GPU_IRQ_STATUS;                    /*!< Offset 0x02C (RO) */
    __OM  uint32_t GPU_COMMAND;                       /*!< Offset 0x030 (WO) */
    __IM  uint32_t GPU_STATUS;                        /*!< Offset 0x034 (RO) */
         RESERVED(0x038[0x003C - 0x0038], uint8_t)
    __IM  uint32_t GPU_FAULTSTATUS;                   /*!< Offset 0x03C (RO) GPU exception type and fault status */
    __IM  uint32_t GPU_FAULTADDRESS_LO;               /*!< Offset 0x040 (RO) GPU exception fault address, low word */
    __IM  uint32_t GPU_FAULTADDRESS_HI;               /*!< Offset 0x044 (RO) GPU exception fault address, high word */
    __IOM uint32_t L2_CONFIG;                         /*!< Offset 0x048 (RW) Level 2 cache configuration */
         RESERVED(0x04C[0x0050 - 0x004C], uint8_t)
    __OM  uint32_t PWR_KEY;                           /*!< Offset 0x050 (WO) Power manager key register */
    __IOM uint32_t PWR_OVERRIDE0;                     /*!< Offset 0x054 (RW) Power manager override settings */
    __IOM uint32_t PWR_OVERRIDE1;                     /*!< Offset 0x058 (RW) Power manager override settings */
         RESERVED(0x05C[0x0090 - 0x005C], uint8_t)
    __IM  uint32_t CYCLE_COUNT_LO;                    /*!< Offset 0x090 (RO) Cycle counter, low word */
    __IM  uint32_t CYCLE_COUNT_HI;                    /*!< Offset 0x094 (RO) Cycle counter, high word */
    __IM  uint32_t TIMESTAMP_LO;                      /*!< Offset 0x098 (RO) Global time stamp counter, low word */
    __IM  uint32_t TIMESTAMP_HI;                      /*!< Offset 0x09C (RO) Global time stamp counter, high word */
    __IM  uint32_t THREAD_MAX_THREADS;                /*!< Offset 0x0A0 (RO) Maximum number of threads per core */
    __IM  uint32_t THREAD_MAX_WORKGROUP_SIZE;         /*!< Offset 0x0A4 (RO) Maximum workgroup size */
    __IM  uint32_t THREAD_MAX_BARRIER_SIZE;           /*!< Offset 0x0A8 (RO) Maximum threads waiting at a barrier */
    __IM  uint32_t THREAD_FEATURES;                   /*!< Offset 0x0AC (RO) Thread features */
    __IM  uint32_t TEXTURE_FEATURES_0;                /*!< Offset 0x0B0 (RO) Support flags for indexed texture formats 0..31 */
    __IM  uint32_t TEXTURE_FEATURES_1;                /*!< Offset 0x0B4 (RO) Support flags for indexed texture formats 32..63 */
    __IM  uint32_t TEXTURE_FEATURES_2;                /*!< Offset 0x0B8 (RO) Support flags for indexed texture formats 64..95 */
    __IM  uint32_t TEXTURE_FEATURES_3;                /*!< Offset 0x0BC (RO) Support flags for texture order */
         RESERVED(0x0C0[0x0100 - 0x00C0], uint8_t)
    __IM  uint32_t SHADER_PRESENT_LO;                 /*!< Offset 0x100 (RO) Shader core present bitmap, low word */
    __IM  uint32_t SHADER_PRESENT_HI;                 /*!< Offset 0x104 (RO) Shader core present bitmap, high word */
         RESERVED(0x108[0x0110 - 0x0108], uint8_t)
    __IM  uint32_t TILER_PRESENT_LO;                  /*!< Offset 0x110 (RO) Tiler core present bitmap, low word */
    __IM  uint32_t TILER_PRESENT_HI;                  /*!< Offset 0x114 (RO) Tiler core present bitmap, high word */
         RESERVED(0x118[0x0120 - 0x0118], uint8_t)
    __IM  uint32_t L2_PRESENT_LO;                     /*!< Offset 0x120 (RO) Level 2 cache present bitmap, low word */
    __IM  uint32_t L2_PRESENT_HI;                     /*!< Offset 0x124 (RO) Level 2 cache present bitmap, high word */
         RESERVED(0x128[0x0140 - 0x0128], uint8_t)
    __IM  uint32_t SHADER_READY_LO;                   /*!< Offset 0x140 (RO) Shader core ready bitmap, low word */
    __IM  uint32_t SHADER_READY_HI;                   /*!< Offset 0x144 (RO) Shader core ready bitmap, high word */
         RESERVED(0x148[0x0150 - 0x0148], uint8_t)
    __IM  uint32_t TILER_READY_LO;                    /*!< Offset 0x150 (RO) Tiler core ready bitmap, low word */
    __IM  uint32_t TILER_READY_HI;                    /*!< Offset 0x154 (RO) Tiler core ready bitmap, high word */
         RESERVED(0x158[0x0160 - 0x0158], uint8_t)
    __IM  uint32_t L2_READY_LO;                       /*!< Offset 0x160 (RO) Level 2 cache ready bitmap, low word */
    __IM  uint32_t L2_READY_HI;                       /*!< Offset 0x164 (RO) Level 2 cache ready bitmap, high word */
         RESERVED(0x168[0x0180 - 0x0168], uint8_t)
    __OM  uint32_t SHADER_PWRON_LO;                   /*!< Offset 0x180 (WO) Shader core power on bitmap, low word */
    __OM  uint32_t SHADER_PWRON_HI;                   /*!< Offset 0x184 (WO) Shader core power on bitmap, high word */
         RESERVED(0x188[0x0190 - 0x0188], uint8_t)
    __OM  uint32_t TILER_PWRON_LO;                    /*!< Offset 0x190 (WO) Tiler core power on bitmap, low word */
    __OM  uint32_t TILER_PWRON_HI;                    /*!< Offset 0x194 (WO) Tiler core power on bitmap, high word */
         RESERVED(0x198[0x01A0 - 0x0198], uint8_t)
    __OM  uint32_t L2_PWRON_LO;                       /*!< Offset 0x1A0 (WO) Level 2 cache power on bitmap, low word */
    __OM  uint32_t L2_PWRON_HI;                       /*!< Offset 0x1A4 (WO) Level 2 cache power on bitmap, high word */
         RESERVED(0x1A8[0x01C0 - 0x01A8], uint8_t)
    __OM  uint32_t SHADER_PWROFF_LO;                  /*!< Offset 0x1C0 (WO) Shader core power off bitmap, low word */
    __OM  uint32_t SHADER_PWROFF_HI;                  /*!< Offset 0x1C4 (WO) Shader core power off bitmap, high word */
         RESERVED(0x1C8[0x01D0 - 0x01C8], uint8_t)
    __OM  uint32_t TILER_PWROFF_LO;                   /*!< Offset 0x1D0 (WO) Tiler core power off bitmap, low word */
    __OM  uint32_t TILER_PWROFF_HI;                   /*!< Offset 0x1D4 (WO) Tiler core power off bitmap, high word */
         RESERVED(0x1D8[0x01E0 - 0x01D8], uint8_t)
    __OM  uint32_t L2_PWROFF_LO;                      /*!< Offset 0x1E0 (WO) Level 2 cache power off bitmap, low word */
    __OM  uint32_t L2_PWROFF_HI;                      /*!< Offset 0x1E4 (WO) Level 2 cache power off bitmap, high word */
         RESERVED(0x1E8[0x0200 - 0x01E8], uint8_t)
    __IM  uint32_t SHADER_PWRTRANS_LO;                /*!< Offset 0x200 (RO) Shader core power transition bitmap, low word */
    __IM  uint32_t SHADER_PWRTRANS_HI;                /*!< Offset 0x204 (RO) Shader core power transition bitmap, high word */
         RESERVED(0x208[0x0210 - 0x0208], uint8_t)
    __IM  uint32_t TILER_PWRTRANS_LO;                 /*!< Offset 0x210 (RO) Tiler core power transition bitmap, low word */
    __IM  uint32_t TILER_PWRTRANS_HI;                 /*!< Offset 0x214 (RO) Tiler core power transition bitmap, high word */
         RESERVED(0x218[0x0220 - 0x0218], uint8_t)
    __IM  uint32_t L2_PWRTRANS_LO;                    /*!< Offset 0x220 (RO) Level 2 cache power transition bitmap, low word */
    __IM  uint32_t L2_PWRTRANS_HI;                    /*!< Offset 0x224 (RO) Level 2 cache power transition bitmap, high word */
         RESERVED(0x228[0x0240 - 0x0228], uint8_t)
    __IM  uint32_t SHADER_PWRACTIVE_LO;               /*!< Offset 0x240 (RO) Shader core active bitmap, low word */
    __IM  uint32_t SHADER_PWRACTIVE_HI;               /*!< Offset 0x244 (RO) Shader core active bitmap, high word */
         RESERVED(0x248[0x0250 - 0x0248], uint8_t)
    __IM  uint32_t TILER_PWRACTIVE_LO;                /*!< Offset 0x250 (RO) Tiler core active bitmap, low word */
    __IM  uint32_t TILER_PWRACTIVE_HI;                /*!< Offset 0x254 (RO) Tiler core active bitmap, high word */
         RESERVED(0x258[0x0260 - 0x0258], uint8_t)
    __IM  uint32_t L2_PWRACTIVE_LO;                   /*!< Offset 0x260 (RO) Level 2 cache active bitmap, low word */
    __IM  uint32_t L2_PWRACTIVE_HI;                   /*!< Offset 0x264 (RO) Level 2 cache active bitmap, high word */
         RESERVED(0x268[0x0300 - 0x0268], uint8_t)
    __IM  uint32_t COHERENCY_FEATURES;                /*!< Offset 0x300 (RO) Coherency features present */
    __IOM uint32_t COHERENCY_ENABLE;                  /*!< Offset 0x304 (RW) Coherency enable */
         RESERVED(0x308[0x0310 - 0x0308], uint8_t)
    __IM  uint32_t THREAD_TLS_ALLOC;                  /*!< Offset 0x310 (RO) Number of threads per core that TLS must be allocated for */
         RESERVED(0x314[0x0E00 - 0x0314], uint8_t)
    __IM  uint32_t STACK_PRESENT_LO;                  /*!< Offset 0xE00 (RO) Core stack present bitmap, low word */
    __IM  uint32_t STACK_PRESENT_HI;                  /*!< Offset 0xE04 (RO) Core stack present bitmap, high word */
         RESERVED(0xE08[0x0E10 - 0x0E08], uint8_t)
    ...
    __IM  uint32_t STACK_PWRTRANS_HI;                 /*!< Offset 0xE44 (RO) Core stack power transition bitmap, high word */
         RESERVED(0xE48[0x0F04 - 0x0E48], uint8_t)
    __IOM uint32_t SHADER_CONFIG;                     /*!< Offset 0xF04 (RW) Shader core configuration (implementation-specific) */
    __IOM uint32_t TILER_CONFIG;                      /*!< Offset 0xF08 (RW) Tiler core configuration (implementation-specific) */
    __IOM uint32_t L2_MMU_CONFIG;                     /*!< Offset 0xF0C (RW) L2 cache and MMU configuration (implementation-specific) */
...
{
    __IOM uint32_t MMU_IRQ_RAWSTAT;                   /*!< Offset 0x000 (RW) Raw interrupt status register */
...
{
    __IOM uint32_t I2Sn_CTL;                          /*!< Offset 0x000 I2Sn Control */
    __IOM uint32_t I2Sn_FMT0;                         /*!< Offset 0x004 I2Sn Format 0 */
    __IOM uint32_t I2Sn_FMT1;                         /*!< Offset 0x008 I2Sn Format 1 */
    __IOM uint32_t I2Sn_CLKD;                         /*!< Offset 0x00C I2Sn Clock Divide */
         RESERVED(0x010[0x0020 - 0x0010], uint8_t)
    __IOM uint32_t I2Sn_RXDIF_CONT;                   /*!< Offset 0x020 I2Sn RXDIF Contact Select */
    __IOM uint32_t I2Sn_CHCFG;                        /*!< Offset 0x024 I2Sn Channel Configuration */
    __IOM uint32_t I2Sn_IRQ_CTRL;                     /*!< Offset 0x028 I2Sn DMA & Interrupt Control */
    __IOM uint32_t I2Sn_IRQ_STS;                      /*!< Offset 0x02C I2Sn DMA & Interrupt Status */
    struct
    {
        __IOM uint32_t I2Sn_SDOUTm_SLOTCTR;           /*!< Offset 0x030 (n=0~3)(m=0~3) */
        __IOM uint32_t I2Sn_SDOUTmCHMAP0;             /*!< Offset 0x034 I2Sn SDOUTm Channel Mapping 0 */
        __IOM uint32_t I2Sn_SDOUTmCHMAP1;             /*!< Offset 0x038 I2Sn SDOUTm Channel Mapping 1 */
             RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
    } I2Sn_SDOUT [0x004];                             /*!< Offset 0x030 SDOUTm (m=0~3) */
    __IOM uint32_t I2Sn_SDIN_SLOTCTR;                 /*!< Offset 0x070 I2Sn Input Slot Control */
    __IOM uint32_t I2Sn_SDINCHMAP [0x004];            /*!< Offset 0x074 I2Sn SDIN Channel Mapping 0..3 */
...
typedef struct IOMMU_Type
{
    ...
    __IOM uint32_t IOMMU_RESET_REG;                   /*!< Offset 0x010 IOMMU ResetRegister */
         RESERVED(0x014[0x0020 - 0x0014], uint8_t)
    __IOM uint32_t IOMMU_ENABLE_REG;                  /*!< Offset 0x020 IOMMU EnableRegister */
         RESERVED(0x024[0x0030 - 0x0024], uint8_t)
    __IOM uint32_t IOMMU_BYPASS_REG;                  /*!< Offset 0x030 IOMMU BypassRegister */
         RESERVED(0x034[0x0040 - 0x0034], uint8_t)
    __IOM uint32_t IOMMU_AUTO_GATING_REG;             /*!< Offset 0x040 IOMMU Auto GatingRegister */
    ...
    __IOM uint32_t IOMMU_TTB_REG;                     /*!< Offset 0x050 IOMMU Translation Table BaseRegister */
         RESERVED(0x054[0x0060 - 0x0054], uint8_t)
    __IOM uint32_t IOMMU_TLB_ENABLE_REG;              /*!< Offset 0x060 IOMMU TLB EnableRegister */
         RESERVED(0x064[0x0070 - 0x0064], uint8_t)
    __IOM uint32_t IOMMU_TLB_PREFETCH_REG;            /*!< Offset 0x070 IOMMU TLB PrefetchRegister */
         RESERVED(0x074[0x0080 - 0x0074], uint8_t)
    ...
    __IOM uint32_t IOMMU_PC_IVLD_ENABLE_REG;          /*!< Offset 0x0A8 IOMMU */
         RESERVED(0x0AC[0x00B0 - 0x00AC], uint8_t)
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG0;            /*!< Offset 0x0B0 IOMMU Domain Authority Control Register 0 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG1;            /*!< Offset 0x0B4 IOMMU Domain Authority Control Register 1 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG2;            /*!< Offset 0x0B8 IOMMU Domain Authority Control Register 2 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG3;            /*!< Offset 0x0BC IOMMU Domain Authority Control Register 3 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG4;            /*!< Offset 0x0C0 IOMMU Domain Authority Control Register 4 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG5;            /*!< Offset 0x0C4 IOMMU Domain Authority Control Register 5 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG6;            /*!< Offset 0x0C8 IOMMU Domain Authority Control Register 6 */
    __IOM uint32_t IOMMU_DM_AUT_CTRL_REG7;            /*!< Offset 0x0CC IOMMU Domain Authority Control Register 7 */
    ...
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG0;           /*!< Offset 0x110 IOMMU Interrupt Error Address Register 0 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG1;           /*!< Offset 0x114 IOMMU Interrupt Error Address Register 1 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG2;           /*!< Offset 0x118 IOMMU Interrupt Error Address Register 2 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG3;           /*!< Offset 0x11C IOMMU Interrupt Error Address Register 3 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG4;           /*!< Offset 0x120 IOMMU Interrupt Error Address Register 4 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG5;           /*!< Offset 0x124 IOMMU Interrupt Error Address Register 5 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG6;           /*!< Offset 0x128 IOMMU Interrupt Error Address Register 6 */
         RESERVED(0x12C[0x0130 - 0x012C], uint8_t)
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG7;           /*!< Offset 0x130 IOMMU Interrupt Error Address Register 7 */
    __IOM uint32_t IOMMU_INT_ERR_ADDR_REG8;           /*!< Offset 0x134 IOMMU Interrupt Error Address Register 8 */
         RESERVED(0x138[0x0150 - 0x0138], uint8_t)
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG0;           /*!< Offset 0x150 IOMMU Interrupt Error Data Register 0 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG1;           /*!< Offset 0x154 IOMMU Interrupt Error Data Register 1 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG2;           /*!< Offset 0x158 IOMMU Interrupt Error Data Register 2 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG3;           /*!< Offset 0x15C IOMMU Interrupt Error Data Register 3 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG4;           /*!< Offset 0x160 IOMMU Interrupt Error Data Register 4 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG5;           /*!< Offset 0x164 IOMMU Interrupt Error Data Register 5 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG6;           /*!< Offset 0x168 IOMMU Interrupt Error Data Register 6 */
         RESERVED(0x16C[0x0170 - 0x016C], uint8_t)
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG7;           /*!< Offset 0x170 IOMMU Interrupt Error Data Register 7 */
    __IOM uint32_t IOMMU_INT_ERR_DATA_REG8;           /*!< Offset 0x174 IOMMU Interrupt Error Data Register 8 */
    ...
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG0;         /*!< Offset 0x230 IOMMU PMU Access Low Register 0 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG0;        /*!< Offset 0x234 IOMMU PMU Access High Register 0 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG0;            /*!< Offset 0x238 IOMMU PMU Hit Low Register 0 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG0;           /*!< Offset 0x23C IOMMU PMU Hit High Register 0 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG1;         /*!< Offset 0x240 IOMMU PMU Access Low Register 1 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG1;        /*!< Offset 0x244 IOMMU PMU Access High Register 1 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG1;            /*!< Offset 0x248 IOMMU PMU Hit Low Register 1 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG1;           /*!< Offset 0x24C IOMMU PMU Hit High Register 1 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG2;         /*!< Offset 0x250 IOMMU PMU Access Low Register 2 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG2;        /*!< Offset 0x254 IOMMU PMU Access High Register 2 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG2;            /*!< Offset 0x258 IOMMU PMU Hit Low Register 2 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG2;           /*!< Offset 0x25C IOMMU PMU Hit High Register 2 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG3;         /*!< Offset 0x260 IOMMU PMU Access Low Register 3 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG3;        /*!< Offset 0x264 IOMMU PMU Access High Register 3 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG3;            /*!< Offset 0x268 IOMMU PMU Hit Low Register 3 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG3;           /*!< Offset 0x26C IOMMU PMU Hit High Register 3 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG4;         /*!< Offset 0x270 IOMMU PMU Access Low Register 4 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG4;        /*!< Offset 0x274 IOMMU PMU Access High Register 4 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG4;            /*!< Offset 0x278 IOMMU PMU Hit Low Register 4 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG4;           /*!< Offset 0x27C IOMMU PMU Hit High Register 4 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG5;         /*!< Offset 0x280 IOMMU PMU Access Low Register 5 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG5;        /*!< Offset 0x284 IOMMU PMU Access High Register 5 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG5;            /*!< Offset 0x288 IOMMU PMU Hit Low Register 5 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG5;           /*!< Offset 0x28C IOMMU PMU Hit High Register 5 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG6;         /*!< Offset 0x290 IOMMU PMU Access Low Register 6 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG6;        /*!< Offset 0x294 IOMMU PMU Access High Register 6 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG6;            /*!< Offset 0x298 IOMMU PMU Hit Low Register 6 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG6;           /*!< Offset 0x29C IOMMU PMU Hit High Register 6 */
         RESERVED(0x2A0[0x02D0 - 0x02A0], uint8_t)
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG7;         /*!< Offset 0x2D0 IOMMU PMU Access Low Register 7 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG7;        /*!< Offset 0x2D4 IOMMU PMU Access High Register 7 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG7;            /*!< Offset 0x2D8 IOMMU PMU Hit Low Register 7 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG7;           /*!< Offset 0x2DC IOMMU PMU Hit High Register 7 */
    __IOM uint32_t IOMMU_PMU_ACCESS_LOW_REG8;         /*!< Offset 0x2E0 IOMMU PMU Access Low Register 8 */
    __IOM uint32_t IOMMU_PMU_ACCESS_HIGH_REG8;        /*!< Offset 0x2E4 IOMMU PMU Access High Register 8 */
    __IOM uint32_t IOMMU_PMU_HIT_LOW_REG8;            /*!< Offset 0x2E8 IOMMU PMU Hit Low Register 8 */
    __IOM uint32_t IOMMU_PMU_HIT_HIGH_REG8;           /*!< Offset 0x2EC IOMMU PMU Hit High Register 8 */
         RESERVED(0x2F0[0x0300 - 0x02F0], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG0;             /*!< Offset 0x300 IOMMU Total Latency Low Register 0 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG0;            /*!< Offset 0x304 IOMMU Total Latency High Register 0 */
    __IOM uint32_t IOMMU_PMU_ML_REG0;                 /*!< Offset 0x308 IOMMU Max Latency Register 0 */
         RESERVED(0x30C[0x0310 - 0x030C], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG1;             /*!< Offset 0x310 IOMMU Total Latency Low Register 1 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG1;            /*!< Offset 0x314 IOMMU Total Latency High Register 1 */
    __IOM uint32_t IOMMU_PMU_ML_REG1;                 /*!< Offset 0x318 IOMMU Max Latency Register 1 */
         RESERVED(0x31C[0x0320 - 0x031C], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG2;             /*!< Offset 0x320 IOMMU Total Latency Low Register 2 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG2;            /*!< Offset 0x324 IOMMU Total Latency High Register 2 */
    __IOM uint32_t IOMMU_PMU_ML_REG2;                 /*!< Offset 0x328 IOMMU Max Latency Register 2 */
         RESERVED(0x32C[0x0330 - 0x032C], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG3;             /*!< Offset 0x330 IOMMU Total Latency Low Register 3 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG3;            /*!< Offset 0x334 IOMMU Total Latency High Register 3 */
    __IOM uint32_t IOMMU_PMU_ML_REG3;                 /*!< Offset 0x338 IOMMU Max Latency Register 3 */
         RESERVED(0x33C[0x0340 - 0x033C], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG4;             /*!< Offset 0x340 IOMMU Total Latency Low Register 4 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG4;            /*!< Offset 0x344 IOMMU Total Latency High Register 4 */
    __IOM uint32_t IOMMU_PMU_ML_REG4;                 /*!< Offset 0x348 IOMMU Max Latency Register 4 */
         RESERVED(0x34C[0x0350 - 0x034C], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG5;             /*!< Offset 0x350 IOMMU Total Latency Low Register 5 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG5;            /*!< Offset 0x354 IOMMU Total Latency High Register 5 */
    __IOM uint32_t IOMMU_PMU_ML_REG5;                 /*!< Offset 0x358 IOMMU Max Latency Register 5 */
         RESERVED(0x35C[0x0360 - 0x035C], uint8_t)
    __IOM uint32_t IOMMU_PMU_TL_LOW_REG6;             /*!< Offset 0x360 IOMMU Total Latency Low Register 6 */
    __IOM uint32_t IOMMU_PMU_TL_HIGH_REG6;            /*!< Offset 0x364 IOMMU Total Latency High Register 6 */
    __IOM uint32_t IOMMU_PMU_ML_REG6;                 /*!< Offset 0x368 IOMMU Max Latency Register 6 */
...
{
    __IOM uint32_t LRADC_CTRL;                        /*!< Offset 0x000 LRADC Control Register */
    __IOM uint32_t LRADC_INTC;                        /*!< Offset 0x004 LRADC Interrupt Control Register */
    __IOM uint32_t LRADC_INTS;                        /*!< Offset 0x008 LRADC Interrupt Status Register */
    __IOM uint32_t LRADC_DATA0;                       /*!< Offset 0x00C LRADC Data Register0 */
...
typedef struct NDFC_Type
{
    ...
    __IOM uint32_t NDFC_DATA_BLOCK_MASK;              /*!< Offset 0x01C NDFC Data Block Mask Register */
    __IOM uint32_t NDFC_CNT;                          /*!< Offset 0x020 NDFC Data Counter Register */
    __IOM uint32_t NDFC_CMD;                          /*!< Offset 0x024 NDFC Commands IO Register */
    ...
    __IOM uint32_t NDFC_ECC_CTL;                      /*!< Offset 0x034 NDFC ECC Control Register */
    __IM  uint32_t NDFC_ECC_ST;                       /*!< Offset 0x038 NDFC ECC Status Register */
    __IM  uint32_t NDFC_DATA_PAT_STA;                 /*!< Offset 0x03C NDFC Data Pattern Status Register */
    __IOM uint32_t NDFC_EFR;                          /*!< Offset 0x040 NDFC Enhanced Feature Register */
    __IOM uint32_t NDFC_RDATA_STA_CTL;                /*!< Offset 0x044 NDFC Read Data Status Control Register */
    __IM  uint32_t NDFC_RDATA_STA_0;                  /*!< Offset 0x048 NDFC Read Data Status Register 0 */
    __IM  uint32_t NDFC_RDATA_STA_1;                  /*!< Offset 0x04C NDFC Read Data Status Register 1 */
    __IM  uint32_t NDFC_ERR_CNT [0x008];              /*!< Offset 0x050 NDFC Error Counter Register(N from 0 to 7) */
    __IOM uint32_t NDFC_USER_DATA_LEN [0x004];        /*!< Offset 0x070 NDFC User Data Length Register(N from 0 to 3) */
    __IOM uint32_t NDFC_USER_DATA [0x020];            /*!< Offset 0x080 NDFC User Data Field Register N (N from 0 to 31) */
         RESERVED(0x100[0x0110 - 0x0100], uint8_t)
    __IM  uint32_t NDFC_EFNAND_STA;                   /*!< Offset 0x110 NDFC EFNAND Status Register */
    __IOM uint32_t NDFC_SPARE_AREA;                   /*!< Offset 0x114 NDFC Spare Area Register */
    __IM  uint32_t NDFC_PAT_ID;                       /*!< Offset 0x118 NDFC Pattern ID Register */
    __IOM uint32_t NDFC_DDR2_SPEC_CTL;                /*!< Offset 0x11C NDFC DDR2 Specific Control Register */
    __IOM uint32_t NDFC_NDMA_MODE_CTL;                /*!< Offset 0x120 NDFC Normal DMA Mode Control Register */
         RESERVED(0x124[0x0200 - 0x0124], uint8_t)
    __IOM uint32_t NDFC_MDMA_DLBA_REG;                /*!< Offset 0x200 NDFC MBUS DMA Descriptor List Base Address Register */
    __IOM uint32_t NDFC_MDMA_STA;                     /*!< Offset 0x204 NDFC MBUS DMA Interrupt Status Register */
    __IOM uint32_t NDFC_DMA_INT_MASK;                 /*!< Offset 0x208 NDFC MBUS DMA Interrupt Enable Register */
    __IM  uint32_t NDFC_MDMA_CUR_DESC_ADDR;           /*!< Offset 0x20C NDFC MBUS DMA Current Descriptor Address Register */
    __IM  uint32_t NDFC_MDMA_CUR_BUF_ADDR;            /*!< Offset 0x210 NDFC MBUS DMA Current Buffer Address Register */
...
{
    __IOM uint32_t OWA_GEN_CTL;                       /*!< Offset 0x000  */
    ...
    __IOM uint32_t OWA_FSTA;                          /*!< Offset 0x018 OWA FIFO */
...
typedef struct PWM_Type
{
    ...
    __IOM uint32_t CISR;                              /*!< Offset 0x014 Capture IRQ Status Register */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t PCCR [0x003];                      /*!< Offset 0x020 PWM01, PWM23, PWM45 Clock Configuration Register */
         RESERVED(0x02C[0x0030 - 0x002C], uint8_t)
    __IOM uint32_t PDZCR [0x003];                     /*!< Offset 0x030 PWM01, PWM23, PWM45 Dead Zone Control Register */
         RESERVED(0x03C[0x0040 - 0x003C], uint8_t)
    __IOM uint32_t PER;                               /*!< Offset 0x040 PWM Enable Register */
    __IOM uint32_t CER;                               /*!< Offset 0x044 Capture Enable Register */
         RESERVED(0x048[0x0060 - 0x0048], uint8_t)
    struct
    {
        __IOM uint32_t PCR;                           /*!< Offset 0x060 PWM Control Register */
        __IOM uint32_t PPR;                           /*!< Offset 0x064 PWM Period Register */
        __IOM uint32_t PCNTR;                         /*!< Offset 0x068 PWM Count Register */
        __IOM uint32_t CCR;                           /*!< Offset 0x06C Capture Control Register */
        __IOM uint32_t CRLR;                          /*!< Offset 0x070 Capture Rise Lock Register */
        __IOM uint32_t CFLR;                          /*!< Offset 0x074 Capture Fall Lock Register */
             RESERVED(0x018[0x0020 - 0x0018], uint8_t)
...
typedef struct RTC_Type
{
    ...
    __IOM uint32_t ALARM_CONFIG_REG;                  /*!< Offset 0x050 Alarm Configuration Register */
         RESERVED(0x054[0x0060 - 0x0054], uint8_t)
    __IOM uint32_t F32K_FANOUT_GATING_REG;            /*!< Offset 0x060 32k Fanout Output Gating Register */
         RESERVED(0x064[0x0100 - 0x0064], uint8_t)
    __IOM uint32_t GP_DATA_REG [0x010];               /*!< Offset 0x100 General Purpose Register (N=0~15) */
    ...
    __IOM uint32_t RTC_VIO_REG;                       /*!< Offset 0x190 RTC_VIO Regulate Register */
         RESERVED(0x194[0x01F0 - 0x0194], uint8_t)
    __IOM uint32_t IC_CHARA_REG;                      /*!< Offset 0x1F0 IC Characteristic Register */
    __IOM uint32_t VDDOFF_GATING_SOF_REG;             /*!< Offset 0x1F4 VDD To RTC Isolation Software Control Register */
    __IOM uint32_t SP_STDBY_FLAG_REG;                 /*!< Offset 0x1F8 Super Standby Flag Register */
    __IOM uint32_t SP_STDBY_SOFT_ENTRY_REG;           /*!< Offset 0x1FC Super Standby Software Entry Register */
    __IOM uint32_t USB_STBY_CTRL_REG;                 /*!< Offset 0x200 USB Standby Control Register */
    ...
    __IOM uint32_t CRY_EN_REG;                        /*!< Offset 0x218 Crypt Enable Register */
         RESERVED(0x21C[0x0400 - 0x021C], uint8_t)
...
typedef struct SYS_CFG_Type
{
    ...
    __IOM uint32_t EMAC_EPHY_CLK_REG1;                /*!< Offset 0x034 EMAC-EPHY Clock Register 1 (T507 only) */
...
typedef struct THS_Type
{
    ...
    __IOM uint32_t THS_FILTER;                        /*!< Offset 0x030 THS Median Filter Control Register */
         RESERVED(0x034[0x0040 - 0x0034], uint8_t)
    __IOM uint32_t THSx_ALARM_CTRL [0x004];           /*!< Offset 0x040 THS0..THS3 Alarm Threshold Control Register */
         RESERVED(0x050[0x0080 - 0x0050], uint8_t)
    __IOM uint32_t THSx_SHUTDOWN_CTRL [0x002];        /*!< Offset 0x080 THS0 & THS1, HS2 & THS3  Shutdown Threshold Control Register */
         RESERVED(0x088[0x00A0 - 0x0088], uint8_t)
    __IOM uint32_t THSx_CDATA [0x002];                /*!< Offset 0x0A0 THS0 & THS1, THS2 & THS3  Calibration Data */
         RESERVED(0x0A8[0x00C0 - 0x00A8], uint8_t)
    __IOM uint32_t THSx_DATA [0x004];                 /*!< Offset 0x0C0 THS0..THS3 Data Register */
...
{
         RESERVED(0x000[0x0010 - 0x0000], uint8_t)
    __IOM uint32_t TSC_PCTLR;                         /*!< Offset 0x010 TSC Port Control Register */
    __IOM uint32_t TSC_PPARR;                         /*!< Offset 0x014 TSC Port Parameter Register */
         RESERVED(0x018[0x0020 - 0x0018], uint8_t)
    __IOM uint32_t TSC_TSFMUXR;                       /*!< Offset 0x020 TSC TSF Input Multiplex Control Register */
         RESERVED(0x024[0x0028 - 0x0024], uint8_t)
    __IOM uint32_t TSC_OUTMUXR;                       /*!< Offset 0x028 TSC Port Output Multiplex Control Register */
...
{
    __IOM uint32_t TSD_CTLR;                          /*!< Offset 0x000 TSD Control Register */
    __IOM uint32_t TSD_STAR;                          /*!< Offset 0x004 TSD Status Register */
         RESERVED(0x008[0x001C - 0x0008], uint8_t)
    __IOM uint32_t TSD_CWIR;                          /*!< Offset 0x01C TSD Control Word Index Register */
    __IOM uint32_t TSD_CWR;                           /*!< Offset 0x020 TSD Control Word Register */
...
{
    __IOM uint32_t TSF_CTLR;                          /*!< Offset 0x000 TSF Control Register */
    __IOM uint32_t TSF_PPR;                           /*!< Offset 0x004 TSF Packet Parameter Register */
    __IOM uint32_t TSF_STAR;                          /*!< Offset 0x008 TSF Status Register */
         RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
    __IOM uint32_t TSF_DIER;                          /*!< Offset 0x010 TSF DMA Interrupt Enable Register */
    __IOM uint32_t TSF_OIER;                          /*!< Offset 0x014 TSF Overlap Interrupt Enable Register */
    __IOM uint32_t TSF_DISR;                          /*!< Offset 0x018 TSF DMA Interrupt Status Register */
    __IOM uint32_t TSF_OISR;                          /*!< Offset 0x01C TSF Overlap Interrupt Status Register */
    __IOM uint32_t TSF_PCRCR;                         /*!< Offset 0x020 TSF PCR Control Register */
    __IOM uint32_t TSF_PCRDR;                         /*!< Offset 0x024 TSF PCR Data Register */
         RESERVED(0x028[0x0030 - 0x0028], uint8_t)
    __IOM uint32_t TSF_CENR;                          /*!< Offset 0x030 TSF Channel Enable Register */
    __IOM uint32_t TSF_CPER;                          /*!< Offset 0x034 TSF Channel PES Enable Register */
    __IOM uint32_t TSF_CDER;                          /*!< Offset 0x038 TSF Channel Descramble Enable Register */
    __IOM uint32_t TSF_CINDR;                         /*!< Offset 0x03C TSF Channel Index Register */
    __IOM uint32_t TSF_CCTLR;                         /*!< Offset 0x040 TSF Channel Control Register */
    __IOM uint32_t TSF_CSTAR;                         /*!< Offset 0x044 TSF Channel Status Register */
    __IOM uint32_t TSF_CCWIR;                         /*!< Offset 0x048 TSF Channel CW Index Register */
    __IOM uint32_t TSF_CPIDR;                         /*!< Offset 0x04C TSF Channel PID Register */
    __IOM uint32_t TSF_CBBAR;                         /*!< Offset 0x050 TSF Channel Buffer Base Address Register */
    __IOM uint32_t TSF_CBSZR;                         /*!< Offset 0x054 TSF Channel Buffer Size Register */
    __IOM uint32_t TSF_CBWPR;                         /*!< Offset 0x058 TSF Channel Buffer Write Pointer Register */
    __IOM uint32_t TSF_CBRPR;                         /*!< Offset 0x05C TSF Channel Buffer Read Pointer Register */
...
{
    __IOM uint32_t TSG_CTLR;                          /*!< Offset 0x000 TSG Control Register */
    __IOM uint32_t TSG_PPR;                           /*!< Offset 0x004 TSG Packet Parameter Register */
    __IOM uint32_t TSG_STAR;                          /*!< Offset 0x008 TSG Status Register */
    __IOM uint32_t TSG_CCR;                           /*!< Offset 0x00C TSG Clock Control Register */
    __IOM uint32_t TSG_BBAR;                          /*!< Offset 0x010 TSG Buffer Base Address Register */
    __IOM uint32_t TSG_BSZR;                          /*!< Offset 0x014 TSG Buffer Size Register */
    __IOM uint32_t TSG_BPR;                           /*!< Offset 0x018 TSG Buffer Pointer Register */
...
#endif /* HEADER__13407CD6_4A45_4d15_9E8C_7F0C1F8E0873__INCLUDED */
