...
typedef struct CCU_Type
{
    ...
    __IO uint32_t PLL_ISP_CTRL_REG;                   /*!< Offset 0x02C PLL_ISP Control Register */
         RESERVED(0x030[0x0044 - 0x0030], uint8_t)
    __IO uint32_t PLL_PERIPH1_CTRL_REG;               /*!< Offset 0x044 PLL_PERIPH1 Control Register */
         RESERVED(0x048[0x004C - 0x0048], uint8_t)
    __IO uint32_t PLL_DDR1_CTRL_REG;                  /*!< Offset 0x04C PLL_DDR1 Control Register */
    __IO uint32_t CPU_AXI_CFG_REG;                    /*!< Offset 0x050 CPU/AXI Configuration Register  */
    __IO uint32_t AHB1_APB1_CFG_REG;                  /*!< Offset 0x054 AHB/APB0 Configuration Register (AHB_APB0_CFG_REG) */
    ...
    __IO uint32_t SS_CLK_REG;                         /*!< Offset 0x09C SS Clock Register */
    __IO uint32_t SPI_CLK_REG;                        /*!< Offset 0x0A0 SPI Clock Register */
         RESERVED(0x0A4[0x00B0 - 0x00A4], uint8_t)
    __IO uint32_t I2S_PCM_CLK_REG;                    /*!< Offset 0x0B0 I2S/PCM Clock Register */
    ...
    __IO uint32_t PLL_DDR1_CFG_REG;                   /*!< Offset 0x0F8 PLL_DDR Configuration Register */
    ...
    __IO uint32_t TCON_CLK_REG;                       /*!< Offset 0x118 TCON Clock Register */
    ...
    __IO uint32_t MIPI_CSI_REG;                       /*!< Offset 0x16C MIPI_CSI Register */
    ...
    __IO uint32_t PLL_CPU_BIAS_REG;                   /*!< Offset 0x220 PLL_CPU Bias Register */
    ...
    __IO uint32_t PLL_ISP_BIAS_REG;                   /*!< Offset 0x238 PLL_ISP Bias Register */
    ...
    __IO uint32_t PLL_CPU_TUN_REG;                    /*!< Offset 0x250 PLL_CPU Tuning Register */
    ...
    __IO uint32_t PLL_CPU_PAT_CTRL_REG;               /*!< Offset 0x280 PLL_CPU Pattern Control Register  */
    __IO uint32_t PLL_AUDIO_PAT_CTRL_REG;             /*!< Offset 0x284 PLL_AUDIO Pattern Control Register */
    __IO uint32_t PLL_VIDEO_PAT_CTRL_REG;             /*!< Offset 0x288 PLL_VIDEO Pattern Control Register */
    ...
    __IO uint32_t PLL_ISP_PAT_CTRL_REG;               /*!< Offset 0x298 PLL_ISP Pattern Control Register */
         RESERVED(0x29C[0x02A4 - 0x029C], uint8_t)
    __IO uint32_t PLL_PERIPH1_PAT_CTRL_REG;           /*!< Offset 0x2A4 PLL_PERIPH1 Pattern Control Register */
...
typedef struct PWM_Type
{
    ...
    __IO uint32_t PWM_CH1_PERIOD;                     /*!< Offset 0x008 PWM Channel 1 Period Registe */
...
typedef struct RTC_Type
{
    ...
    __IO uint32_t ALARM1_IRQ_STA_REG;                 /*!< Offset 0x04C Alarm 1 IRQ Status Register */
    ...
    __IO uint32_t GP_DATA_REG [0x008];                /*!< Offset 0x100 General Purpose Register (N=0~7) */
...
typedef struct SYS_CFG_Type
{
    ...
    __I  uint32_t VER_REG;                            /*!< Offset 0x024 Version Register */
         RESERVED(0x028[0x0030 - 0x0028], uint8_t)
    __IO uint32_t EMAC_CLK_REG;                       /*!< Offset 0x030 EMAC-EPHY Clock Register */
...
typedef struct TIMER_Type
{
    ...
    __IO uint32_t CNT64_TEST_REG;                     /*!< Offset 0x0D0 64-bit Counter Test Mode Register */
    __IO uint32_t CNT64_CTRL_REG;                     /*!< Offset 0x0D4 64-bit Counter Control Register */
    __IO uint32_t CNT64_LOW_REG;                      /*!< Offset 0x0D8 64-bit Counter Low Register */
    __IO uint32_t CNT64_HIGH_REG;                     /*!< Offset 0x0DC 64-bit Counter High Register */
...
typedef struct USBPHYC_Type
{
    ...
    __IO uint32_t UTMI_TUNE;                          /*!< Offset 0x018 HSIC UTMI PHY TUNE Register(Default Value: 0x023438E4) */
         RESERVED(0x01C[0x0020 - 0x001C], uint8_t)
    __IO uint32_t HSIC_CFG;                           /*!< Offset 0x020 HSIC PHY CFG(Default Value: 0x00000000) */
    __IO uint32_t HSIC_PHY_STATUS;                    /*!< Offset 0x024 HSIC PHY STATUS(Default Value: 0x00000000 */
