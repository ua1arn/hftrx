 ...
 * allwnr_t153.h
 *
 * Copyright (c) 2026 by Genadi V. Zawidowski. All rights reserved.
 *
 *       For details of A7 CPUX signals, refer to the technical
 *       reference manual of DDI0464F_cortex_A7_mpcore_r0p5_trm.pdf.
 */

#ifndef ARCH_ALLWNR_T153_H_
#define ARCH_ALLWNR_T153_H_
