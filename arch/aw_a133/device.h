...
#define GIC_DISTRIBUTOR_BASE ((uintptr_t) 0x03021000) /*!< GIC_DISTRIBUTOR GICD Base */
...
typedef struct C0_CPUX_CFG_Type
{
    ...
    __IOM uint32_t C0_CPUx_CTRL_REG [0x004];          /*!< Offset 0x060 Cluster 0 CPU0..CPU03 Control Register */
...
typedef struct CCU_Type
{
    ...
    __IOM uint32_t PLL_PERI0_CTRL_REG;                /*!< Offset 0x020 PLL_PERI0 Control Register  */
         RESERVED(0x024[0x0028 - 0x0024], uint8_t)
    __IOM uint32_t PLL_PERI1_CTRL_REG;                /*!< Offset 0x028 PLL_PERI1 Control Register  */
         RESERVED(0x02C[0x0030 - 0x002C], uint8_t)
    __IOM uint32_t PLL_GPU_CTRL_REG;                  /*!< Offset 0x030 PLL_GPU Control Register  */
    ...
    __IOM uint32_t PLL_VIDEO2_CTRL_REG;               /*!< Offset 0x050 PLL_VIDEO2 Control Register  */
    ...
    __IOM uint32_t PLL_COM_CTRL_REG;                  /*!< Offset 0x060 PLL_COM Control Register  */
         RESERVED(0x064[0x0068 - 0x0064], uint8_t)
    __IOM uint32_t PLL_VIDEO3_CTRL_REG;               /*!< Offset 0x068 PLL_VIDEO3 Control Register  */
         RESERVED(0x06C[0x0078 - 0x006C], uint8_t)
    __IOM uint32_t PLL_AUDIO_CTRL_REG;                /*!< Offset 0x078 PLL_AUDIO Control Register  */
    ...
    __IOM uint32_t PLL_PERI0_PAT0_CTRL_REG;           /*!< Offset 0x120 PLL_PERI0 Pattern0 Control Register  */
    __IOM uint32_t PLL_PERI0_PAT1_CTRL_REG;           /*!< Offset 0x124 PLL_PERI0 Pattern1 Control Register  */
    __IOM uint32_t PLL_PERI1_PAT0_CTRL_REG;           /*!< Offset 0x128 PLL_PERI1 Pattern0 Control Register  */
    __IOM uint32_t PLL_PERI1_PAT1_CTRL_REG;           /*!< Offset 0x12C PLL_PERI1 Pattern1 Control Register  */
    __IOM uint32_t PLL_GPU0_PAT0_CTRL_REG;            /*!< Offset 0x130 PLL_GPU0 Pattern0 Control Register  */
    __IOM uint32_t PLL_GPU0_PAT1_CTRL_REG;            /*!< Offset 0x134 PLL_GPU0 Pattern1 Control Register  */
    ...
    __IOM uint32_t PLL_VIDEO2_PAT0_CTRL_REG;          /*!< Offset 0x150 PLL_VIDEO2 Pattern0 Control Register */
    __IOM uint32_t PLL_VIDEO2_PAT1_CTRL_REG;          /*!< Offset 0x154 PLL_VIDEO2 Pattern1 Control Register  */
    ...
    __IOM uint32_t PLL_COM_PAT0_CTRL_REG;             /*!< Offset 0x160 PLL_COM Pattern0 Control Register  */
    __IOM uint32_t PLL_COM_PAT1_CTRL_REG;             /*!< Offset 0x164 PLL_COM Pattern1 Control Register  */
    __IOM uint32_t PLL_VIDEO3_PAT0_CTRL_REG;          /*!< Offset 0x168 PLL_VIDEO3 Pattern0 Control Register  */
    __IOM uint32_t PLL_VIDEO3_PAT1_CTRL_REG;          /*!< Offset 0x16C PLL_VIDEO3 Pattern1 Control Register  */
         RESERVED(0x170[0x0178 - 0x0170], uint8_t)
    __IOM uint32_t PLL_AUDIO_PAT0_CTRL_REG;           /*!< Offset 0x178 PLL_AUDIO Pattern0 Control Register  */
    __IOM uint32_t PLL_AUDIO_PAT1_CTRL_REG;           /*!< Offset 0x17C PLL_AUDIO Pattern1 Control Register  */
         RESERVED(0x180[0x0300 - 0x0180], uint8_t)
    __IOM uint32_t PLL_CPUX_BIAS_REG;                 /*!< Offset 0x300 PLL_CPUX Bias Register  */
    ...
    __IOM uint32_t PLL_PERI0_BIAS_REG;                /*!< Offset 0x320 PLL_PERI0 Bias Register  */
         RESERVED(0x324[0x0328 - 0x0324], uint8_t)
    __IOM uint32_t PLL_PERI1_BIAS_REG;                /*!< Offset 0x328 PLL_PERI1 Bias Register  */
         RESERVED(0x32C[0x0330 - 0x032C], uint8_t)
    __IOM uint32_t PLL_GPU0_BIAS_REG;                 /*!< Offset 0x330 PLL_GPU0 Bias Register  */
    ...
    __IOM uint32_t PLL_VIDEO2_BIAS_REG;               /*!< Offset 0x350 PLL_VIDEO2 Bias Register  */
    ...
    __IOM uint32_t PLL_COM_BIAS_REG;                  /*!< Offset 0x360 PLL_COM Bias Register  */
         RESERVED(0x364[0x0368 - 0x0364], uint8_t)
    __IOM uint32_t PLL_VIDEO3_BIAS_REG;               /*!< Offset 0x368 PLL_VIDEO3 Bias Register  */
         RESERVED(0x36C[0x0378 - 0x036C], uint8_t)
    __IOM uint32_t PLL_AUDIO_BIAS_REG;                /*!< Offset 0x378 PLL_AUDIO Bias Register  */
         RESERVED(0x37C[0x0400 - 0x037C], uint8_t)
    __IOM uint32_t PLL_CPUX_TUN_REG;                  /*!< Offset 0x400 PLL_CPUX Tuning Register  */
         RESERVED(0x404[0x0500 - 0x0404], uint8_t)
    __IOM uint32_t C0_CPUX_AXI_CFG_REG;               /*!< Offset 0x500 CPUX_AXI Configuration Register  */
         RESERVED(0x504[0x0510 - 0x0504], uint8_t)
    __IOM uint32_t PSI_AHB1_AHB2_CFG_REG;             /*!< Offset 0x510 PSI_AHB1_AHB2 Configuration Register  */
         RESERVED(0x514[0x051C - 0x0514], uint8_t)
    __IOM uint32_t AHB3_CFG_REG;                      /*!< Offset 0x51C AHB3 Configuration Register  */
    __IOM uint32_t APB1_CFG_REG;                      /*!< Offset 0x520 APB1 Configuration Register  */
    __IOM uint32_t APB2_CFG_REG;                      /*!< Offset 0x524 APB2 Configuration Register  */
         RESERVED(0x528[0x0540 - 0x0528], uint8_t)
    __IOM uint32_t MBUS_CFG_REG;                      /*!< Offset 0x540 MBUS Configuration Register  */
    ...
    __IOM uint32_t GPU_CORE_CLK_REG;                  /*!< Offset 0x670 GPU Clock Register  */
         RESERVED(0x674[0x067C - 0x0674], uint8_t)
    __IOM uint32_t GPU_BGR_REG;                       /*!< Offset 0x67C GPU Bus Gating Reset Register  */
    ...
    __IOM uint32_t PSI_BGR_REG;                       /*!< Offset 0x79C PSI Bus Gating Reset Register  */
    ...
    __IOM uint32_t NAND0_0_CLK_REG;                   /*!< Offset 0x810 NAND0_0 Clock Register  */
    __IOM uint32_t NAND0_1_CLK_REG;                   /*!< Offset 0x814 NAND0_1 Clock Register  */
         RESERVED(0x818[0x082C - 0x0818], uint8_t)
    __IOM uint32_t NAND_BGR_REG;                      /*!< Offset 0x82C NAND Bus Gating Reset Register  */
    ...
    __IOM uint32_t SPI2_CLK_REG;                      /*!< Offset 0x948 SPI2 Clock Register  */
         RESERVED(0x94C[0x096C - 0x094C], uint8_t)
    __IOM uint32_t SPI_BGR_REG;                       /*!< Offset 0x96C SPI Bus Gating Reset Register  */
    __IOM uint32_t EMAC0_25M_CLK_REG;                 /*!< Offset 0x970 EMAC0_25M Clock Register  */
    ...
    __IOM uint32_t IRRX_CLK_REG;                      /*!< Offset 0x990 IRRX Clock Register  */
         RESERVED(0x994[0x099C - 0x0994], uint8_t)
    __IOM uint32_t IRRX_BGR_REG;                      /*!< Offset 0x99C IRRX Bus Gating Reset Register  */
    ...
    __IOM uint32_t I2SPCM0_CLK_REG;                   /*!< Offset 0xA10 I2S/PCM0 Clock Register  */
    __IOM uint32_t I2SPCM1_CLK_REG;                   /*!< Offset 0xA14 I2S/PCM1 Clock Register  */
    __IOM uint32_t I2SPCM2_CLK_REG;                   /*!< Offset 0xA18 I2S/PCM2 Clock Register  */
    __IOM uint32_t I2SPCM3_CLK_REG;                   /*!< Offset 0xA1C I2S/PCM3 Clock Register  */
    __IOM uint32_t I2SPCM_BGR_REG;                    /*!< Offset 0xA20 I2S/PCM Bus Gating Reset Register  */
    __IOM uint32_t OWA_CLK_REG;                       /*!< Offset 0xA24 OWA Clock Register  */
    ...
    __IOM uint32_t AUDIO_CODEC_DAC_1X_CLK_REG;        /*!< Offset 0xA50 AUDIO CODEC DAC 1X Clock Register  */
    __IOM uint32_t AUDIO_CODEC_ADC_1X_CLK_REG;        /*!< Offset 0xA54 AUDIO CODEC ADC 1X Clock Register  */
    __IOM uint32_t AUDIO_CODEC_4X_CLK_REG;            /*!< Offset 0xA58 AUDIO CODEC 4X Clock Register  */
    __IOM uint32_t AUDIO_CODEC_BGR_REG;               /*!< Offset 0xA5C AUDIO CODEC Bus Gating Reset Register  */
    ...
    __IOM uint32_t LRADC_BGR_REG;                     /*!< Offset 0xA9C LRADC Bus Gating Reset Register */
         RESERVED(0xAA0[0x0ABC - 0x0AA0], uint8_t)
    __IOM uint32_t DPSS_TOP0_BGR_REG;                 /*!< Offset 0xABC DPSS_TOP0 Bus Gating Reset Register  */
         RESERVED(0xAC0[0x0ACC - 0x0AC0], uint8_t)
    __IOM uint32_t DPSS_TOP1_BGR_REG;                 /*!< Offset 0xACC DPSS_TOP1 Bus Gating Reset Register  */
         RESERVED(0xAD0[0x0B24 - 0x0AD0], uint8_t)
    __IOM uint32_t MIPI_DSI_HOST0_CLK_REG;            /*!< Offset 0xB24 MIPI DSI Host0 Clock Register  */
         RESERVED(0xB28[0x0B4C - 0x0B28], uint8_t)
    __IOM uint32_t MIPI_BGR_REG;                      /*!< Offset 0xB4C MIPI DSI Bus Gating Reset Register  */
         RESERVED(0xB50[0x0B5C - 0x0B50], uint8_t)
    __IOM uint32_t DISPLAY_IF_TOP_BGR_REG;            /*!< Offset 0xB5C DISPLAY_IF_TOP Bus Gating Reset Register  */
    __IOM uint32_t TCON_LCD0_CLK_REG;                 /*!< Offset 0xB60 TCON LCD0 Clock Register  */
         RESERVED(0xB64[0x0B7C - 0x0B64], uint8_t)
    __IOM uint32_t TCON_LCD_BGR_REG;                  /*!< Offset 0xB7C TCON LCD Bus Gating Reset Register  */
    ...
    __IOM uint32_t CSI0_TOP_CLK_REG;                  /*!< Offset 0xC04 CSI0 TOP Clock Register  */
    __IOM uint32_t CSI0_0_MST_CLK_REG;                /*!< Offset 0xC08 CSI0_0 Master Clock Register  */
    __IOM uint32_t CSI0_1_MST_CLK_REG;                /*!< Offset 0xC0C CSI0_1 Master Clock Register  */
         RESERVED(0xC10[0x0C1C - 0x0C10], uint8_t)
    __IOM uint32_t CSI_BGR_REG;                       /*!< Offset 0xC1C CSI Bus Gating Reset Register  */
    __IOM uint32_t CSI_ISP_CLK_REG;                   /*!< Offset 0xC20 CSI ISP Clock Register  */
         RESERVED(0xC24[0x0C2C - 0x0C24], uint8_t)
    __IOM uint32_t CSI_ISP_BGR_REG;                   /*!< Offset 0xC2C CSI ISP Bus Gating Reset Register  */
         RESERVED(0xC30[0x0F00 - 0x0C30], uint8_t)
    __IOM uint32_t CCU_SEC_SWITCH_REG;                /*!< Offset 0xF00 CCU Security Switch Register  */
    __IOM uint32_t PLL_LOCK_DBG_CTRL_REG;             /*!< Offset 0xF04 PLL Lock Debug Control Register  */
         RESERVED(0xF08[0x0F20 - 0x0F08], uint8_t)
    __IOM uint32_t PLL_CPUX_HW_FM_REG;                /*!< Offset 0xF20 PLL_CPUX Hardware FM Register */
...
typedef struct CPU_SUBSYS_CTRL_Type
{
    ...
    __IOM uint32_t IRQ_FIQ_STATUS;                    /*!< Offset 0x014 IRQ/FIQ Status Register */
    ...
    __IOM uint32_t CPUx_CTRL_REG [0x004];             /*!< Offset 0x020 CPU0..CPU3 Control Register */
         RESERVED(0x030[0x0040 - 0x0030], uint8_t)
    struct
    {
        __IOM uint32_t LOW;                           /*!< Offset 0x040 Reset Vector Base Address Registerx_L */
        __IOM uint32_t HIGH;                          /*!< Offset 0x044 Reset Vector Base Address Registerx_H */
...
{
    __IOM uint32_t DSI_CTL_REG;                       /*!< Offset 0x000 DSI Control Register */
    __IOM uint32_t DSI_GINT0_REG;                     /*!< Offset 0x004 DSI Global Interrupt Register0 */
    __IOM uint32_t DSI_GINT1_REG;                     /*!< Offset 0x008 DSI Global Interrupt Register1 */
    __IOM uint32_t DSI_BASIC_CTL_REG;                 /*!< Offset 0x00C DSI Basic Control Register */
    __IOM uint32_t DSI_BASIC_CTL0_REG;                /*!< Offset 0x010 DSI Basic Control Register0 */
    __IOM uint32_t DSI_BASIC_CTL1_REG;                /*!< Offset 0x014 DSI Basic Control Register1 */
    __IOM uint32_t DSI_BASIC_SIZE0_REG;               /*!< Offset 0x018 DSI Basic Timing Register0 */
    __IOM uint32_t DSI_BASIC_SIZE1_REG;               /*!< Offset 0x01C DSI Basic Timing Register1 */
    __IOM uint32_t DSI_BASIC_INST0_REG [0x008];       /*!< Offset 0x020 DSI Basic Instruction Register0 (N=0,1,2,3,4,5,6,7) */
    __IOM uint32_t DSI_BASIC_INST1_REG;               /*!< Offset 0x040 DSI Basic Instruction Register1 */
    __IOM uint32_t DSI_BASIC_INST2_REG;               /*!< Offset 0x044 DSI Basic Instruction Register2 */
    __IOM uint32_t DSI_BASIC_INST3_REG;               /*!< Offset 0x048 DSI Basic Instruction Register3 */
    __IOM uint32_t DSI_BASIC_INST4_REG;               /*!< Offset 0x04C DSI Basic Instruction Register4 */
    __IOM uint32_t DSI_BASIC_INST5_REG;               /*!< Offset 0x050 DSI Basic Instruction Register5 */
    __IOM uint32_t DSI_BASIC_INST6_REG;               /*!< Offset 0x054 DSI Basic Instruction Register6 */
         RESERVED(0x058[0x0060 - 0x0058], uint8_t)
    __IOM uint32_t DSI_BASIC_TRAN0_REG;               /*!< Offset 0x060 DSI Basic Transmission Register0 */
         RESERVED(0x064[0x0078 - 0x0064], uint8_t)
    __IOM uint32_t DSI_BASIC_TRAN4_REG;               /*!< Offset 0x078 DSI Basic Transmission Register4 */
    __IOM uint32_t DSI_BASIC_TRAN5_REG;               /*!< Offset 0x07C DSI Basic Transmission Register5 */
    __IOM uint32_t DSI_PIXEL_CTL0_REG;                /*!< Offset 0x080 DSI Pixel Control Register0 */
         RESERVED(0x084[0x0090 - 0x0084], uint8_t)
    __IOM uint32_t DSI_PIXEL_PH_REG;                  /*!< Offset 0x090 DSI Pixel Packet Header Register */
    __IOM uint32_t DSI_PIXEL_PD_REG;                  /*!< Offset 0x094 DSI Pixel Packet Data Register */
    __IOM uint32_t DSI_PIXEL_PF0_REG;                 /*!< Offset 0x098 DSI Pixel Packet Footer Register0 */
    __IOM uint32_t DSI_PIXEL_PF1_REG;                 /*!< Offset 0x09C DSI Pixel Packet Footer Register1 */
         RESERVED(0x0A0[0x00B0 - 0x00A0], uint8_t)
    __IOM uint32_t DSI_SYNC_HSS_REG;                  /*!< Offset 0x0B0 DSI H Sync Start Register */
    __IOM uint32_t DSI_SYNC_HSE_REG;                  /*!< Offset 0x0B4 DSI H Sync End Register */
    __IOM uint32_t DSI_SYNC_VSS_REG;                  /*!< Offset 0x0B8 DSI V Sync Start Register */
    __IOM uint32_t DSI_SYNC_VSE_REG;                  /*!< Offset 0x0BC DSI V Sync End Register */
    __IOM uint32_t DSI_BLK_HSA0_REG;                  /*!< Offset 0x0C0 DSI Blanking H Sync Active Register0 */
    __IOM uint32_t DSI_BLK_HSA1_REG;                  /*!< Offset 0x0C4 DSI Blanking H Sync Active Register1 */
    __IOM uint32_t DSI_BLK_HBP0_REG;                  /*!< Offset 0x0C8 DSI Blanking H Back Porch Register0 */
    __IOM uint32_t DSI_BLK_HBP1_REG;                  /*!< Offset 0x0CC DSI Blanking H Back Porch Register0 */
    __IOM uint32_t DSI_BLK_HFP0_REG;                  /*!< Offset 0x0D0 DSI Blanking H Front Porch Register0 */
    __IOM uint32_t DSI_BLK_HFP1_REG;                  /*!< Offset 0x0D4 DSI Blanking H Front Porch Register1 */
         RESERVED(0x0D8[0x00E0 - 0x00D8], uint8_t)
    __IOM uint32_t DSI_BLK_HBLK0_REG;                 /*!< Offset 0x0E0 DSI H Blanking Register0 */
    __IOM uint32_t DSI_BLK_HBLK1_REG;                 /*!< Offset 0x0E4 DSI H Blanking Register1 */
    __IOM uint32_t DSI_BLK_VBLK0_REG;                 /*!< Offset 0x0E8 DSI V Blanking Register0 */
    __IOM uint32_t DSI_BLK_VBLK1_REG;                 /*!< Offset 0x0EC DSI V Blanking Register1 */
    __IOM uint32_t DSI_BURST_LINE_REG;                /*!< Offset 0x0F0 DSI Burst Line Register */
    __IOM uint32_t DSI_BURST_DRQ_REG;                 /*!< Offset 0x0F4 DSI Burst DRQ Register */
         RESERVED(0x0F8[0x00FC - 0x00F8], uint8_t)
    __IOM uint32_t DSI_DEBUG_REG;                     /*!< Offset 0x0FC DSI Debug Register */
         RESERVED(0x100[0x0120 - 0x0100], uint8_t)
    __IOM uint32_t DSI_BASIC_INST10_REG [0x007];      /*!< Offset 0x120 DSI Basic INST10 Register (N=0,1,2,3,4,5,6) */
         RESERVED(0x13C[0x0140 - 0x013C], uint8_t)
    __IOM uint32_t DSI_BASIC_INST11_REG;              /*!< Offset 0x140 DSI Basic INST11 Register */
         RESERVED(0x144[0x0148 - 0x0144], uint8_t)
    __IOM uint32_t DSI_BASIC_INST13_REG;              /*!< Offset 0x148 DSI Basic INST13 Register */
         RESERVED(0x14C[0x01F0 - 0x014C], uint8_t)
    __IOM uint32_t DSI_SAFE_PERIOD_REG;               /*!< Offset 0x1F0  */
         RESERVED(0x1F4[0x0200 - 0x01F4], uint8_t)
    __IOM uint32_t DSI_CMD_CTL_REG;                   /*!< Offset 0x200  */
         RESERVED(0x204[0x0240 - 0x0204], uint8_t)
    __IOM uint32_t DSI_CMD_RX_REG [0x008];            /*!< Offset 0x240 DSI Command RX Register (N=0,1,2,3,4,5,6,7) */
         RESERVED(0x260[0x02E0 - 0x0260], uint8_t)
    __IOM uint32_t DSI_DEBUG0_REG;                    /*!< Offset 0x2E0 DSI Debug Register0 */
    __IOM uint32_t DSI_DEBUG1_REG;                    /*!< Offset 0x2E4 DSI Debug Register1 */
         RESERVED(0x2E8[0x02EC - 0x02E8], uint8_t)
    __IOM uint32_t DSI_INST_DEBUG_REG;                /*!< Offset 0x2EC DSI INST Debug Register */
    __IOM uint32_t DSI_DEBUG2_REG;                    /*!< Offset 0x2F0 DSI Debug Register2 */
    __IOM uint32_t DSI_DEBUG3_REG;                    /*!< Offset 0x2F4 DSI Debug Register3 */
    __IOM uint32_t DSI_DEBUG4_REG;                    /*!< Offset 0x2F8  */
         RESERVED(0x2FC[0x0300 - 0x02FC], uint8_t)
    __IOM uint32_t DSI_CMD_TX_REG [0x040];            /*!< Offset 0x300 DSI Command TX Register (N=0,1,2,�,63) */
         RESERVED(0x400[0x0FF8 - 0x0400], uint8_t)
    __IOM uint32_t DSI_FIFO_BIST_REG;                 /*!< Offset 0xFF8 DSI FIFO Bist Register */
         RESERVED(0xFFC[0x1000 - 0x0FFC], uint8_t)
    __IOM uint32_t DPHY_CTL_REG;                      /*!< Offset 0x1000 DPHY Control Register */
    __IOM uint32_t DPHY_TX_CTL_REG;                   /*!< Offset 0x1004 DPHY TX Control Register */
         RESERVED(0x1008[0x1010 - 0x1008], uint8_t)
    __IOM uint32_t DPHY_TX_TIME0_REG;                 /*!< Offset 0x1010 DPHY TX Timing Parameter 0 Register */
    __IOM uint32_t DPHY_TX_TIME1_REG;                 /*!< Offset 0x1014 DPHY TX Timing Parameter 1 Register */
    __IOM uint32_t DPHY_TX_TIME2_REG;                 /*!< Offset 0x1018 DPHY TX Timing Parameter 2 Register */
    __IOM uint32_t DPHY_TX_TIME3_REG;                 /*!< Offset 0x101C DPHY TX Timing Parameter 3 Register */
    __IOM uint32_t DPHY_TX_TIME4_REG;                 /*!< Offset 0x1020 DPHY TX Timing Parameter 4 Register */
         RESERVED(0x1024[0x1030 - 0x1024], uint8_t)
    __IOM uint32_t DPHY_RX_TIME0_REG;                 /*!< Offset 0x1030 DPHY RX Timing Parameter 0 Register */
    __IOM uint32_t DPHY_RX_TIME1_REG;                 /*!< Offset 0x1034 DPHY RX Timing Parameter 1 Register */
         RESERVED(0x1038[0x1040 - 0x1038], uint8_t)
    __IOM uint32_t DPHY_RX_TIME3_REG;                 /*!< Offset 0x1040 DPHY RX Timing Parameter 3 Register */
         RESERVED(0x1044[0x104C - 0x1044], uint8_t)
    __IOM uint32_t DPHY_ANA0_REG;                     /*!< Offset 0x104C DPHY Analog 0 Register */
    __IOM uint32_t DPHY_ANA1_REG;                     /*!< Offset 0x1050 DPHY Analog 1 Register */
    __IOM uint32_t DPHY_ANA2_REG;                     /*!< Offset 0x1054 DPHY Analog 2 Register */
    __IOM uint32_t DPHY_ANA3_REG;                     /*!< Offset 0x1058 DPHY Analog 3 Register */
    __IOM uint32_t DPHY_ANA4_REG;                     /*!< Offset 0x105C DPHY Analog 4 Register */
    __IOM uint32_t DPHY_INT_EN0_REG;                  /*!< Offset 0x1060 DPHY Interrupt Enable 0 Register */
    __IOM uint32_t DPHY_INT_EN1_REG;                  /*!< Offset 0x1064 DPHY Interrupt Enable 1 Register */
    __IOM uint32_t DPHY_INT_EN2_REG;                  /*!< Offset 0x1068 DPHY Interrupt Enable 2 Register */
         RESERVED(0x106C[0x1070 - 0x106C], uint8_t)
    __IOM uint32_t DPHY_INT_PD0_REG;                  /*!< Offset 0x1070 DPHY Interrupt Pending 0 Register */
    __IOM uint32_t DPHY_INT_PD1_REG;                  /*!< Offset 0x1074 DPHY Interrupt Pending 1 Register */
         RESERVED(0x1078[0x10E0 - 0x1078], uint8_t)
    __IOM uint32_t DPHY_DBG0_REG;                     /*!< Offset 0x10E0 DPHY Debug 0 Register */
    __IOM uint32_t DPHY_DBG1_REG;                     /*!< Offset 0x10E4 DPHY Debug 1 Register */
    __IOM uint32_t DPHY_DBG2_REG;                     /*!< Offset 0x10E8 DPHY Debug 2 Register */
    __IOM uint32_t DPHY_DBG3_REG;                     /*!< Offset 0x10EC DPHY Debug 3 Register */
    __IOM uint32_t DPHY_DBG4_REG;                     /*!< Offset 0x10F0 DPHY Debug 4 Register */
         RESERVED(0x10F4[0x10F8 - 0x10F4], uint8_t)
    __IOM uint32_t DPHY_TX_SKEW_REG0;                 /*!< Offset 0x10F8 DPHY TX Skew Register0 */
    __IOM uint32_t DPHY_TX_SKEW_REG1;                 /*!< Offset 0x10FC DPHY TX Skew Register1 */
    __IOM uint32_t DPHY_TX_SKEW_REG2;                 /*!< Offset 0x1100 DPHY TX Skew Register2 */
    __IOM uint32_t DPHY_PLL_REG0;                     /*!< Offset 0x1104 DPHY PLL Register0 */
    __IOM uint32_t DPHY_PLL_REG1;                     /*!< Offset 0x1108 DPHY PLL Register1 */
         RESERVED(0x110C[0x1110 - 0x110C], uint8_t)
    __IOM uint32_t COMBO_PHY_REG0;                    /*!< Offset 0x1110 Combo PHY Register0 */
    __IOM uint32_t COMBO_PHY_REG1;                    /*!< Offset 0x1114 Combo PHY Register1 */
...
{
    __IOM uint32_t CPUS_CFG_REG;                      /*!< Offset 0x000 CPUS Configuration Register */
         RESERVED(0x004[0x000C - 0x0004], uint8_t)
    __IOM uint32_t APBS1_CFG_REG;                     /*!< Offset 0x00C APBS1 Configuration Register */
    ...
    __IOM uint32_t R_RSB_BGR_REG;                     /*!< Offset 0x1BC R_RSB Bus Gating Reset Register */
    __IOM uint32_t R_IR_RX_CLK_REG;                   /*!< Offset 0x1C0 R_IR_RX Clock Register */
         RESERVED(0x1C4[0x01CC - 0x01C4], uint8_t)
    __IOM uint32_t R_IR_RX_BGR_REG;                   /*!< Offset 0x1CC R_IR_RX Bus Gating Reset Register */
    ...
    __IOM uint32_t PLL_CTRL_REG0;                     /*!< Offset 0x240 PLL Control Register 0 */
    __IOM uint32_t PLL_CTRL_REG1;                     /*!< Offset 0x244 PLL Control Register 1 */
         RESERVED(0x248[0x0250 - 0x0248], uint8_t)
    __IOM uint32_t VDD_SYS_PWROFF_GATING_REG;         /*!< Offset 0x250 VDD_SYS Power Off Gating Register */
    __IOM uint32_t GPU_PWROFF_GATING;                 /*!< Offset 0x254 GPU Power Off Gating Register */
    __IOM uint32_t VE_PWROFF_GATING;                  /*!< Offset 0x258 VE Power Off Gating Register */
         RESERVED(0x25C[0x0270 - 0x025C], uint8_t)
    __IOM uint32_t RAM_CFG_REG;                       /*!< Offset 0x270 RAM Configuration Register */
    __IOM uint32_t RAM_TEST_CTRL_REG;                 /*!< Offset 0x274 RAM Test Control Register */
    ...
    __IOM uint32_t RES_CAL_CTRL_REG;                  /*!< Offset 0x310 Resistor Calibration Control Register */
    __IOM uint32_t RES200_CTRL_REG;                   /*!< Offset 0x314 200ohms Resistor Manual Control Register */
    __IOM uint32_t RES240_CTRL_REG;                   /*!< Offset 0x318 240ohms Resistor Manual Control Register */
    __IOM uint32_t RES_CAL_STATUS_REG;                /*!< Offset 0x31C Resistor Calibration Status Register */
    __IOM uint32_t NMI_IRQ_CTRL_REG;                  /*!< Offset 0x320 NMI Interrupt Control Register */
    __IOM uint32_t NMI_IRQ_ENABLE_REG;                /*!< Offset 0x324 NMI Interrupt Enable Register */
    __IOM uint32_t NMI_IRQ_PEND_REG;                  /*!< Offset 0x328 NMI Interrupt Pending Register */
...
{
    __IOM uint32_t USB_CTRL;                          /*!< Offset 0x000 HCI Interface Register - REG_ISCR 0x00 */
         RESERVED(0x004[0x0008 - 0x0004], uint8_t)
    __IOM uint32_t HCI_CTRL3;                         /*!< Offset 0x008 HCI Control 3 Register */
         RESERVED(0x00C[0x0010 - 0x000C], uint8_t)
    __IOM uint32_t PHY_CTRL;                          /*!< Offset 0x010 PHY Control Register  */
         RESERVED(0x014[0x001C - 0x0014], uint8_t)
    __IOM uint32_t HSIC_PHY_tune1;                    /*!< Offset 0x01C HSIC PHY Tune1 Register  */
    __IOM uint32_t HSIC_PHY_tune2;                    /*!< Offset 0x020 HSIC PHY Tune2 Register - REG_PHY_OTGCTL 0x20 */
    __IOM uint32_t HSIC_PHY_tune3;                    /*!< Offset 0x024 HSIC PHY Tune3 Register  */
