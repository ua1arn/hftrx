...
typedef enum IRQn
{
    ...
    USB0_DEVICE_IRQn = 45,                            /*!< USBOTG USB OTG Dual-Role Device controller */
...
{
    __IOM uint32_t msip;                              /*!< Offset 0x000 This register generates machine mode software interrupts when set. */
         RESERVED(0x004[0x4000 - 0x0004], uint8_t)
    __IOM uint32_t mtimecmplo;                        /*!< Offset 0x4000 This register holds the compare value for the timer. */
    __IOM uint32_t mtimecmphi;                        /*!< Offset 0x4004 This register holds the compare value for the timer. */
         RESERVED(0x4008[0xBFF8 - 0x4008], uint8_t)
    ...
    __IOM uint32_t mtimehi;                           /*!< Offset 0xBFFC Provides the current timer value. */
         RESERVED(0xC000[0xC000 - 0xC000], uint8_t)
...
{
    __IOM uint32_t PLIC_PRIO_REGn [0x400];            /*!< Offset 0x000 (0<n<256) PLIC Priority Register n - Interrupt Source Priority */
    __IOM uint32_t PLIC_IP_REGn [0x020];              /*!< Offset 0x1000 (0≤n<9) PLIC Interrupt Pending Register n - Interrupt Pending Bits */
         RESERVED(0x1080[0x2000 - 0x1080], uint8_t)
    __IOM uint32_t PLIC_MIE_REGn [0x020];             /*!< Offset 0x2000 (0≤n<9) PLIC Machine Mode Interrupt Enable Register n - Machine Interrupt Enable Bits */
    __IOM uint32_t PLIC_SIE_REGn [0x020];             /*!< Offset 0x2080 (0≤n<9) PLIC Superuser Mode Interrupt Enable Register n - Superuser Interrupt Enable Bits */
         RESERVED(0x2100[0x1FFFFC - 0x2100], uint8_t)
    __IOM uint32_t PLIC_CTRL_REG;                     /*!< Offset 0x1FFFFC PLIC Control Register */
    __IOM uint32_t PLIC_MTH_REG;                      /*!< Offset 0x200000 PLIC Machine Threshold Register - Priority Threshold  for context 0 */
    __IOM uint32_t PLIC_MCLAIM_REG;                   /*!< Offset 0x200004 PLIC Machine Claim Register (EOI) - Interrupt Claim Process for context 0 */
         RESERVED(0x200008[0x201000 - 0x200008], uint8_t)
    __IOM uint32_t PLIC_STH_REG;                      /*!< Offset 0x201000 PLIC Superuser Threshold Register - Priority Threshold  for context 1 */
    __IOM uint32_t PLIC_SCLAIM_REG;                   /*!< Offset 0x201004 PLIC Superuser Claim Register (EOI) - Interrupt Claim Process for context 1 */
...
typedef struct SYSMAP_Type
{
    struct
    {
        __IOM uint32_t ADDR;                          /*!< Offset 0x000 Upper 28 bits of an address. The largest address (noninclusive) of address space */
        __IOM uint32_t ATTR;                          /*!< Offset 0x004 Page attributes of memory */
