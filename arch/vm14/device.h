...
#define GIC_BASE ((uintptr_t) 0x39000000)             /*!< GIC  Base */
...
#define GICVSELF_BASE ((uintptr_t) 0x39004000)        /*!< GICV  Base */
#define GICV_BASE ((uintptr_t) 0x39005000)            /*!< GICV  Base */
...
typedef __PACKED_STRUCT CMCTR_Type
{
    ...
    __IO uint32_t DIV_NFC_CTR;                        /*!< Offset 0x038 Регистр делителя частоты NFC_SCLK */
    __IO uint32_t DIV_NOR_CTR;                        /*!< Offset 0x03C Регистр делителя частоты NOR_SCLK */
    __IO uint32_t DIV_SYS0_CTR;                       /*!< Offset 0x040 Регистр делителя частоты L1_HCLK и связанных с ней частот */
    ...
    __IO uint32_t SEL_SPLL;                           /*!< Offset 0x10C Регистр контроля SPLL */
    __IO uint32_t SEL_VPLL;                           /*!< Offset 0x110 Регистр контроля VPLL */
    __IO uint32_t SEL_UPLL;                           /*!< Offset 0x114 Регистр контроля UPLL */
...
typedef __PACKED_STRUCT GPIO_Type
{
    ...
    __IO uint32_t gpio_swport_ctl;                    /*!< Offset 0x008 Регистр источника данных порта А. W/R 0x0 0x08 */
...
typedef __PACKED_STRUCT GPIOBLOCK_Type
{
    ...
    __IO uint32_t gpio_swporta_ctl;                   /*!< Offset 0x008 Регистр источника данных порта А. W/R 0x0 0x08 */
    __IO uint32_t gpio_swportb_dr;                    /*!< Offset 0x00C Регистр данных порта B. W/R 0x0 0x0C  */
    __IO uint32_t gpio_swportb_ddr;                   /*!< Offset 0x010 Регистр направления потока данных через порт B. W/R 0x0 0x10 */
    __IO uint32_t gpio_swportb_ctl;                   /*!< Offset 0x014 Регистр источника данных порта B. W/R 0xFFFF 0x14 */
    __IO uint32_t gpio_swportc_dr;                    /*!< Offset 0x018 Регистр данных порта C. W/R 0x0 0x18 */
    __IO uint32_t gpio_swportc_ddr;                   /*!< Offset 0x01C Регистр направления потока данных через порт C. W/R 0x0 0x1C */
    __IO uint32_t gpio_swportc_ctl;                   /*!< Offset 0x020 Регистр источника данных порта C. W/R 0x0 0x20 */
    __IO uint32_t gpio_swportd_dr;                    /*!< Offset 0x024 Регистр данных порта D. W/R 0x0 0x24  */
    __IO uint32_t gpio_swportd_ddr;                   /*!< Offset 0x028 Регистр направления потока данных через порт D. W/R 0x0 0x28 */
    __IO uint32_t gpio_swportd_ctl;                   /*!< Offset 0x02C Регистр источника данных порта D. W/R 0x0 0x2C */
    __IO uint32_t gpio_inten;                         /*!< Offset 0x030 Регистр включения прерываний. W/R 0x0 0x30 */
    __IO uint32_t gpio_intmask;                       /*!< Offset 0x034 Регистр маскирования прерываний. W/R 0x0 0x34 */
    __IO uint32_t gpio_inttype_level;                 /*!< Offset 0x038 Регистр уровня прерываний. W/R 0x0 0x38 */
    __IO uint32_t gpio_int_polarity;                  /*!< Offset 0x03C Регистр полярности прерываний. W/R 0x0 0x3C */
    __IO uint32_t gpio_intstatus;                     /*!< Offset 0x040 Регистр статуса прерываний R 0x0 0x40 */
    __IO uint32_t gpio_raw_intstatus;                 /*!< Offset 0x044 Регистр статуса немаскированных прерываний R 0x0 0x44 */
    __IO uint32_t gpio_debounce;                      /*!< Offset 0x048 Регистр включения фильтра дребезга. W/R 0x0 0x48 */
    __IO uint32_t gpio_porta_eoi;                     /*!< Offset 0x04C Регистр сброса прерываний. W 0x0 0x4C */
    __IO uint32_t gpio_ext_porta;                     /*!< Offset 0x050 Внешний регистр порта А. R 0x0 0x50 */
    __IO uint32_t gpio_ext_portb;                     /*!< Offset 0x054 Внешний регистр порта B. R 0x0 0x54 */
    __IO uint32_t gpio_ext_portc;                     /*!< Offset 0x058 Внешний регистр порта C. R 0x0 0x58 */
    __IO uint32_t gpio_ext_portd;                     /*!< Offset 0x05C Внешний регистр порта D. R 0x0 0x5C */
    __IO uint32_t gpio_ls_sync;                       /*!< Offset 0x060 Регистр включения синхронизации прерываний по уровню. W/R 0x0 0x60 */
...
typedef __PACKED_STRUCT I2C_Type
{
    ...
    __IO uint32_t IC_SAR;                             /*!< Offset 0x008 Регистр slave-адреса. W/R 0x55 0x8 */
    __IO uint32_t IC_HS_MADD;                         /*!< Offset 0x00C Регистр кода адреса мастера для high speed режима. W/R 0x1 0xС */
    __IO uint32_t IC_DATA_CMD;                        /*!< Offset 0x010 Регистр управления передачей. W/R 0x0 0x10 */
    __IO uint32_t IC_SS_SCL_HCNT;                     /*!< Offset 0x014 Старший регистр счетчика предделителя частоты для standard.speed режима. W/R 0x190 0x14 */
    __IO uint32_t IC_SS_SCL_LCNT;                     /*!< Offset 0x018 Младший регистр счетчика предделителя частоты для standard.speed режима. W/R 0x1d6 0x18 */
    __IO uint32_t IC_FS_SCL_HCNT;                     /*!< Offset 0x01C Старший регистр счетчика предделителя частоты для fast-speed режима. W/R 0x3c 0x1C */
    __IO uint32_t IC_FS_SCL_LCNT;                     /*!< Offset 0x020 Младший регистр счетчика предделителя частоты для fast-speed режима. W/R 0x82 0x20 */
    __IO uint32_t IC_HS_SCL_HCNT;                     /*!< Offset 0x024 Старший регистр счетчика предделителя частоты для high-speed режима. W/R 0x6 0x24 */
    __IO uint32_t IC_HS_SCL_LCNT;                     /*!< Offset 0x028 Младший регистр счетчика предделителя частоты для high-speed режима. W/R 0x10 0x28 */
    __IO uint32_t IC_INTR_STAT;                       /*!< Offset 0x02C Регистр статуса прерывания. R 0x0 0x2C */
    __IO uint32_t IC_INTR_MASK;                       /*!< Offset 0x030 Регистр маски прерывания W/R 0x8ff 0X30 */
    __IO uint32_t IC_RAW_INTR_STAT;                   /*!< Offset 0x034 Регистр статуса необработанного прерывания R 0x0 0x34 */
    __IO uint32_t IC_RX_TL;                           /*!< Offset 0x038 Регистр порога заполнения FIFO приемника. W/R 0x0 0x38 */
    __IO uint32_t IC_TX_TL;                           /*!< Offset 0x03C Регистр порога заполнения FIFO передатчика. W/R 0x0 0x3C */
    __IO uint32_t IC_CLT_INTR;                        /*!< Offset 0x040 Регистр сброса прерываний. R 0x0 0x40 */
    __IO uint32_t C_CLR_RX_UNDER;                     /*!< Offset 0x044 Регистр сброса прерывания RX_UNDER R 0x0 0x44 */
    __IO uint32_t IC_CLR_RX_OVER;                     /*!< Offset 0x048 Регистр сброса прерывания RX_OVER R 0x0 0x48 */
    __IO uint32_t IC_CLR_TX_OVER;                     /*!< Offset 0x04C Регистр сброса прерывания TX_OVER R 0x0 0x4C */
    __IO uint32_t IC_CLR_RD_REQ;                      /*!< Offset 0x050 Регистр сброса прерывания RD_REQ R 0x0 0x50 */
    __IO uint32_t IC_CLR_TX_ABR;                      /*!< Offset 0x054 Регистр сброса прерывания TX_ABR R 0x0 0x54 */
    __IO uint32_t IC_CLR_RX_DONE;                     /*!< Offset 0x058 Регистр сброса прерывания RX_DONE R 0x0 0x58 */
    __IO uint32_t IC_CLR_ACTIVITY;                    /*!< Offset 0x05C Регистр сброса прерывания ACTIVITY R 0x0 0x5C */
    __IO uint32_t IC_CLR_STOP_DET;                    /*!< Offset 0x060 Регистр сброса прерывания STOP_DET R 0x0 0x60 */
    __IO uint32_t IC_CLR_START_DET;                   /*!< Offset 0x064 Регистр сброса прерывания START_DET R 0x0 0x64 */
    __IO uint32_t IC_CLR_GEN_CALL;                    /*!< Offset 0x068 Регистр сброса прерывания GEN_CALL R 0x0 0x68 */
    __IO uint32_t IC_ENABLE;                          /*!< Offset 0x06C Регистр включения шины. W/R 0x0 0x6C */
    __IO uint32_t IC_STATUS;                          /*!< Offset 0x070 Регистр статуса шины. R 0x6 0x70 */
    __IO uint32_t IC_TXFLR;                           /*!< Offset 0x074 Регистр уровня FIFO передатчика R 0x0 0x74 */
    __IO uint32_t IC_RXFLR;                           /*!< Offset 0x078 Регистр уровня FIFO приемника R 0x0 0x78 */
    __IO uint32_t IC_SDA_HOLD;                        /*!< Offset 0x07C Регистр времени удержания SDA. W/R 0x1 0x7C */
    __IO uint32_t IC_TX_ABRT_SOURCE;                  /*!< Offset 0x080 Регистр статуса обрыва передачи. R 0x0 0x80 */
    __IO uint32_t IC_SLV_DATA_NACK_ONLY;              /*!< Offset 0x084 Регистр генерирования SLV_DATA_NACK W/R 0x0 0x84 */
    __IO uint32_t IC_DMA_CR;                          /*!< Offset 0x088 Регистр контроля DMA интерфейса. W/R 0x0 0x88 */
    __IO uint32_t IC_DMA_TDLR;                        /*!< Offset 0x08C Регистр передачи данных через DMA интерфейс. W/R 0x0 0x8C */
    __IO uint32_t IC_DMA_RDLR;                        /*!< Offset 0x090 Регистр приема данных через DMA интерфейс. W/R 0x0 0x90 */
    __IO uint32_t IC_SDA_SETUP;                       /*!< Offset 0x094 Регистр установки SDA W/R 0x64 0x94 */
    __IO uint32_t IC_ACK_GENERAL_CALL;                /*!< Offset 0x098 Регистр вызова общего ACK W/R 0x1 0x98 */
    __IO uint32_t IC_ENABLE_STATUS;                   /*!< Offset 0x09C Регистр статуса включения R 0x0 0x9C */
    __IO uint32_t IC_FS_SPKLEN;                       /*!< Offset 0x0A0 Регистр управления фильтрацией для standard-speed и fast.speed режимов W/R 0x5 0xA0 */
    __IO uint32_t IC_HS_SPKLEN;                       /*!< Offset 0x0A4 Регистр управления фильтрацией для high.speed режима. W/R 0x1 0xA4 */
...
typedef __PACKED_STRUCT I2S_Type
{
    ...
    __IO uint32_t ITER;                               /*!< Offset 0x008 Регистр включения блока передачи. W/R 0x0 0x8 */
    __IO uint32_t CER;                                /*!< Offset 0x00C Регистр включения тактовой частоты. W/R 0x0 0xC */
    ...
    __IO uint32_t TER0;                               /*!< Offset 0x02C Регистр включения нулевого передатчика. W/R 0x1 0x2C */
    __IO uint32_t RCR0;                               /*!< Offset 0x030 Регистр конфигурации приемника. W/R 0x5 0x30 */
    __IO uint32_t TCR0;                               /*!< Offset 0x034 Регистр конфигурации нулевого передатчика. W/R 0x5 0x34 */
    __IO uint32_t ISR0;                               /*!< Offset 0x038 Регистр статуса прерывания нулевого канала. R 0x10 0x38 */
    __IO uint32_t IMR0;                               /*!< Offset 0x03C Регистр маски прерывания нулевого канала. W/R 0x33 0x3C */
    __IO uint32_t ROR0;                               /*!< Offset 0x040 Регистр переполнения FIFO приемника. R 0x0 0x40 */
    __IO uint32_t TOR0;                               /*!< Offset 0x044 Регистр переполнения FIFO нулевого передатчика. R 0x0 0x44 */
    __IO uint32_t RFCR0;                              /*!< Offset 0x048 Регистр конфигурации FIFO приемника. W/R 0x3 0x48 */
    ...
    __IO uint32_t I2S_COMP_TYPE;                      /*!< Offset 0x1FC Регистр типа компонента. R 0x445701a0 0x1FC */
...
typedef __PACKED_STRUCT MFBSP_Type
{
    ...
    __IO uint32_t DIR_MFBSP;                          /*!< Offset 0x008 R/W Регистр управления направлением выводов порта ввода-вывода */
    __IO uint32_t GPIO_DR;                            /*!< Offset 0x00C R/W Регистр данных порта ввода-вывода */
    __IO uint32_t TCTR;                               /*!< Offset 0x010 R/W Регистр управления передатчиком */
    __IO uint32_t RCTR;                               /*!< Offset 0x014 R/W Регистр управления приёмником  */
    __IO uint32_t TSR;                                /*!< Offset 0x018 R/W Регистр состояния передатчика */
    __IO uint32_t RSR;                                /*!< Offset 0x01C R/W Регистр состояния приёмника */
    __IO uint32_t TCTR_RATE;                          /*!< Offset 0x020 (null) */
    __IO uint32_t RCTR_RATE;                          /*!< Offset 0x024 (null) */
    __IO uint32_t TSTART;                             /*!< Offset 0x028 R/W псевдорегистр ten – запуск/останов передатчика без изменения настроек передатчика */
    __IO uint32_t RSTART;                             /*!< Offset 0x02C R/W псевдорегистр ren – запуск/останов приемника без изменения настроек приемника */
    __IO uint32_t EMERG_MFBSP;                        /*!< Offset 0x030 R/W Регистр аварийного управления портом */
    __IO uint32_t IMASK_MFBSP;                        /*!< Offset 0x034 R/W Регистр маски прерываний от порта */
...
typedef __PACKED_STRUCT NANDMPORT_Type
{
    ...
    __IO uint32_t MEMADDR2;                           /*!< Offset 0x008 RW Регистр адреса 2 */
    __IO uint32_t COMMAND;                            /*!< Offset 0x00C RW Регистр команды */
    __IO uint32_t PROGRAM;                            /*!< Offset 0x010 RW Регистр программы */
    __IO uint32_t INTERRUPT_STATUS_EN;                /*!< Offset 0x014 RW Регистр разрешения статуса прерываний */
    __IO uint32_t INTERRUPT_SIGNAL_EN;                /*!< Offset 0x018 RW Регистр разрешения сигнала прерываний */
    __IO uint32_t INTERRUPT_STATUS;                   /*!< Offset 0x01C RW Регистр статуса прерываний */
    __IO uint32_t ID1;                                /*!< Offset 0x020 RO Регистр ID1 */
    __IO uint32_t ID2;                                /*!< Offset 0x024 RO Регистр ID2 */
    __IO uint32_t FLASH_STATUS;                       /*!< Offset 0x028 RO Регистр статуса флэш-памяти */
    __IO uint32_t TIMING;                             /*!< Offset 0x02C RW Регистр временных параметров */
    __IO uint32_t BUFFER_DATA;                        /*!< Offset 0x030 RW Регистр данных буфера */
    __IO uint32_t ECC;                                /*!< Offset 0x034 RW Регистр ECC */
    __IO uint32_t ECC_ERROR_CNT;                      /*!< Offset 0x038 RO Счётчик ошибок ECC */
    __IO uint32_t ECC_SPARE_CMD;                      /*!< Offset 0x03C RW Регистр команд ECC */
    __IO uint32_t ERROR_CNT_1BIT;                     /*!< Offset 0x040 RW Счётчик 1-битных ошибок */
    __IO uint32_t ERROR_CNT_2BIT;                     /*!< Offset 0x044 RW Счётчик 2-битных ошибок */
    __IO uint32_t ERROR_CNT_3BIT;                     /*!< Offset 0x048 RW Счётчик 3-битных ошибок */
    __IO uint32_t ERROR_CNT_4BIT;                     /*!< Offset 0x04C RW Счётчик 4-битных ошибок */
    __IO uint32_t DMA_SYS_ADDR;                       /*!< Offset 0x050 RW Системный адрес DMA */
    __IO uint32_t DMA_BUFFER_BOUNDARY;                /*!< Offset 0x054 RW Граница DMA пересылки */
    __IO uint32_t CPU_STATE;                          /*!< Offset 0x058 RW Регистр состояния CPU */
    __IO uint32_t ERROR_COUNT_5BIT;                   /*!< Offset 0x05C RW Счётчик 5-битных ошибок */
...
typedef __PACKED_STRUCT NORMPORT_Type
{
    ...
    __IO uint32_t SMC_MEMC_CFG_CLR;                   /*!< Offset 0x100C WO Регистр сброса конфигурации контроллера */
    ...
    __IO uint32_t SMC_PERIPH_ID_4;                    /*!< Offset 0x1FEC RO ID регистр периферии 3 */
    __IO uint32_t SMC_PCELL_ID_0;                     /*!< Offset 0x1FF0 RO ID регистр компонента 0 */
...
typedef __PACKED_STRUCT PMCTR_Type
{
    ...
    __IO uint32_t SYS_PWR_INT;                        /*!< Offset 0x018 Регистр статуса прерывания SYS_PWR_INT */
    __IO uint32_t SYS_PWR_ICLR;                       /*!< Offset 0x01C Регистр очистки статуса прерывания SYS_PWR_INT */
    __IO uint32_t SYS_PWR_DELAY;                      /*!< Offset 0x020 Регистр задания задержек автоматов */
    ...
    __IO uint32_t NVMODE;                             /*!< Offset 0x04C Регистр управления сигналами NVMODE */
    __IO uint32_t CPU0_WKP_MASK [0x004];              /*!< Offset 0x050 Регистр маски включения домена CPU0 по прерываниям */
    __IO uint32_t CPU1_WKP_MASK [0x004];              /*!< Offset 0x060 Регистр маски включения домена CPU1 по прерываниям */
    ...
    __IO uint32_t CORE_PWR_ISTAT;                     /*!< Offset 0x098 Регистр статуса прерывания CORE_PWR_INT */
    __IO uint32_t CORE_PWR_ICLR;                      /*!< Offset 0x09C Регистр очистки статуса прерывания CORE_PWR_INT */
    __IO uint32_t CORE_PWR_DELAY;                     /*!< Offset 0x0A0 Регистр задания задержек автоматов доменов */
...
typedef __PACKED_STRUCT SDMA_Type
{
    ...
    __IO uint32_t INTCLR;                             /*!< Offset 0x02C WO Сброс прерываний */
...
typedef __PACKED_STRUCT SMCTR_Type
{
    ...
    __IO uint32_t EMA_ARM;                            /*!< Offset 0x030 Регистр подстройки памятей в ARM MPU */
    __IO uint32_t EMA_L2;                             /*!< Offset 0x034 Регистр подстройки памятей в L2CACHE */
    __IO uint32_t EMA_DSP;                            /*!< Offset 0x038 Регистр подстройки памятей в DSP и VPU */
    __IO uint32_t EMA_CORE;                           /*!< Offset 0x03C Регистр подстройки памятей в CORE */
    __IO uint32_t IOPULL_CTR;                         /*!< Offset 0x040 Регистры управления подтягивающими резисторами контактных площадок микросхемы */
    __IO uint32_t COMM_DLOCK;                         /*!< Offset 0x044 Регистр индикации зависания коммутатора микросхемы */
...
typedef __PACKED_STRUCT SWIC_Type
{
    ...
    __IO uint32_t RX_CODE;                            /*!< Offset 0x008 Регистр управляющего символа, принятого из сети (маркера времени, кода распределенного прерывания, кода подтверждения распределенного прерывания или кода CC11) RD 0x08 */
    __IO uint32_t MODE_CR;                            /*!< Offset 0x00C Регистр режима работы WR 0x0С */
    ...
    __IO uint32_t TRUE_TIME;                          /*!< Offset 0x02C Регистр, содержащий значение последнего правильного маркера времени и последнего принятого из сети маркера времени RD 0x2C */
    __IO uint32_t TOUT_CODE;                          /*!< Offset 0x030 Регистр размера таймаутов RD/WR 0x30 */
    __IO uint32_t ISR_tout_L;                         /*!< Offset 0x034 Младшие разряды регистра флагов таймаутов ISR RD/WR 0x34 */
    __IO uint32_t ISR_tout_H;                         /*!< Offset 0x038 Старшие разряды регистра флагов таймаутов ISR RD/WR 0x38 */
    __IO uint32_t LOG_ADDR;                           /*!< Offset 0x03C Регистр логического адреса RD/WR 0x3С */
    __IO uint32_t ack_nonack_regime;                  /*!< Offset 0x040 Регистр управления режимом распределенных прерываний (с подтверждениями или без подтверждений) RD/WR 0x40 */
    __IO uint32_t isr_touts2;                         /*!< Offset 0x044 Регистр таймаутов кодов распределенных прерываний 2 RD/WR 0x44 */
    __IO uint32_t ISR_handler_TERM_FUNCT;             /*!< Offset 0x048 Регистр флагов функций терминального узла –обработчика RD/WR 0x48 */
    __IO uint32_t ISR_SPEC;                           /*!< Offset 0x04C Регистр рассылки управляющих кодов в специальный набор портов RD/WR 0x4C */
    __IO uint32_t ISR_1101;                           /*!< Offset 0x050 Регистр флагов приема управляющих кодов, назначение которых не определено в текущей версии стандарта RD/WR 0x50 */
    __IO uint32_t ISR_MACK_1101;                      /*!< Offset 0x054 Регистр маски портов, из которых не должны приниматься управляющие коды, назначение которых не определено в текущей версии стандарта RD/WR 0x54 */
    __IO uint32_t INT_RESET;                          /*!< Offset 0x058 Регистр параметров команды внешнего сброса WR/RD 0x58 */
    __IO uint32_t STATUS2;                            /*!< Offset 0x05C Регистр состояния 0x5C */
    __IO uint32_t MODE_CR2;                           /*!< Offset 0x060 Регистр режима работы 2 0x60 */
    __IO uint32_t Int_H_mack;                         /*!< Offset 0x064 Старшая половина регистра маски распределенных прерываний WR/RD 0x64 */
    __IO uint32_t Int_L_mack;                         /*!< Offset 0x068 Младшая половина регистра маски распределенных прерываний WR/RD 0x68 */
    __IO uint32_t Ack_H_mack;                         /*!< Offset 0x06C Старшая половина регистра маски кодов подтверждения WR/RD 0x6C */
    __IO uint32_t Ackl_L_mack;                        /*!< Offset 0x070 Младшая половина регистра маски кодов подтверждения WR/RD 0x70 */
    __IO uint32_t AUTO_SPEED_MANAGE;                  /*!< Offset 0x074 Регистр параметров автоматической установки скорости передачи WR/RD 0x74 */
    __IO uint32_t ISR_source_TERM_FUNCT;              /*!< Offset 0x078 Регистр флагов функций терминального узла –источника 0x78 */
    __IO uint32_t ISR_spec_term_funct;                /*!< Offset 0x07C Регистр признака специальной функции для терминального узла обработчика 0x7C */
    __IO uint32_t ISR_L_reset;                        /*!< Offset 0x080 Младшая половина регистра глобального сброса ISR 0x80 */
    __IO uint32_t ISR_H_reset;                        /*!< Offset 0x084 Старшая половина регистра глобального сброса ISR 0x84 */
...
typedef __PACKED_STRUCT SWIC_MFBSP_DMA_Type
{
    ...
    __IO uint32_t IR;                                 /*!< Offset 0x008 Регистр индекса */
    __IO uint32_t RUN;                                /*!< Offset 0x00C На запись: Псевдорегистр управления состоянием бита RUN регистра CSR На чтение: Регистр управления и состояния без сброса битов «END» и «DONE» */
...
typedef __PACKED_STRUCT UART_Type
{
    ...
    __IO uint32_t UART_HTX;                           /*!< Offset 0x0A4  */
