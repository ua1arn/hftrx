...
typedef struct UART_Type
{
    ...
    __IOM uint32_t UART_SRBR_STHR;                    /*!< Offset 0x030 W 0x00000000 Shadow Receive Buffer Register, Shadow Transmit Holding Register */
         RESERVED(0x034[0x0070 - 0x0034], uint8_t)
    __IOM uint32_t UART_FAR;                          /*!< Offset 0x070 W 0x00000000 FIFO Access Register */
    __IOM uint32_t UART_TFR;                          /*!< Offset 0x074 W 0x00000000 Transmit FIFO Read */
    __IOM uint32_t UART_RFW;                          /*!< Offset 0x078 W 0x00000000 Receive FIFO write */
    __IOM uint32_t UART_USR;                          /*!< Offset 0x07C W 0x00000006 UART Status Register */
    __IOM uint32_t UART_TFL;                          /*!< Offset 0x080 W 0x00000000 Transmit FIFO level */
    __IOM uint32_t UART_RFL;                          /*!< Offset 0x084 W 0x00000000 Receive FIFO level */
    __IOM uint32_t UART_SRR;                          /*!< Offset 0x088 W 0x00000000 Software Reset Register */
    __IOM uint32_t UART_SRTS;                         /*!< Offset 0x08C W 0x00000000 Shadow Request to Send */
    __IOM uint32_t UART_SBCR;                         /*!< Offset 0x090 W 0x00000000 Shadow Break Control Register */
    __IOM uint32_t UART_SDMAM;                        /*!< Offset 0x094 W 0x00000000 Shadow DMA Mode */
    __IOM uint32_t UART_SFE;                          /*!< Offset 0x098 W 0x00000000 Shadow FIFO enable */
    __IOM uint32_t UART_SRT;                          /*!< Offset 0x09C W 0x00000000 Shadow RCVR Trigger */
    __IOM uint32_t UART_STET;                         /*!< Offset 0x0A0 W 0x00000000 Shadow TX Empty Trigger */
    __IOM uint32_t UART_HTX;                          /*!< Offset 0x0A4 W 0x00000000 Halt TX */
    __IOM uint32_t UART_DMASA;                        /*!< Offset 0x0A8 W 0x00000000 DMA Software Acknowledge */
         RESERVED(0x0AC[0x00F4 - 0x00AC], uint8_t)
    __IOM uint32_t UART_CPR;                          /*!< Offset 0x0F4 W 0x00043FF2 Component Parameter Register */
    __IOM uint32_t UART_UCV;                          /*!< Offset 0x0F8 W 0x3330382A UART Component Version */
    __IOM uint32_t UART_CTR;                          /*!< Offset 0x0FC W 0x44570110 Component Type Register */
