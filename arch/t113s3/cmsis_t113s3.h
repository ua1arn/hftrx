...
{
	uint32_t reserved_0x000 [0x0008];
	__IO uint32_t MSGBOX_RD_IRQ_EN_REG;                  /*!< Offset 0x020 MSGBOX Read IRQ Enable Register */
	__IO uint32_t MSGBOX_RD_IRQ_STATUS_REG;              /*!< Offset 0x024 MSGBOX Read IRQ Status Register */
	uint32_t reserved_0x028 [0x0002];
	__IO uint32_t MSGBOX_WR_IRQ_EN_REG;                  /*!< Offset 0x030 MSGBOX Write IRQ Enable Register */
	__IO uint32_t MSGBOX_WR_IRQ_STATUS_REG;              /*!< Offset 0x034 MSGBOX Write IRQ Status Register */
	uint32_t reserved_0x038 [0x0002];
	__IO uint32_t MSGBOX_DEBUG_REG;                      /*!< Offset 0x040 MSGBOX Debug Register */
	uint32_t reserved_0x044 [0x0003];
	__IO uint32_t MSGBOX_FIFO_STATUS_REG;                /*!< Offset 0x050 MSGBOX FIFO Status Register */
	uint32_t reserved_0x054 [0x0003];
	__IO uint32_t MSGBOX_MSG_STATUS_REG;                 /*!< Offset 0x060 MSGBOX Message Status Register */
	uint32_t reserved_0x064 [0x0003];
	__IO uint32_t MSGBOX_MSG_REG;                        /*!< Offset 0x070 MSGBOX Message Queue Register */
	uint32_t reserved_0x074 [0x0003];
	__IO uint32_t MSGBOX_WR_INT_THRESHOLD_REG;           /*!< Offset 0x080 MSGBOX Write IRQ Threshold Register */
...
#ifdef PRINTF
/* Print CPU_SUBSYS_CTRL */
static void CPU_SUBSYS_CTRL_Type_print(const CPU_SUBSYS_CTRL_TypeDef * p)
{
	PRINTF("%s->GENER_CTRL_REG0=0x%08X\n", p);	/*!< Offset 0x000 General Control Register0 */
	PRINTF("%s->GIC_JTAG_RST_CTRL=0x%08X\n", p);	/*!< Offset 0x00C GIC and JTAG Reset Control Register */
	PRINTF("%s->C0_INT_EN=0x%08X\n", p);	/*!< Offset 0x010 Cluster0 Interrupt Enable Control Register */
	PRINTF("%s->RQ_FIQ_STATUS=0x%08X\n", p);	/*!< Offset 0x014 IRQ/FIQ Status Register */
	PRINTF("%s->GENER_CTRL_REG2=0x%08X\n", p);	/*!< Offset 0x018 General Control Register2 */
	PRINTF("%s->DBG_STATE=0x%08X\n", p);	/*!< Offset 0x01C Debug State Register */
}
/* Print CCU */
static void CCU_Type_print(const CCU_TypeDef * p)
{
	...
	PRINTF("%s->CPU_AXI_CFG_REG=0x%08X\n", p);	/*!< Offset 0x500 CPU_AXI Configuration Register */
	PRINTF("%s->CPU_GATING_REG=0x%08X\n", p);	/*!< Offset 0x504 CPU_GATING Configuration Register */
	...
	PRINTF("%s->MSGBOX_BGR_REG=0x%08X\n", p);	/*!< Offset 0x71C MSGBOX Bus Gating Reset Register */
	PRINTF("%s->SPINLOCK_BGR_REG=0x%08X\n", p);	/*!< Offset 0x72C SPINLOCK Bus Gating Reset Register */
	...
	PRINTF("%s->DSP_CLK_REG=0x%08X\n", p);	/*!< Offset 0xC70 DSP Clock Register */
	PRINTF("%s->DSP_BGR_REG=0x%08X\n", p);	/*!< Offset 0xC7C DSP Bus Gating Reset Register */
	PRINTF("%s->PLL_LOCK_DBG_CTRL_REG=0x%08X\n", p);	/*!< Offset 0xF04 PLL Lock Debug Control Register */
	PRINTF("%s->FRE_DET_CTRL_REG=0x%08X\n", p);	/*!< Offset 0xF08 Frequency Detect Control Register */
	PRINTF("%s->FRE_UP_LIM_REG=0x%08X\n", p);	/*!< Offset 0xF0C Frequency Up Limit Register */
	PRINTF("%s->FRE_DOWN_LIM_REG=0x%08X\n", p);	/*!< Offset 0xF10 Frequency Down Limit Register */
	PRINTF("%s->CCU_FAN_GATE_REG=0x%08X\n", p);	/*!< Offset 0xF30 CCU FANOUT CLOCK GATE Register */
	PRINTF("%s->CLK27M_FAN_REG=0x%08X\n", p);	/*!< Offset 0xF34 CLK27M FANOUT Register */
	PRINTF("%s->PCLK_FAN_REG=0x%08X\n", p);	/*!< Offset 0xF38 PCLK FANOUT Register */
	PRINTF("%s->CCU_FAN_REG=0x%08X\n", p);	/*!< Offset 0xF3C CCU FANOUT Register */
}
/* Print SYS_CFG */
...
/* Print C0_CPUX_CFG */
static void C0_CPUX_CFG_Type_print(const C0_CPUX_CFG_TypeDef * p)
{
	PRINTF("%s->C0_RST_CTRL=0x%08X\n", p);	/*!< Offset 0x000 Cluster 0 Reset Control Register */
	PRINTF("%s->C0_CTRL_REG0=0x%08X\n", p);	/*!< Offset 0x010 Cluster 0 Control Register0 */
	PRINTF("%s->C0_CTRL_REG1=0x%08X\n", p);	/*!< Offset 0x014 Cluster 0 Control Register1 */
	PRINTF("%s->C0_CTRL_REG2=0x%08X\n", p);	/*!< Offset 0x018 Cluster 0 Control Register2 */
	PRINTF("%s->CACHE_CFG_REG=0x%08X\n", p);	/*!< Offset 0x024 Cache Configuration Register */
	PRINTF("%s->C0_CPU_STATUS=0x%08X\n", p);	/*!< Offset 0x080 Cluster 0 CPU Status Register */
	PRINTF("%s->L2_STATUS_REG=0x%08X\n", p);	/*!< Offset 0x084 Cluster 0 L2 Status Register */
	PRINTF("%s->DBG_REG0=0x%08X\n", p);	/*!< Offset 0x0C0 Cluster 0 Debug Control Register0 */
	PRINTF("%s->DBG_REG1=0x%08X\n", p);	/*!< Offset 0x0C4 Cluster 0 Debug Control Register1 */
	PRINTF("%s->AXI_MNT_CTRL_REG=0x%08X\n", p);	/*!< Offset 0x0D0 AXI Monitor Control Register */
	PRINTF("%s->AXI_MNT_PRD_REG=0x%08X\n", p);	/*!< Offset 0x0D4 AXI Monitor Period Register */
	PRINTF("%s->AXI_MNT_RLTCY_REG=0x%08X\n", p);	/*!< Offset 0x0D8 AXI Monitor Read Total Latency Register */
	PRINTF("%s->AXI_MNT_WLTCY_REG=0x%08X\n", p);	/*!< Offset 0x0DC AXI Monitor Write Total Latency Register */
	PRINTF("%s->AXI_MNT_RREQ_REG=0x%08X\n", p);	/*!< Offset 0x0E0 AXI Monitor Read Request Times Register */
	PRINTF("%s->AXI_MNT_WREQ_REG=0x%08X\n", p);	/*!< Offset 0x0E4 AXI Monitor Write Request Times Register */
	PRINTF("%s->AXI_MNT_RBD_REG=0x%08X\n", p);	/*!< Offset 0x0E8 AXI Monitor Read Bandwidth Register */
	PRINTF("%s->AXI_MNT_WBD_REG=0x%08X\n", p);	/*!< Offset 0x0EC AXI Monitor Write Bandwidth Register */
}
/* Print DDRPHYC */
...
/* Print SPINLOCK */
static void SPINLOCK_Type_print(const SPINLOCK_TypeDef * p)
{
	PRINTF("%s->SPINLOCK_SYSTATUS_REG=0x%08X\n", p);	/*!< Offset 0x000 Spinlock System Status Register */
	PRINTF("%s->SPINLOCK_STATUS_REG=0x%08X\n", p);	/*!< Offset 0x010 Spinlock Status Register */
	PRINTF("%s->SPINLOCK_IRQ_EN_REG=0x%08X\n", p);	/*!< Offset 0x020 Spinlock Interrupt Enable Register */
	PRINTF("%s->SPINLOCK_IRQ_STA_REG=0x%08X\n", p);	/*!< Offset 0x040 Spinlock Interrupt Status Register */
	PRINTF("%s->SPINLOCK_LOCKID0_REG=0x%08X\n", p);	/*!< Offset 0x080 Spinlock Lockid0 Register */
	PRINTF("%s->SPINLOCK_LOCKID1_REG=0x%08X\n", p);	/*!< Offset 0x084 Spinlock Lockid1 Register */
	PRINTF("%s->SPINLOCK_LOCKID2_REG=0x%08X\n", p);	/*!< Offset 0x088 Spinlock Lockid2 Register */
	PRINTF("%s->SPINLOCK_LOCKID3_REG=0x%08X\n", p);	/*!< Offset 0x08C Spinlock Lockid3 Register */
	PRINTF("%s->SPINLOCK_LOCKID4_REG=0x%08X\n", p);	/*!< Offset 0x090 Spinlock Lockid4 Register */
}
/* Print DMAC_CH */
...
/* Print MSGBOX */
static void MSGBOX_Type_print(const MSGBOX_TypeDef * p)
{
	PRINTF("%s->MSGBOX_RD_IRQ_EN_REG=0x%08X\n", p);	/*!< Offset 0x020 MSGBOX Read IRQ Enable Register */
	PRINTF("%s->MSGBOX_RD_IRQ_STATUS_REG=0x%08X\n", p);	/*!< Offset 0x024 MSGBOX Read IRQ Status Register */
	PRINTF("%s->MSGBOX_WR_IRQ_EN_REG=0x%08X\n", p);	/*!< Offset 0x030 MSGBOX Write IRQ Enable Register */
	PRINTF("%s->MSGBOX_WR_IRQ_STATUS_REG=0x%08X\n", p);	/*!< Offset 0x034 MSGBOX Write IRQ Status Register */
	PRINTF("%s->MSGBOX_DEBUG_REG=0x%08X\n", p);	/*!< Offset 0x040 MSGBOX Debug Register */
	PRINTF("%s->MSGBOX_FIFO_STATUS_REG=0x%08X\n", p);	/*!< Offset 0x050 MSGBOX FIFO Status Register */
	PRINTF("%s->MSGBOX_MSG_STATUS_REG=0x%08X\n", p);	/*!< Offset 0x060 MSGBOX Message Status Register */
	PRINTF("%s->MSGBOX_MSG_REG=0x%08X\n", p);	/*!< Offset 0x070 MSGBOX Message Queue Register */
	PRINTF("%s->MSGBOX_WR_INT_THRESHOLD_REG=0x%08X\n", p);	/*!< Offset 0x080 MSGBOX Write IRQ Threshold Register */
}
#endif /* PRINTF */
