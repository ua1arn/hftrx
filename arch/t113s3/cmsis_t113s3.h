...
typedef enum IRQn
{
    ...
    AUDIO_CODEC_IRQn = 57,                            /*!< AUDIO_CODEC Audio Codec Interrupt */
    ...
    TZMA_ERR_IRQn = 79,                               /*!< TZMA  Interrupt */
    CCU_FERR_IRQn = 80,                               /*!< CCU Clock Controller Unit (CCU) Interrupt */
    ...
    WATCHDOG_IRQn = 95,                               /*!< TIMER  Interrupt */
    ...
    TVE_IRQn = 123,                                   /*!< TVE_TOP TV Output (TV_Encoder) Interrupt */
    DSI0_IRQn = 124,                                  /*!< DSI MIPI DSI Display Interface Interrupt */
    TV_Encoder_IRQn = 126,                            /*!< TV_Encoder TV Encoder (display out interface = CVBS OUT) Interrupt */
